...
static bool CheckFormatValid(const aclTensor* permutedTokens,
                             const aclTensor* sortedIndices,
                             const aclTensor* routingMapOptional,
                             const aclTensor* probsOptional,
                             const aclTensor* unpermutedTokens,
                             ...
                             const aclTensor* permuteProbs)
{
    IsFormatSupport(permutedTokens, Format::FORMAT_ND, "permutedTokens");
    IsFormatSupport(sortedIndices, Format::FORMAT_ND, "sortedIndices");
    IsFormatSupport(routingMapOptional, Format::FORMAT_ND, "routingMapOptional");
    IsFormatSupport(probsOptional, Format::FORMAT_ND, "probsOptional");
    IsFormatSupport(unpermutedTokens, Format::FORMAT_ND, "unpermutedTokens");
    IsFormatSupport(outIndex, Format::FORMAT_ND, "outIndex");
    IsFormatSupport(permuteTokenId, Format::FORMAT_ND, "permuteTokenId");
    IsFormatSupport(permuteProbs, Format::FORMAT_ND, "permuteProbs");
    return true;
}
                               ...
                               aclTensor* unpermutedTokens, aclTensor* outIndex, aclTensor* permuteTokenId, aclTensor* permuteProbs)
{
    ...
    CHECK_RET(CheckFormatValid(permuteTokens, sortedIndices, routingMapOptional, probsOptional, unpermutedTokens, outIndex, permuteTokenId, permuteProbs), 
                              ACLNN_ERR_PARAM_INVALID);
