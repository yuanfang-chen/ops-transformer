...
- **参数说明**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>输入</td>
      <td>表示输入输出梯度的映射关系。</td>
      <td>非paddedMode模式要求索引取值范围[0，tokens_num * topK_num - 1]，<br>paddedMode模式索引取值范围[0，tokens_num - 1]。</td>
      <td>INT32</td>
      <td>ND</td>
      <td>非paddedMode模式：(tokens_num * topK_num)，<br>paddedMode模式：(experts_num * capacity)。</td>
      <td>√</td>
    </tr>
    <tr>
