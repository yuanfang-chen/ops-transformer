...
/*!
 * \file expert_mrgsort_out.h
 * \brief
 */
#ifndef EXPERT_MRGSORT_OUT_H
#define EXPERT_MRGSORT_OUT_H
...
class ExpertMrgsortOut
{
public:
    __aicore__ inline ExpertMrgsortOut(){};
    __aicore__ inline void Init(ExpertMrgsortParam* param, TPipe* tPipe);
...
private:
    ExpertMrgsortParam* param = nullptr;
...
__aicore__ inline void ExpertMrgsortOut::ClearCache()
{
    this->listNum = 0;
...
__aicore__ inline void ExpertMrgsortOut::SetInput(GlobalTensor<float>& gmInput, LocalTensor<float>& ubInput)
{
...
__aicore__ inline void ExpertMrgsortOut::SetOutput(GlobalTensor<int32_t>& gmOutput1, GlobalTensor<int32_t>& gmOutput2,
                                                   LocalTensor<float>& ubOutput1, LocalTensor<float>& ubOutput2)
{
...
__aicore__ inline void ExpertMrgsortOut::SetBuffer(LocalTensor<float>& tempBuffer)
{
    this->tempBuffer = tempBuffer;
}

__aicore__ inline void ExpertMrgsortOut::UpdateMrgParam()
{
...
__aicore__ inline void ExpertMrgsortOut::CopyIn()
{
...
__aicore__ inline void ExpertMrgsortOut::MrgsortCompute()
{
...
__aicore__ inline void ExpertMrgsortOut::UpdateSortInfo()
{
    curLoopSortedNum = 0;
    for (int64_t i = 0, j = 0; i < listNum; i++) {
        if (lengths[i] > 0) {
...
__aicore__ inline void ExpertMrgsortOut::Extract()
{
...
__aicore__ inline void ExpertMrgsortOut::CopyOut()
{
...
__aicore__ inline void ExpertMrgsortOut::Init(ExpertMrgsortParam* param, TPipe* tPipe)
{
    this->param = param;
    this->allRemainElements = 0;
...
__aicore__ inline void ExpertMrgsortOut::Process()
{
