...
/*!
 * \file expert_mrgsort.h
 * \brief
 */
#ifndef EXPERT_MRGSORT_H
#define EXPERT_MRGSORT_H
...
{
public:
    __aicore__ inline ExpertMrgsort(){};
    __aicore__ inline void Init(ExpertMrgsortParam* param);
...
__aicore__ inline void ExpertMrgsort::ClearCache()
{
    this->listNum = 0;
...
__aicore__ inline void ExpertMrgsort::SetInput(GlobalTensor<float>& gmInput, LocalTensor<float>& ubInput)
{
...
__aicore__ inline void ExpertMrgsort::SetOutput(GlobalTensor<float>& gmOutput, LocalTensor<float>& ubOutput)
{
    this->gmOutput = gmOutput;
    this->ubOutput = ubOutput;
}

__aicore__ inline void ExpertMrgsort::UpdateMrgParam()
{
...
__aicore__ inline void ExpertMrgsort::CopyIn()
{
...
__aicore__ inline void ExpertMrgsort::MrgsortCompute()
{
...
__aicore__ inline void ExpertMrgsort::UpdateSortInfo()
{
    curLoopSortedNum = 0;
    for (int64_t i = 0, j = 0; i < listNum; i++) {
        if (lengths[i] > 0) {
...
__aicore__ inline void ExpertMrgsort::CopyOut()
{
...
__aicore__ inline void ExpertMrgsort::Init(ExpertMrgsortParam* param)
{
    this->param = param;
...
__aicore__ inline void ExpertMrgsort::Process()
{
