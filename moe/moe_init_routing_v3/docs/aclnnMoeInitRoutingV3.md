...
- **参数说明**：
  ...
  <tbody>
    <tr>
      ...
      <td>shape为(NUM_ROWS, H)，quantMode=6时输入x支持类型HIFLOAT8</td>
    ...
    <tr>
      ...
      <td><ul>
        ...
        <li>非量化场景下数据类型同x，量化场景quantMode为0、1时数据类型支持INT8，quantMode为2、3时数据类型分别支持FLOAT8_E5M2、FLOAT8_E4M3FN，quantMode为6、7、8时数据类型分别支持HIFLOAT8。</li>
      </ul></td>
