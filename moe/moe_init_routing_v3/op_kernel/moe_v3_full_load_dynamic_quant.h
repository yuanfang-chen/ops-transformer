...
private:
    ...
    TQue<QuePosition::VECIN, 1> smoothInQueue_;   // 输入的量化因子
    TBuf<TPosition::VECCALC> tmpBuff_;            // 动态量化的中间结果
    TQue<QuePosition::VECOUT, 1> inputXOutQueue_; // 量化后的x
    TQue<QuePosition::VECOUT, 1> scaleOutQueue_;  // 输出的量化因子
...
template <typename T, const int COPYOUTTYPE, const int SMOOTHTYPE>
__aicore__ inline void MoeV3FullLoadDynamicQuant<T, COPYOUTTYPE, SMOOTHTYPE>::Init(
...
template <typename T, const int COPYOUTTYPE, const int SMOOTHTYPE>
__aicore__ inline void MoeV3FullLoadDynamicQuant<T, COPYOUTTYPE, SMOOTHTYPE>::Process()
{
...
template <typename T, const int COPYOUTTYPE, const int SMOOTHTYPE>
__aicore__ inline void MoeV3FullLoadDynamicQuant<T, COPYOUTTYPE, SMOOTHTYPE>::CopyOutXDynamicQuantFromScatter()
{
...
template <typename T, const int COPYOUTTYPE, const int SMOOTHTYPE>
__aicore__ inline void MoeV3FullLoadDynamicQuant<T, COPYOUTTYPE, SMOOTHTYPE>::CopyOutXDynamicQuantFromGather()
{
...
template <typename T, const int COPYOUTTYPE, const int SMOOTHTYPE>
__aicore__ inline void MoeV3FullLoadDynamicQuant<T, COPYOUTTYPE, SMOOTHTYPE>::FreeLocalTensor()
{
