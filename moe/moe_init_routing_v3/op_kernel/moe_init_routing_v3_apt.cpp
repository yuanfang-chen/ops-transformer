 ...
 * MXFP4量化
 */
#define MOE_INIT_ROUTING_V3_SORTONECORE_MXFP4QUANT_GATHER 9000000    // 单核排序、非量化、GATHER索引
#define MOE_INIT_ROUTING_V3_SORTONECORE_MXFP4QUANT_SCATTER 9001000   // 单核排序、非量化、SCATTER索引
#define MOE_INIT_ROUTING_V3_SORTMULTICORE_MXFP4QUANT_GATHER 9100000  // 多核排序、非量化、GATHER索引
#define MOE_INIT_ROUTING_V3_SORTMULTICORE_MXFP4QUANT_SCATTER 9101000 // 多核排序、非量化、SCATTER索引
