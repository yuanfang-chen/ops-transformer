 ...
 * MXFP4量化
 */
#define MOE_INIT_ROUTING_V3_SORTONECORE_MXFP4QUANT_GATHER 91030000    // 单核排序、MXFP4量化、GATHER索引
#define MOE_INIT_ROUTING_V3_SORTONECORE_MXFP4QUANT_SCATTER 9031000   // 单核排序、MXFP4量化、SCATTER索引
#define MOE_INIT_ROUTING_V3_SORTMULTICORE_MXFP4QUANT_GATHER 9130000  // 多核排序、MXFP4量化、GATHER索引
#define MOE_INIT_ROUTING_V3_SORTMULTICORE_MXFP4QUANT_SCATTER 9131000 // 多核排序、MXFP4量化、SCATTER索引
