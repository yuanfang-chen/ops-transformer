...
constexpr int64_t GATHER_OUT_HIF8_PERTENSOR_QUANT_BUFFER_NUM = 2;
...
__aicore__ inline void MoeGatherOutHif8PertensorQuant<T>::Compute()
{
    ...
    __VEC_SCOPE__
    {
        ...
        for (uint16_t i = 0; i < repeatTimes; i++) {
            ...
            MicroAPI::DataCopy(inUbAddr + i * FLOAT_REG_TENSOR_LENGTH, inReg, maskRegInLoop); // fp16/bf16转float后写回UB
