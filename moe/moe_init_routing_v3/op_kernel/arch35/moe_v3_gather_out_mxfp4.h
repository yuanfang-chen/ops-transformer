...
__aicore__ inline void MoeGatherOutFp4<T>::CopyScaleIn(int64_t scaleSrcOffset)
{
    ...
    DataCopyExtParams copyParams1{static_cast<uint16_t>(1), static_cast<uint32_t>(cols_ * sizeof(uint8_t) / 32), 0, 0, 0};
...
__aicore__ inline void MoeGatherOutFp4<T>::CopyScaleOut(int64_t scaleDstOffset)
{
    ...
    DataCopyExtParams copyParams3{1, static_cast<uint32_t>(cols_ * sizeof(uint8_t) / 32), 0, 0, 0};
