...
private:
    ...
    __aicore__ inline bool isUint8Type();
};
...
template <typename T>
__aicore__ inline bool MoeGatherOut<T>::isUint8Type()
{
    return IsSameType<T, hifloat8_t>::value || IsSameType<T, fp8_e4m3fn_t>::value || IsSameType<T, fp8_e5m2_t>::value;
}
