 ...
 * \brief
 */
#ifndef MOE_V3_ROW_IDX_GATHER_DROPPAD_H
#define MOE_V3_ROW_IDX_GATHER_DROPPAD_H
...
class MoeV3SrcToDstWithCapacity {
public:
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstWithCapacity<T, TilingData>::AssistInit()
{
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstWithCapacity<T, TilingData>::CopyIn(int64_t progress)
{
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstWithCapacity<T, TilingData>::CopyOut(int64_t progress)
{
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstWithCapacity<T, TilingData>::CopyOutRemain()
{
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstWithCapacity<T, TilingData>::SyncAll()
{
    if (coreNum == 1) {
        return;
    }
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstWithCapacity<T, TilingData>::Process()
{
...
#endif // MOE_V3_ROW_IDX_GATHER_DROPPAD_H