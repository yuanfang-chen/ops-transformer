...
/*!
 * \file moe_v3_row_idx_gather_droppad_dynamic.h
 * \brief
 */
#ifndef MOE_V3_ROW_IDX_GATHER_DROPPAD_DYNAMIC_H
#define MOE_V3_ROW_IDX_GATHER_DROPPAD_DYNAMIC_H
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstAndGather<T, TilingData>::AssistInit()
{
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstAndGather<T, TilingData>::CopyIn(int64_t progress)
{
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstAndGather<T, TilingData>::Compute(int32_t srcIdx, int32_t dstIdx, int32_t expertIdx)
{
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstAndGather<T, TilingData>::CopyOut(int64_t progress)
{
...
template <typename T, typename TilingData>
__aicore__ inline float MoeV3SrcToDstAndGather<T, TilingData>::ComputeMax(LocalTensor<float> &inLocal,
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstAndGather<T, TilingData>::ComputeScale(LocalTensor<float> &inLocal,
                                                                           LocalTensor<float> &tempLocal,
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstAndGather<T, TilingData>::ComputeLoops(int32_t srcIdx, int32_t dstIdx,
                                                                           int32_t expertIdx)
{
    LocalTensor<float> inLocal = inputXInQueue.AllocTensor<float>();
    LocalTensor<float> tempLocal = calcQueue.AllocTensor<float>();
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstAndGather<T, TilingData>::CopyOutLoops(int64_t progress)
{
    LocalTensor<int32_t> inLocal = copyInQueue.DeQue<int32_t>();
    LocalTensor<int32_t> outLocal = copyOutQueue.AllocTensor<int32_t>();
    int64_t length = Align(currentLoopRows, sizeof(int32_t));
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstAndGather<T, TilingData>::CopyOutRemain()
{
    DataCopyExtParams quantScaleParams{1, static_cast<uint32_t>(sizeof(int32_t)), 0, 0, 0};
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstAndGather<T, TilingData>::Process()
{
...
#endif // MOE_V3_ROW_IDX_GATHER_DROPPAD_DYNAMIC_H