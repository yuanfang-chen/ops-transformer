...
/*!
 * \file moe_v3_gather_droppad_static_quant.h
 * \brief
 */
#ifndef MOE_V3_GATHER_DROPPAD_STATIC_QUANT_H
#define MOE_V3_GATHER_DROPPAD_STATIC_QUANT_H
...
#endif // MOE_V3_GATHER_DROPPAD_STATIC_QUANT_H
