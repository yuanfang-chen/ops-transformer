...
* @li quant_mode: Optional parameter. Type is:Int. Valid values: -1(unquant), 0(static), 1(dynamic), 2(fp8_e5m2), 3(fp8_e4m3fn), 6(hif8 cast), 7(hif8_pertensor), 8(hif8_pertoken), 9(fp4_e2m1). Default: -1.
