...
uint64_t MoeInitRoutingV3Arch35TilingClass::GetTilingKey() const
{
    ...
    if (quantMode_ == QUANT_MODE_MXFP8_E5M2 || quantMode_ == QUANT_MODE_MXFP8_E4M3FN || quantMode_ == QUANT_MODE_MXFP4_E2M1) {
        ...
        // 对于MXFP4量化，TilingKey计算变更，不然会与非量化重合
        if (quantMode_ == QUANT_MODE_MXFP4_E2M1) {
            return static_cast<uint64_t>(QUANT_MODE_MXFP4_E2M1 * TILINGKEY_BASE + sortMode_ * SORT_CORE_TILINGKEY_BASE +
...
ge::graphStatus MoeInitRoutingV3Arch35TilingClass::CheckSetAttrs()
{
    ...
    OP_CHECK_IF(quantMode_ != QUANT_MODE_UNQUANT && quantMode_ != QUANT_MODE_DYNAMIC &&
                    ...
                    quantMode_ != QUANT_MODE_HIF8_PERTOKEN && quantMode_ != QUANT_MODE_MXFP4_E2M1,
                OP_LOGE(context_, "Attr quant_mode currently supports (%ld, %ld, %ld, %ld, %ld, %ld, %ld, %ld), but got %ld",
                        QUANT_MODE_UNQUANT, QUANT_MODE_DYNAMIC, QUANT_MODE_MXFP8_E5M2, QUANT_MODE_MXFP8_E4M3FN,
                        QUANT_MODE_HIF8_CAST, QUANT_MODE_HIF8_PERTENSOR, QUANT_MODE_HIF8_PERTOKEN, QUANT_MODE_MXFP4_E2M1, quantMode_),
                return ge::GRAPH_FAILED);
...
ge::graphStatus MoeInitRoutingV3Arch35TilingClass::CheckInputX()
{
    ...
    static const unordered_set<DataType> UNQUANT_SUPPORTED_DTYPES = {DataType::DT_FLOAT, DataType::DT_FLOAT16,
                                                                     ...
                                                                     DataType::DT_HIFLOAT8, ge::DT_FLOAT4_E2M1};
    ...
    static const std::unordered_set<DataType> MX_OR_HIF8_QUANT_SUPPORTED_DTYPES = {ge::DataType::DT_FLOAT16,
                                                                          ge::DataType::DT_BF16};
    static const std::unordered_set<DataType> MXFP4_QUANT_SUPPORT_DTYPES = {DataType::DT_FLOAT, DataType::DT_BF16, 
                                                                            DataType::DT_FLOAT16};
    ...
    if (quantMode_ == QUANT_MODE_MXFP8_E5M2 || quantMode_ == QUANT_MODE_MXFP8_E4M3FN || quantMode_ == QUANT_MODE_HIF8_CAST
        ...
        supportedDtypes = MXFP4_QUANT_SUPPORT_DTYPES;
    } else {
...
ge::graphStatus MoeInitRoutingV3Arch35TilingClass::CheckInputScale()
{
    ...
    OP_CHECK_IF(scaleDtype_ != ge::DataType::DT_FLOAT && scaleDtype_ != ge::DT_FLOAT8_E8M0,
                OP_LOGE(context_, "Unsupported dtype of input scale: %d, should be: DT_FLOAT(%d) or DT_FLOAT8_E8M0(%d) when dtype of x is fp4.", xDtype_,
