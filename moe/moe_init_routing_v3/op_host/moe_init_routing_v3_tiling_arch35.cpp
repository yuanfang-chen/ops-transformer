...
// bufferNumber保底为2
// 在此基础上检查剩余空间能容纳的额外行数
PerLoopParams MoeInitRoutingV3Arch35TilingClass::GetPerLoopParams(MultipleParams& multipleParams, int64_t perCoreIndicesElements)
{
    ...
    if (quantMode_ == QUANT_MODE_HIF8_PERTENSOR) {
        ...
        int64_t remainSpace = availUbSize_ - usedSpace;
        int64_t rowSpace = Align(perLoopParams.perLoopCols, inputXDtypeSize_);
