...
function(opbuild)
  ...
  execute_process(COMMAND ${CMAKE_COMPILE} -g -fPIC -shared -std=c++11 ${OPBUILD_OPS_SRC} -D_GLIBCXX_USE_CXX11_ABI=0
                  ...
                  -I ${ASCEND_CANN_PACKAGE_PATH}/${SYSTEM_PREFIX}/asc/include
                  -I ${ASCEND_CANN_PACKAGE_PATH}/${SYSTEM_PREFIX}/asc/include/basic_api
                  -I ${ASCEND_CANN_PACKAGE_PATH}/${SYSTEM_PREFIX}/asc/include/adv_api
                  -I ${ASCEND_CANN_PACKAGE_PATH}/${SYSTEM_PREFIX}/include/ascendc/highlevel_api
                  -I ${ASCEND_CANN_PACKAGE_PATH}/${SYSTEM_PREFIX}/pkg_inc
                  -I ${ASCEND_CANN_PACKAGE_PATH}/${SYSTEM_PREFIX}/pkg_inc/base
                  -I ${ASCEND_CANN_PACKAGE_PATH}/${SYSTEM_PREFIX}/pkg_inc/op_common
                  -I ${ASCEND_CANN_PACKAGE_PATH}/${SYSTEM_PREFIX}/pkg_inc/op_common/op_host
                  -I ${CMAKE_CURRENT_SOURCE_DIR}/../op_host
                  -I ${CMAKE_CURRENT_SOURCE_DIR}/../op_kernel
                  -L ${ASCEND_CANN_PACKAGE_PATH}/lib64
                  -L ${ASCEND_CANN_PACKAGE_PATH}/${SYSTEM_PREFIX}/lib64 
                  -lexe_graph -lregister -ltiling_api -lops_base
