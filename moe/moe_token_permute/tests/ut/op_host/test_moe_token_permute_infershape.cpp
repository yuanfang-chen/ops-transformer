...
protected:
    ...
    {
        std::cout << "MoeTokenPermuteProto SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MoeTokenPermuteProto TearDown" << std::endl;
    }
};
...
TEST_F(MoeTokenPermute, MoeTokenPermute_infershape_unkownshape)
{
    gert::InfershapeContextPara infershapeContextPara("MoeTokenPermute",
                                                      {
