...
/*!
 * \file prompt_flash_attention_pioneer.cpp
 * \brief
 */
...
// attention_pioneer only supports arch35
#include "arch35/prompt_flash_attention_pioneer_entry_regbase.h"

extern "C" __global__ __aicore__ void prompt_flash_attention_pioneer_FIAS(__gm__ uint8_t* query, __gm__ uint8_t* key, __gm__ uint8_t* value,
...
{
    {
        ...
        prompt_flash_attention_pioneer_FIAS_regbase(query, key, value, pseShift, attenMask, actualSeqLengths, actualSeqLengthsKV,
    ...
    #else
        prompt_flash_attention_pioneer_FIAS_arch32(query, key, value, pseShift, attenMask, actualSeqLengths,
...
extern "C" __global__ __aicore__ void prompt_flash_attention_pioneer(__gm__ uint8_t* query, __gm__ uint8_t* key, __gm__ uint8_t* value,
                                                             __gm__ uint8_t* pseShift, __gm__ uint8_t* attenMask,
                                                             __gm__ uint8_t* actualSeqLengths, __gm__ uint8_t* actualSeqLengthsKV,
                                                             __gm__ uint8_t* deq_scale1, __gm__ uint8_t* quant_scale1,
                                                             __gm__ uint8_t* deq_scale2, __gm__ uint8_t* quant_scale2,
                                                             ...
                                                             __gm__ uint8_t* workspace, __gm__ uint8_t* tiling)
{
    prompt_flash_attention_pioneer_FIAS(query, key, value, pseShift, attenMask, actualSeqLengths, actualSeqLengthsKV, deq_scale1, quant_scale1, deq_scale2, quant_scale2,
