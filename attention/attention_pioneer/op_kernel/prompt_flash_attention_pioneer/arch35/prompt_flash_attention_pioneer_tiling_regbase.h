...
/*!
 * \file prompt_flash_attention_pioneer_tiling_regbase.h
 * \brief
 */
#ifndef PROMPT_FLASH_ATTENTION_PIONEER_TILING_REGBASE_H
#define PROMPT_FLASH_ATTENTION_PIONEER_TILING_REGBASE_H
...
class PromptFlashAttentionPioneerTilingData {
public:
...
class PFAPioneerFullQuantTilingData {
public:
    ...
    void MigrateFromLegacyFormat(PromptFlashAttentionPioneerTilingData& tiling) {
