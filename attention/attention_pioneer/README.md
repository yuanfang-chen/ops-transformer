...
| 调用方式  | 样例代码                                                     | 说明                                                         |
| --------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| aclnn接口 | [test_aclnn_AttentionPioneer](./examples/test_aclnn_attention_pioneer.cpp) | 通过[aclnnAttentionPioneer](./docs/aclnnAttentionPioneer.md)调用AttentionPioneer算子 |
