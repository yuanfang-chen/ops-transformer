...
/*!
 * \file prompt_flash_attention_pioneer_tiling_v2.h
 * \brief
 */
...
#include "../../op_kernel/common/arch35/flash_attention_score_tiling_regbase.h"
...
class PromptFlashAttentionPioneerTilingV2 : public FiaTilingBase{
public:
    explicit PromptFlashAttentionPioneerTilingV2(gert::TilingContext *context) : FiaTilingBase(context) {}
    ~PromptFlashAttentionPioneerTilingV2() override = default;
    ...
    ge::graphStatus PromptFlashAttentionPioneerSetTilingData() const;
    bool CheckNonEmptyShapeExceptions(const ContextParamsForPFATiling& contextKeyParams, const gert::StorageShape* shape,
        const std::string &sName) const;
    ge::graphStatus DoSubOpTiling(PromptFlashAttentionPioneerTilingData& tilingData, ContextParamsForPFATiling& contextParamsForPFATiling);
...
protected:
    ...
    void PromptFlashAttentionPioneerInitOutputSplit(int64_t totalSize, PromptFlashAttentionPioneerTilingData &tilingData);
    ...
    bool SetAndCheckHeadNumRatio(ContextParamsForPFATiling& contextKeyParams, PromptFlashAttentionPioneerTilingData& tilingData);
    ...
    bool CheckBlockTableShape(ContextParamsForPFATiling& contextKeyParams, PFAShapeInfo& queryShapeInfo, PFAShapeInfo& queryRopeShapeInfo,
        const int32_t* blockSize, const gert::StorageShape* blockTableShape, PromptFlashAttentionPioneerTilingData& tilingData);
    ...
    bool CheckMaskShapeCrossSparse(ContextParamsForPFATiling& contextKeyParams, PromptFlashAttentionPioneerTilingData& tilingData,
    ...
    bool CheckQueryAndKey(ContextParamsForPFATiling& contextKeyParams, PFAShapeInfo& queryShapeInfo, 
        PFAShapeInfo& keyShapeInfo, PromptFlashAttentionPioneerTilingData& tilingData);
    ...
    bool CheckPATypeAndShape(ContextParamsForPFATiling& contextKeyParams, PFAShapeInfo& queryShapeInfo,
        PFAShapeInfo& queryRopeShapeInfo, PromptFlashAttentionPioneerTilingData& tilingData);
    bool CheckPseShiftTypeAndShape(ContextParamsForPFATiling& contextKeyParams, uint32_t b, uint32_t n,
        uint32_t s1, uint32_t s2);
    bool CheckInnerPrecise(ContextParamsForPFATiling& contextKeyParams, PromptFlashAttentionPioneerTilingData& tilingData);
    ...
    void PromptFlashAttentionPioneerSplitNBSeq(PromptFlashAttentionPioneerTilingData& tilingData, std::vector<int64_t>& actualSeqLengths,
    ...
    bool AdjustCVTilingCVDiff(const ContextParamsForPFATiling& contextKeyParams, uint32_t& sOuterFactor,
        uint32_t& sInnerFactor, uint32_t& softmaxSOuterFactor, PromptFlashAttentionPioneerTilingData& tilingData,
    ...
    bool PromptFlashAttentionPioneerCheckBmm2(PromptFlashAttentionPioneerTilingData& tilingData, TCubeTiling& bmm2TilingData,
    ...
    void GetPreNextTokensLeftUp(PromptFlashAttentionPioneerTilingData& tilingData, int64_t actualSeqLength, 
        int64_t actualSeqLengthKV, int64_t& preTokensLeftUp, int64_t& nextTokensLeftUp);
    void PromptFlashAttentionPioneerInitSoftmaxLseOutputSplit(int64_t totalSize, PromptFlashAttentionPioneerTilingData &tilingData);
    ...
    ge::graphStatus ComputeTilingData(ContextParamsForPFATiling& contextKeyParams, std::vector<int64_t>& actualSeqLengths,
        std::vector<int64_t>& actualSeqLengthsKV, PromptFlashAttentionPioneerTilingData& tilingData);
    ge::graphStatus ComputeTilingKey(ContextParamsForPFATiling& contextKeyParams,
        uint32_t& numBlocksToBeSet, PromptFlashAttentionPioneerTilingData& tilingData);
    void SetAttenMaskCompressMode();
    void SetLayoutType();
    void PFATilingDataconvert(PromptFlashAttentionPioneerTilingData& tilingData);
    ...
    ge::graphStatus SplitBNS(PromptFlashAttentionPioneerTilingData& tilingData, uint64_t bng);
    ...
    void UpdateTilingKeyPFAMask(PromptFlashAttentionPioneerTilingData& tilingData, ge::DataType inputDataType);
    void UpdateTilingKeyPFAMatMulType(PromptFlashAttentionPioneerTilingData& tilingData, ge::DataType inputDataType);
...
#endif  // AP_AIR_CXX_RUNTIME_V2_OP_IMPL_PROMPTFLASHATTENTIONPIONEER_V2_H_
