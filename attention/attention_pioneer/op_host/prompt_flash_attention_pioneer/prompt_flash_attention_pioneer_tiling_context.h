...
/*!
 * \file prompt_flash_attention_pioneer_tiling_context.h
 * \brief
 */
...
struct ContextParamsForPFATiling {
    ...
    const PromptFlashAttentionPioneerCompileInfo *compileInfoPtr = nullptr;
...
#endif // AP_PROMPT_FLASH_ATTENTION_PIONEER_TILING_CONTEXT_H
