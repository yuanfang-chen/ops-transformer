...
/*!
 * \file prompt_flash_attention_pioneer_tiling.h
 * \brief
 */
#ifndef AIR_CXX_RUNTIME_V2_OP_IMPL_PROMPTFLASHATTENTIONPIONEER_H_
#define AIR_CXX_RUNTIME_V2_OP_IMPL_PROMPTFLASHATTENTIONPIONEER_H_
...
#include "prompt_flash_attention_pioneer_tiling_const.h"
#include "prompt_flash_attention_pioneer_tiling_context.h"
#include "prompt_flash_attention_pioneer_tiling_struct.h"
#include "../common/fia_tiling_templates_registry.h"
...
BEGIN_TILING_DATA_DEF(PromptFlashAttentionPioneerTilingData)
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer, PromptFlashAttentionPioneerTilingData)
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_4000000000000000000, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_4000000000000000001, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_4000000000000000002, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_4000000000000000003, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_4000000000000100002, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_4000000000000100003, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_4000000000010000002, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_4000000000010000003, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_4000000000010100002, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_4000000000010100003, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_4000000000020000002, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_4000000000020000003, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_4000000000020100002, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_4000000000020100003, MLAGeneralTilingData)

BEGIN_TILING_DATA_DEF(PromptFlashAttentionPioneerBaseApiTilingData)
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_1000000000000112288, PromptFlashAttentionPioneerBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_1000000000000122288, PromptFlashAttentionPioneerBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_2000000002004000012, PromptFlashAttentionPioneerBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_2000000000004001012, PromptFlashAttentionPioneerBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_2000000010004001012, PromptFlashAttentionPioneerBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_2000000000004000012, PromptFlashAttentionPioneerBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_2000000010004000012, PromptFlashAttentionPioneerBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_2000000002004010112, PromptFlashAttentionPioneerBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_2000000000004010112, PromptFlashAttentionPioneerBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_2000000010004010112, PromptFlashAttentionPioneerBaseApiTilingData)
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_1000000000000000090, FlashAttentionScoreSimplifiedTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_10000000000000090, FlashAttentionScoreSimplifiedTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_1002312000040001212, FlashAttentionScoreSimplifiedTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_1002312000040021212, FlashAttentionScoreSimplifiedTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_1001311000000001212, FlashAttentionScoreSimplifiedTilingData)
REGISTER_TILING_DATA_CLASS(PromptFlashAttentionPioneer_1001311000000021212, FlashAttentionScoreSimplifiedTilingData)
...
class PromptFlashAttentionPioneerTiling : public FiaTilingBase {
public:    
    explicit PromptFlashAttentionPioneerTiling(gert::TilingContext *context) : FiaTilingBase(context), ascendcPlatform(nullptr) {}
    ~PromptFlashAttentionPioneerTiling() override = default;
    ...
    ge::graphStatus PromptFlashAttentionPioneerSetTilingData(gert::TilingContext* context,
                                                    PromptFlashAttentionPioneerTilingData& tilingData);
...
protected:
    ...
    ge::graphStatus TilingGetTilingKeyAttentionAscendC(uint64_t& tilingKey, ContextParamsForPFATiling& contextKeyParams,
                                                       bool useNewTiling, PromptFlashAttentionPioneerTilingData& tilingData);
    void PromptFlashAttentionPioneerSplitNS(const ContextParamsForPFATiling& contextKeyParams, PromptFlashAttentionPioneerTilingData& tilingData, uint32_t curCoreNum, const std::vector<int64_t>& actualSeqLengths);
    void PromptFlashAttentionPioneerSplitNSNew(const ContextParamsForPFATiling& contextKeyParams, PromptFlashAttentionPioneerTilingData& tilingData, uint32_t curCoreNum, const std::vector<int64_t>& actualSeqLengths,
                                        const std::vector<int64_t>& actualSeqLengthsKV, int64_t actualSharedPrefixLen, bool useBalanceTiling);
    void GetPreNextTokensLeftUp(PromptFlashAttentionPioneerTilingData& tilingData, uint32_t actualSeqLength, uint32_t actualSeqLengthKV, int64_t& preTokensLeftUp, int64_t& nextTokensLeftUp);
    void SetSplitCoreMode(PromptFlashAttentionPioneerTilingData& tilingData, uint32_t sOuterFactor);
    void PromptFlashAttentionPioneerSplitSeqOneN(PromptFlashAttentionPioneerTilingData& tilingData, uint32_t curCoreNum, bool isVectorCore);
    bool EnableMTE2BmmPipe(PromptFlashAttentionPioneerTilingData& tilingData, matmul_tiling::MatmulApiTiling& bmm,
    ...
    void PromptFlashAttentionPioneer310PSetBmm1(matmul_tiling::MatmulApiTiling& bmm1);
    void PromptFlashAttentionPioneer310PSetBmm2(matmul_tiling::MatmulApiTiling& bmm2);
    bool PromptFlashAttentionPioneerCheckBmm1(PromptFlashAttentionPioneerTilingData& tilingData, TCubeTiling& bmm1TilingData,
                                       int64_t l1SizeRemain, int64_t l0CSize,
                                       uint32_t sOuterFactor, uint32_t sInnerFactor,
                                       bool allGM = false, bool autoBaseMNK = false);
    bool PromptFlashAttentionPioneerCheckBmm2(PromptFlashAttentionPioneerTilingData& tilingData, TCubeTiling& bmm1TilingData,
                                       int64_t l1SizeRemain, int64_t l0CSize,
                                       uint32_t sOuterFactor, uint32_t sInnerFactor,
                                       uint32_t dSplitFactor, bool allGM = false, bool autoBaseMNK = false);
    void PromptFlashAttentionPioneerSetTensorSize(PromptFlashAttentionPioneerTilingData& tilingData,
                        PromptAttentionSingleCoreTensorSize& tensorSize, uint32_t sOuterFactor, uint32_t sInnerFactor);
    bool PromptFlashAttentionPioneerCheckArgsLegal(PromptFlashAttentionPioneerTilingData& tilingData, int64_t ubSize, int64_t l1Size,
    ...
    ge::graphStatus AdjustBasicBlock(PromptFlashAttentionPioneerTilingData& tilingData, uint32_t& sOuterFactor);
    ge::graphStatus PromptFlashAttentionPioneerApiTiling(PromptFlashAttentionPioneerTilingData& tilingData, uint32_t typeSize,
    ...
    uint32_t CalculateL1SizeUsed(PromptFlashAttentionPioneerTilingData& tilingData, const uint32_t typeByteSize);
    ...
    bool SetTilingHeadNumRatio(ContextParamsForPFATiling& contextKeyParams, const int32_t* numQueryHeads,
                               const int32_t* numKeyValueHeads, PromptFlashAttentionPioneerTilingData& tilingData);
    void PromptFlashAttentionPioneerInitOutputSplit(uint64_t totalSize, PromptFlashAttentionPioneerTilingData &tilingData,
                                             uint32_t curCoreNum);
    void PromptFlashAttentionPioneerInitSoftmaxLseOutputSplit(uint64_t totalSize, PromptFlashAttentionPioneerTilingData &tilingData);
    ...
    ge::graphStatus GetBasicShape910B(uint32_t &b, uint32_t &s, uint32_t &h, uint32_t &seqInnerSize,
                                      const gert::StorageShape *queryShape, const gert::StorageShape *keyShape, const uint32_t n);
    size_t GetPFAWorkSpaceSize(PromptFlashAttentionPioneerTilingData& tilingData);
    ...
    bool CheckActualSeqLength(ContextParamsForPFATiling& contextKeyParams, uint32_t b, uint32_t sQ, uint32_t sKV,
                              const gert::Tensor* actualSeqLenQ, const gert::Tensor* actualSeqLenKV, InputLayout inLayout, PromptFlashAttentionPioneerTilingData& tilingData);
    ...
    bool CheckPAAntiquantSupportScenarios(ContextParamsForPFATiling& contextKeyParams, PromptFlashAttentionPioneerTilingData& tilingData);
    ...
    ge::graphStatus PromptFlashAttentionPioneerCVDiffSetTensorSize(PromptFlashAttentionPioneerTilingData& tilingData,
        PromptAttentionSingleCoreTensorSize& tensorSize, uint32_t sOuterFactor,
        uint32_t sInnerFactor, uint32_t softmaxSOuterFactor);
    bool PromptFlashAttentionPioneerComputeCVDiffParams(PromptFlashAttentionPioneerTilingData& tilingData,
    ...
    bool FindOptimalTilingBasicBLock(PromptFlashAttentionPioneerTilingData& tilingData,
    ...
    bool FindOptimalTilingSouter(PromptFlashAttentionPioneerTilingData& tilingData,
        uint32_t& sOuterFactor, uint32_t &sInnerFactor, uint32_t &softmaxSOuterFactor,
        int64_t ubSize, uint32_t typeByteSize, uint32_t maskTypeSize);
    ...
    ge::graphStatus AdjustCVTiling(uint32_t hDivN, uint32_t n, int64_t middle_actualSeqLengths,
        ...
        uint32_t& sOuterFactor, uint32_t& sInnerFactor, PromptFlashAttentionPioneerTilingData& tilingData);
    ...
    int64_t PromptFlashAttentionPioneerSetMsdUbSize(PromptFlashAttentionPioneerTilingData& tilingData, PromptAttentionSingleCoreTensorSize& tensorSize, int32_t sInnerFactorTmp) const;
    ge::graphStatus CheckIOType(ContextParamsForPFATiling& contextKeyParams, PromptFlashAttentionPioneerTilingData& tilingData, int32_t& outputDataTypeSize);
    ...
    ge::graphStatus CheckMaskType(ContextParamsForPFATiling& contextKeyParams, PromptFlashAttentionPioneerTilingData& tilingData, uint32_t& maskElemSize) const;
    void SetMaskSize(const gert::StorageShape* attenMaskShape, PromptFlashAttentionPioneerTilingData& tilingData) const;
...
protected:
    ...
    bool isSameAB = true;
    PromptFlashAttentionPioneerBaseApiTilingData baseApiTilingData;
    MLAGeneralTilingData mlaTilingData;
};
// end of class PromptFlashAttentionPioneer
PFA_EXTERN_C ge::graphStatus TilingPromptFlashAttentionPioneer(gert::TilingContext* context);
} // namespace optiling

#endif  // AIR_CXX_RUNTIME_V2_OP_IMPL_PROMPTFLASHATTENTIONPIONEER_H_
