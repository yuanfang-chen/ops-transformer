...
#ifndef AP_FIA_TILING_BASE_H
#define AP_FIA_TILING_BASE_H
...
protected:
    ...
    [[nodiscard]] ge::graphStatus SetTilingData(optiling::TilingDef &tilingData) const
    {
