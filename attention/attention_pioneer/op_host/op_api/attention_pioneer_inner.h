...
#ifndef ACLNN_ATTENTION_PIONEER_INNER_H_
#define ACLNN_ATTENTION_PIONEER_INNER_H_
...
extern aclnnStatus aclnnInnerAttentionPioneerGetWorkspaceSize(
...
extern aclnnStatus aclnnInnerAttentionPioneerTensorGetWorkspaceSize(
    const aclTensor *query, const aclTensorList *key, const aclTensorList *value, const aclTensor *pseShift,
...
extern aclnnStatus aclnnInnerAttentionPioneer(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
                                                      const aclrtStream stream);

void AP_TensorPreProcess(const aclTensorList *&tensorListKey, const aclTensorList *&tensorListValue);
void AP_PrefixTensorPreProcess(const aclTensor *&tensorKey, const aclTensor *&tensorValue);
aclnnStatus AP_FakeArray(const aclIntArray *inArray, aclTensor *&outArray);

void AP_AttentionPioneerProcessSoftmaxLse(bool softmaxLseFlag, const aclTensor *softmaxLse,
