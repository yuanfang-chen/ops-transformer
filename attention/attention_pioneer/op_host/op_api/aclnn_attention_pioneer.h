...
#ifndef ACLNN_ATTENTION_PIONEER_H_
#define ACLNN_ATTENTION_PIONEER_H_
...
/**
 * @brief The first interface of aclnnAttentionPioneer calculates the workspace size based on the specific calculation process.
 * @domain aclnn_ops_infer
 */
__attribute__((visibility("default"))) aclnnStatus aclnnAttentionPioneerGetWorkspaceSize(
    ...
    const aclIntArray *kvStartIdxOptional, const aclTensor *keySink, const aclTensor *keyRopeSink, 
    const aclTensor *valueSink, int64_t numHeads, double scaleValue, int64_t preTokens,
...
/**
 * @brief The second interface of aclnnAttentionPioneer is used to perform calculations.
 */
__attribute__((visibility("default"))) aclnnStatus aclnnAttentionPioneer(void *workspace,
