...
/*!
 * \file attention_pioneer_def.cpp
 * \brief
 */
...
namespace ops {
class AttentionPioneer : public OpDef {
public:
    AttentionPioneer(const char *name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
        ...
        this->Input("key_sink")
            .ParamType(OPTIONAL)
            .DataTypeList({ge::DT_FLOAT16, ge::DT_BF16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        ...
        aicore_config_95.Input("key_sink")
            ...
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        aicore_config_95.Input("key_rope_sink")
            .ParamType(OPTIONAL)
            .DataTypeList({ge::DT_FLOAT16, ge::DT_BF16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        ...
        aicore_config_95.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "attention_pioneer")
            .ExtendCfgInfo("jitCompile.flag", "static_false,dynamic_false");
        this->AICore().AddConfig("ascend950", aicore_config_95);
    }
};
OP_ADD(AttentionPioneer, optiling::AttentionPioneerCompileInfo);
} // namespace ops