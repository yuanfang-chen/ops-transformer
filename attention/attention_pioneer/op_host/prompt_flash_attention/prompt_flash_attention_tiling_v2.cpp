...
#include "../../op_kernel/prompt_flash_attention/arch35/prompt_flash_attention_template_tiling_key.h"
...
REGISTER_TILING_TEMPLATE_FIA(AttentionPioneer, PromptFlashAttentionTilingV2, std::vector<int32_t>({static_cast<int32_t>(NpuArch::DAV_3510)}), 90);
} // namespace v2
} // namespace optiling
