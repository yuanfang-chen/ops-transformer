 ...
 * \brief
 */
#ifndef AP_AIR_CXX_RUNTIME_V2_OP_IMPL_PROMPTFLASHATTENTION_V2_H_
#define AP_AIR_CXX_RUNTIME_V2_OP_IMPL_PROMPTFLASHATTENTION_V2_H_
...
#include "../../op_kernel/prompt_flash_attention/arch35/prompt_flash_attention_tiling_regbase.h"
#include "../common/fia_tiling_base.h"

namespace ap_optiling {
namespace v2 {
using PromptFlashAttentionTilingData = ::optiling::PromptFlashAttentionTilingData;
using FlashAttentionScoreSimplifiedTilingData = ::optiling::FlashAttentionScoreSimplifiedTilingData;
...
#endif  // AP_AIR_CXX_RUNTIME_V2_OP_IMPL_PROMPTFLASHATTENTION_V2_H_
