...
// Case 7: Invalid layout - should fail
// DISABLED: Source code bug at attention_pioneer_infershape.cpp:115 - uses *inputLayoutPtr instead of inputLayoutPtr
// which causes SEGV when logging invalid layout string
TEST_F(AttentionPioneerProto, DISABLED_AttentionPioneer_infershape_invalid_layout)
{
    gert::InfershapeContextPara infershapeContextPara(
        "AttentionPioneer",
        {
         ...
         {{{}, {}}, ge::DT_FLOAT, ge::FORMAT_ND}},
        {
         ...
         {"pre_tokens", Ops::Transformer::AnyValue::CreateFrom<int64_t>(2)},
         {"next_tokens", Ops::Transformer::AnyValue::CreateFrom<int64_t>(5128)},
         {"input_layout", Ops::Transformer::AnyValue::CreateFrom<std::string>("INVALID")},
         {"num_key_value_heads", Ops::Transformer::AnyValue::CreateFrom<int64_t>(1)},
         {"sparse_mode", Ops::Transformer::AnyValue::CreateFrom<int64_t>(0)},
         {"inner_precise", Ops::Transformer::AnyValue::CreateFrom<int64_t>(3)},
         {"block_size", Ops::Transformer::AnyValue::CreateFrom<int64_t>(0)},
