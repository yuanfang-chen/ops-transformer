...
BEGIN_TILING_DATA_DEF(FFAGPreParams)
...
TILING_DATA_FIELD_DEF(uint32_t, k1v1PreBlockFactor);
TILING_DATA_FIELD_DEF(uint32_t, k1v1PreBlockTotal);
TILING_DATA_FIELD_DEF(uint32_t, k1v1PreBlockTail);
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(FFAGPreParamsOp, FFAGPreParams)

// sfmg pre
BEGIN_TILING_DATA_DEF(FFAGPreSfmgParams)
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(FFAGPreSfmgParamsOp, FFAGPreSfmgParams)

// dq/dv/dk cast fp322T1
BEGIN_TILING_DATA_DEF(FFAGPostParams)
...
TILING_DATA_FIELD_DEF(uint32_t, k1v1PostBlockFactor);
TILING_DATA_FIELD_DEF(uint32_t, k1v1PostBlockTotal);
TILING_DATA_FIELD_DEF(uint32_t, k1v1PostBaseNum);
TILING_DATA_FIELD_DEF(uint32_t, k1v1PostTailNum);
TILING_DATA_FIELD_DEF(uint64_t, qSizeAlign);
TILING_DATA_FIELD_DEF(uint64_t, kvSizeAlign);
TILING_DATA_FIELD_DEF(uint64_t, k1v1SizeAlign);
...
TILING_DATA_FIELD_DEF(uint64_t, dk1WorkSpaceOffset);
TILING_DATA_FIELD_DEF(uint64_t, dv1WorkSpaceOffset);
TILING_DATA_FIELD_DEF(int64_t, b);
TILING_DATA_FIELD_DEF(int64_t, n2);
TILING_DATA_FIELD_DEF(int64_t, g);
TILING_DATA_FIELD_DEF(int64_t, s1);
