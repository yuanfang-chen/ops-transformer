...
void FlashAttentionScoreGradTilingNormalRegbase::CalcleDeterParam()
{
    ...
    uint8_t deterTilingSplitMode = (fBaseParams.s1CvInner == fBaseParams.cvS2Inner ? 0 : (fBaseParams.s1CvInner > fBaseParams.cvS2Inner ? 2 : 1));
    int64_t s1Outer{fBaseParams.s1Outer}, s2Outer{fBaseParams.s2Outer}, s1Inner{fBaseParams.s1Inner}, s2Inner{fBaseParams.s2Inner};
    bool needChangeSplitItemMode2 = (deterTilingSplitMode == 2) && (fBaseParams.deterSparseType != static_cast<uint32_t>(DeterSparseType::DETER_DENSE));
    bool needChangeSplitItemMode1 = (deterTilingSplitMode == 1) && (fBaseParams.deterSparseType != static_cast<uint32_t>(DeterSparseType::DETER_DENSE));
...
ge::graphStatus FlashAttentionScoreGradTilingNormalRegbase::SaveToTilingData()
{
    ...
    bool isSplitByBlockIdx = fBaseParams.enableSwizzle &&
        ...
        fBaseParams.s1CvInner == fBaseParams.cvS2Inner;
