...
ge::graphStatus FlashAttentionScoreGradTilingUs1s2Bs2Regbase::ProcessQuantInfo()
{
    ...
    if (fBaseParams.queryType == ge::DT_HIFLOAT8) {
        ...
        if (!((fBaseParams.b == 1 && fBaseParams.s1 == 54000 && fBaseParams.n1 == 5 && fBaseParams.d == 128 &&
            ...
            OP_LOGD(context_, "Scenario HIFP8, query & key shape only support{[1, 54000, 5, 128], [1, 54000, 5, 128]}, {[1, 9360, 40, 128], [1, 9360, 40, 128]}, {[1, 54000, 10, 128], [1, 54000, 10, 128]}, {[1, 9360, 80, 128], [1, 9360, 80, 128]}, {[1, 57600, 5, 128], [1, 57600, 5, 128]}, {[1, 7200, 40, 128], [1, 512, 40, 128]}.");
        }
    }
