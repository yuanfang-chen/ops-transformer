...
public:
    ...
    __aicore__ inline void ProcessVec2(mm2ResPos &bmm2ResBuf, RunInfo_arch35 &runInfo,
        ConstInfo_arch35 &constInfo);
...
private:
    ...
    __aicore__ inline void ProcessNotSparseKv(Buffer<BufferType::L1, SyncType::CROSS_CORE_SYNC_FORWARD> &outputL1,
        const RunInfo_arch35 &runInfo, ConstInfo_arch35 &constInfo);
    __aicore__ inline int64_t GetkeyOffset(int64_t s2Idx, const RunInfo_arch35 &runInfo, ConstInfo_arch35 &constInfo);
    ...
    __aicore__ inline void CopyOutMrgeResult(Buffer<BufferType::L1, SyncType::CROSS_CORE_SYNC_FORWARD> &outputL1,
        int64_t mte2Size, int64_t mte3Size, int64_t s2keyOffset, int64_t mergeMte3Idx, const RunInfo_arch35 &runInfo);
    ...
    __aicore__ inline void Bmm2DataCopyOut(RunInfo_arch35 &runInfo, ConstInfo_arch35 &constInfo,
...
template <typename VEC2_RES_T, typename QSFAT>
...
template <typename VEC2_RES_, typename QSFAT>
...
template <typename QSFAT> __aicore__ inline void QSFAVectorService<QSFAT>::InitOutputSingleCore(ConstInfo_arch35 &constInfo)
{
    ...
    // n2 = 1, n1 = gn2 = gSize
    if (constInfo.layoutType == static_cast<uint8_t>(QSFA_LAYOUT::BSND)) {
        totalOutputSize = constInfo.bSize * constInfo.gSize * constInfo.s1Size * constInfo.dSizeV;
    } else if(constInfo.layoutType == static_cast<uint8_t>(QSFA_LAYOUT::TND)) {
