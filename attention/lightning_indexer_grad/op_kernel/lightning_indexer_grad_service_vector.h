    ...
    LIGCommon::ConstInfo constInfo, LIGCommon::RunInfo runInfo)
{
    ...
    // intriParams.blockCount = constInfo.groupNum;
    // intriParams.blockLen = constInfo.headDim * sizeof(dataType) / DATA_BLOCK_SIZE;
    // intriParams.srcStride = - constInfo.headDim * sizeof(dataType) / DATA_BLOCK_SIZE;
