...
public:
    ...
    void set_dkWorkSpaceOffset(int64_t dkWorkSpaceOffset) { this->dkWorkSpaceOffset = dkWorkSpaceOffset; }

    int64_t get_dkCoreWorkspaceOffset() const { return dkCoreWorkspaceOffset; }
    void set_dkCoreWorkspaceOffset(int64_t dkCoreWorkspaceOffset) { this->dkCoreWorkspaceOffset = dkCoreWorkspaceOffset; }

    int64_t get_keyGatherWorkspaceOffset() const { return keyGatherWorkspaceOffset; }
    void set_keyGatherWorkspaceOffset(int64_t keyGatherWorkspaceOffset) { this->keyGatherWorkspaceOffset = keyGatherWorkspaceOffset; }

    int64_t get_reluInWorkspaceOffset() const { return reluInWorkspaceOffset; }
    void set_reluInWorkspaceOffset(int64_t reluInWorkspaceOffset) { this->reluInWorkspaceOffset = reluInWorkspaceOffset; }

    int64_t get_reluGradWorkspaceOffset() const { return reluGradWorkspaceOffset; }
    void set_reluGradWorkspaceOffset(int64_t reluGradWorkspaceOffset) { this->reluGradWorkspaceOffset = reluGradWorkspaceOffset; }

    int64_t get_scatterAddWorkspaceOffset() const { return scatterAddWorkspaceOffset; }
    void set_scatterAddWorkspaceOffset(int64_t scatterAddWorkspaceOffset) { this->scatterAddWorkspaceOffset = scatterAddWorkspaceOffset; }
