...
__simd_vf__ void DequantVFImpl (__ubuf__ O* yAddr, __ubuf__ T* xAddr, __ubuf__ C * scalePerChannelAddr, __ubuf__ C * scalePerTokenAddr,
    const uint32_t floatRepSize, const uint32_t fp32BlockElementNum, uint32_t dLoops, uint32_t dTail, uint32_t dTailLoop, uint32_t row, uint32_t col, uint32_t stride)
{
...
{   
    ...
    const uint32_t floatRepSize = 64;
