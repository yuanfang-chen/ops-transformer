...
说明：MlaProlog算子已在Ascend 950产品侧注册支持，但本README中的`aclnnMlaProlog`调用方式属于废弃接口，`aclnnMlaProlog`和`aclnnMlaPrologGetWorkspaceSize`在Ascend 950上会返回运行时错误。Ascend 950请使用`aclnnMlaPrologV3WeightNz`。
...
| query                   | 输出      | 公式中Query的输出tensor（对应$q^N$） | BF16 | ND         |
| query_rope               | 输出      | 公式中Query位置编码的输出tensor（对应$q^R$） | BF16       | ND |


## 约束说明

-   该README中的调用说明基于废弃接口`aclnnMlaProlog`。算子在Ascend 950产品侧已注册支持，但`aclnnMlaProlog`和`aclnnMlaPrologGetWorkspaceSize`在Ascend 950上会返回运行时错误，建议改用`aclnnMlaPrologV3WeightNz`。
...
- 当前`aclnnMlaProlog`调用方式仅支持`cache_mode`取值为`PA_BSND`或`PA_NZ`。
    ...
    <table style="table-layout: auto;" border="1">
      ...
      <tr>
        ...
        <td>
            ...
            出参：kv_cache返回per-tensor量化数据，其余出参返回非量化数据
        </td>
      </tr>
    </table>
...
<tbody>
  <tr>
    ...
    <td class="tg-0pky">
    <a href="./examples/test_aclnn_mla_prolog.cpp">MlaProlog通用接口测试用例代码
    </a>
    </td>
  ...
  <tr>
    <td class="tg-0pky">
    <a href="./examples/test_aclnn_mla_prolog.cpp">MlaProlog通用量化场景测试用例代码
    </a>
</td>
  </tr>
  <tr>
    <td class="tg-0pky">
    <a href="./examples/test_aclnn_mla_prolog.cpp">MlaProlog通用PagedAttention场景测试用例代码
    </a>
  </td>
  </tr>
  <tr>
    <td class="tg-0pky">
    <a href="./examples/test_aclnn_mla_prolog.cpp">MlaProlog通用部分量化场景测试用例代码
    </a>
  </td>
  </tr>
  <tr>
    <td class="tg-0pky">
    <a href="./examples/test_aclnn_mla_prolog.cpp">MlaProlog通用全量化场景测试用例代码
    </a>
  </td>
  </tr>
</tbody></table>
