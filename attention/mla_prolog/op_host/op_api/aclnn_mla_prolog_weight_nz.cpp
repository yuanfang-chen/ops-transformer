...
#include "aclnn_mla_prolog_weight_nz.h"
...
aclnnStatus aclnnMlaPrologWeightNzGetWorkspaceSize(
...
aclnnStatus aclnnMlaPrologWeightNz(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
                                     const aclrtStream stream)
{
