...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvScfa<CubeBlockType, VecBlockType>::ComputeConstexpr()
{
    // 计算轴的乘积
    if ASCEND_IS_AIC {
        constInfo.bSize = this->sharedParams.bSize;
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvScfa<CubeBlockType, VecBlockType>::InitUniqueConstInfo()
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvScfa<CubeBlockType, VecBlockType>::Process()
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvScfa<CubeBlockType, VecBlockType>::ComputeAxisIdxByBnAndGs1(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvScfa<CubeBlockType, VecBlockType>::SetRunInfo(
...
SparseAttnSharedkvScfa<CubeBlockType, VecBlockType>::InitUniqueRunInfo(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvScfa<CubeBlockType, VecBlockType>::ComputeBmm1Tail(
