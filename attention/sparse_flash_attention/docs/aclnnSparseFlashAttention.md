...
int InitializeTensors(TensorResources& resources) {
    ...
    std::vector<int8_t> sparseIndicesHostData(sparseIndicesShapeSize, 1);
...
int ExecuteSparseFlashAttention(TensorResources& resources, aclrtStream stream, 
    ...
    memcpy(layoutQuery, layerOutStr, layerOutLen);
    memcpy(layoutKv, layerOutStr, layerOutLen);
