...
extern aclnnStatus aclnnSparseFlashAttentionGetWorkspaceSize(
    ...
    aclOpExecutor **executor)
{
    ...
    return aclnnSparseFlashAttentionGetWorkspaceSize(
...
aclnnStatus aclnnSparseFlashAttention(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
                                     const aclrtStream stream)
{
    return aclnnSparseFlashAttention(workspace, workspaceSize, executor, stream);
}
