...
const std::map<std::string, std::vector<SFALayout>> LAYOUT_SUPPORT_MAP = {
    ...
    {ATTEN_OUT_NAME,         {SFALayout::BNSG, SFALayout::NTG}},
    {ATTEN_OUT_NAME,         {SFALayout::BNSG, SFALayout::NTG}},
};
...
ge::graphStatus SFATilingCheck::CheckSoftmaxMaxShape()
{
    ...
    if (CompareShape(shapeParams, softmaxMaxShapeCmp_, softmaxMaxLayout_, ATTEN_OUT_NAME) != ge::GRAPH_SUCCESS) {
        return ge::GRAPH_FAILED;
    }
    return ge::GRAPH_SUCCESS;
}
...
ge::graphStatus SFATilingCheck::CheckSoftmaxSumShape()
{
    ...
    shapeParams.T = qTSize_;
    shapeParams.G = n1Size_/n2Size_;
    if (CompareShape(shapeParams, softmaxSumShapeCmp_, softmaxSumLayout_, ATTEN_OUT_NAME) != ge::GRAPH_SUCCESS) {
        return ge::GRAPH_FAILED;
    }
    return ge::GRAPH_SUCCESS;
}
