...
static constexpr uint32_t N_WORKSPACE_SIZE = 256; // n方向切分
...
constexpr uint32_t SY_GATHER_SPLIT_SIZE = 256;
constexpr uint32_t P_GATHER_SPLIT_SIZE = 128;
