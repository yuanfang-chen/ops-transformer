...
void SparseLightningIndexerGradKLLossTilingBase::SetSparseParamsRegbase()
{
    ...
    SetSparseStartIdx(sparseValidArray, validAicNum, totalSize, sparseStartIdx, splitFactorSize, static_cast<int64_t>(MAX_CORE_NUM));
}
