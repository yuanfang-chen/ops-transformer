 ...
 */
 ...
 #include "block_sparse_attention_kernel.h"

 using namespace NpuArch;
 
 namespace BlockSparse {
    // Block Sparse Attention Infer Interface
    // This template provides the entry point for block sparse attention kernels
