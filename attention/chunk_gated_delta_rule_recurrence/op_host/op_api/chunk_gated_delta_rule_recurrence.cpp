    ...
    aclOpExecutor   *executor)
{
    ...
    if (ret != ACLNN_SUCCESS) {
        OP_LOGE(ACLNN_ERR_PARAM_INVALID, "ChunkGatedDeltaRuleRecurrence InferShape failed.");
        return {nullptr, nullptr};
    }
    ...
    ret = ADD_TO_LAUNCHER_LIST_AICORE(
        ...
        OP_ATTR(scaleValue));
    if (ret != ACLNN_SUCCESS) {
        OP_LOGE(ACLNN_ERR_PARAM_INVALID, "ChunkGatedDeltaRuleRecurrence ADD_TO_LAUNCHER_LIST_AICORE failed.");
        return {nullptr, nullptr};
    }
