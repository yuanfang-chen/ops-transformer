...
def recurrent_gated_delta_rule(testcase_files):   # 初始化参数和tensor
    ...
    row_data = {
        ...
        "data_type": params[12],
        "query_datarange": params[13],
        "key_datarange": params[14],
        "value_datarange": params[15],
        "gamma_datarange": params[16],
        "gamma_k_datarange": params[17],
        "beta_datarange": params[18],
        "state_datarange": params[19],
        "result":result,
