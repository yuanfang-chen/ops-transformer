...
/*!
 * \file causal_conv1d_update_infershape.cpp
 * \brief
 */
...
ge::graphStatus InferShape4CausalConv1dUpdate(gert::InferShapeContext *context)
{
    OP_LOGD(context, "Begin to do InferShape4CausalConv1dUpdate");
    ...
    *outputConvStatesShape = *inputConvStatesShape;
    ...
    OP_LOGD(context, "End to do InferShape4CausalConv1dUpdate");
    return GRAPH_SUCCESS;
}

ge::graphStatus InferDataType4CausalConv1dUpdate(gert::InferDataTypeContext *context)
{
    OP_LOGD(context, "Begin to do InferDataType4CausalConv1dUpdate");
    ...
    OP_LOGD(context, "End to do InferDataType4CausalConv1dUpdate");
