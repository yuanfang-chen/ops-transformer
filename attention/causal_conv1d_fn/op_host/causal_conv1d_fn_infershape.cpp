...
/*!
 * \file causal_conv1d_fn_infershape.cpp
 * \brief
 */
...
ge::graphStatus InferShape4CausalConv1dFn(gert::InferShapeContext *context)
{
    OP_LOGD(context, "Begin to do InferShape4CausalConv1dFn");
    ...
    *outputConvStatesShape = *inputConvStatesShape;
    ...
    OP_LOGD(context, "End to do InferShape4CausalConv1dFn");
    return GRAPH_SUCCESS;
}

ge::graphStatus InferDataType4CausalConv1dFn(gert::InferDataTypeContext *context)
{
    OP_LOGD(context, "Begin to do InferDataType4CausalConv1dFn");
    ...
    OP_LOGD(context, "End to do InferDataType4CausalConv1dFn");
    return ge::GRAPH_SUCCESS;
}

IMPL_OP_INFERSHAPE(CausalConv1dFn)
    .InferShape(InferShape4CausalConv1dFn)
    .InferDataType(InferDataType4CausalConv1dFn);
