...
/*!
 * \file flash_attention_tiling_regbase.h
 * \brief FlashAttention arch35 tiling基类（非量化场景）
 *
 * 参照flash_attention_score/op_host/arch35/flash_attention_score_tiling_regbase.h框架，
 * 去除PSE/dropout/rope/量化相关内容，新增PA和metadata预计算tiling支持。
 */

#ifndef ARCH35_FLASH_ATTENTION_TILING_REGBASE_H_
#define ARCH35_FLASH_ATTENTION_TILING_REGBASE_H_
...
// 常量定义（参照flash_attention_score_tiling_regbase.h保持一致）
...
// layout枚举（与flash_attention_score对齐）
...
// ImplMode枚举（与flash_attention_score对齐）
...
// DTemplateType枚举（与flash_attention_score对齐）
...
// STemplateType枚举（与flash_attention_score对齐）
...
protected:
    ...
    // TilingData指针（直接复用FlashAttentionScoreSimplifiedTilingData）
...
#endif // ARCH35_FLASH_ATTENTION_TILING_REGBASE_H_
