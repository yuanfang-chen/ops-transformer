...
__simd_vf__ void ProcessVec1NoUpdateGeneralImpl256VF(
    ...
    const float slopes, const float posShift, const T scale, const T minValue, float sinkValue)
{
...
__aicore__ inline void ProcessVec1NoUpdateGeneralImpl256(
    ...
    const uint32_t pseStride, const float slopes, const float posShift, const T scale, const T minValue, float keepProb, float sinkValue)
{
