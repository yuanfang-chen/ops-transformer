...
__simd_vf__ void ProcessVec1UpdateGeneralImpl256VF(
    ...
    const float posShift, const T scale, const T minValue, const bool hasSink = false, const uint32_t sinkValue = 0)
{
...
__aicore__ inline void ProcessVec1UpdateGeneralImpl256(
    ...
    const T minValue, float keepProb, const bool hasSink = false, const uint32_t sinkValue = 0)
{
    ...
    ProcessVec1UpdateGeneralImpl256VF<T, T2, pseShiftType, s1BaseSize, s2BaseSize, hasAtten, pseMode, hasDrop>(
        ...
        divValue, pltN, m, pseStride, slopes, posShift, scale, minValue, hasSink, sinkValue);
}
} // namespace
