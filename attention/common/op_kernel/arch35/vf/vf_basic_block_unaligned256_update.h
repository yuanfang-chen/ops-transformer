    ...
    const float posShift, const T scale, const T minValue)
{
    ...
    for (uint16_t i = 0; i < m; ++i) {
        ...
        if constexpr (hasSink) {
            ...
            ExpSub(vreg_sink_input1, vreg_sink_input1, vreg_max, preg_all);
            ExpSub(vreg_sink_input2, vreg_sink_input2, vreg_max, preg_all);
            ExpSub(vreg_sink_input3, vreg_sink_input3, vreg_max, preg_all);
            ExpSub(vreg_sink_input4, vreg_sink_input4, vreg_max, preg_all);
        }
