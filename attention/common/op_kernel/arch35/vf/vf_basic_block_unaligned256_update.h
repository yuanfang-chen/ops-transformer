...
__simd_vf__ void ProcessVec1UpdateGeneralImpl256VF(
    ...
    const float posShift, const T scale, const T minValue, const bool hasSink = false, const float sinkValue = 0)
{
...
__aicore__ inline void ProcessVec1UpdateGeneralImpl256(
    ...
    const T minValue, float keepProb, const bool hasSink = false, const float sinkValue = 0)
{
