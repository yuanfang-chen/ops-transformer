...
namespace BaseApi {
namespace BlockCubeGqaFulquant {
...
private:
    ...
    static constexpr GmFormat Q_FORMAT = BlockCubeGqaFulquant::GetQueryGmFormat<layout>();
    static constexpr GmFormat KV_FORMAT = BlockCubeGqaFulquant::GetKVGmFormat<layout>();
    ...
    typename BlockCubeGqaFulquant::QL1BuffSel<INPUT_T, dBaseSize>::Type l1QBuffers;
    // mm1右矩阵K
    typename BlockCubeGqaFulquant::KVL1BuffSel<INPUT_T, s2BaseSize, dBaseSize>::Type l1KBuffers;

    // mm2右矩阵V
    typename BlockCubeGqaFulquant::KVL1BuffSel<INPUT_T, s2BaseSize, dBaseSize>::Type l1VBuffers;
    // L0A
    using L0AType = typename BlockCubeGqaFulquant::L0ABuffSel<INPUT_T>::Type;
    L0AType mmL0ABuffers;
    // L0B
    using L0BType = typename BlockCubeGqaFulquant::L0BBuffSel<INPUT_T, s2BaseSize, dBaseSize>::Type;
    L0BType mmL0BBuffers;
    // L0C
    using L0CType = typename BlockCubeGqaFulquant::L0CBuffSel<INPUT_T, s1BaseSize, s2BaseSize, dVBaseSize>::Type;
