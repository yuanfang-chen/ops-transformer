...
#define PROCESS_VEC1NZ_CASES(HAS_ATTEN_MASK) \
    if (runInfo.s2LoopCount == 0) { \
        if (runInfo.s2RealSize <= 256) { \
            ProcessVec1Vf<half, INPUT_T, pseShiftType, false, s1BaseSize, s2BaseSize, GT_0_AND_LTE_256, HAS_ATTEN_MASK, \
            ...
            ProcessVec1Vf<half, INPUT_T, pseShiftType, false, s1BaseSize, s2BaseSize, GT_256_AND_LTE_512, HAS_ATTEN_MASK, \
                pseMode, hasDrop, false, false, useNz>( \
                stage1CastTensor, this->vselrIndexesBuf, sumUb, maxUb, mmRes, expUb, sumUb, maxUb, \
                attenMaskUb, pseUb, dropMaskUb, apiTmpBuffer, pScaleUb, runInfo.halfS1RealSize, runInfo.s2RealSize, \
                pseInfoPtr->pseStride, slopes, posShift, static_cast<T>(constInfo.scaleValue), descaleQK, negativeFloatScalar, \
        ...
        if (runInfo.s2RealSize <= 256) { \
            ProcessVec1Vf<half, INPUT_T, pseShiftType, true, s1BaseSize, s2BaseSize, GT_0_AND_LTE_256, HAS_ATTEN_MASK, \
                pseMode, hasDrop, false, false, useNz>( \
                stage1CastTensor, this->vselrIndexesBuf, sumUb, maxUb, mmRes, expUb, sumUb, maxUb, \
                attenMaskUb, pseUb, dropMaskUb, apiTmpBuffer, pScaleUb, runInfo.halfS1RealSize, runInfo.s2RealSize, \
                pseInfoPtr->pseStride, slopes, posShift, static_cast<T>(constInfo.scaleValue), descaleQK, negativeFloatScalar, \
            ...
            ProcessVec1Vf<half, INPUT_T, pseShiftType, true, s1BaseSize, s2BaseSize, GT_256_AND_LTE_512, HAS_ATTEN_MASK, \
                pseMode, hasDrop, false, false, useNz>( \
                stage1CastTensor, this->vselrIndexesBuf, sumUb, maxUb, mmRes, expUb, sumUb, maxUb, \
                attenMaskUb, pseUb, dropMaskUb, apiTmpBuffer, pScaleUb, runInfo.halfS1RealSize, runInfo.s2RealSize, \
                pseInfoPtr->pseStride, slopes, posShift, static_cast<T>(constInfo.scaleValue), descaleQK, negativeFloatScalar, \
    ...
    ConstInfo<isInfer, hasRope> &constInfo)
{
    ...
    if (unlikely(runInfo.s2LoopCount == 0)) {
        if constexpr (isFp8) {
            if constexpr (hasAtten) {
                if (constInfo.hasAttenMaskRT) {
                    FaVectorApi::ProcessVec1VfDn<T, INPUT_T, false, true, s2BaseSize, false>(
        ...
        if constexpr (isFp8) {
            if constexpr (hasAtten) {
                if (constInfo.hasAttenMaskRT) {
                    FaVectorApi::ProcessVec1VfDn<T, INPUT_T, true, true, s2BaseSize, false>(
                        stage1CastTensor, sumUb, maxUb, mmRes, expUb, this->vselrIndexesBuf, attenMaskUb,
                        ((runInfo.s1RealSizeAlign32 >> 1) + 63) >> 6 << 6, runInfo.s2AlignedSize, runInfo.s2RealSize,
                        static_cast<T>(constInfo.scaleValue), descaleQK,
    ...
    if (constInfo.learnableSinkFlag) { \
        if (runInfo.s2LoopCount == 0) { \
            if (likely(runInfo.s2RealSize == 128)) { \
                ProcessVec1Vf<T, INPUT_T, pseShiftType, false, s1BaseSize, s2BaseSize, EQ_128, HAS_ATTEN_MASK, pseMode, \
                ...
                ProcessVec1Vf<T, INPUT_T, pseShiftType, false, s1BaseSize, s2BaseSize, GT_0_AND_LTE_64, HAS_ATTEN_MASK, \
                ...
                ProcessVec1Vf<T, INPUT_T, pseShiftType, false, s1BaseSize, s2BaseSize, GT_64_AND_LTE_128, HAS_ATTEN_MASK, \
                    pseMode, hasDrop, useMlaSgdFlag, isMlaFullQuant, false, true>( \
                    stage1CastTensor, this->vselrIndexesBuf, sumUb, maxUb, mmRes, expUb, sumUb, maxUb, \
                    attenMaskUb, pseUb, dropMaskUb, apiTmpBuffer, pScaleUb, runInfo.halfS1RealSize, runInfo.s2RealSize, \
                    pseInfoPtr->pseStride, slopes, posShift, static_cast<T>(constInfo.scaleValue), descaleQK, \
                ...
                ProcessVec1Vf<T, INPUT_T, pseShiftType, false, s1BaseSize, s2BaseSize, GT_128_AND_LTE_256, HAS_ATTEN_MASK, \
            ...
            if (likely(runInfo.s2RealSize == 128)) { \
                ProcessVec1Vf<T, INPUT_T, pseShiftType, true, s1BaseSize, s2BaseSize, EQ_128, HAS_ATTEN_MASK, pseMode, \
                    hasDrop, useMlaSgdFlag, isMlaFullQuant, false, true>( \
                    stage1CastTensor, this->vselrIndexesBuf, sumUb, maxUb, mmRes, expUb, sumUb, maxUb, \
                    attenMaskUb, pseUb, dropMaskUb, apiTmpBuffer, pScaleUb, runInfo.halfS1RealSize, runInfo.s2RealSize, \
                    pseInfoPtr->pseStride, slopes, posShift, static_cast<T>(constInfo.scaleValue), descaleQK, \
                ...
                ProcessVec1Vf<T, INPUT_T, pseShiftType, true, s1BaseSize, s2BaseSize, GT_0_AND_LTE_64, HAS_ATTEN_MASK, \
                    pseMode, hasDrop, useMlaSgdFlag, isMlaFullQuant, false, true>( \
                    stage1CastTensor, this->vselrIndexesBuf, sumUb, maxUb, mmRes, expUb, sumUb, maxUb, \
                    attenMaskUb, pseUb, dropMaskUb, apiTmpBuffer, pScaleUb, runInfo.halfS1RealSize, runInfo.s2RealSize, \
                    pseInfoPtr->pseStride, slopes, posShift, static_cast<T>(constInfo.scaleValue), descaleQK, \
                ...
                ProcessVec1Vf<T, INPUT_T, pseShiftType, true, s1BaseSize, s2BaseSize, GT_64_AND_LTE_128, HAS_ATTEN_MASK, \
                    pseMode, hasDrop, useMlaSgdFlag, isMlaFullQuant, false, true>( \
                    stage1CastTensor, this->vselrIndexesBuf, sumUb, maxUb, mmRes, expUb, sumUb, maxUb, \
                    attenMaskUb, pseUb, dropMaskUb, apiTmpBuffer, pScaleUb, runInfo.halfS1RealSize, runInfo.s2RealSize, \
                    pseInfoPtr->pseStride, slopes, posShift, static_cast<T>(constInfo.scaleValue), descaleQK, \
                ...
                ProcessVec1Vf<T, INPUT_T, pseShiftType, true, s1BaseSize, s2BaseSize, GT_128_AND_LTE_256, HAS_ATTEN_MASK, \
                    pseMode, hasDrop, false, false, false, true>( \
                    stage1CastTensor, this->vselrIndexesBuf, sumUb, maxUb, mmRes, expUb, sumUb, maxUb, \
                    attenMaskUb, pseUb, dropMaskUb, apiTmpBuffer, expUb, runInfo.halfS1RealSize, runInfo.s2RealSize, \
                    pseInfoPtr->pseStride, slopes, posShift, static_cast<T>(constInfo.scaleValue), descaleQK, \
