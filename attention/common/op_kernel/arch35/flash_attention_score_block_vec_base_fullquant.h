...
__aicore__ inline void FABlockVecBaseFullquant<TEMPLATE_BASE_ARGS>::UnInit()
{
    ...
    GetTPipePtr()->AllocEventID<HardEvent::MTE3_V>(mte3ToVId[0]);
    GetTPipePtr()->AllocEventID<HardEvent::MTE3_V>(mte3ToVId[1]);
    GetTPipePtr()->AllocEventID<HardEvent::V_MTE3>(vToMte3Id[0]);
    GetTPipePtr()->AllocEventID<HardEvent::V_MTE3>(vToMte3Id[1]);
}
