...
namespace BaseApi {
namespace BlockCubeMlaFulquant {
...
private:
    ...
    static constexpr GmFormat Q_FORMAT = BlockCubeMlaFulquant::GetQueryGmFormat<layout>();
    static constexpr GmFormat KV_FORMAT = BlockCubeMlaFulquant::GetKVGmFormat<layout>();
    ...
    typename BlockCubeMlaFulquant::QL1BuffSel<INPUT_T, dBaseSize>::Type l1QBuffers;
    // mm1右矩阵K
    typename BlockCubeMlaFulquant::KVL1BuffSel<INPUT_T, s2BaseSize, dBaseSize>::Type l1KBuffers;

    // mm2右矩阵V
    typename BlockCubeMlaFulquant::KVL1BuffSel<INPUT_T, s2BaseSize, dBaseSize>::Type l1VBuffers;
    // L0A
    using L0AType = typename BlockCubeMlaFulquant::L0ABuffSel<INPUT_T>::Type;
    L0AType mmL0ABuffers;
    // L0B
    using L0BType = typename BlockCubeMlaFulquant::L0BBuffSel<INPUT_T, s2BaseSize, dBaseSize>::Type;
    L0BType mmL0BBuffers;
    // L0C
    using L0CType = typename BlockCubeMlaFulquant::L0CBuffSel<INPUT_T, s1BaseSize, s2BaseSize, dVBaseSize>::Type;
