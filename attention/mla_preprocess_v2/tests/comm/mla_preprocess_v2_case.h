...
/*!
 * \file mla_preprocess_v2_case.h
 * \brief MlaPreprocessV2 测试用例.
 */
...
namespace ops::adv::tests::mla_preprocess_v2 {
class MlaPreprocessV2Case : public ops::adv::tests::utils::Case {
...
public:
    ...
    public:
        ...
        Param(int64_t tokenNum_, int64_t hiddenNum_, int64_t headNum_, int64_t bloackNum_, int64_t bloackSize_,
              ...
              int64_t quantMode_, bool doRmsNorm_, int64_t wdkvSplitCount_, bool qDownOutFlag_, ge::DataType inputDataType_,
    ...
    Tensor hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, descale1Gm, bias1Gm, gamma2Gm,
        ...
        keycacheRopeGm, slotMappingGm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2, keycacheOutGm2, qDownGm;

    OpInfo mOpInfo;
    Context mCtx;
    Param mParam;
    gert::OpImplRegisterV2::TilingKernelFunc MlaPreprocessV2TilingFunc = nullptr;
    MlaPreprocessV2Case();
    MlaPreprocessV2Case(const char *name, bool enable, const char *dbgInfo, OpInfo opInfo, Param param);
    bool Run() override;
