...
/*!
 * \file fused_floyd_attention_def.cpp
 * \brief
 */
...
class FusedFloydAttention : public OpDef {
public:
    explicit FusedFloydAttention(const char* name) : OpDef(name) {
        this->Input("query")
            .ParamType(REQUIRED)
