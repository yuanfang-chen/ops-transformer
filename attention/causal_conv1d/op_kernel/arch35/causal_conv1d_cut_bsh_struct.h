...
/*!
 * \file causal_conv1d_cut_bsh_struct.h
 * \brief tiling data struct
 */

#ifndef __CAUSAL_CONV1D_CUT_BSH_TILING_DATA_H__
#define __CAUSAL_CONV1D_CUT_BSH_TILING_DATA_H__

struct CausalConv1dCutBSHTilingData {
    // ===== 核内UB切分参数 =====
