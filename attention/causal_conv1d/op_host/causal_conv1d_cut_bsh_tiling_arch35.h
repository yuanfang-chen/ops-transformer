...
/*!
 * \file causal_conv1d_cut_bsh_tiling_arch35.h
 * \brief
 */
#ifndef CAUSAL_CONV1D_CUT_BSH_TILING_H
#define CAUSAL_CONV1D_CUT_BSH_TILING_H
#include "log/log.h"
...
#include "attention/causal_conv1d/op_kernel/arch35/causal_conv1d_cut_bsh_struct.h"
#include "platform/platform_ascendc.h"

namespace optiling {
using namespace Ops::Transformer::OpTiling;

class CausalConv1dCutBSHTiling : public TilingBaseClass {
public:
    explicit CausalConv1dCutBSHTiling(gert::TilingContext *context) : TilingBaseClass(context)
    {
    }
...
private:
    ...
    CausalConv1dCutBSHTilingData tilingData_;
};

} // namespace optiling
#endif // CAUSAL_CONV1D_CUT_BSH_TILING_H
