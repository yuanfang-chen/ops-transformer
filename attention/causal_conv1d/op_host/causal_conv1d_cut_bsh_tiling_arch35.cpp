...
/*!
 * \file causal_conv1d_cut_bsh_tiling_arch35.cpp
 * \brief
 */
...
bool CausalConv1dCutBSHTiling::IsCapable()
{
    return true;
}

ge::graphStatus CausalConv1dCutBSHTiling::DoLibApiTiling()
{
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus CausalConv1dCutBSHTiling::GetPlatformInfo()
{
...
// 检查输入数据类型
ge::graphStatus CausalConv1dCutBSHTiling::CheckInputDtype()
{
...
// 检查输入参数
ge::graphStatus CausalConv1dCutBSHTiling::CheckInputParams()
{
...
ge::graphStatus CausalConv1dCutBSHTiling::CheckOutputParams()
{
...
ge::graphStatus CausalConv1dCutBSHTiling::GetShapeAttrsInfo()
{
    ...
    OP_CHECK_IF(CheckOutputParams() != ge::GRAPH_SUCCESS,
                OP_LOGE(context_->GetNodeName(), "CausalConv1dCutBSH CheckOutputParams FAILED."),
                return ge::GRAPH_FAILED);
...
CausalConv1dCutBSHTiling::CuSeqLenSplitInfo CausalConv1dCutBSHTiling::CalculateCuSeqLenSplitInfo(
...
uint64_t CausalConv1dCutBSHTiling::GetTilingKey() const
{
...
ge::graphStatus CausalConv1dCutBSHTiling::GetWorkspaceSize()
{
...
void CausalConv1dCutBSHTiling::DumpTilingInfo()
{
