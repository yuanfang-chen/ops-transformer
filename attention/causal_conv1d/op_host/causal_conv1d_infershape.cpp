...
ge::graphStatus InferShape4CausalConv1d(gert::InferShapeContext *context)
{
    OP_LOGD(context, "Begin to do InferShape4CausalConv1d");
    ...
    *outputConvStatesShape = *inputConvStatesShape;
    ...
    OP_LOGD(context, "End to do InferShape4CausalConv1d");
    return GRAPH_SUCCESS;
}

ge::graphStatus InferDataType4CausalConv1d(gert::InferDataTypeContext *context)
{
    OP_LOGD(context, "Begin to do InferDataType4CausalConv1d");
    ...
    OP_LOGD(context, "End to do InferDataType4CausalConv1d");
    return ge::GRAPH_SUCCESS;
}

IMPL_OP_INFERSHAPE(CausalConv1d)
    .InferShape(InferShape4CausalConv1d)
    .InferDataType(InferDataType4CausalConv1d);
