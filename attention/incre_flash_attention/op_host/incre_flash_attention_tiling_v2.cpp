  ...
  if (kvAntiParamSplitFlag_) {
    ...
    if (isPFAFlag_) {
      OP_CHECK_IF((antiquantMode == PER_CHANNEL_MODE || antiquantMode == PER_TOKEN_MODE)
                ...
                return ge::GRAPH_FAILED);
      OP_CHECK_IF((antiquantMode == PER_CHANNEL_MODE || antiquantMode == PER_TOKEN_MODE) && (inputKvType_ == ge::DT_INT8 && sOfQuery_ > 16),
                OP_LOGE(ifaContext_->opName, "In keyAntiquant/valueAntiquant split mode and data type of key/value is int8 scenario,"
                        "if keyAntiquantMode/valueAntiquantMode is 0 or 1, S of query should not be greater than 16."),
                return ge::GRAPH_FAILED);
      OP_CHECK_IF((antiquantMode == PER_CHANNEL_MODE || antiquantMode == PER_TOKEN_MODE) && (inputKvType_ == ge::DT_INT8 && !batchContinuousFlag_),
                OP_LOGE(ifaContext_->opName, "In keyAntiquant/valueAntiquant split mode and data type of key/value is int8 scenario,"
      ...
      OP_CHECK_IF((antiquantMode == PER_CHANNEL_MODE || antiquantMode == PER_TOKEN_MODE)
                ...
                return ge::GRAPH_FAILED);
      OP_CHECK_IF((antiquantMode == PER_CHANNEL_MODE || antiquantMode == PER_TOKEN_MODE) && (inputKvType_ == ge::DT_INT8 && pageAttentionFlag_),
                OP_LOGE(ifaContext_->opName, "In keyAntiquant/valueAntiquant split mode and data type of key/value is int8 scenario,"
