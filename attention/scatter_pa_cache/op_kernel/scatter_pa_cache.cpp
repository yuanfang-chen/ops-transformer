...
#if __has_include("../../common/op_kernel/arch35/scatter_pa_kv_cache_normal_fully_load.h")
#include "../../common/op_kernel/arch35/scatter_pa_kv_cache_normal_fully_load.h"
#include "../../common/op_kernel/arch35/scatter_pa_kv_cache_normal_not_fully_load.h"
#include "../../common/op_kernel/arch35/scatter_pa_kv_cache_rope_fully_load.h"
#include "../../common/op_kernel/arch35/scatter_pa_kv_cache_rope_not_fully_load.h"
#include "../../common/op_kernel/arch35/scatter_pa_kv_cache_alibi_fully_load.h"
#include "../../common/op_kernel/arch35/scatter_pa_kv_cache_alibi_not_fully_load.h"
#else
#include "../common/arch35/scatter_pa_kv_cache_normal_fully_load.h"
#include "../common/op_kernel/arch35/scatter_pa_kv_cache_normal_not_fully_load.h"
#include "../common/op_kernel/arch35/scatter_pa_kv_cache_rope_fully_load.h"
#include "../common/op_kernel/arch35/scatter_pa_kv_cache_rope_not_fully_load.h"
#include "../common/op_kernel/arch35/scatter_pa_kv_cache_alibi_fully_load.h"
