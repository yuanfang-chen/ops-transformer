...
#ifndef ATTENTION_WORKER_COMBINE_SPLIT_BS_H
#define ATTENTION_WORKER_COMBINE_SPLIT_BS_H
...
template <typename T>
__aicore__ inline void KernelAttentionWorkerCombineSplitBS<T>::Init(GM_ADDR schedule_context,
