 ...
 * \brief
 */
#ifndef OPS_BUILT_IN_OP_PROTO_INC_ATTN_WORKER_COMBINE_OPS_H_
#define OPS_BUILT_IN_OP_PROTO_INC_ATTN_WORKER_COMBINE_OPS_H_
...
#endif  // OPS_BUILT_IN_OP_PROTO_INC_ATTN_WORKER_COMBINE_OPS_H_
