...
TEST_F(Ts_ncaInfer, case_nsa_compress_attention_infer_0_tiling)
{
...
TEST_F(Ts_ncaInfer, case_nsa_compress_attention_infer_1_tiling)
{
...
TEST_F(Ts_ncaInfer, case_nsa_compress_attention_infer_aclgraph_tiling)
{
...
TEST_F(Ts_ncaInfer, case_nsa_compress_attention_infer_mtp_tiling)
{
