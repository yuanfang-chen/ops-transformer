...
bool PromptFlashAttentionTilingV2::CheckPerTensorQuantParams(const ContextParamsForPFATiling& contextKeyParams,
    ...
    OP_CHECK_IF((contextKeyParams.keyAntiquantMode == nullptr || contextKeyParams.keyAntiquantMode == nullptr ||
        contextKeyParams.keyAntiquantMode == nullptr), OPS_REPORT_VECTOR_INNER_ERR(contextKeyParams.opName,
