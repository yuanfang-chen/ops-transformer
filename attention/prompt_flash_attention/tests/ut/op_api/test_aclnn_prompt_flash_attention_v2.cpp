...
#include "../../../op_host/op_api/aclnn_prompt_flash_attention_v2.h"
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
    auto ut = OP_API_UT(
        ...
        OUTPUT(
            TensorDesc({2, 8, 64, 128}, ACL_FLOAT16, ACL_FORMAT_ND)  // attentionOut
        )
    );
#pragma GCC diagnostic pop
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
    auto ut = OP_API_UT(
        ...
        OUTPUT(
            TensorDesc({2, 64, 1024}, ACL_FLOAT16, ACL_FORMAT_ND)  // attentionOut: B,S,H_q
        )
    );
#pragma GCC diagnostic pop
