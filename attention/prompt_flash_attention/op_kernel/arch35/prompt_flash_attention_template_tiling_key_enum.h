...
#define PARSE_PARAMS_AntiQuant(qkoDtype, inOutLayoutType, config, pseMode, ...) \
...
#define PARSE_PARAMS_NoQuant(qkoDtype, inOutLayoutType, config, pseMode, ...) \
    constexpr LayOutTypeEnum inputLayoutType = static_cast<LayOutTypeEnum>(InOutLayoutTypeValue[inOutLayoutType][0]); \
    constexpr LayOutTypeEnum outputLayoutType = static_cast<LayOutTypeEnum>(InOutLayoutTypeValue[inOutLayoutType][1]); \
    constexpr S1TemplateType s1TemplateType = static_cast<S1TemplateType>(ConfigValue[config].s1); \
    constexpr S2TemplateType s2TemplateType = static_cast<S2TemplateType>(ConfigValue[config].s2); \
...
#define PARSE_PARAMS_FullQuant(qkoDtype, inOutLayoutType, config, pseMode, ...) \
...
// QKO_DType
#define QFLOAT16_KINT8_OFLOAT16 0
#define QFLOAT16_KINT4_OFLOAT16 1
#define QFLOAT16_KHIFLOAT8_OFLOAT16 2
#define QFLOAT16_KFLOAT8_E4M3FN_OFLOAT16 3
#define QFLOAT16_KFLOAT4_E2M1_OFLOAT16 4
#define QBF16_KINT8_OBF16 5
#define QBF16_KINT4_OBF16 6
#define QBF16_KHIFLOAT8_OBF16 7
#define QBF16_KFLOAT8_E4M3FN_OBF16 8
#define QBF16_KFLOAT4_E2M1_OBF16 9
#define QBF16_KINT8_OINT8 10
#define QFLOAT16_KINT8_OINT8 11
#define QBF16_KHIFLOAT8_OHIFLOAT8 12
#define QFLOAT16_KHIFLOAT8_OHIFLOAT8 13
#define QBF16_KFLOAT8_E4M3FN_OFLOAT8_E4M3FN 14
#define QFLOAT16_KFLOAT8_E4M3FN_OFLOAT8_E4M3FN 15
#define QFLOAT16_KFLOAT16_OFLOAT16 16
#define QBF16_KBF16_OBF16 17
#define QFLOAT16_KFLOAT16_OINT8 18
#define QFLOAT16_KFLOAT16_OHIFLOAT8 19
#define QFLOAT16_KFLOAT16_OFLOAT8_E4M3FN 20
#define QBF16_KBF16_OINT8 21
#define QBF16_KBF16_OHIFLOAT8 22
#define QBF16_KBF16_OFLOAT8_E4M3FN 23
#define QINT8_KINT8_OFLOAT16 24
#define QFLOAT8_E4M3FN_KFLOAT8_E4M3FN_OFLOAT16 25
#define QFLOAT8_E4M3FN_KFLOAT8_E4M3FN_OBF16 26
#define QHIFLOAT8_KHIFLOAT8_OFLOAT16 27
#define QHIFLOAT8_KHIFLOAT8_OBF16 28
