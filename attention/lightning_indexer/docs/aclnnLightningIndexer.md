    ...
    <col style="width: 671px">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>161002</td>
                <td>query、key、weights、actual_seq_lengths_query、actual_seq_lengths_key、layout_query、layout_key、sparse_count、sparse_mode、return_value、sparse_indices、sparse_values的数据类型和数据格式不在支持的范围内。</td>
            </tr>
        </tbody>
    </table>
