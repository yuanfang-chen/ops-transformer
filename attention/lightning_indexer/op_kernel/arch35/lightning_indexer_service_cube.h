...
template <typename LIT>
__aicore__ inline void LIVector<LIT>::InitParams(const ConstInfo &constInfo)
{
...
LIVector<LIT>::InitMm1GlobalTensor(const GlobalTensor<int32_t> &blkTableGm, const GlobalTensor<K_T> &keyGm,
                                   const GlobalTensor<Q_T> &queryGm)
{
...
template <typename LIT>
__aicore__ inline void LIVector<LIT>::ComputeMm1(const LICommon::RunInfo &runInfo)
{
...
template <typename LIT>
__aicore__ inline void LIVector<LIT>::KeyNd2Nz(uint64_t s2L1RealSize, uint64_t s2GmOffset,
                                                    const LICommon::RunInfo &runInfo)
{
...
// blkNum, blkSize, N2, D
template <typename LIT>
__aicore__ inline void LIVector<LIT>::KeyNd2NzForPA(uint64_t s2L1RealSize, uint64_t s2GmOffset,
                                                    const LICommon::RunInfo &runInfo)
{
...
// batch, s1, n2, g, d
template <typename LIT>
__aicore__ inline void LIVector<LIT>::QueryNd2Nz(uint64_t s1gL1RealSize, uint64_t s1gGmOffset,
                                                 const LICommon::RunInfo &runInfo)
{
    Nd2NzParams nd2nzPara;
    nd2nzPara.ndNum = 1;
...
template <typename LIT>
__aicore__ inline void LIVector<LIT>::LoadQueryToL0a(uint64_t s1gGmOffset, uint64_t s1gL1Offset, uint64_t s1gL1RealSize,
                                                     uint64_t s1gL0RealSize, const LICommon::RunInfo &runInfo)
{
...
template <typename LIT>
__aicore__ inline void LIVector<LIT>::LoadKeyToL0b(uint64_t s2L1Offset, uint64_t s2L1RealSize, uint64_t s2L0RealSize,
                                                   const LICommon::RunInfo &runInfo)
{
    LoadData2DParamsV2 loadData2DParamsV2;
...
template <typename LIT>
__aicore__ inline void LIVector<LIT>::ComputeL0c(uint64_t s1gL0RealSize, uint64_t s2L0RealSize,
                                                const LICommon::RunInfo &runInfo)
{
...
template <typename LIT>
__aicore__ inline void LIVector<LIT>::Fixp(uint64_t s1gGmOffset, uint64_t s2GmOffset, uint64_t s1gL0RealSize,
                                           uint64_t s2L0RealSize, const LICommon::RunInfo &runInfo)
{
