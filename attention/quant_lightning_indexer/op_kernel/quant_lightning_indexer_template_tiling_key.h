...
#define QLI_TPL_FLOAT8_E4M3FN 36
#define QLI_TPL_HIFLOAT8 34
// 模板参数支持的范围定义
#if (__CCE_AICORE__ == 310)
    ASCENDC_TPL_ARGS_DECL(QuantLightningIndexer,  // 算子OpType
                        ASCENDC_TPL_DTYPE_DECL(DT_Q, QLI_TPL_FLOAT8_E4M3FN, QLI_TPL_HIFLOAT8), ASCENDC_TPL_DTYPE_DECL(DT_K, QLI_TPL_FLOAT8_E4M3FN, QLI_TPL_HIFLOAT8),
    ...
    ASCENDC_TPL_SEL(
        ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_DTYPE_SEL(DT_Q, QLI_TPL_FLOAT8_E4M3FN), ASCENDC_TPL_DTYPE_SEL(DT_K, QLI_TPL_FLOAT8_E4M3FN),
        ...
        ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_DTYPE_SEL(DT_Q, QLI_TPL_HIFLOAT8), ASCENDC_TPL_DTYPE_SEL(DT_K, QLI_TPL_HIFLOAT8),
                            ASCENDC_TPL_DTYPE_SEL(DT_OUT, LI_TPL_INT32), ASCENDC_TPL_BOOL_SEL(PAGE_ATTENTION, 1),
                            ASCENDC_TPL_UINT_SEL(Q_LAYOUT_T, ASCENDC_TPL_UI_LIST, QLI_LAYOUT_BSND, QLI_LAYOUT_TND),
                            ASCENDC_TPL_UINT_SEL(K_LAYOUT_T, ASCENDC_TPL_UI_LIST, QLI_LAYOUT_PA_BSND), ),
        ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_DTYPE_SEL(DT_Q, QLI_TPL_HIFLOAT8), ASCENDC_TPL_DTYPE_SEL(DT_K, QLI_TPL_HIFLOAT8),
