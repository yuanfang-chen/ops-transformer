...
__aicore__ inline void QLIVector<QLIT>::ProcessVec1(const QLICommon::RunInfo &info)
{
    ...
    wDataCopyExtParams.dstStride = (UB_BANK_DEPTH_STRIDE - UB_BANK_STRIDE) / 32;
    ...
    AsendC::Cast(weightFloatUB_, weightUB_, RoundMode::CAST_NONE, gSize_ * sizeof(bfloat16_t));
    //qScaleGm  -->  qScaleUB_
    ...
    qDataCopyExtParams.dstStride = (UB_BANK_DEPTH_STRIDE - UB_BANK_STRIDE) / 32;
