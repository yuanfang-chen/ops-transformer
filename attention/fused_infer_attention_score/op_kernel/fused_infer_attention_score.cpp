                                                                ...
                                                                __gm__ uint8_t* attentionOut, __gm__ uint8_t* softmaxLse, __gm__ uint8_t* workspace, __gm__ uint8_t* tiling)
{
    if (TILING_KEY_VAR >= FAI_FLAG_TILING) {
        ...
        TILING_KEY_IS(QF16_KVF16_OUTF16_NOLSEOUT_TND_NOCACHE_FULLMASK_SINK_SPLITFUSE_TILING);
        TILING_KEY_IS(QF16_KVF16_OUTF16_NOLSEOUT_TND_PAGEDCACHE_FULLMASK_SPLITFUSE_TILING);
        TILING_KEY_IS(QF16_KVF16_OUTF16_NOLSEOUT_TND_PAGEDCACHE_FULLMASK_SINK_SPLITFUSE_TILING);
        TILING_KEY_IS(QF16_KVF16_OUTF16_LSEOUT_TND_NOCACHE_FULLMASK_SPLITFUSE_TILING);
        TILING_KEY_IS(QF16_KVF16_OUTF16_LSEOUT_TND_NOCACHE_FULLMASK_SINK_SPLITFUSE_TILING);
        TILING_KEY_IS(QF16_KVF16_OUTF16_LSEOUT_TND_PAGEDCACHE_FULLMASK_SPLITFUSE_TILING);
        TILING_KEY_IS(QF16_KVF16_OUTF16_LSEOUT_TND_PAGEDCACHE_FULLMASK_SINK_SPLITFUSE_TILING);
        TILING_KEY_IS(QBF16_KVBF16_OUTBF16_NOLSEOUT_TND_NOCACHE_FULLMASK_SPLITFUSE_TILING);
        TILING_KEY_IS(QBF16_KVBF16_OUTBF16_NOLSEOUT_TND_NOCACHE_FULLMASK_SINK_SPLITFUSE_TILING);
        TILING_KEY_IS(QBF16_KVBF16_OUTBF16_NOLSEOUT_TND_PAGEDCACHE_FULLMASK_SPLITFUSE_TILING);
        TILING_KEY_IS(QBF16_KVBF16_OUTBF16_NOLSEOUT_TND_PAGEDCACHE_FULLMASK_SINK_SPLITFUSE_TILING);
        TILING_KEY_IS(QBF16_KVBF16_OUTBF16_LSEOUT_TND_NOCACHE_FULLMASK_SPLITFUSE_TILING);
        TILING_KEY_IS(QBF16_KVBF16_OUTBF16_LSEOUT_TND_NOCACHE_FULLMASK_SINK_SPLITFUSE_TILING);
        TILING_KEY_IS(QBF16_KVBF16_OUTBF16_LSEOUT_TND_PAGEDCACHE_FULLMASK_SPLITFUSE_TILING);
        TILING_KEY_IS(QBF16_KVBF16_OUTBF16_LSEOUT_TND_PAGEDCACHE_FULLMASK_SINK_SPLITFUSE_TILING);
        ...
        SplitFuse::FAInfer<half, half, float, false, FaiKernel::MaskType::FULL_MASK, FaiKernel::inputLayout::TND>(
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        #elif TILING_KEY_VAR == QF16_KVF16_OUTF16_NOLSEOUT_TND_PAGEDCACHE_FULLMASK_SPLITFUSE_TILING
        SplitFuse::FAInfer<half, half, float, true, FaiKernel::MaskType::FULL_MASK, FaiKernel::inputLayout::TND>(
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        ...
        SplitFuse::FAInfer<bfloat16_t, bfloat16_t, float, false, FaiKernel::MaskType::FULL_MASK, FaiKernel::inputLayout::TND>(
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        #elif TILING_KEY_VAR == QBF16_KVBF16_OUTBF16_NOLSEOUT_TND_PAGEDCACHE_FULLMASK_SPLITFUSE_TILING
        SplitFuse::FAInfer<bfloat16_t, bfloat16_t, float, true, FaiKernel::MaskType::FULL_MASK, FaiKernel::inputLayout::TND>(
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        ...
        SplitFuse::FAInfer<
            half, half, float, false, FaiKernel::MaskType::FULL_MASK,
            FaiKernel::inputLayout::TND, NpuArch::Epilogue::LseMode::OUT_ONLY>(
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        #elif TILING_KEY_VAR == QF16_KVF16_OUTF16_LSEOUT_TND_PAGEDCACHE_FULLMASK_SPLITFUSE_TILING
        SplitFuse::FAInfer<
            half, half, float, true, FaiKernel::MaskType::FULL_MASK,
            FaiKernel::inputLayout::TND, NpuArch::Epilogue::LseMode::OUT_ONLY>(
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        ...
        SplitFuse::FAInfer<
            bfloat16_t, bfloat16_t, float, false, FaiKernel::MaskType::FULL_MASK,
            FaiKernel::inputLayout::TND, NpuArch::Epilogue::LseMode::OUT_ONLY>(
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        #elif TILING_KEY_VAR == QBF16_KVBF16_OUTBF16_LSEOUT_TND_PAGEDCACHE_FULLMASK_SPLITFUSE_TILING
        SplitFuse::FAInfer<
            bfloat16_t, bfloat16_t, float, true, FaiKernel::MaskType::FULL_MASK,
            FaiKernel::inputLayout::TND, NpuArch::Epilogue::LseMode::OUT_ONLY>(
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        ...
        SplitFuse::FAInfer<half, half, float, true, FaiKernel::MaskType::MASK_CAUSAL, FaiKernel::inputLayout::TND,
            ...
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        #elif TILING_KEY_VAR == QF16_KVF16_OUTF16_NOLSEOUT_TND_NOCACHE_FULLMASK_SINK_SPLITFUSE_TILING
        SplitFuse::FAInfer<half, half, float, false, FaiKernel::MaskType::FULL_MASK, FaiKernel::inputLayout::TND,
            NpuArch::Epilogue::LseMode::NONE, NpuArch::Epilogue::SinkMode::ENABLE>(
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        #elif TILING_KEY_VAR == QF16_KVF16_OUTF16_NOLSEOUT_TND_PAGEDCACHE_FULLMASK_SINK_SPLITFUSE_TILING
        SplitFuse::FAInfer<half, half, float, true, FaiKernel::MaskType::FULL_MASK, FaiKernel::inputLayout::TND,
            NpuArch::Epilogue::LseMode::NONE, NpuArch::Epilogue::SinkMode::ENABLE>( 
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        ...
        SplitFuse::FAInfer<bfloat16_t, bfloat16_t, float, true, FaiKernel::MaskType::MASK_CAUSAL, FaiKernel::inputLayout::TND,
            ...
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        #elif TILING_KEY_VAR == QBF16_KVBF16_OUTBF16_NOLSEOUT_TND_NOCACHE_FULLMASK_SINK_SPLITFUSE_TILING
        SplitFuse::FAInfer<bfloat16_t, bfloat16_t, float, false, FaiKernel::MaskType::FULL_MASK, FaiKernel::inputLayout::TND,
            NpuArch::Epilogue::LseMode::NONE, NpuArch::Epilogue::SinkMode::ENABLE>( 
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        #elif TILING_KEY_VAR == QBF16_KVBF16_OUTBF16_NOLSEOUT_TND_PAGEDCACHE_FULLMASK_SINK_SPLITFUSE_TILING
        SplitFuse::FAInfer<bfloat16_t, bfloat16_t, float, true, FaiKernel::MaskType::FULL_MASK, FaiKernel::inputLayout::TND,
            NpuArch::Epilogue::LseMode::NONE, NpuArch::Epilogue::SinkMode::ENABLE>( 
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        ...
        SplitFuse::FAInfer<
            ...
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        #elif TILING_KEY_VAR == QF16_KVF16_OUTF16_LSEOUT_TND_NOCACHE_FULLMASK_SINK_SPLITFUSE_TILING
        SplitFuse::FAInfer<
            half, half, float, false, FaiKernel::MaskType::FULL_MASK,
            FaiKernel::inputLayout::TND, NpuArch::Epilogue::LseMode::OUT_ONLY, NpuArch::Epilogue::SinkMode::ENABLE>(
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        #elif TILING_KEY_VAR == QF16_KVF16_OUTF16_LSEOUT_TND_PAGEDCACHE_FULLMASK_SINK_SPLITFUSE_TILING
        SplitFuse::FAInfer<
            half, half, float, true, FaiKernel::MaskType::FULL_MASK,
            FaiKernel::inputLayout::TND, NpuArch::Epilogue::LseMode::OUT_ONLY, NpuArch::Epilogue::SinkMode::ENABLE>(
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
        ...
        SplitFuse::FAInfer<
            ...
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        #elif TILING_KEY_VAR == QBF16_KVBF16_OUTBF16_LSEOUT_TND_NOCACHE_FULLMASK_SINK_SPLITFUSE_TILING
        SplitFuse::FAInfer<
            bfloat16_t, bfloat16_t, float, false, FaiKernel::MaskType::FULL_MASK,
            FaiKernel::inputLayout::TND, NpuArch::Epilogue::LseMode::OUT_ONLY, NpuArch::Epilogue::SinkMode::ENABLE>(
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
            actualSeqLengths, actualSeqLengthsKV, user, tiling, learnableSink);
        #elif TILING_KEY_VAR == QBF16_KVBF16_OUTBF16_LSEOUT_TND_PAGEDCACHE_FULLMASK_SINK_SPLITFUSE_TILING
        SplitFuse::FAInfer<
            bfloat16_t, bfloat16_t, float, true, FaiKernel::MaskType::FULL_MASK,
            FaiKernel::inputLayout::TND, NpuArch::Epilogue::LseMode::OUT_ONLY, NpuArch::Epilogue::SinkMode::ENABLE>(
            query, key, value, attenMask, blocktable, attentionOut, softmaxLse,
