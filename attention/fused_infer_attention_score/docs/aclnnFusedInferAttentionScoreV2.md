...
- 参数key、value使用限制：
  ...
  - <term>昇腾910_95 AI处理器</term>：数据类型支持FLOAT16、BFLOAT16、INT8、HIFLOAT8、FLOAT8_E4M3FN、INT4（INT32）、FLOAT4_E2M1。
...
- **当Q_S大于1时**：
  ...
  - query，key，value输入，功能使用限制如下：
    ...
    - D轴限制：<term>
      - Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：
  ...
  - page attention场景：
    ...
    - page attention 伪量化场景
      ...
      - <term>昇腾910_95 AI处理器</term>：支持query dtype为FLOAT16/BFLOAT16，支持key、value dtype为INT8/HIFLOAT8/FLOAT8_E4M3FN/FLOAT4_E2M1/INT4（INT32）。
  ...
  - query左padding场景：
    ...
    - <term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：不支持Q为BF16/FP16、KV为INT4的场景。
  - kv左padding场景：
  ...
  - kv伪量化参数分离：
    ...
    - <term>昇腾910_95 AI处理器</term>：
      ...
      - 部分伪量化场景不支持后量化
        - <term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：INT4（INT32）伪量化场景不支持后量化。
        - <term>昇腾910_95 AI处理器</term>：INT4（INT32）、FLOAT4_E2M1伪量化场景不支持后量化。
