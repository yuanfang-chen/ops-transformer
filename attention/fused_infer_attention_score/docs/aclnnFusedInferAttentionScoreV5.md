...
- **参数说明：**
        ...
        <ul>
            <li>sparseMode = 0、1时
                <ul>
                    ...
                    <li>Atlas A2/A3 训练/推理系列产品：
                        另外输入Layout为BSH、BSND、BNSD、BNSD_BSND时，且query与key的D等于value的D，并且不传query_rope和key_rope时，Q_S=1可支持传入(B,KV_S)，Q_S>1时可支持传入(Q_S,KV_S)。</li>
                    <li>Ascend 950PR/Ascend 950DT：
                        不支持2维Mask</li>
                </ul>
            </li>
    ...
    <tr>
        ...
        <td>
        <ul>
            <li>Atlas A2/A3 训练/推理系列产品：Q_S为1且不带rope输入时该参数无效。</li>
            <li>Ascend 950PR/Ascend 950DT：无上述限制。</li>
