    ...
    <table style="undefined;table-layout: fixed; width: 942px"><colgroup>
        ...
        <tr>
            ...
            <td rowspan="2">忽略入参preTokens、nextTokens并按照相关规则赋值</br>
                传入的attenMask为下三角矩阵，对角线全0。attentionMask为nullptr或者传入的shape不正确报错。shape需要为S,S或1,S,S或1,1,S,S,其中S的值需要固定为2048。</td>
        </tr>
        <tr>
            <td>3</td>
        ...
        <tr>
            ...
            <td>传入的attenMask为下三角矩阵，对角线全0。attentionMask为nullptr或者传入的shape不正确报错。shape需要为S,S或1,S,S或1,1,S,S,其中S的值需要固定为2048。</td></td>
        </tr>
        <tr>
        <td colspan="3"><ul>
