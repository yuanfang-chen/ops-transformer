...
- **参数说明：**
    ...
    <tr>
        ...
        <ul>
            ...
            <li>inputLayout=BSH_BNSD、BSND_BNSD、NTD、NTD_TND仅支持Q_D=K_D=V_D都等于64或128，或Q_D=K_D等于192，V_D等于128<br></li>
        </ul>
        </td>
        <td>CHAR</td>
        <td>-</td>
    ...
    <tr>
        ...
        <ul>
            ...
            <li>需要满足numHeads整除numKeyValueHeads，numHeads与numKeyValueHeads的比值不能大于64。在BNSD、BSND、BNSD_BSND、BSND_BNSD、BNSD_NBSD、BSND_NBSD、TND、NTD、NTD_TND、TND_NTD场景下，还需要与shape中的key/value的N轴shape值相同，否则执行异常</li>
        </ul>
        </td>
        <td>INT64</td>
        <td>-</td>
