...
class FusedInferAttentionScoreOptionalTilingArch32 : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "FusedInferAttentionScoreOptionalTiling SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "FusedInferAttentionScoreOptionalTiling TearDown" << std::endl;
    }
};

TEST_F(FusedInferAttentionScoreOptionalTilingArch32, PSE_BNSD_FP16)
{
    ...
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
        {
            ...
            {{{4, 4, 1024, 128}, {4, 4, 1024, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{1, 16, 512, 1024}, {1, 16, 512, 1024}}, ge::DT_FLOAT16, ge::FORMAT_ND},
...
TEST_F(FusedInferAttentionScoreOptionalTilingArch32, LeftPadding_BNSD_FP16)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
        ...
        &compileInfo, "Ascend910B", Fia_tiling_A2SocInfo, 4096);
    int64_t expectTilingKey = 104000000000000000;
    std::string expectTilingData = "";
    ExecuteTestCase(tilingContextPara, ge::GRAPH_SUCCESS, expectTilingKey, expectTilingData);
}

TEST_F(FusedInferAttentionScoreOptionalTilingArch32, SystemPrefix_BNSD_FP16)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
        {
            ...
            {{{}, {}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{1, 4, 64, 128}, {1, 4, 64, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{1, 4, 64, 128}, {1, 4, 64, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{1}, {1}}, ge::DT_INT64, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_FLOAT16, ge::FORMAT_ND},
...
TEST_F(FusedInferAttentionScoreOptionalTilingArch32, PostQuant_BNSD_FP16)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
        ...
        {{{{4, 16, 512, 128}, {4, 16, 512, 128}}, ge::DT_INT8, ge::FORMAT_ND}, {{{}, {}}, ge::DT_FLOAT, ge::FORMAT_ND}},
        {
            {"num_heads", Ops::Transformer::AnyValue::CreateFrom<int64_t>(16)},
            {"scale", Ops::Transformer::AnyValue::CreateFrom<float>(0.088388347648318f)},
            {"pre_tokens", Ops::Transformer::AnyValue::CreateFrom<int64_t>(2147483647)},
        ...
        &compileInfo, "Ascend910B", Fia_tiling_A2SocInfo, 4096);
    int64_t expectTilingKey = 103000000000103000;
    std::string expectTilingData = "";
    ExecuteTestCase(tilingContextPara, ge::GRAPH_SUCCESS, expectTilingKey, expectTilingData);
}

TEST_F(FusedInferAttentionScoreOptionalTilingArch32, PostQuant_WithOffset_BSND_FP16)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
        {
            {{{4, 512, 16, 128}, {4, 512, 16, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{4, 1024, 4, 128}, {4, 1024, 4, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{4, 1024, 4, 128}, {4, 1024, 4, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_INT8, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_INT64, ge::FORMAT_ND},
        ...
        {{{{4, 512, 16, 128}, {4, 512, 16, 128}}, ge::DT_INT8, ge::FORMAT_ND}, {{{}, {}}, ge::DT_FLOAT, ge::FORMAT_ND}},
        {
            {"num_heads", Ops::Transformer::AnyValue::CreateFrom<int64_t>(16)},
            {"scale", Ops::Transformer::AnyValue::CreateFrom<float>(0.088388347648318f)},
            {"pre_tokens", Ops::Transformer::AnyValue::CreateFrom<int64_t>(2147483647)},
        ...
        &compileInfo, "Ascend910B", Fia_tiling_A2SocInfo, 4096);
    int64_t expectTilingKey = 103000000010103001;
    std::string expectTilingData = "";
    ExecuteTestCase(tilingContextPara, ge::GRAPH_SUCCESS, expectTilingKey, expectTilingData);
}