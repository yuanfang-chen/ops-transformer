...
class FusedInferAttentionScoreLayoutSparseTilingArch32 : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "FusedInferAttentionScoreLayoutSparseTiling SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "FusedInferAttentionScoreLayoutSparseTiling TearDown" << std::endl;
    }
};

TEST_F(FusedInferAttentionScoreLayoutSparseTilingArch32, BNSD_NBSD_FP16_QS2)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
        {
            {{{2, 8, 2, 128}, {2, 8, 2, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND},
        ...
        {{{{8, 2, 2, 128}, {8, 2, 2, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND}, {{{}, {}}, ge::DT_FLOAT, ge::FORMAT_ND}},
        {
...
TEST_F(FusedInferAttentionScoreLayoutSparseTilingArch32, BSND_NBSD_FP16_QS4)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
        ...
        {{{{8, 2, 4, 128}, {8, 2, 4, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND}, {{{}, {}}, ge::DT_FLOAT, ge::FORMAT_ND}},
        {
            {"num_heads", Ops::Transformer::AnyValue::CreateFrom<int64_t>(8)},
            {"scale", Ops::Transformer::AnyValue::CreateFrom<float>(0.08838834764831845f)},
            {"pre_tokens", Ops::Transformer::AnyValue::CreateFrom<int64_t>(2147483647)},
...
TEST_F(FusedInferAttentionScoreLayoutSparseTilingArch32, BSH_NBSD_FP16_QS8)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
        {
            {{{2, 8, 1024}, {2, 8, 1024}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{2, 64, 1024}, {2, 64, 1024}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{2, 64, 1024}, {2, 64, 1024}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_INT8, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_INT64, ge::FORMAT_ND},
        ...
        {{{{8, 2, 8, 128}, {8, 2, 8, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND}, {{{}, {}}, ge::DT_FLOAT, ge::FORMAT_ND}},
        {
            {"num_heads", Ops::Transformer::AnyValue::CreateFrom<int64_t>(8)},
            {"scale", Ops::Transformer::AnyValue::CreateFrom<float>(0.08838834764831845f)},
            {"pre_tokens", Ops::Transformer::AnyValue::CreateFrom<int64_t>(2147483647)},
...
TEST_F(FusedInferAttentionScoreLayoutSparseTilingArch32, BNSD_FP16_SparseMode1_AllMask)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
        {
            ...
            {{{2, 8, 64, 128}, {2, 8, 64, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{16, 64}, {16, 64}}, ge::DT_INT8, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_INT64, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_INT64, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_UINT64, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_FLOAT, ge::FORMAT_ND},
...
TEST_F(FusedInferAttentionScoreLayoutSparseTilingArch32, BNSD_FP16_SparseMode2_LeftUpCausal)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
...
TEST_F(FusedInferAttentionScoreLayoutSparseTilingArch32, BSH_FP16_SparseMode3_RightDownCausal)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
        ...
        {{{{2, 16, 1024}, {2, 16, 1024}}, ge::DT_FLOAT16, ge::FORMAT_ND}, {{{}, {}}, ge::DT_FLOAT, ge::FORMAT_ND}},
        {
            {"num_heads", Ops::Transformer::AnyValue::CreateFrom<int64_t>(8)},
            {"scale", Ops::Transformer::AnyValue::CreateFrom<float>(0.08838834764831845f)},
            {"pre_tokens", Ops::Transformer::AnyValue::CreateFrom<int64_t>(2147483647)},
...
TEST_F(FusedInferAttentionScoreLayoutSparseTilingArch32, BSND_FP16_SparseMode4_Band)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
        {
            {{{2, 16, 8, 128}, {2, 16, 8, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{2, 64, 8, 128}, {2, 64, 8, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{2, 64, 8, 128}, {2, 64, 8, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{2048, 2048}, {2048, 2048}}, ge::DT_INT8, ge::FORMAT_ND},
        ...
        {{{{2, 16, 8, 128}, {2, 16, 8, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND}, {{{}, {}}, ge::DT_FLOAT, ge::FORMAT_ND}},
        {
            {"num_heads", Ops::Transformer::AnyValue::CreateFrom<int64_t>(8)},
            {"scale", Ops::Transformer::AnyValue::CreateFrom<float>(0.08838834764831845f)},
            {"pre_tokens", Ops::Transformer::AnyValue::CreateFrom<int64_t>(64)},
            {"next_tokens", Ops::Transformer::AnyValue::CreateFrom<int64_t>(64)},
...
TEST_F(FusedInferAttentionScoreLayoutSparseTilingArch32, BNSD_BF16_GQA_HeadDim128)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
        {
            {{{4, 16, 64, 128}, {4, 16, 64, 128}}, ge::DT_BF16, ge::FORMAT_ND},
        ...
        {{{{4, 16, 64, 128}, {4, 16, 64, 128}}, ge::DT_BF16, ge::FORMAT_ND}, {{{}, {}}, ge::DT_FLOAT, ge::FORMAT_ND}},
        {
        ...
        &compileInfo, "Ascend910B", Fia_tiling_A2SocInfo, 4096);
    int64_t expectTilingKey = 103000000000022220;
    std::string expectTilingData = "";
    ExecuteTestCase(tilingContextPara, ge::GRAPH_SUCCESS, expectTilingKey, expectTilingData);
}

TEST_F(FusedInferAttentionScoreLayoutSparseTilingArch32, BSH_BF16_MHA_HeadDim64)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
        {
            {{{2, 16, 512}, {2, 16, 512}}, ge::DT_BF16, ge::FORMAT_ND},
            {{{2, 64, 512}, {2, 64, 512}}, ge::DT_BF16, ge::FORMAT_ND},
            {{{2, 64, 512}, {2, 64, 512}}, ge::DT_BF16, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_INT8, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_INT64, ge::FORMAT_ND},
        ...
        {{{{2, 16, 512}, {2, 16, 512}}, ge::DT_BF16, ge::FORMAT_ND}, {{{}, {}}, ge::DT_FLOAT, ge::FORMAT_ND}},
        {
            {"num_heads", Ops::Transformer::AnyValue::CreateFrom<int64_t>(8)},
        ...
        &compileInfo, "Ascend910B", Fia_tiling_A2SocInfo, 4096);
    int64_t expectTilingKey = 103000000010022221;
    std::string expectTilingData = "";
    ExecuteTestCase(tilingContextPara, ge::GRAPH_SUCCESS, expectTilingKey, expectTilingData);
}