...
class FusedInferAttentionScoreCheckConsistencyArch32 : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "FusedInferAttentionScoreCheckConsistency SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "FusedInferAttentionScoreCheckConsistency TearDown" << std::endl;
    }
};

// ============================================================================
// 以下为补充的测试用例 - 用于提升 consistency.cpp 覆盖率
// 添加时间: 2026-03-17
// 目的: 触发 CheckBlockTable, CheckKVShapeForPageAttention, CheckKVShapeForTensorList
//       CheckSystemPrefix, CheckPostQuant, CheckTokens, CheckPseShift 等分支
// ============================================================================

// CC-BLOCK-01: PageAttention 场景 - blockTable shape size 为 0
TEST_F(FusedInferAttentionScoreCheckConsistencyArch32, PageAttention_BlockTableZeroSize)
{
...
// CC-TOKENS-01: preTokens 和 nextTokens 都为负数
TEST_F(FusedInferAttentionScoreCheckConsistencyArch32, TokensBothNegative)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
...
// CC-SOFTMAX-LSE-01: softmaxLseFlag 为 true 但 lseOut dtype 非 FP32
TEST_F(FusedInferAttentionScoreCheckConsistencyArch32, SoftmaxLse_DtypeNotFP32)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
...
// CC-SYSTEM-PREFIX-01: SystemPrefix dtype 与 key 不匹配
TEST_F(FusedInferAttentionScoreCheckConsistencyArch32, SystemPrefix_DtypeMismatch)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
        {
            ...
            {{{}, {}}, ge::DT_INT64, ge::FORMAT_ND},
            {{{}, {}}, ge::DT_INT64, ge::FORMAT_ND},
            {{{1, 8, 32, 128}, {1, 8, 32, 128}}, ge::DT_BF16, ge::FORMAT_ND},
...
// CC-POST-QUANT-01: PostQuant 场景 - output dtype 非 INT8
TEST_F(FusedInferAttentionScoreCheckConsistencyArch32, PostQuant_OutputNotINT8)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
...
// CC-PSE-01: PSE dtype 与 query 不匹配
TEST_F(FusedInferAttentionScoreCheckConsistencyArch32, PSE_DtypeMismatch)
{
    optiling::FusedInferAttentionScoreCompileInfo compileInfo = {48};
    gert::TilingContextPara tilingContextPara(
        "FusedInferAttentionScore",
