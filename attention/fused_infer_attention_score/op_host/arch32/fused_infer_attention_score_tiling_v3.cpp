...
bool CheckSpecConditions(const gert::TilingContext *context)
{
    ...
    int32_t headNum = static_cast<int32_t>(*(attrs->GetAttrPointer<int64_t>(ATTR_N_INDEX)));
    int32_t kvHeadNum = static_cast<int32_t>(*(attrs->GetAttrPointer<int64_t>(ATTR_NUM_KV_HEADS_INDEX)));
