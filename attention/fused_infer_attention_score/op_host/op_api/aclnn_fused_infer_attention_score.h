...
#warning "aclnn_fused_infer_attention_score.h is scheduled to be deprecated in December 2026, and will be replaced by the aclnn_fused_infer_attention_score_v4.h. We apologize for any inconvenience caused and appreciate your timely migration to the new interface.."
 ...
 */
__attribute__((deprecated("aclnnFusedInferAttentionScoreGetWorkspaceSize is scheduled to be deprecated in December 2026, and will be replaced by the aclnnFusedInferAttentionScoreV4GetWorkspaceSize. "
 ...
 */
__attribute__((deprecated("aclnnFusedInferAttentionScore is scheduled to be deprecated in December 2026, and will be replaced by the aclnnFusedInferAttentionScoreV4. "
                          "We apologize for any inconvenience caused and appreciate your timely migration to the new interface..")))
