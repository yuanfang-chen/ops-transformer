...
#warning "aclnn_fused_infer_attention_score_v3.h is scheduled to be deprecated in December 2026, and will be replaced by the aclnn_fused_infer_attention_score_v4.h. We apologize for any inconvenience caused and appreciate your timely migration to the new interface. "
 ...
 */
__attribute__((deprecated("aclnnFusedInferAttentionScoreV3GetWorkspaceSize is scheduled to be deprecated in December 2026, and will be replaced by the aclnnFusedInferAttentionScoreV4GetWorkspaceSize. "
 ...
 */
__attribute__((deprecated("aclnnFusedInferAttentionScoreV3 is scheduled to be deprecated in December 2026, and will be replaced by the aclnnFusedInferAttentionScoreV4. "
                          "We apologize for any inconvenience caused and appreciate your timely migration to the new interface. ")))
