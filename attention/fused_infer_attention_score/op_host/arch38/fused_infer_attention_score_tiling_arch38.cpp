...
static ge::graphStatus ConvertQuantOptionalInputs(const gert::TilingContext* context, ContextParamsForPFATiling& contextKeyParams) {
...
ge::graphStatus FusedInferAttentionScoreTilingArch38::DoOpTiling() {
    ...
    if (usingIFA) {
        ...
        OP_CHECK_IF(ret == ge::GRAPH_FAILED,
                    ...
                    return ge::GRAPH_FAILED);
        uint64_t tiling_key = GET_TPL_TILING_KEY(static_cast<uint64_t>(ifaTilingArch38.inOutLayoutType), static_cast<uint64_t>(ifaTilingArch38.config), static_cast<uint64_t>(ifaTilingArch38.pseMode),
                                                static_cast<uint64_t>(ifaTilingArch38.quantMode), ifaTilingArch38.hasAttenMask, ifaTilingArch38.hasRope, ifaTilingArch38.isPa, ifaTilingArch38.isFd, ifaTilingArch38.emptyTensor,
                                                static_cast<uint64_t>(ifaTilingArch38.PFAMask), static_cast<uint64_t>(ifaTilingArch38.pFAMatMulType), ifaTilingArch38.enableKVPrefix);
        ...
        OP_LOGI(ifaContext.opName, "The new template tilingkey param is inOutLayoutType: %llu, config: %llu, pseMode: %llu, quantMode: %llu, hasAttenMask: %llu, hasRope: %llu, isPa: %llu, isFd: %llu, emptyTensor: %llu, PFAMask: %llu, pFAMatMulType: %llu, enableKVPrefix: %llu.", 
                static_cast<uint64_t>(ifaTilingArch38.inOutLayoutType), static_cast<uint64_t>(ifaTilingArch38.config), static_cast<uint64_t>(ifaTilingArch38.pseMode),
                static_cast<uint64_t>(ifaTilingArch38.quantMode), ifaTilingArch38.hasAttenMask, ifaTilingArch38.hasRope, ifaTilingArch38.isPa, ifaTilingArch38.isFd, ifaTilingArch38.emptyTensor,
                static_cast<uint64_t>(ifaTilingArch38.PFAMask), static_cast<uint64_t>(ifaTilingArch38.pFAMatMulType), ifaTilingArch38.enableKVPrefix);
        return ret;
    } else {
