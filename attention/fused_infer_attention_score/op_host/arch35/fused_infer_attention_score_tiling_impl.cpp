                                                                ...
                                                                const FiaTilingInfo &fiaInfo)
{
    if (fiaInfo.quantMode == FiaQuantMode::ANTI_QUANT) {
        ...
        OP_LOGE(fiaInfo.opName, "enableS1OutSplit:%d\n", enableS1OutSplit);
        OP_LOGI(fiaInfo.opName, "enableS1OutSplit:%d\n", enableS1OutSplit);
    }
    return ge::GRAPH_SUCCESS;
}
                                                                 ...
                                                                 const FiaTilingInfo &fiaInfo)
{
    ...
    uint64_t genTilingkey = GET_TPL_TILING_KEY(
        ...
        tilingKeyInfo_.emptyTensor, tilingKeyInfo_.maskMode, tilingKeyInfo_.matmulMode, tilingKeyInfo_.enableKvPrefix, tilingKeyInfo_.enableS1OutSplit);
