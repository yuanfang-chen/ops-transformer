...
ge::graphStatus FusedInferAttentionScoreTilingV2::DoOpTiling() {
    ...
    if (usingIFA) {
        ...
        OP_LOGE(context_->GetNodeName(), "The new template tilingkey param is inOutLayoutType: %llu, config: %llu, pseMode: %llu, quantMode: %llu, hasAttenMask: %llu, hasRope: %llu,"
                " isPa: %llu, isFd: %llu, emptyTensor: %llu, PFAMask: %llu, pFAMatMulType: %llu, enableKVPrefix: %llu, pfa_tiling.enableS1OutSplit:%llu.",
