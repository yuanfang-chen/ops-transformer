...
constexpr uint32_t MAX_HEAD_NUM = 48;
...
TEST_F(ChunkGatedDeltaRuleTilingTest, SingleBatch) {
    ...
    gert::TilingContextPara tilingContextPara("ChunkGatedDeltaRule",
        {{queryShape, ge::DT_BF16, ge::FORMAT_ND}, {keyShape, ge::DT_BF16, ge::FORMAT_ND},
         {valueShape, ge::DT_BF16, ge::FORMAT_ND}, {betaShape, ge::DT_BF16, ge::FORMAT_ND},
         {stateShape, ge::DT_BF16, ge::FORMAT_ND}, {seqLengthsShape, ge::DT_INT32, ge::FORMAT_ND}},
        {{{{t, nv, dv}, {t, nv, dv}}, ge::DT_BF16, ge::FORMAT_ND},
         {{{bs, nv, dv, dk}, {bs, nv, dv, dk}}, ge::DT_BF16, ge::FORMAT_ND}},
        {{"scale_value", Ops::Transformer::AnyValue::CreateFrom<float>(1.0f)}},
        &compileinfo
...
TEST_F(ChunkGatedDeltaRuleTilingTest, Invalid_NkExceedMax49) {
    // nk=49 > 48, 期望失败
    optiling::ChunkGatedDeltaRuleCompileInfo compileinfo = {48, 196608};
    uint32_t bs = 2, seqLen = 64, t = bs * seqLen;
    uint32_t nk = 49, nv = 49, dk = 32, dv = 32;  // nk, nv > 48
...
TEST_F(ChunkGatedDeltaRuleTilingTest, Invalid_NvExceedMax49) {
    // nv=49 > 48, 期望失败
    optiling::ChunkGatedDeltaRuleCompileInfo compileinfo = {48, 196608};
    uint32_t bs = 2, seqLen = 64, t = bs * seqLen;
    uint32_t nk = 1, nv = 49, dk = 64, dv = 64;  // nv > 48
...
TEST_F(ChunkGatedDeltaRuleTilingTest, Invalid_BatchExceedMax9) {
    // bs=9 > 8, 期望失败
    optiling::ChunkGatedDeltaRuleCompileInfo compileinfo = {48, 196608};
    uint32_t bs = 9;  // 超过最大值 8
    uint32_t seqLen = 64, t = bs * seqLen;
    uint32_t nk = 4, nv = 4, dk = 64, dv = 64;
...
TEST_F(ChunkGatedDeltaRuleTilingTest, Invalid_DkExceedMax129) {
    // dk=129 > 128, 期望失败
    optiling::ChunkGatedDeltaRuleCompileInfo compileinfo = {48, 196608};
    uint32_t bs = 2, seqLen = 64, t = bs * seqLen;
    uint32_t nk = 4, nv = 4, dk = 129, dv = 64;  // dk > 128
