                                                          ...
                                                          GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    // alibi
        ...
        op.Process(key, value, slot_mapping, compress_lens, seq_lens, key_cache_out, value_cache_out);
    }
    ...
    // rope
        ...
        op.Init(&pipe, &tilingData);
        op.Method(key, value, slot_mapping, compress_lens, seq_lens, compress_seq_offset,
