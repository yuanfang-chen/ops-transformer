...
class l2_mla_prolog_v3_test : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        cout << "l2_mla_prolog_v3_test SetUp" << endl;
    }

    static void TearDownTestCase()
    {
        cout << "l2_mla_prolog_v3_test TearDown" << endl;
    }
};

// 全量化 kvcache pertensor量化
TEST_F(l2_mla_prolog_v3_test, Ascend910B2_mla_prolog_v3_0)
{
    ...
    auto ut = OP_API_UT(
        ...
        INPUT(
            ...
            qcQrScale, 
            kcScale),
        OUTPUT(queryOut, queryRopeOut, dequantScaleQNopeOut, nullptr, nullptr));
