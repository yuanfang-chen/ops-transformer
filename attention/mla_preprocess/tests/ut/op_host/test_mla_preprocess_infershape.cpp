...
class MlaPreprocessProto : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "MlaPreprocessProto SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MlaPreprocessProto TearDown" << std::endl;
    }
};

TEST_F(MlaPreprocessProto, mla_preprocess_infershape_1)
{
    int64_t tokenNum = 8;
    ...
    gert::InfershapeContextPara infershapeContextPara(
        ...
        },
        {
            ...
            {{{blockNum, blockSize, 1, 576}, {blockNum, blockSize, 1, 576}}, ge::DT_FLOAT16, ge::FORMAT_ND},
    ...
    std::vector<std::vector<int64_t>> expectOutputShape = {
        {tokenNum, headNum, 512}, {blockNum, blockSize, 1, 576}, {tokenNum, headNum, 64}, {blockNum, blockSize, 1, 64}};
