...
macro(add_modules_sources)
  ...
  message(STATUS "======  ACLNN_EXTRA_SRCS IS : ${ACLNN_EXTRA_SRCS}")
  message(STATUS "======  PARENT_ACLNN_EXTRA_SRCS IS : ${PARENT_ACLNN_EXTRA_SRCS}")
  message(STATUS "======  ACLNN_EXTRA_HEADERS IS : ${ACLNN_EXTRA_HEADERS}")
  message(STATUS "======  PARENT_ACLNN_EXTRA_HEADERS IS : ${PARENT_ACLNN_EXTRA_HEADERS}")
  message(STATUS "======  ACLNNINNER_EXTRA_SRCS IS : ${ACLNNINNER_EXTRA_SRCS}")
  message(STATUS "======  PARENT_ACLNNINNER_EXTRA_SRCS IS : ${PARENT_ACLNNINNER_EXTRA_SRCS}")
  message(STATUS "======  ACLNNINNER_EXTRA_HEADERS IS : ${ACLNNINNER_EXTRA_HEADERS}")
  message(STATUS "======  PARENT_ACLNNINNER_EXTRA_HEADERS IS : ${PARENT_ACLNNINNER_EXTRA_HEADERS}")
  ...
  # opapi 默认全部编译
  message(STATUS "======  PARENT_ACLNNINNER_EXTRA_SRCS IS : ${PARENT_ACLNNINNER_EXTRA_SRCS}")
  file(GLOB OPAPI_SRCS ${OP_API_SRC_DIR}/*.cpp ${PARENT_ACLNNINNER_EXTRA_SRCS})
