...
function(concat_op_names)
    ...
    if(${ARG_ACLNNTYPE} STREQUAL "aclnn")
        ...
        message("======== liuwenda aclnn ACLNN_EXTRA_HEADERS is : ${ACLNN_EXTRA_HEADERS}==============")
        message("======== liuwenda aclnn ACLNN_EXTRA_SRCS is : ${ACLNN_EXTRA_SRCS}==============")

    elseif(${ARG_ACLNNTYPE} STREQUAL "aclnn_inner")
        message("======== liuwenda aclnn_inner ==============")
        ...
        message("======== liuwenda aclnn ACLNNINNER_EXTRA_HEADERS is : ${ACLNNINNER_EXTRA_HEADERS}==============")
        message("======== liuwenda aclnn ACLNNINNER_EXTRA_SRCS is : ${ACLNNINNER_EXTRA_SRCS}==============")
    endif()
endfunction()