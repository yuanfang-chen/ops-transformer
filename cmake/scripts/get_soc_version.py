...
import sys
import yaml
from parse_changed_file import Module


class GetSocModule(Module):
...
class Parser:
    ...
    _Modules: List[GetSocModule] = []         # 保存规则文件(tests/test_config.yaml)内设置的模块列表
