...
class BinParamBuilder(opdesc_parser.OpDesc):
    ...
    def gen_input_json(self: any, auto_gen_path: str, bisheng_flags: str):
        key_map = {}
...
def gen_bin_param_file(cfgfile: str, out_dir: str, soc: str, bisheng_flags: str,
    ...
    for op_desc in op_descs:
        ...
        op_desc.gen_input_json(auto_gen_path_dir, bisheng_flags)
