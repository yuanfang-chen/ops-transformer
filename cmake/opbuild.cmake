...
function(gen_aclnn_classify host_obj prefix ori_out_srcs ori_out_headers opbuild_out_srcs opbuild_out_headers)
  ...
  if("${prefix}" STREQUAL "aclnnExc")
    ...
    set(${opbuild_out_srcs} ${ori_out_srcs} ${out_srcs} ${ACLNN_EXTRA_SRCS} ${ACLNNINNER_EXTRA_SRCS} PARENT_SCOPE)
    set(${opbuild_out_headers} ${ori_out_headers} ${out_headers} ${ACLNN_EXTRA_HEADERS} ${ACLNNINNER_EXTRA_HEADERS} PARENT_SCOPE)
  endif()
endfunction()
