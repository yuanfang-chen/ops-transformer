...
if (EXISTS "${EIGEN_DST_DIR}" AND IS_DIRECTORY "${CANN_3RD_LIB_PATH}/eigen")
    ...
    set(EIGEN_ARCHIVE ${CANN_3RD_LIB_PATH}/pkg/eigen-3.4.0.tar.gz)
    file(MAKE_DIRECTORY ${CANN_3RD_LIB_PATH}/pkg)

    # Search in CANN_3RD_LIB_PATH and move to pkg if found
    if(EXISTS ${CANN_3RD_LIB_PATH}/eigen-3.4.0.tar.gz AND NOT EXISTS ${EIGEN_ARCHIVE})
        message(STATUS "Found eigen archive in ${CANN_3RD_LIB_PATH}, moving to pkg")
        file(RENAME ${CANN_3RD_LIB_PATH}/eigen-3.4.0.tar.gz ${EIGEN_ARCHIVE})
    endif()
