...
macro(add_modules_sources)
  ...
  if (MODULE_OP_MC2_ENABLE)
    ...
    foreach(COMPUTE_UNIT IN LISTS ASCEND_COMPUTE_UNIT)
        ...
        elseif("${COMPUTE_UNIT}" STREQUAL "ascend910_95" OR "${COMPUTE_UNIT}" STREQUAL "ascend950")
            list(APPEND ARCH_VERSIONS "arch35")
        endif()
    endforeach()
    
    # If no ARCH_VERSION is set, use all versions
    if(NOT ARCH_VERSIONS)
        message(STATUS "ARCH_VERSIONS is empty, ASCEND_COMPUTE_UNIT is ${ASCEND_COMPUTE_UNIT}, adding all architectures")
        list(APPEND ARCH_VERSIONS "arch31" "arch32" "arch35")
    endif()
