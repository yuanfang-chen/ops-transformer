...
macro(add_modules_sources)
  ...
  if(NOT DEFINED SUB_OPTILING_SRC)
    set(SUB_OPTILING_SRC)
  endif()
  if(NOT DEFINED OPTILING_SRCS)
    set(OPTILING_SRCS)
  endif()

  if (MODULE_OP_MC2_ENABLE)
    message(STATUS "MC2 TILING PRINT: ${SOURCE_DIR}")
    ...
    list(APPEND OPTILING_SRCS ${OPTILING_BASE_SRCS})
    ...
    message(STATUS "OTHERS TILING PRINT: ${SOURCE_DIR}")
    file(GLOB_RECURSE OTHER_SUB_OPTILING_SRC ${SOURCE_DIR}/op_tiling/*.cpp)
    list(APPEND SUB_OPTILING_SRC OTHER_SUB_OPTILING_SRC)
    file(GLOB OTHER_OPTILING_SRCS 
      ${SOURCE_DIR}/*fallback*.cpp
      ${SOURCE_DIR}/*_tiling*.cpp
      ${SOURCE_DIR}/op_tiling/arch35/*.cpp
      ${SOURCE_DIR}/../op_graph/fallback_*.cpp
      ${SOURCE_DIR}/../graph_plugin/fallback_*.cpp)
    list(APPEND OPTILING_SRCS OTHER_OPTILING_SRCS)
  endif()
