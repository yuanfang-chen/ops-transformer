...
macro(add_modules_sources)
  ...
  if (EXISTS ${ASCEND_AUTOGEN_DIR}/aclnn_kv_rms_norm_rope_cache_v2.cpp)
    message(STATUS "liuwenda buile content")
    install(FILES ${ASCEND_AUTOGEN_DIR}/aclnn_kv_rms_norm_rope_cache_v2.cpp DESTINATION install_path OPTIONAL)
  elseif(EXISTS ${ASCEND_CURRENT_BINARY_DIR}/prepare_build/autogen/aclnn_kv_rms_norm_rope_cache_v2.cpp)
    message(STATUS "liuwenda prepare_build content")
  ...
  message("========== liuwenda OPAPI_SRCS is : ${OP_API_SRC}==========")
  if (OPAPI_SRCS)
    # aclnn
    add_opapi_modules()
