...
macro(add_modules_sources)
  ...
  if (MODULE_OP_MC2_ENABLE)
    ...
    set(MC2_OPTILING_SRCS ${OPTILING_BASE_SRCS})
    foreach(ARCH_VERSION IN LISTS ARCH_VERSIONS)
        ...
        if(EXISTS ${ARCH_DIR} AND IS_DIRECTORY ${ARCH_DIR})
            ...
            if(ARCH_SPECIFIC_SRCS)
                list(APPEND MC2_OPTILING_SRCS ${ARCH_SPECIFIC_SRCS})
  ...
  if (MC2_OPTILING_SRCS OR SUB_OPTILING_SRC OR OPTILING_SRCS)
    # tiling
    add_tiling_modules()
    target_sources(${OPHOST_NAME}_tiling_obj PRIVATE ${OPTILING_SRCS} ${SUB_OPTILING_SRC} ${MC2_OPTILING_SRCS})
