...
macro(add_modules_sources)
  ...
  message("MODULE_OP_MC2_ENABLE = 1")
    ...
    message(STATUS "SUB_OPTILING_SRC files:")
    foreach(src ${SUB_OPTILING_SRC})
        message(STATUS "  - ${src}")
    endforeach()
    message(STATUS "Total SUB_OPTILING_SRC files: ${SUB_OPTILING_SRC}")
    file(GLOB OPTILING_SRCS 
      ...
      ${SOURCE_DIR}/../op_graph/fallback_*.cpp
      ${SOURCE_DIR}/../graph_plugin/fallback_*.cpp)
    message(STATUS "OPTILING_SRCS files:")
    foreach(src ${OPTILING_SRCS})
        message(STATUS "  - ${src}")
    endforeach()
    message(STATUS "Total OPTILING_SRCS files: ${OPTILING_SRCS}")
  endif()
