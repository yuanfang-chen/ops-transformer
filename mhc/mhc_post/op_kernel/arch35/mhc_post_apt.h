...
TEMPLATE_DECLARE
__aicore__ inline void MhcPostKernelApt<TEMPLATE_ARGS>::CopyInTile(uint32_t bsIdx, uint32_t dIdx)
{
...
TEMPLATE_DECLARE
__aicore__ inline void MhcPostKernelApt<TEMPLATE_ARGS>::ComputeAndCopyOutTile(uint32_t bsIdx, uint32_t dIdx)
{
...
TEMPLATE_DECLARE
__aicore__ inline void MhcPostKernelApt<TEMPLATE_ARGS>::CopyInX(uint32_t bsIdx, uint32_t dIdx, uint32_t nI,
...
TEMPLATE_DECLARE
__aicore__ inline void MhcPostKernelApt<TEMPLATE_ARGS>::CopyOutTile(uint32_t bsIdx, uint32_t dIdx, uint32_t nI)
{
    uint32_t dStart = dIdx * dInner_;
