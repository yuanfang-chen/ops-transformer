...
int main() {
    ...
    std::vector<half> xHostData(xShapeSize, static_cast<half>(1.0f));
    std::vector<float> hResHostData(hResShapeSize, 1.0f);
    std::vector<half> hOutHostData(hOutShapeSize, static_cast<half>(1.0f));
    std::vector<float> hPostHostData(hPostShapeSize, 1.0f);
    std::vector<half> outHostData(outShapeSize, static_cast<half>(0.0f));
    ...
    std::vector<half> resultData(size, static_cast<half>(0.0f));
