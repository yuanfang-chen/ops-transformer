...
#ifndef MHC_PRE_SINKHORN_TILING_H_
#define MHC_PRE_SINKHORN_TILING_H_
#pragma once
#include "register/tilingdata_base.h"
#include "tiling/tiling_api.h"
#include "tiltiling_base/tiling_base.h"
#include "tiling_base/tiling_templates_registry.h"
#include "register/op_impl_registry.h"
#include "register/op_def_registry.h"
#include "util/math_util.h"
#include "kernel_tiling/kernel_tiling.h"
#include "../op_kernel/arch35/mhc_pre_sinkhorn_struct.h"
#include "../op_kernel/arch35/mhc_pre_sinkhorn_tiling_key.h"
...
class MhcPreSinkhornTiling : public TilingBaseClass
{
public:
    explicit MhcPreSinkhornTiling(gert::TilingContext* context) : TilingBaseClass(context)
    {
    }
...
private:
    ...
    const char* opName_ = "MhcPreSinkhorn";
};
}  // namespace optiling
#endif  // MHC_PRE_SINKHORN_TILING_H_
