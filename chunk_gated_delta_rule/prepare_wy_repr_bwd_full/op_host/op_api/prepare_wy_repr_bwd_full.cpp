    ...
    aclOpExecutor *executor)
{
    ...
    if (cuSeqlensOptional) {
        ...
        actualCuSeqQLen = executor->AllocTensor(DataType::DT_INT64, Format::FORMAT_ND, Format::FORMAT_ND);
    }
    ...
    if (chunkIndicesOptional) {
        ...
        actualChunkIndices = executor->AllocTensor(DataType::DT_INT64, Format::FORMAT_ND, Format::FORMAT_ND);
    }
