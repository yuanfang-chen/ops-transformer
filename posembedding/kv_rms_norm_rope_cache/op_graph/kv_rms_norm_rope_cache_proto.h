 ...
 *
 * @par Inputs:
 * @li kv: A tensor. The type supports float, float16 and bfloat16. Its shape is [Bkv, N, Skv, D] or [Bkv, N, Skv, Dk] when v is not None. Format: ND.
 ...
 * @li k_cache: A tensor. Its type must be either consistent with kv, or one of:int8, float8_e5m2, float8_e4m3fn, hifloat8. When the cache_mode is in PA scenario(cache_mode is
 ...
 * @li ckv_cache: A tensor. Its type must be either consistent with kv, or one of:int8, float8_e5m2, float8_e4m3fn, hifloat8. When the cache_mode is in PA scenario, its shape is
 ...
 * @li v: A tensor. The type supports float, float16 and bfloat16. Its shape is [Bkv, N, Skv, Dv]. Format: ND.
 *
 * @par Outputs:
 * @li k_cache: A tensor. Its type must be either consistent with kv, or one of:int8, float8_e5m2, float8_e4m3fn, hifloat8. When the cache_mode is in PA scenario, its shape is
