                                                                           ...
                                                                           GM_ADDR mean, GM_ADDR rstd)
{
    ...
    // 设置不写入L2 Cache
    this->xGm_.SetL2CacheHint(CacheMode::CACHE_MODE_DISABLE);
    this->weightGm_.SetL2CacheHint(CacheMode::CACHE_MODE_DISABLE);
    this->biasGm_.SetL2CacheHint(CacheMode::CACHE_MODE_DISABLE);
    this->meanGm_.SetL2CacheHint(CacheMode::CACHE_MODE_DISABLE);
    this->rstdGm_.SetL2CacheHint(CacheMode::CACHE_MODE_DISABLE);
...
public:
    ...
    __aicore__ inline void Prepare(GM_ADDR y, uint32_t curSeq, uint32_t totalSeq)
    {
        ...
        this->yGm_.SetL2CacheHint(CacheMode::CACHE_MODE_DISABLE);
