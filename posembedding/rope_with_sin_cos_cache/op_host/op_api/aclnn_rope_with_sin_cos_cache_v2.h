...
#ifndef OP_API_INC_ROPE_WITH_SIN_COS_CACHE_V2_H_
#define OP_API_INC_ROPE_WITH_SIN_COS_CACHE_V2_H_
 ...
 * style）计算模式，数据类型bool
 * @param [in] cacheMode: 属性，表示从cache中获取cos和sin的方式，目前只支持0和1。0代表分段式，1代表交错式
 ...
 */
ACLNN_API aclnnStatus aclnnRopeWithSinCosCacheV2GetWorkspaceSize(
...
aclnnRopeWithSinCosCacheV2(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);
