...
ge::graphStatus ApplyRotaryPosEmbRegbaseTilingBaseClass::CheckShape()
{
    OP_CHECK_IF((qShape_.GetDimNum() != DIM_NUM && qShape_.GetDimNum() != DIM_NUM_TND),
                OP_LOGE(context_, "dim of query expect 4 or 3, actual %zu.", qShape_.GetDimNum()), return ge::GRAPH_FAILED);
    OP_CHECK_IF((kShape_.GetDimNum() != DIM_NUM && kShape_.GetDimNum() != DIM_NUM_TND),
                OP_LOGE(context_, "dim of key expect 4 or 3, actual %zu.", kShape_.GetDimNum()), return ge::GRAPH_FAILED);
    OP_CHECK_IF((cosShape_.GetDimNum() != DIM_NUM && cosShape_.GetDimNum() != DIM_NUM_TND),
                OP_LOGE(context_, "dim of cos expect 4 or 3, actual %zu.", cosShape_.GetDimNum()), return ge::GRAPH_FAILED);
    OP_CHECK_IF((sinShape_.GetDimNum() != DIM_NUM && sinShape_.GetDimNum() != DIM_NUM_TND),
                OP_LOGE(context_, "dim of sin expect 4 or 3, actual %zu.", sinShape_.GetDimNum()), return ge::GRAPH_FAILED);
