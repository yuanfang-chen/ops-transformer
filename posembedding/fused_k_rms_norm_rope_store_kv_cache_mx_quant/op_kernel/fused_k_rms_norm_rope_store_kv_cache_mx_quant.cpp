...
extern "C" __global__ __aicore__ void kv_rms_norm_rope_cache(GM_ADDR qkv, GM_ADDR cos, GM_ADDR sin, GM_ADDR gamma,
                                                             GM_ADDR kv_slot_mapping, GM_ADDR v_scale_slot_mapping,
                                                             GM_ADDR k_cache, GM_ADDR k_scale_cache, GM_ADDR v_cache,
                                                             GM_ADDR v_scale_cache, GM_ADDR q, GM_ADDR q_scale,
                                                             GM_ADDR k_cache_out, GM_ADDR k_scale_cache_out,
                                                             GM_ADDR v_cache_out, GM_ADDR v_scale_cache_out,
