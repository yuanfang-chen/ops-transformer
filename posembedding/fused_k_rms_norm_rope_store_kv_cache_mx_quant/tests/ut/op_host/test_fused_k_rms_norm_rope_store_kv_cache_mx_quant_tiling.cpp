...
// ==================== Cross-tensor consistency: cos T/D mismatch ====================

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_cos_t_mismatch)
{
    // cos T=1024 != qkv T=2048
    auto tilingContextPara = BuildTilingContextWithBadInput(1,
        {{{1024, 1, 128}, {1024, 1, 128}}, ge::DT_BF16, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_cos_d_mismatch)
{
    // cos D=64 != headDim=128
    auto tilingContextPara = BuildTilingContextWithBadInput(1,
        {{{2048, 1, 64}, {2048, 1, 64}}, ge::DT_BF16, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

// ==================== Cross-tensor consistency: sin T/D mismatch ====================

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_sin_t_mismatch)
{
    // sin T=1024 != qkv T=2048
    auto tilingContextPara = BuildTilingContextWithBadInput(2,
        {{{1024, 1, 128}, {1024, 1, 128}}, ge::DT_BF16, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_sin_d_mismatch)
{
    // sin D=64 != headDim=128
    auto tilingContextPara = BuildTilingContextWithBadInput(2,
        {{{2048, 1, 64}, {2048, 1, 64}}, ge::DT_BF16, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

// ==================== Cross-tensor consistency: cos/sin dtype mismatch ====================

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_cos_dtype_mismatch)
{
    // cos dtype=FP16 != qkv dtype=BF16
    auto tilingContextPara = BuildTilingContextWithBadInput(1,
        {{{2048, 1, 128}, {2048, 1, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_sin_dtype_mismatch)
{
    // sin dtype=FP16 != qkv dtype=BF16
    auto tilingContextPara = BuildTilingContextWithBadInput(2,
        {{{2048, 1, 128}, {2048, 1, 128}}, ge::DT_FLOAT16, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

// ==================== Cross-tensor consistency: gamma D mismatch ====================

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_gamma_dim_mismatch)
{
    // gamma dim=64 != headDim=128
    auto tilingContextPara = BuildTilingContextWithBadInput(3,
        {{{64}, {64}}, ge::DT_FLOAT, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

// ==================== Cross-tensor consistency: kv_slot_mapping length mismatch ====================

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_kv_slot_mapping_len_mismatch)
{
    // kv_slot_mapping length=1024 != T=2048
    auto tilingContextPara = BuildTilingContextWithBadInput(4,
        {{{1024}, {1024}}, ge::DT_INT64, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

// ==================== Cross-tensor consistency: v_scale_slot_mapping length mismatch ====================

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_v_scale_slot_mapping_len_mismatch)
{
    // v_scale_slot_mapping length=16 != T/32/2=32
    auto tilingContextPara = BuildTilingContextWithBadInput(5,
        {{{16}, {16}}, ge::DT_INT64, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

// ==================== Cross-tensor consistency: k_cache D mismatch ====================

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_k_cache_d_mismatch)
{
    // k_cache D=64 != headDim=128
    auto tilingContextPara = BuildTilingContextWithBadInput(6,
        {{{4, 2, 512, 64}, {4, 2, 512, 64}}, ge::DT_FLOAT8_E4M3FN, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

// ==================== Cross-tensor consistency: k_scale_cache Bn/Nk/Bs/scaleDim mismatch ====================

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_k_scale_cache_bn_mismatch)
{
    // k_scale_cache Bn=2 != blockNum=4
    auto tilingContextPara = BuildTilingContextWithBadInput(7,
        {{{2, 2, 512, 2, 2}, {2, 2, 512, 2, 2}}, ge::DT_FLOAT8_E8M0, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_k_scale_cache_nk_mismatch)
{
    // k_scale_cache Nk=4 != numHeadK=2
    auto tilingContextPara = BuildTilingContextWithBadInput(7,
        {{{4, 4, 512, 2, 2}, {4, 4, 512, 2, 2}}, ge::DT_FLOAT8_E8M0, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_k_scale_cache_bs_mismatch)
{
    // k_scale_cache Bs=256 != blockSize=512
    auto tilingContextPara = BuildTilingContextWithBadInput(7,
        {{{4, 2, 256, 2, 2}, {4, 2, 256, 2, 2}}, ge::DT_FLOAT8_E8M0, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_k_scale_cache_scale_dim_mismatch)
{
    // k_scale_cache D/32/2=4 != expected=2 (headDim=128, 128/32/2=2)
    auto tilingContextPara = BuildTilingContextWithBadInput(7,
        {{{4, 2, 512, 4, 2}, {4, 2, 512, 4, 2}}, ge::DT_FLOAT8_E8M0, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

// ==================== Cross-tensor consistency: v_cache Bn/Bs/D mismatch ====================

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_v_cache_bn_mismatch)
{
    // v_cache Bn=2 != blockNum=4
    auto tilingContextPara = BuildTilingContextWithBadInput(8,
        {{{2, 2, 512, 128}, {2, 2, 512, 128}}, ge::DT_FLOAT8_E4M3FN, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_v_cache_bs_mismatch)
{
    // v_cache Bs=256 != blockSize=512
    auto tilingContextPara = BuildTilingContextWithBadInput(8,
        {{{4, 2, 256, 128}, {4, 2, 256, 128}}, ge::DT_FLOAT8_E4M3FN, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_v_cache_d_mismatch)
{
    // v_cache D=64 != headDim=128
    auto tilingContextPara = BuildTilingContextWithBadInput(8,
        {{{4, 2, 512, 64}, {4, 2, 512, 64}}, ge::DT_FLOAT8_E4M3FN, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

// ==================== Cross-tensor consistency: v_scale_cache Bn/Nv/scaleSeq/D mismatch ====================

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_v_scale_cache_bn_mismatch)
{
    // v_scale_cache Bn=2 != blockNum=4
    auto tilingContextPara = BuildTilingContextWithBadInput(9,
        {{{2, 2, 8, 128, 2}, {2, 2, 8, 128, 2}}, ge::DT_FLOAT8_E8M0, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_v_scale_cache_nv_mismatch)
{
    // v_scale_cache Nv=4 != numHeadV=2
    auto tilingContextPara = BuildTilingContextWithBadInput(9,
        {{{4, 4, 8, 128, 2}, {4, 4, 8, 128, 2}}, ge::DT_FLOAT8_E8M0, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_v_scale_cache_scale_seq_mismatch)
{
    // v_scale_cache Bs/32/2=4 != expected=8 (blockSize=512, 512/32/2=8)
    auto tilingContextPara = BuildTilingContextWithBadInput(9,
        {{{4, 2, 4, 128, 2}, {4, 2, 4, 128, 2}}, ge::DT_FLOAT8_E8M0, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}

TEST_F(FusedKRmsNormRopeStoreKvCacheMxQuantTiling, tiling_fail_when_v_scale_cache_d_mismatch)
{
    // v_scale_cache D=64 != headDim=128
    auto tilingContextPara = BuildTilingContextWithBadInput(9,
        {{{4, 2, 8, 64, 2}, {4, 2, 8, 64, 2}}, ge::DT_FLOAT8_E8M0, ge::FORMAT_ND});
    ExecuteTestCase(tilingContextPara, ge::GRAPH_FAILED);
}
