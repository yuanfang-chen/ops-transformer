...
std::vector<MatmulAllReduceTilingUtParam> cases910 {
    ...
    // 注意: 910B不支持FRACTAL_NZ格式的A16W8场景，使用ND格式
    // ============================================================================
    ...
    {"a16w8_weight_quant_nd", TD({{256, 1536}, {256, 1536}}, ge::DT_FLOAT16, ge::FORMAT_ND), TD({{1536, 8192}, {1536, 8192}}, ge::DT_INT8, ge::FORMAT_ND), std::nullopt, std::nullopt, TD({{8192}, {8192}}, ge::DT_FLOAT16, ge::FORMAT_ND), TD({{8192}, {8192}}, ge::DT_FLOAT16, ge::FORMAT_ND), std::nullopt, std::nullopt, std::nullopt, std::nullopt, TD({{256, 8192}, {256, 8192}}, ge::DT_FLOAT16, ge::FORMAT_ND), "group", "sum", false, true, 0, 0, 0, 0, 0, 8, ge::GRAPH_SUCCESS, 72548364UL, ""},
    {"a16w8_weight_quant_with_bias", TD({{512, 1024}, {512, 1024}}, ge::DT_FLOAT16, ge::FORMAT_ND), TD({{1024, 2048}, {1024, 2048}}, ge::DT_INT8, ge::FORMAT_ND), TD({{2048}, {2048}}, ge::DT_FLOAT16, ge::FORMAT_ND), std::nullopt, TD({{2048}, {2048}}, ge::DT_FLOAT16, ge::FORMAT_ND), TD({{2048}, {2048}}, ge::DT_FLOAT16, ge::FORMAT_ND), std::nullopt, std::nullopt, std::nullopt, std::nullopt, TD({{512, 2048}, {512, 2048}}, ge::DT_FLOAT16, ge::FORMAT_ND), "group", "sum", false, true, 0, 0, 0, 0, 0, 8, ge::GRAPH_SUCCESS, 72548364UL, ""},
    {"a16w8_weight_quant_transB", TD({{1024, 2048}, {1024, 2048}}, ge::DT_FLOAT16, ge::FORMAT_ND), TD({{4096, 2048}, {4096, 2048}}, ge::DT_INT8, ge::FORMAT_ND), std::nullopt, std::nullopt, TD({{4096}, {4096}}, ge::DT_FLOAT16, ge::FORMAT_ND), TD({{4096}, {4096}}, ge::DT_FLOAT16, ge::FORMAT_ND), std::nullopt, std::nullopt, std::nullopt, std::nullopt, TD({{1024, 4096}, {1024, 4096}}, ge::DT_FLOAT16, ge::FORMAT_ND), "group", "sum", false, true, 0, 0, 0, 0, 0, 8, ge::GRAPH_SUCCESS, 72548364UL, ""},
    {"a16w8_weight_quant_n_unaligned", TD({{512, 1024}, {512, 1024}}, ge::DT_FLOAT16, ge::FORMAT_ND), TD({{1024, 4097}, {1024, 4097}}, ge::DT_INT8, ge::FORMAT_ND), std::nullopt, std::nullopt, TD({{4097}, {4097}}, ge::DT_FLOAT16, ge::FORMAT_ND), TD({{4097}, {4097}}, ge::DT_FLOAT16, ge::FORMAT_ND), std::nullopt, std::nullopt, std::nullopt, std::nullopt, TD({{512, 4097}, {512, 4097}}, ge::DT_FLOAT16, ge::FORMAT_ND), "group", "sum", false, true, 0, 0, 0, 0, 0, 8, ge::GRAPH_SUCCESS, 72548364UL, ""},
    // 失败用例
