...
// ============================================================================
// 以下为补充的测试用例 - 用于提升 all_gather_matmul_v2 tiling 覆盖率
// 添加时间: 2026-02-02
// 目的: 覆盖 arch32 (Ascend910B) 实现的代码
// ============================================================================

// 补充测试用例1: arch32 基础场景 - 使用 Ascend910B (期望失败，因为 arch32 不支持此场景)
TEST_F(AllGatherMatmulV2TilingTest, all_gather_matmul_v2_arch32_fp16_basic)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
    ...
    gert::TilingContextPara tilingContextPara(
        ...
        },
        {
            ...
            {"is_gather_out", Ops::Transformer::AnyValue::CreateFrom<bool>(false)},
            {"is_amax_out", Ops::Transformer::AnyValue::CreateFrom<bool>(false)},
            {"y_dtype", Ops::Transformer::AnyValue::CreateFrom<int64_t>(static_cast<int>(ge::DT_FLOAT16))}
        },
        &compileInfo, "Ascend910B", 64
    );
    Mc2Hcom::MockValues hcomTopologyMockValues{
        {"rankNum", 8}
    };
...
// 补充测试用例2: arch32 bf16 场景
TEST_F(AllGatherMatmulV2TilingTest, all_gather_matmul_v2_arch32_bf16_basic)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
    ...
    gert::TilingContextPara tilingContextPara(
        "AllGatherMatmulV2",
        {
            ...
            {{{2048, 512}, {2048, 512}}, ge::DT_BF16, ge::FORMAT_ND},
            {{}, ge::DT_FLOAT, ge::FORMAT_ND},
            {{}, ge::DT_FLOAT, ge::FORMAT_ND},
            {{}, ge::DT_FLOAT, ge::FORMAT_ND},
            {{}, ge::DT_FLOAT, ge::FORMAT_ND},
        ...
        {
            {{{2048, 512}, {2048, 512}}, ge::DT_FLOAT, ge::FORMAT_ND},
...
// 补充测试用例3: arch32 is_trans_b=true 场景
TEST_F(AllGatherMatmulV2TilingTest, all_gather_matmul_v2_arch32_trans_b_true)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
    ...
    gert::TilingContextPara tilingContextPara(
        ...
        {
            {{{2048, 512}, {2048, 512}}, ge::DT_FLOAT16, ge::FORMAT_ND},
...
// ============================================================================
// 以下为补充的测试用例 v4 - 用于提升 all_gather_matmul_v2 AIV Mode 覆盖率
// 添加时间: 2026-02-02
// 目的: 覆盖 arch32 AIV Mode 实现 (all_gather_matmul_aiv_mode_tiling.cpp)
// ============================================================================

// 补充测试用例4: AIV Mode 基础场景 - FP16
// 触发条件: Ascend910B + commMode="aiv"
TEST_F(AllGatherMatmulV2TilingTest, all_gather_matmul_v2_aiv_mode_fp16_basic)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
    ...
    gert::TilingContextPara tilingContextPara(
        ...
        },
        {
            ...
            {"is_amax_out", Ops::Transformer::AnyValue::CreateFrom<bool>(false)},
            {"y_dtype", Ops::Transformer::AnyValue::CreateFrom<int64_t>(static_cast<int>(ge::DT_FLOAT16))},
            {"comm_mode", Ops::Transformer::AnyValue::CreateFrom<std::string>("aiv")}
        },
        &compileInfo, "Ascend910B", 64
    );
    Mc2Hcom::MockValues hcomTopologyMockValues{
    ...
    Mc2ExecuteTestCase(tilingContextPara, hcomTopologyMockValues, ge::GRAPH_SUCCESS, 10000);
}

// 补充测试用例5: AIV Mode BF16 场景
TEST_F(AllGatherMatmulV2TilingTest, all_gather_matmul_v2_aiv_mode_bf16_basic)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
    ...
    gert::TilingContextPara tilingContextPara(
        ...
        {
            {{{1024, 512}, {1024, 512}}, ge::DT_FLOAT, ge::FORMAT_ND},
            {{{1024, 2048}, {1024, 2048}}, ge::DT_BF16, ge::FORMAT_ND},
        },
        {
            {"group", Ops::Transformer::AnyValue::CreateFrom<std::string>("hcclCom")},
...
// 补充测试用例6: AIV Mode is_trans_b=true 场景 (tilingKey = 10010)
TEST_F(AllGatherMatmulV2TilingTest, all_gather_matmul_v2_aiv_mode_trans_b_true)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
    ...
    Mc2ExecuteTestCase(tilingContextPara, hcomTopologyMockValues, ge::GRAPH_SUCCESS, 10010);
}

// 补充测试用例7: AIV Mode 使用 Ascend910_93 SOC
TEST_F(AllGatherMatmulV2TilingTest, all_gather_matmul_v2_aiv_mode_910c)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
