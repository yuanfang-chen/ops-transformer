 ...
 *
 * This struct implements data copy in the DAV_3510 architecture using the CopyOutSplitNWithParams mode
 *
...
struct Copy<
    Arch::DAV_3510, CopyOutSplitNWithParams, void, OutputType, InputType,
...
public:
     ...
     * @note This functionimplements data copy in the DAV_3510 architecture using the CopyOutSplitNWithParams mode
     */
...
/**
 * @struct Copy
 * @brief Copy struct for DAV_3510 architecture with specific conditions
 *
