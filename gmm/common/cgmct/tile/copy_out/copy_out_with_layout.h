...
/**
 * @struct Copy
 * @brief Copy struct for DAV_3510 architecture with specific tensor traits
 *
 * This struct is specialized for the DAV_3510 architecture and CopyWithLayout,
...
template <class OutputType, class DstTrait, class SrcTrait>
struct Copy<
    Arch::DAV_3510, CopyWithLayout, OutputType, DstTrait, SrcTrait,
