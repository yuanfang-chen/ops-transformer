 ...
 *
 * This struct implements data copy operations in the Arch::DAV_3510 architecture using the CopyOutSplitMWithParams mode
 *
...
struct Copy<
    Arch::DAV_3510, CopyOutSplitMWithParams, void, OutputType, InputType,
 ...
 *
 * This struct implements data copy operations for Arch::DAV_3510 platform when the output is positioned in UB
