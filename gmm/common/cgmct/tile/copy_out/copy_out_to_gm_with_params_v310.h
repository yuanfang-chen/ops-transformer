...
/**
 * @struct Copy
 * @brief Copy struct for DAV_3510 architecture with specific parameters
 * @param [in] OutputType: the type of the output tensor
 * @param [in] InputType: the type of the input tensor
 */
template <class OutputType, class InputType>
struct Copy<
    Arch::DAV_3510, CopyWithParams, void, OutputType, InputType,
 ...
 */
template <class OutputType, class InputType>
struct Copy<Arch::DAV_3510, CopyWithParams, void, OutputType, InputType,
    AscendC::Std::enable_if_t<
...
public:
    ...
    /**
     * @brief Overloaded operator() for DAV_3510 architecture
