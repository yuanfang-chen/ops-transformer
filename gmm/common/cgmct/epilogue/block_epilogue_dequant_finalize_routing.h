...
GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpilogueDequantFinalizeRouting<GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_FUNC_LOCAL_PARAMS>::Init(Params const &params)
{
    if ASCEND_IS_AIC
    {
        return;
...
GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_CLASS_LOCAL_PARAMS
__aicore__ inline auto BlockEpilogueDequantFinalizeRouting<GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_FUNC_LOCAL_PARAMS>::GetL0c2UbTensor()
{
    return l0cOutUb_;
}

GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpilogueDequantFinalizeRouting<GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_FUNC_LOCAL_PARAMS>::UpdateNextProblem(
...
GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpilogueDequantFinalizeRouting<GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_FUNC_LOCAL_PARAMS>::UpdateGlobalAddr(
...
GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpilogueDequantFinalizeRouting<GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_FUNC_LOCAL_PARAMS>::CopyInLogit(
...
GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpilogueDequantFinalizeRouting<GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_FUNC_LOCAL_PARAMS>::VectorAtomicProcess(
...
GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpilogueDequantFinalizeRouting<GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_FUNC_LOCAL_PARAMS>::VFDoLogitMuls(
    ...
    LocalTensor<DataTypeX2Scale> x2ScaleUb, LocalTensor<DataTypeX1Scale> x1ScaleUb, LocalTensor<BiasDtype> biasUb, uint16_t mSize)
{
    ...
    if (params_->x1ScaleGmAddr != nullptr) {
        if (params_->biasGmAddr != nullptr) {
            VFDoDequant<true>(l0cOutUbAddr, l0cOutUbAddr, (__ubuf__ DataTypeX2Scale*)x2ScaleUb.GetPhyAddr(),
                (__ubuf__ DataTypeX1Scale*)x1ScaleUb.GetPhyAddr(), (__ubuf__ BiasDtype*)biasUb.GetPhyAddr(), mSize, singleN_);
        } else {
            VFDoDequant<false>(l0cOutUbAddr, l0cOutUbAddr, (__ubuf__ DataTypeX2Scale*)x2ScaleUb.GetPhyAddr(),
                (__ubuf__ DataTypeX1Scale*)x1ScaleUb.GetPhyAddr(), nullptr, mSize, singleN_);
        }
    } else {
        if (params_->biasGmAddr != nullptr) {
            VFDoDequantOnlyX2<true>(l0cOutUbAddr, l0cOutUbAddr, (__ubuf__ DataTypeX2Scale*)x2ScaleUb.GetPhyAddr(),
                (__ubuf__ BiasDtype*)biasUb.GetPhyAddr(), mSize, singleN_);
        } else {
            VFDoDequantOnlyX2<false>(l0cOutUbAddr, l0cOutUbAddr, (__ubuf__ DataTypeX2Scale*)x2ScaleUb.GetPhyAddr(),
...
GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpilogueDequantFinalizeRouting<GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_FUNC_LOCAL_PARAMS>::CopyX1ScaleFromGm2Ub(
    LocalTensor<DataTypeX1Scale>& dst, uint64_t blockLen, uint64_t offset)
{
...
GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpilogueDequantFinalizeRouting<GMM_BLOCK_EPILOGUE_DEQUANT_FINALIZE_ROUTING_FUNC_LOCAL_PARAMS>::CopyX2ScaleFromGm2Ub(
    LocalTensor<DataTypeX2Scale>& dst, uint64_t offset)
{
    ...
    const BlockShape& blockShape, const BlockCoord& blockCoord)
{
    ...
    uint16_t remainRepeatTimesLogit = (singleMInVec % MAX_OUTPUT_M_UBS != 0) ? singleMInVec % MAX_OUTPUT_M_UBS : MAX_OUTPUT_M_UBS;
    ...
    for (int32_t i = 0;  i < loopNumY;  i++) {
        ...
        VFDoLogitMuls(i * MAX_OUTPUT_M_UBS * alignN_, i * MAX_OUTPUT_M_UBS, repeatTimesLine_, repeatTimesRe, outUbAddr, logitUb);
