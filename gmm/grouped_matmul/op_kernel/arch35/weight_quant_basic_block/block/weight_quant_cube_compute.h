                                                                         ...
                                                                         int64_t biasRealN)
{
    ...
    if (maxSpace > 0) {
        ...
        auto gmBlockA = gmA_(AscendC::Te::MakeCoord(param.mOffset, kaGmOffset),
                                                                   ...
                                                                   uint64_t kbL1Offset)
{
    ...
    auto gmBlockScaleA = gmScaleA_(AscendC::Te::MakeCoord(param.mOffset, kbL1Offset / MX_GROUP_SIZE),
    ...
    auto gmBlockScaleB = gmScaleB_(AscendC::Te::MakeCoord(kbL1Offset / MX_GROUP_SIZE, param.nOffset),
...
__aicore__ inline void WQBMM_CUBE_COMPUTE_CLASS::GetTensorC(const BasicBlockOffsetParam &param)
{
    ...
    auto tensorBlockGmC = gmC_(AscendC::Te::MakeCoord(param.mOffset, param.nOffset),
                               AscendC::Te::MakeShape(param.mL1Size, param.nL1Size));
    AscendC::Te::Copy(CopyL0C2GM, tensorBlockGmC, tensorL0C, FP32_64_AS_UINT64,
                      AscendC::Te::FixpipeParams{/*unitflag*/3});
}
}  // namespace WeightQuantBatchMatmulV2::Arch35
