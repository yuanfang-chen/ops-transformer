...
struct CopyL12L0MxScaleA3510 {
    ...
    __aicore__ inline static void Copy(const T& dst, const U& src, const Coord& coord)
    {
        ...
        // Zz -> Zz
        uint16_t mStartPosition = Cgmct::Gemm::CeilDiv(AscendC::Std::get<0>(coord), MATMUL_MNK_ALIGN);
        uint16_t kStartPosition = Cgmct::Gemm::CeilDiv(AscendC::Std::get<1>(coord), 2);
		...
		#ifdef __XBL_PRINT__
        AscendC::printf("[Patch] load_cbuf_to_ca_mx %p,%p,%d,%d,%d,%d,%d,%d",mxDstAddr, static_cast<__cbuf__ void*>(src.Data().Get()), mStartPosition, kStartPosition, mStep, kStep,
            srcStride, dstStride);
        #endif
        load_cbuf_to_ca_mx(
...
template <>
struct AscendC::Te::CopyTraits<Cgmct::Gemm::Tile::CopyL12L0MxScaleA3510>
    : public CopyTraits<
          Cgmct::Gemm::Tile::CopyL12L0MxScaleA3510, LoadDataTraitDefault, Cgmct::Gemm::Tile::CopyL12L0MxScaleA3510,
