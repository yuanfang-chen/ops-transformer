...
private:
    ...
    static constexpr uint64_t MX_A8W4_L1_K_DYNAMIC_CONFIG_M_THRESHOLD_248 = 248;
    uint64_t mxA8W4L1KDynamicConfigMThreshold_; // m轴依赖空间划分，无法动态配置
};
    ...
    const TCubeTiling *__restrict mmTiling, GM_ADDR tiling, TPipe *tPipe)
{
    ...
    mxA8W4L1KDynamicConfigMThreshold_ = gmmBaseTiling_->hasBias ? MX_A8W4_L1_K_DYNAMIC_CONFIG_M_THRESHOLD_256 :
                                                                  MX_A8W4_L1_K_DYNAMIC_CONFIG_M_THRESHOLD_248;
}
