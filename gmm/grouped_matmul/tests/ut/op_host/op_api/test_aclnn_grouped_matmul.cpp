...
TEST_F(l2_grouped_matmul_test, Ascend950_grouped_matmul_v4_sparsem_2d_grouplist)
{
    size_t M = 345;
    size_t K = 1280;
    size_t N = 567;
    ...
    auto antiquantOffsetOptional = nullptr;
    auto perTokenScaleOptional = TensorListDesc(1, TensorDesc({M}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, 10));
    auto groupListOptional = TensorDesc({E, 2}, ACL_INT64, ACL_FORMAT_ND);
    auto activationInputOptional = nullptr;
    auto activationQuantScaleOptional = nullptr;
    auto activationQuantOffsetOptional = nullptr;
    int64_t splitItem = 3;
    int64_t groupType = 0;
    int64_t groupListType = 2;
    int64_t actType = 0;
    auto tuningConfigOptional = nullptr;
    auto activationFeatureOutOptional = nullptr;
    auto dynQuantScaleOutOptional = nullptr;
...
TEST_F(l2_grouped_matmul_test, Ascend950_grouped_matmul_v5_sparsem_2d_grouplist)
{
    size_t M = 345;
    size_t K = 1280;
    size_t N = 567;
...
TEST_F(l2_grouped_matmul_test, Ascend950_grouped_matmul_weightnz_sparsem_2d_grouplist)
{
    size_t M = 345;
    size_t K = 1280;
    size_t N = 567;
...
TEST_F(l2_grouped_matmul_test, Ascend950_grouped_matmul_v4_sparsem_1d_grouplist_error)
{
    size_t M = 345;
    size_t K = 1280;
    size_t N = 567;
...
TEST_F(l2_grouped_matmul_test, Ascend950_grouped_matmul_v5_sparsem_1d_grouplist_error)
{
    size_t M = 345;
    size_t K = 1280;
    size_t N = 567;
...
TEST_F(l2_grouped_matmul_test, Ascend950_grouped_matmul_weightnz_sparsem_1d_grouplist_error)
{
    size_t M = 345;
    size_t K = 1280;
    size_t N = 567;
