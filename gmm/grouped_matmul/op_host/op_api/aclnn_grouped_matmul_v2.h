 ...
 */
__attribute__((visibility("default"), deprecated("aclnnGroupedMatmulV2GetWorkspaceSize is scheduled to be deprecated in December 2026, and will be replaced by the aclnnGroupedMatmulV5GetWorkspaceSize. We apologize for any inconvenience caused and appreciate your timely migration to the new interface.")))
 ...
 * @return aclnnStatus: 返回状态码。
 */
__attribute__((visibility("default"), deprecated("aclnnGroupedMatmulV2 is scheduled to be deprecated in December 2026, and will be replaced by the aclnnGroupedMatmulV5. We apologize for any inconvenience caused and appreciate your timely migration to the new interface.")))
