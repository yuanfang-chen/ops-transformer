 ...
 */
__attribute__((visibility("default"), deprecated("aclnnGroupedMatmulGetWorkspaceSize is scheduled to be deprecated in December 2026, "
 ...
 * @return aclnnStatus: 返回状态码。
 */
__attribute__((visibility("default"), deprecated("aclnnGroupedMatmul is scheduled to be deprecated in December 2026, "
