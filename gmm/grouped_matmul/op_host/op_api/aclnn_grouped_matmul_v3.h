 ...
 */
__attribute__((visibility("default"), deprecated("aclnnGroupedMatmulV3GetWorkspaceSize is scheduled to be deprecated in December 2026, "
 ...
 * @return aclnnStatus: 返回状态码。
 */
__attribute__((visibility("default"), deprecated("aclnnGroupedMatmulV3 is scheduled to be deprecated in December 2026, "
