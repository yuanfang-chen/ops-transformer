...
aclnnStatus AclnnGroupedMatmulWeightQuant91095Checker::CheckScaleAndPerTokenScaleShape() const
{
    if (IsMxA8W4NZ()) {
        ...
        size_t perTokenScaleSupportDimNum = 3; // MxA8W4NZ场景下，perToken
...
aclnnStatus AclnnGroupedMatmulWeightQuant91095Checker::CheckGroupSize(size_t idx) const
{
    ...
    int64_t groupNum = IsMxA8W4NZ() ? antiquantScaleShape.GetDim(antiquantScaleDimNum - 3) : antiquantScaleShape.GetDim(antiquantScaleDimNum - 2);
