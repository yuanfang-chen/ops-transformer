...
{
    CHECK_COND(CheckInputAndOutputDtypeForV3Version(), ACLNN_ERR_PARAM_INVALID,
...
{   
    ...
    if (IsQuant(xDtype, weightDtype)) {
        ...
        if (gmmParams_.apiVersion == gmm::GMMApiVersion::V3) {
            CHECK_COND(CheckInputParamsForV3Version(), ACLNN_ERR_PARAM_INVALID, "CheckInputParamsForV3Version failed.");
        }
    }
    return ACLNN_SUCCESS;
}