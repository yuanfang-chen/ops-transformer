...
{
    CHECK_COND(gmmParams_.apiVersion == gmm::GMMApiVersion::WeightNz || gmmParams_.apiVersion == gmm::GMMApiVersion::V4,
               ACLNN_ERR_PARAM_INVALID,
               "WeightNz feature is only supported in aclnnGroupedMatmulWeightNz and aclnnGroupedMatmulV4");
...
template <typename T>
aclnnStatus AclnnGroupedMatmulDAV3510Checker<T>::CheckMxBiasInputShape(const TensorDimInfo &dimInfo,
                                                                             size_t index) const
{
...
template <typename T>
bool AclnnGroupedMatmulDAV3510Checker<T>::IsSpecialperTileScene(int64_t groupNum, int64_t weightNDim, int64_t weightKDim,
