...
aclnnStatus AclnnGroupedMatmulNoQuant91095Checker::CheckGroupedMatmulNoQuant91095() const
{
    CHECK_COND(CheckEmptyTensor() == ACLNN_SUCCESS, ACLNN_ERR_PARAM_INVALID, "gmm check empty tensor failed.");
    return ACLNN_SUCCESS;
}

aclnnStatus AclnnGroupedMatmulNoQuant91095Checker::CheckEmptyTensor() const
{
