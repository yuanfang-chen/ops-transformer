  ...
  <table style="undefined;table-layout: fixed;width: 1567px"><colgroup>
    ...
    <tbody>
      ...
      <tr>
        <td>offset</td>
        <td rowspan="1">输入</td>
        <td>per-channel非对称反量化的偏移，对应公式中的$offset$。</td>
      ...
      <tr>
        <td>weightScale</td>
        <td rowspan="1">输入</td>
        <td>右矩阵的量化因子，对应公式中的$w\_scale$。</td>
        <td>
          <ul>
      ...
      <tr>
        <td>xScale</td>
        <td rowspan="1">输入</td>
        <td>左矩阵的量化因子，对应公式中的$x\_scale$。</td>
        <td>长度需与x的首轴维度相等。</td>
        <td>FLOAT</td>
        <td>ND</td>
        <td>1</td>
      ...
      <tr>
        <td>groupList</td>
        <td rowspan="1">输入</td>
        <td>指示每个分组参与计算的Token个数，对应公式中的$grouplist$。</td>
        <td>
          <ul>
      ...
      <tr>
        <td>outputOffset</td>
        <td rowspan="1">输出</td>
        <td>输出的非对称量化的偏移，对应公式中的$Q\_offset$。</td>
        <td>预留输入，暂不支持，需要传空指针。</td>
        <td>FLOAT</td>
        <td>ND</td>
        <td>1</td>
