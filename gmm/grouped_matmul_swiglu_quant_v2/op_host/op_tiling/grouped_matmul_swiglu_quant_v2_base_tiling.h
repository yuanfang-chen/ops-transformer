...
protected:
    ...
    int32_t FindBestSingleN(int64_t aicNum, int64_t baseM, int64_t baseN) const;
    bool TryFullLoadA(int64_t baseM, int64_t baseN, int64_t baseK, uint64_t l1Size) const;
