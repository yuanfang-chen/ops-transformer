...
protected:
    ...
    bool CheckInputOutDimsA4W4orA8W4(bool isA8W4, bool isA4W4)
    {
        OP_CHECK_WRONG_DIMENSION(gmmDsqParams_.x, X_DIM_LIMIT, return false);
        if (isA4W4 && gmmDsqParams_.weightAssistMatrix != nullptr) {
    ...
    bool CheckInputOutDims() override
    {
        ...
        if (isA8W4 || isA4W4) {
            ...
            return CheckInputOutDimsA4W4orA8W4(isA8W4, isA4W4);
        }
        return false;
    }
