...
private:
    ...
    __aicore__ inline void UpdateMnConfig(MNConfig &mnConfig, bool flag);
...
template <typename mmType>
__aicore__ inline void GMMA4W4MidProcess<mmType>::UpdateMnConfig(MNConfig &mnConfig, bool flag)
{
