...
class l2_GroupedMatmulSwigluQuantV2_910b_test : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        cout << "l2_GroupedMatmulSwigluQuantV2_910b_test SetUp" << endl;
    }
};

TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w8a8_normal_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
    ...
    TensorDesc weight = TensorDesc({e, k, n}, ACL_INT8, ACL_FORMAT_ND, {}, 0, {e, n / 32, k / 16, 16, 32}).ValueRange(-1, 1);
    TensorListDesc weight_desc = TensorListDesc({weight});
    TensorDesc weight_scale = TensorDesc({e, n}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(0, 3);
    TensorListDesc weight_scale_desc = TensorListDesc({weight_scale});
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w8a8_normal_nz_workspace_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w8a8_wrong_nd_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w8a8_wrong_nd_no_nz_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w4a8_without_weight_assist_matrix_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
    ...
    TensorDesc x_desc = TensorDesc({m, k}, ACL_INT8, ACL_FORMAT_ND).ValueRange(-1, 1);
    TensorDesc weight = TensorDesc({e, k, n}, ACL_INT4, ACL_FORMAT_ND, {}, 0, {e, n / 64, k / 16, 16, 64}).ValueRange(-1, 1);
    TensorListDesc weight_desc = TensorListDesc({weight});
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w4a4_redundant_weight_assist_matrix_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w4a4_normal_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w4a4_smoothscale_1d_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
    ...
    auto ut = OP_API_UT(aclnnGroupedMatmulSwigluQuantWeightNzV2,
                        INPUT(x_desc, weight_desc, weight_scale_desc, nullptr, nullptr, xScale_desc, smoothScale_desc,
                              groupList_desc, 0, 0, 0, 0, tuningConfig),
                        OUTPUT(out1_desc, out2_desc));
    uint64_t workspace_size = 0;
    aclnnStatus aclRet = ut.TestGetWorkspaceSize(&workspace_size);
    EXPECT_EQ(aclRet, 0);
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w4a4_smoothscale_2d_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w4a4_smoothscale_invalid_dim_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w4a4_smoothscale_wrong_shape_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w4a4_wtrans_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
    ...
    TensorDesc x_desc = TensorDesc({m, k}, ACL_INT4, ACL_FORMAT_ND).ValueRange(-1, 1);
    TensorDesc weight = TensorDesc({e, k, n}, ACL_INT4, ACL_FORMAT_ND, {e, 1, k}, 0, {e, k / 64, n / 16, 16, 64}).ValueRange(-1, 1);
    TensorListDesc weight_desc = TensorListDesc({weight});
    TensorDesc weight_sacle = TensorDesc({e, n}, ACL_UINT64, ACL_FORMAT_ND).ValueRange(0, 3);
    TensorListDesc weight_scale_desc = TensorListDesc({weight_sacle});
    TensorDesc xScale_desc = TensorDesc({m}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(0, 3);
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w8a8_multi_weight_normal_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
    ...
    TensorDesc x_desc = TensorDesc({m, k}, ACL_INT8, ACL_FORMAT_ND).ValueRange(-1, 1);
    TensorDesc weight0 = TensorDesc({k, n}, ACL_INT8, ACL_FORMAT_ND, {}, 0, {n / 32, k / 16, 16, 32}).ValueRange(-1, 1);
    TensorDesc weight1 = TensorDesc({k, n}, ACL_INT8, ACL_FORMAT_ND, {}, 0, {n / 32, k / 16, 16, 32}).ValueRange(-1, 1);
    TensorDesc weight2 = TensorDesc({k, n}, ACL_INT8, ACL_FORMAT_ND, {}, 0, {n / 32, k / 16, 16, 32}).ValueRange(-1, 1);
    TensorDesc weight3 = TensorDesc({k, n}, ACL_INT8, ACL_FORMAT_ND, {}, 0, {n / 32, k / 16, 16, 32}).ValueRange(-1, 1);
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w8a8_multi_weight_normal_nz_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w8a8_multi_weight_normal_nz_workspace_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_test, ascend910B2_test_opapi_w8a8_multi_weight_wrong_nd_no_nz_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
