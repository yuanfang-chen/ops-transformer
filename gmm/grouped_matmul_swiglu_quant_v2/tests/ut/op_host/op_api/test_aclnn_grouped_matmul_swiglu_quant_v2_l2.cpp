...
class l2_GroupedMatmulSwigluQuantV2_910b_legacy_test : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        cout << "l2_GroupedMatmulSwigluQuantV2_910b_legacy_test SetUp" << endl;
    }
};

TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_legacy_test, ascend910B2_test_opapi_w8a8_normal_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
...
TEST_F(l2_GroupedMatmulSwigluQuantV2_910b_legacy_test, ascend910B2_test_opapi_w8a8_normal_nz_workspace_case)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 2048;
