...
TEST_F(l2_GroupedMatmulFinalizeRoutingV3_test, ascend91095_test_opapi_MXFP4_normal_case)
{
    int64_t m = 192;
    int64_t k = NORMAL_K_VAL;
    int64_t n = NORMAL_N_VAL;
    ...
    TensorDesc x1_desc = TensorDesc({m, k}, ACL_FLOAT4_E1M2, ACL_FORMAT_ND).ValueRange(-1, 1);
    TensorDesc x2_desc = TensorDesc({e, k, n}, ACL_FLOAT4_E1M2, ACL_FORMAT_ND).ValueRange(-1, 1);
...
TEST_F(l2_GroupedMatmulFinalizeRoutingV3_test, ascend91095_test_opapi_MXFP8_illegal_case)
{
    int64_t m = 192;
    int64_t k = NORMAL_K_VAL;
    int64_t n = NORMAL_N_VAL;
