...
- **在 Ascend 950PR/Ascend 950DT 上参数说明**
  ...
  <tbody>
    ...
    <tr>
      <td>x2</td>
      <td>输入</td>
      <td>输入weight(右矩阵),支持转置条件false,true</td>
      <td>无</td>
      <td>FLOAT8_E5M2,FLOAT8_E4M3FN,FLOAT4_E2M1,FLOAT4_E1M2</td>
      <td>ND</td>
      <td>shape支持三维，维度为(e,k,n)，转置情况下维度为(e,n,k)，e取值范围[1,1024]。
      </td>
      <td>×</td>
    </tr>
    <tr>
      ...
      <td>FLOAT8_E8M0</td>
      <td>ND</td>
      <td>shape支持四维场景，在MX量化场景下，支持的维度为(e,n,Ceil(k/64),2) 并且数据类型只支持FLOAT8_E8M0,转置属性必须和x2保持一致</td>
      <td>×</td>
    </tr>
    <tr>
      <td>biasOptional</td>
...
|------|------|------|-------|---------|---------|----------------|-------------|---------|----------|---------|
MXFP8| FLOAT8_E4M3FN FLOAT8_E5M2 | FLOAT8_E4M3FN  FLOAT8_E5M2| FLOAT8_E8M0 | BFLOAT16             | FLOAT8_E8M0       | INT64     | BFLOAT16    | FLOAT32 | INT64    | FLOAT32 |
MXFP4| FLOAT4_E2M1 FLOAT4_E1M2 | FLOAT4_E2M1 FLOAT4_E1M2 | FLOAT8_E8M0 | BFLOAT16            | FLOAT8_E8M0       | INT64     | BFLOAT16    | FLOAT32 | INT64    | FLOAT32 |
