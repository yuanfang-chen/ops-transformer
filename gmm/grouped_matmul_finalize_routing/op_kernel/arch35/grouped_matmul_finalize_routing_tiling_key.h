...
ASCENDC_TPL_ARGS_DECL(GroupedMatmulFinalizeRouting,
                      ...
                      ASCENDC_TPL_UINT_DECL(SCLAEDTYPE, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, 0, 1, 2, 3),
                      ASCENDC_TPL_UINT_DECL(ROWINDEXDTYPE, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, 0, 1));
...
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(ATRANS, ASCENDC_TPL_UI_LIST, 0),
                                     ...
                                     ASCENDC_TPL_UINT_SEL(SCLAEDTYPE, ASCENDC_TPL_UI_LIST, 0, 1, 2),
                                     ASCENDC_TPL_UINT_SEL(ROWINDEXDTYPE, ASCENDC_TPL_UI_LIST, 0, 1)));
} // namespace GMMFinalizeRoutingArch35Tiling
