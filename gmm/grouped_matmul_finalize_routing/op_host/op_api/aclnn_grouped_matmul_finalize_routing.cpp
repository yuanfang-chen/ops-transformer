...
static inline bool CheckDimRange(const GroupedMatmulParams &params)
{
    ...
    OP_LOGE(ACLNN_ERR_PARAM_INVALID, "GroupedMatmulFinalizeRouting CheckDimRange x2DimNum =%lld x2MinDimNum = %lld x2MaxDimNum=%lld ", x2DimNum , x2MinDimNum, x2MaxDimNum);
