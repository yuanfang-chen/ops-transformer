    ...
    const aclIntArray *tuningConfigOptional, aclTensor *out, uint64_t *workspaceSize, aclOpExecutor **executor)
{
    ...
    OP_LOGD("zzzlog aclnnGroupedMatmulFinalizeRoutingWeightNzV2GetWorkspaceSize:"
    ...
    OP_LOGD("zzzlog aclnnGroupedMatmulFinalizeRoutingWeightNzV2GetWorkspaceSize: tmpWeight final:"
