 ...
 * @param [in] x1: matmul左矩阵，数据类型支持：int8。在MX量化模式中，数据类型支持FLOAT8_E5M2,FLOAT8_E4M3FN,FLOAT4_E2M1,FLOAT4_E1M2。
 * @param [in] x2: matmul右矩阵，数据类型支持：int4。在MX量化模式中，数据类型支持FLOAT8_E5M2,FLOAT8_E4M3FN,FLOAT4_E2M1,FLOAT4_E1M2。
 * @param [in] scaleOptional: 量化参数中的缩放因子，数据类型支持：int64。在MX量化模式中，数据类型支持FLOAT8_E8M0。
 ...
 * @param [in] pertokenScaleOptional: 反量化参数，数据类型支持：float32。在MX量化模式中，数据类型支持FLOAT8_E8M0。
 ...
 * @param [in] transposeW: 右矩阵是否转置，默认值：false。在MX量化模式中，支持Weight矩阵转置。
