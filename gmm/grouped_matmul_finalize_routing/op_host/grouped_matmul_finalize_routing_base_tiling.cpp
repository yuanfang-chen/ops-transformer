...
ge::graphStatus GroupedMatmulFinalizeRoutingBaseTiling::W4A8BaseTilingProcess()
{
    ...
    OP_LOGI("zzzlog GroupedMatmulFinalizeRoutingBaseTiling W4A8BaseTiling tilingKey_=%llu",
...
ge::graphStatus GroupedMatmulFinalizeRoutingBaseTiling::W4A8L1OptTilingProcess()
{
    ...
    OP_LOGI("zzzlog GroupedMatmulFinalizeRoutingBaseTiling W4A8L1OptTiling tilingKey_=%llu",
            static_cast<unsigned long long>(tilingKey_));
...
{
    OP_LOGI("zzzlog GroupedMatmulFinalizeRoutingBaseTiling tilingKey_=%llu",
            static_cast<unsigned long long>(tilingKey_));
