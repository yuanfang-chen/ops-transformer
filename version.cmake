...
set_package(transformer VERSION "9.0.0")

set_build_dependencies(runtime ">=3.1")
set_build_dependencies(opbase ">=8.1")
set_build_dependencies(hcomm ">=3.2")
set_build_dependencies(ge-executor ">=3.3")
set_build_dependencies(metadef ">=3.5")
set_build_dependencies(tbe-tik ">=4.0")
set_build_dependencies(ge-compiler ">=4.1.1")
set_build_dependencies(asc-devkit ">=4.2.1")
set_build_dependencies(bisheng-compiler ">=4.3")
set_build_dependencies(asc-tools ">=6.1")
