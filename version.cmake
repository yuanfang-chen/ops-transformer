...
set_build_dependencies(runtime ">=8.5.0")
set_build_dependencies(opbase ">=8.5.0")
set_build_dependencies(hcomm ">=8.5.0")
set_build_dependencies(ge-executor ">=8.5.0")
set_build_dependencies(metadef ">=8.5.0")
set_build_dependencies(tbe-tik ">=8.5.0")
set_build_dependencies(ge-compiler ">=8.5.0")
set_build_dependencies(asc-devkit ">=8.5.0")
set_build_dependencies(bisheng-compiler ">=8.5.0")
set_build_dependencies(asc-tools ">=8.5.0")
