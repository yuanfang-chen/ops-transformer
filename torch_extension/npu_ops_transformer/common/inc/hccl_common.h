...
using _HcclKfcAllocOpArgs HcclKfcAllocOpArgsFunc = nullptr;
using _HcclKfcOpArgsSetAlgConfig HcclKfcOpArgsSetAlgConfigFunc = nullptr;
using _HcclKfcOpArgsSetCommEngine HcclKfcOpArgsSetCommEngineFunc = nullptr;
using _HcclCreateOpResCtx HcclCreateOpResCtxFunc = nullptr;
using _HcclGetRemoteIpcHcclBuf HcclGetRemoteIpcHcclBufFunc = nullptr;
using _HcclKfcFreeOpArgs HcclKfcFreeOpArgsFunc = nullptr;
using _HcclCommGetHandleWithName HcclCommGetHandleWithNameFunc = nullptr;
using _HcclGetRankSize HcclGetRankSizeFunc = nullptr;
using _HcclGetRankId HcclGetRankIdFunc = nullptr;
using _HcclGetHcclBuffer HcclGetHcclBufferFunc = nullptr;
