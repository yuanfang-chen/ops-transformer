...
class MoeDistributeBuffer:
    def __init__(self, group, ccl_buffer_size: int = 0, comm_alg: int = 0):
        ...
        self.mc2_context = torch.zeros(context_tensor_size, dtype=torch.int32).npu()
        update_context(self.group_name, self.world_size, self.mc2_context)
