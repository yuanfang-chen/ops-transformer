...
class MoeDistributeBuffer:
    ...
    def get_low_latency_ccl_buffer_size_hint(self, num_max_dispatch_token_per_rank: int, hidden: int,
    ...
    def npu_low_latency_dispatch(self, x, topk_idx, num_experts: int, *,
        ...
        (expand_x, dynamic_scales, expand_idx, expert_token_nums, ep_recv_counts, tp_recv_counts, expand_scales) \
            = npu_moe_distribute_dispatch_v2(x=x,
                                             expert_ids=topk_idx,
    ...
    def npu_low_latency_combine(self, x, topk_idx, topk_weights, assist_info_for_combine, ep_send_counts, *,
                            ...
                            num_max_dispatch_token_per_rank=0):
        return npu_moe_distribute_combine_v2(expand_x=x,
                                             expert_ids=topk_idx,
                                             ...
                                             global_bs=num_max_dispatch_token_per_rank * self.world_size)
