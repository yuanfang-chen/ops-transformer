...
class FlashAttenOpBuilder(OpBuilder):
    ...
    def schema(self) -> str:
        ...
        return "npu_flash_attn(Tensor context, Tensor expand_x, Tensor expert_ids, " \
    ...
    def register_meta(self):
        ...
        def npu_flash_attn_meta(context, expand_x, expert_ids, assist_info_for_combine, 
...
def npu_flash_attn(context, expand_x, expert_ids, assist_info_for_combine, ep_send_counts, 
    ...
    """
    return op_module.npu_flash_attn(context, expand_x, expert_ids, assist_info_for_combine,
                                                  ep_send_counts, expert_scales, ep_world_size, ep_rank_id,
