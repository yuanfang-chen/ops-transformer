...
if _TORCHAIR_AVAILABLE:
    ...
    def MoeDistributeCombineV3(context: Tensor, expand_x: Tensor, expert_ids: Tensor, assist_info_for_combine: Tensor,
                            ...
                            const_expert_v: Optional[Tensor], performance_info: Optional[Tensor], *, ep_world_size: int, ep_rank_id: int,
                            moe_expert_num: int, ccl_buffer_size: int, tp_world_size: int = 0, tp_rank_id: int = 0,
