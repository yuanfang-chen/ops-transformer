...
if _TORCHAIR_AVAILABLE:
    ...
    def MoeDistributeDispatchV3(context: Tensor, x: Tensor, expert_ids: Tensor, scales: Optional[Tensor], x_active_mask: Optional[Tensor],
                                expert_scales: Optional[Tensor], elastic_info: Optional[Tensor], performance_info: Optional[Tensor], *, 
                                ep_world_size: int, ep_rank_id: int, moe_expert_num: int, ccl_buffer_size: int,
                                tp_world_size: int = 0, tp_rank_id: int = 0, expert_shard_type: int = 0, shared_expert_num: int = 1, 
                                shared_expert_rank_num: int = 0, quant_mode: int = 0, global_bs: int = 0, expert_token_nums_type: int = 1,
                                comm_alg: str = "", zero_expert_num: int = 0, copy_expert_num: int = 0, const_expert_num: int = 0,
                                y_dtype: int = 0, dependencies=[], node_name=None):
        ...
        return ge_op(
            ...
            .optional_input("expert_scales", "DT_BOOL") \
            ...
            .attr("shared_expert_num", attr.Int(0)) \
            .attr("shared_expert_rank_num", attr.Int(0)) \
            .attr("quant_mode", attr.Int(0)) \
            .attr("global_bs", attr.Int(0)) \
            .attr("expert_token_nums_type", attr.Int(0)) \
            .attr("comm_alg", attr.Int(0)) \
            ...
            .output("assis_info_for_combine", "DT_INT32") \
    ...
    def converter_moe_distribute_dispatch_v3(
        ...
        *,
        ...
        return ge.MoeDistributeDispatchV3(context=context,
                                        x=x,
                                        expert_ids=expert_ids,
                                        scales=scales,
                                        x_active_mask=x_active_mask,
