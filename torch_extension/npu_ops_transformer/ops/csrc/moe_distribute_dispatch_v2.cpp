...
static bool check_v3_param(const c10::optional<at::Tensor> &elastic_info, int64_t zero_expert_num,
                                           ...
                                           c10::optional<int64_t> scales_dtype)
{
    ...
    at::Tensor dynamic_scales = at::empty({a}, at::TensorOptions().dtype(at::kFloat)
        .device(c10::DeviceType::PrivateUse1).memory_format(c10::MemoryFormat::Contiguous));

    at::Tensor expert_token_nums = at::empty({local_moe_expert_num}, at::TensorOptions().dtype(at::kLong)
        .device(c10::DeviceType::PrivateUse1).memory_format(c10::MemoryFormat::Contiguous));
    at::Tensor ep_recv_counts = at::empty({ep_recv_cnt_num}, at::TensorOptions().dtype(at::kInt)
        .device(c10::DeviceType::PrivateUse1).memory_format(c10::MemoryFormat::Contiguous));
