...
class UpdateContextOpBuilder(OpBuilder):
    ...
    def register_meta(self):
        ...
        def update_context_meta(group_ep, ep_world_size, ccl_buffer_size, conetxt_tensor):
            return False
...
def update_context(group_ep, ep_world_size, ccl_buffer_size, conetxt_tensor):
    """
    dispatcher implementation for NPU.
    'PrivateUse1' is the combine key for custom NPU backends.
    """
    return op_module.update_context(group_ep, ep_world_size, ccl_buffer_size, conetxt_tensor)