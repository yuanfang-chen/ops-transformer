...
class UpdateContextOpBuilder(OpBuilder):
    ...
    def schema(self) -> str:
        ...
        return "update_context(str group_ep, int ep_world_size, Tensor context_tensor) -> bool"
    ...
    def register_meta(self):
        ...
        def update_context_meta(group_ep, ep_world_size, context_tensor):
            return False
...
def update_context(group_ep, ep_world_size, context_tensor):
    """
    dispatcher implementation for NPU.
    'PrivateUse1' is the combine key for custom NPU backends.
    """
    return op_module.update_context(group_ep, ep_world_size, context_tensor)