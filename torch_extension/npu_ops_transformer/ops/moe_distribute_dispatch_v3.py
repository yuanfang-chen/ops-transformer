...
class MoeDistributeDispatchV3OpBuilder(OpBuilder):
    ...
    def schema(self) -> str:
        ...
        return "npu_moe_distribute_dispatch_v3(Tensor mc2_context, Tensor x, Tensor expert_ids, str group_ep, int ep_world_size, " \
    ...
    def register_meta(self):
        ...
        def npu_moe_distribute_dispatch_v3_meta(mc2_context, x, expert_ids, group_ep, ep_world_size, ep_rank_id, moe_expert_num,
...
def npu_moe_distribute_dispatch_v3(mc2_context, x, expert_ids, group_ep, ep_world_size, ep_rank_id, moe_expert_num, scales=None,
    ...
    """
    return op_module.npu_moe_distribute_dispatch_v3(mc2_context, x, expert_ids, group_ep, ep_world_size, ep_rank_id, moe_expert_num,
...
if _TORCHAIR_AVAILABLE:
    ...
    def converter_moe_distribute_dispatch_v3(
        ...
        *,
        ...
        return ge.MoeDistributeDispatchV3(mc2_context=mc2_context,
                                        x=x,
