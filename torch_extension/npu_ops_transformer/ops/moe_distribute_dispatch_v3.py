...
class MoeDistributeDispatchV3OpBuilder(OpBuilder):
    ...
    def schema(self) -> str:
        ...
        return "npu_moe_distribute_dispatch_v3(Tensor context, Tensor x, Tensor expert_ids, int ep_world_size, " \
            "int ep_rank_id, int moe_expert_num, int ccl_buffer_size, *, Tensor? scales=None, Tensor? x_active_mask=None, " \
