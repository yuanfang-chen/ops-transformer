...
TEST_F(L2AlltoAllvGroupedMatMulTest, Test)
{
	...
	auto ut = OP_API_UT(aclnnAlltoAllvGroupedMatMul, INPUT(gmmX, gmmWeight, nullptr, nullptr, nullptr, nullptr,
						"test_allto_allv_quant_grouped_mat_mul_ep_group", epWorldSize, sendCounts, recvCounts,
...
TEST_F(L2AlltoAllvGroupedMatMulTest, TestSendCountsNull)
{
	...
	TensorDesc gmmY_desc = TensorDesc({8192, 4096}, ACL_FLOAT16, ACL_FORMAT_ND);
	auto ut = OP_API_UT(aclnnAlltoAllvGroupedMatMul, INPUT(gmmX, gmmWeight, nullptr, nullptr, nullptr, nullptr,
						"test_allto_allv_quant_grouped_mat_mul_ep_group", epWorldSize, nullptr, recvCounts, 
						transGmmWeight, transMmWeight, permuteOutFlag),
						OUTPUT(gmmY_desc, nullptr, nullptr));
	uint64_t workspace_size = 0;
	aclOpExecutor* executor = nullptr;
...
TEST_F(L2AlltoAllvGroupedMatMulTest, TestRecvCountsNull)
{
	...
	TensorDesc gmmY_desc = TensorDesc({8192, 4096}, ACL_FLOAT16, ACL_FORMAT_ND);
	auto ut = OP_API_UT(aclnnAlltoAllvGroupedMatMul, INPUT(gmmX, gmmWeight, nullptr, nullptr, nullptr, nullptr,
						"test_allto_allv_quant_grouped_mat_mul_ep_group", epWorldSize, sendCounts, nullptr, 
						transGmmWeight, transMmWeight, permuteOutFlag),
						OUTPUT(gmmY_desc, nullptr, nullptr));
	uint64_t workspace_size = 0;
	aclOpExecutor* executor = nullptr;
...
TEST_F(L2AlltoAllvGroupedMatMulTest, TestGroupEpInvalid)
{
	...
	TensorDesc gmmY_desc = TensorDesc({8192, 4096}, ACL_FLOAT16, ACL_FORMAT_ND);
	auto ut = OP_API_UT(aclnnAlltoAllvGroupedMatMul, INPUT(gmmX, gmmWeight, nullptr, nullptr, nullptr, nullptr,
						"test_allto_allv_quant_grouped_mat_mul_ep_group_test_allto_allv_quant_grouped_mat_mul_ep_group_"
						"test_allto_allv_quant_grouped_mat_mul_ep_group_test_allto_allv_quant_grouped_mat_mul_ep_group_"
						"test_allto_allv_quant_grouped_mat_mul_ep_group_test_allto_allv_quant_grouped_mat_mul_ep_group_"
						"test_allto_allv_quant_grouped_mat_mul_ep_group_test_allto_allv_quant_grouped_mat_mul_ep_group",
...
} // allto_allv_quant_grouped_mat_mul_ut