...
static ge::graphStatus ExecuteAlltoAllvQuantGroupedMatMul(
    ...
    const gert::Tensor* permuteOut)
{
    const auto apiRet = EXEC_OPAPI_CMD(aclnnAlltoAllvQuantGroupedMatMul, inputs.gmmX, inputs.gmmWeight,
        inputs.gmmXScale, inputs.gmmWeightScale, inputs.sendCountsTensor, inputs.recvCountsTensor,
        inputs.mmX, inputs.mmWeight, inputs.mmXScale, inputs.mmWeightScale, attrsData.group,
        *attrsData.epWorldSize, actSendCountsSeqArray, actRecvCountsSeqArray, *attrsData.transGmmWeight,
        *attrsData.transMmWeight, *attrsData.permuteOutFlag, *attrsData.gmmXQuantMode,
        *attrsData.gmmWeightQuantMode, *attrsData.mmXQuantMode, *attrsData.mmWeightQuantMode,
        *attrsData.groupSize, *attrsData.yDtype, *attrsData.mmDtype, gmmY, mmY, permuteOut);
...
static ge::graphStatus AlltoAllvQuantGroupedMatMulExecuteFunc(gert::OpExecuteContext* host_api_ctx)
{
    ...
    return ExecuteAlltoAllvQuantGroupedMatMul(inputs, attrsData, actSendCountsSeqArray, actRecvCountsSeqArray,
                                             gmmY, mmY, permuteOut);
}
