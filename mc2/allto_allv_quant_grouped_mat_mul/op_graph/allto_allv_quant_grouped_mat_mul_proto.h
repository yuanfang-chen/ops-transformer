...
REG_OP(AlltoAllvQuantGroupedMatMul)
      ...
      .OPTIONAL_INPUT(gmm_x_scale, TensorType({DT_FLOAT, DT_FLOAT8_E8M0}))
      .OPTIONAL_INPUT(gmm_weight_scale, TensorType({DT_FLOAT, DT_FLOAT8_E8M0}))
      ...
      .ATTR(gmm_x_quant_mode, Int, 0, 6)
      .ATTR(gmm_weight_quant_mode, Int, 0, 6)
      .ATTR(mm_x_quant_mode, Int, 0, 6)
      .ATTR(mm_weight_quant_mode, Int, 0, 6)
