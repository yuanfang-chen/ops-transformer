...
* @par Inputs:
* @li gmm_x: A matrix Tensor of shape [BSK, H1]. The data type of elements supports hifloat8, float8_e4m3fn or float8_e5m2; the format supports ND.
* @li gmm_weight: A matrix Tensor of shape [e, H1, N1]. The data type of elements supports hifloat8, float8_e4m3fn or float8_e5m2 and should match that of gmm_x; the format supports ND.
...
* @li mm_x: A matrix Tensor of shape [BS, H1]. The data type of elements supports hifloat8, float8_e4m3fn or float8_e5m2 and should match that of gmm_x; the format supports ND.
* @li mm_weight: A matrix Tensor of shape [H2, N2]. The data type of elements supports hifloat8, float8_e4m3fn or float8_e5m2 and should match that of gmm_weight; the format supports ND.
...
REG_OP(AlltoAllvQuantGroupedMatMul)
      .INPUT(gmm_x, TensorType({DT_HIFLOAT8, DT_FLOAT8_E4M3FN, DT_FLOAT8_E5M2}))
      .INPUT(gmm_weight, TensorType({DT_HIFLOAT8, DT_FLOAT8_E4M3FN, DT_FLOAT8_E5M2}))
      .OPTIONAL_INPUT(send_counts_tensor, TensorType({DT_INT64}))
      .OPTIONAL_INPUT(recv_counts_tensor, TensorType({DT_INT64}))
      .OPTIONAL_INPUT(mm_x, TensorType({DT_HIFLOAT8, DT_FLOAT8_E4M3FN, DT_FLOAT8_E5M2}))
      .OPTIONAL_INPUT(mm_weight, TensorType({DT_HIFLOAT8, DT_FLOAT8_E4M3FN, DT_FLOAT8_E5M2}))
      ...
      .OUTPUT(permute_out, TensorType({DT_HIFLOAT8, DT_FLOAT8_E4M3FN, DT_FLOAT8_E5M2}))
