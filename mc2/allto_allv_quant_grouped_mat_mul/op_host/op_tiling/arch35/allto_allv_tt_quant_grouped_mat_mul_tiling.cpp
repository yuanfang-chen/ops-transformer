...
ge::graphStatus AlltoAllvTTQuantGmmTiling::CheckGmmDType() const
{
    ...
    OP_TILING_CHECK(gmmXScaleDesc == nullptr, OP_LOGE(context_->GetNodeName(), "When pertensor quant mode, gmmXScale should not be null."), 
    ...
    OP_TILING_CHECK(gmmWeightScaleDesc == nullptr, OP_LOGE(context_->GetNodeName(), "When pertensor quant mode, gmmXScale should not be null."), 
                    return ge::GRAPH_FAILED);
...
ge::graphStatus AlltoAllvTTQuantGmmTiling::CheckMmDType() const
{
    ...
    OP_TILING_CHECK(mmXScaleDesc == nullptr, OP_LOGE(context_->GetNodeName(), "When pertensor quant mode, mmXScale should not be null."), 
                    return ge::GRAPH_FAILED);
    ...
    OP_TILING_CHECK(mmWeightScaleDesc == nullptr, OP_LOGE(context_->GetNodeName(), "When pertensor quant mode, mmWeightScale should not be null."), 
                    return ge::GRAPH_FAILED);
