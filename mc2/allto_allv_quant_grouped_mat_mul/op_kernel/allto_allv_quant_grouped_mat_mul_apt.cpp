    ...
    GM_ADDR workspaceGM, GM_ADDR tilingGM)
{
    ...
    using ComputeOpType = QuantGroupedMatmul<QuantAlltoAllvGroupedMatmulTilingData, GMMQuantTilingData, DTYPE_GMM_X,
        DTYPE_GMM_WEIGHT, fp8_e8m0_t, DTYPE_GMM_Y, CubeFormat::ND, false, TILINGKEY_GMM_WEIGHT_TRANSPOSE,
    ...
    using LocalComputeOpType =
        ...
        fp8_e8m0_t, DTYPE_GMM_Y, CubeFormat::ND, false, TILINGKEY_MM_WEIGHT_TRANSPOSE,
