...
public:
                                ...
                                bool isA2avGmmFlag)
    {
        ...
        if (AscendC::IsSameType<DTYPE_GMM_X, fp8_e4m3fn_t>::value ||
            AscendC::IsSameType<DTYPE_GMM_X, fp8_e5m2_t>::value) {
            uint64_t commOutLen = Align((tilingData_->taskTilingInfo.A) * (tilingData_->taskTilingInfo.H1), TENSOR_LIST_SIZE);
        ...
        computeScaleGM = (AscendC::IsSameType<DTYPE_GMM_X, fp8_e4m3fn_t>::value ||
                          AscendC::IsSameType<DTYPE_GMM_X, fp8_e5m2_t>::value) ?
                             gmmxScaleCommOutGm :
                             gmmxScaleGM;
