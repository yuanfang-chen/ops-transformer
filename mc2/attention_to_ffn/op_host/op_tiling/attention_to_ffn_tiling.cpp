...
constexpr uint32_t WORKSPACE_ELEMENT_OFFSET = 32;  // 每个FFN预留32B
...
static ge::graphStatus SetWorkSpace(gert::TilingContext *context, AttentionToFFNTilingData *tilingData)
{
    ...
    workSpaces[0] = ascendcPlatform.GetLibApiWorkSpaceSize() + static_cast<size_t>(ffnNum * WORKSPACE_ELEMENT_OFFSET * aivNum);
