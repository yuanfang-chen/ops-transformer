...
TEST_P(GroupedMatMulAlltoAllvInfershape, InferdatatypeTest)
{
    ...
    auto inferDtypeFunc = spaceRegistry->GetOpImpl("GroupedMatMulAlltoAllvV2")->infer_datatype;
...
INSTANTIATE_TEST_SUITE_P(GroupedMatMulAlltoAllvV2, GroupedMatMulAlltoAllvInfershape, testing::ValuesIn(g_testParamss), [](const testing::TestParamInfo<GroupedMatMulAlltoAllvInfershape::ParamType>& info) {
