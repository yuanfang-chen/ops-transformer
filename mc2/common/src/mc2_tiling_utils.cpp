                                    ...
                                    uint64_t &groupSizeN, uint64_t &groupSizeK)
{
  ...
  if (groupSizeM == 0) {
    ...
    OP_TILING_CHECK((mValue % scaleMValue) != 0,
                     OP_LOGE(mmInfo.opName, "The groupSize in m dimension is 0 and the m dimension of x1 [%lu] is "
    "not divisible by m dimension of x1Scale [%lu]. the real groupSize in in m dimension can not be infered.",
  ...
  if (groupSizeN == 0) {
    ...
    OP_TILING_CHECK((nValue % scaleNValue) != 0,
                     OP_LOGE(mmInfo.opName, "The groupSize in n dimension is 0 and the n dimension of x2 [%lu] is "
    "not divisible by n dimension of x2Scale [%lu]. the real groupSize in in n dimension can not be infered.",
  ...
  if (groupSizeK == 0) {
    ...
    OP_TILING_CHECK((kValue % scaleKValue) != 0,
                     OP_LOGE(mmInfo.opName, "The groupSize in k dimension is 0 and the k dimension of x1 [%lu] is"
    "not divisible by k dimension of x1Scale [%lu]. the real groupSize in in k dimension can not be infered.",
