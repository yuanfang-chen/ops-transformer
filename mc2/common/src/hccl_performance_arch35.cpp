 ...
 * \brief
 */
#include "tiling/hccl_performance_arch35.h"
...
const static map<string, HCCLFittingParameters> ARCH35_FITTING_PARAMETER_MAP = {
    ...
    {"4_1_0_8", HCCLFittingParameters{0, 0, 3.3586, 24.9879, 0, 0,  // 950 allgather STANDARD_CARD_8p
                                  0, 0, 0, 0, 0, 0}},
    {"4_1_0_4", HCCLFittingParameters{0, 0, 3.3586, 24.9879, 0, 0,  // 950 allgather STANDARD_CARD_4p
                                  0, 0, 0, 0, 0, 0}},
    {"4_0_0_8", HCCLFittingParameters{0, 25, 9.8048, 95.508, 0, 10.299,  // 950 allreduce STANDARD_CARD_8p
                                  37.5938, 0, 340.12, 0, 10.299, 37.5938}},
};
