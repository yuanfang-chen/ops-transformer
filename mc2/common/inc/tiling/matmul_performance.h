...
constexpr double CYCLE_PER_MICRO_SEC_ARCH_3510 = 1.65 * ONE_KBYTE;
...
constexpr uint64_t MM_MIN_DATASIZE_ARCH_3510 = 5 * ONE_GBYTE;
...
public:
    ...
    void SetCyclePerMicroSec(SocVersion inputSocVersion)
    {
        ...
        if (inputSocVersion == SocVersion::SOC310_P) {
            ...
            mmShapeInfo_.cyclePerMicroSec = MatmulPerformance::CYCLE_PER_MICRO_SEC_ARCH_3510;
            mmMinDataSize_ = MatmulPerformance::MM_MIN_DATASIZE_ARCH_3510;
        } else {
            mmShapeInfo_.cyclePerMicroSec = MatmulPerformance::CYCLE_PER_MICRO_SEC;
        }
    }
