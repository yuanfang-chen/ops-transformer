...
{
    if (!Mc2GenTaskOpsUtils::IsTargetPlatform(OP_NAME.c_str(), NPUARCH_A5)) {
        OP_LOGE(OP_NAME, "Mc2 exception handler is not supported on current arch, skip dump process.");
        return;
    }
