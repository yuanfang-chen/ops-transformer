...
TEST_P(Arch32TilingTest, MatmulAllReduceAddRmsNormGeneralTest)
{
...
INSTANTIATE_TEST_CASE_P(MatMulAllReduceAddResNormal, Arch32TilingTest,
        testing::ValuesIn(g_casesParamsQuant));

// 异常用例合集

INSTANTIATE_TEST_CASE_P(MatMulAllReduceAddResNormal2, Arch32TilingTest,
