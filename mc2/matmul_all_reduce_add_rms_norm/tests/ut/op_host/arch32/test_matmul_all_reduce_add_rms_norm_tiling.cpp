...
class MatmulAllReduceAddRmsNormArch32TilingTest : public testing::TestWithParam<TestParam> {
protected:
    static void SetUpTestCase()
    {
        std::cout << "MatmulAllReduceAddRmsNormArch32TilingTest SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MatmulAllReduceAddRmsNormArch32TilingTest TearDown" << std::endl;
    }
};
...
TEST_P(MatmulAllReduceAddRmsNormArch32TilingTest, MatmulAllReduceAddRmsNormGeneralTest)
{
...
INSTANTIATE_TEST_CASE_P(MatMulAllReduceAddResNormal, MatmulAllReduceAddRmsNormArch32TilingTest,
        testing::ValuesIn(g_casesParamsQuant));

// 异常用例合集

INSTANTIATE_TEST_CASE_P(MatMulAllReduceAddResNormal2, MatmulAllReduceAddRmsNormArch32TilingTest,
