...
@li expand_x: A tensor. Support dtype: float16, bfloat16, dimension must be 2. Shape supports (A, H), support format: ND.
...
@li assist_info_for_combine: A tensor. Support dtype: int32, dimension must be 1. Shape supports (N, ), support format: ND.
...
@li comm_quant_mode: Input quant mode. The options are 0 (non-quantization), 1 (static quantization), and 2 (dynamic quantization). dtype: int64.
@li global_bs: Input global batch size, dtype: int64.
@li comm_type: Input comm type, dtype: int64.
@li comm_alg: Input comm algorithm, dtype: String.

@par Outputs
Two outputs, including:
@li quant_expand_x: A tensor. Result of quantized expand_x. Support dtype: int8, dimension must be 2. Shape supports (A, H), support format: ND.
@li comm_cmd_info: A tensor. Communication command info. Support dtype: int32, dimension must be 1. Shape supports (N, ), support format: ND.
*/
