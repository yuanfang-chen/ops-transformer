...
TEST_F(Arch32TilingTest, MatmulReduceScatterFloat16Test1)
{
...
TEST_F(Arch32TilingTest, MatmulReduceScatterFloat16Test2)
{
    struct MatmulReduceScatterCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(Arch32TilingTest, MatmulReduceScatterFloat16Test3)
{
    struct MatmulReduceScatterCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(Arch32TilingTest, MatmulReduceScatterFloat16Test4)
{
    struct MatmulReduceScatterCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(Arch32TilingTest, MatmulReduceScatterFloat16Test5)
{
    struct MatmulReduceScatterCompileInfo {} compileInfo;
    uint64_t coreNum = 24;
    uint64_t ubSize = 196608;
...
TEST_F(Arch32TilingTest, MatmulReduceScatterFloat16Test6)
{
    struct MatmulReduceScatterCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(Arch32TilingTest, MatmulReduceScatterBfloat16)
{
    struct MatmulReduceScatterCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
