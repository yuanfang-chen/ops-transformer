...
TEST_F(MatmulReduceScatterTiling, Float16Test1)
{
...
TEST_F(MatmulReduceScatterTiling, Float16Test2)
{
    struct MatmulReduceScatterCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(MatmulReduceScatterTiling, Float16Test3)
{
    struct MatmulReduceScatterCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(MatmulReduceScatterTiling, Float16Test4)
{
    struct MatmulReduceScatterCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(MatmulReduceScatterTiling, Float16Test5)
{
    struct MatmulReduceScatterCompileInfo {} compileInfo;
    uint64_t coreNum = 24;
    uint64_t ubSize = 196608;
...
TEST_F(MatmulReduceScatterTiling, Float16Test6)
{
    struct MatmulReduceScatterCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(MatmulReduceScatterTiling, Bfloat16)
{
    struct MatmulReduceScatterCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
