...
template <typename SchedulerType, typename SchedulerContextType, typename GroupedMatmulAlltoAllvTilingData>
...
template <typename SchedulerType, typename SchedulerContextType, typename GroupedMatmulAlltoAllvTilingData>
__aicore__ inline void QuantGmmA2avKernel<SchedulerType, SchedulerContextType, GroupedMatmulAlltoAllvTilingData>::Init(
...
template <typename SchedulerType, typename SchedulerContextType, typename GroupedMatmulAlltoAllvTilingData>
__aicore__ inline void QuantGmmA2avKernel<SchedulerType, SchedulerContextType, GroupedMatmulAlltoAllvTilingData>::Process()
{
    // 启动流水
    ProcessTile(expertNumInOneRank_);
...
template <typename SchedulerType, typename SchedulerContextType, typename GroupedMatmulAlltoAllvTilingData>
__aicore__ inline void QuantGmmA2avKernel<SchedulerType, SchedulerContextType, GroupedMatmulAlltoAllvTilingData>::ProcessExpert(uint32_t taskCnt)
{  
    pipeLineContext_.gmmxGM = gmmxGM_;
    pipeLineContext_.gmmweightGM = gmmweightGM_;
    pipeLineContext_.mmxGM = mmxGM_;
    pipeLineContext_.mmweightGM = mmweightOptionalGM;
    pipeLineContext_.gmmxScaleGM = gmmxScaleGM_;
    pipeLineContext_.gmmWeightScaleGM = gmmWeightScaleGM_;
    pipeLineContext_.mmxScaleGM = mmxScaleGM_;
    pipeLineContext_.mmWeightScaleGM = mmWeightScaleGM_;
    pipeLineContext_.gmmyGM = gmmyGM_;
    pipeLineContext_.mmyGM = mmyGM_;
    pipeLineContext_.gmmOutGM = gmmOutGM_;
    pipeLineContext_.tilingData = tilingData_;
    pipeLineContext_.tilingGM = tilingGM_;

    pipeLineContext_.axisBsK = axisBsK_;
    pipeLineContext_.axisH = axisH_;
    pipeLineContext_.axisA = axisA_;
    pipeLineContext_.axisN1 = axisN1_;

    ProcessPipeLine(taskCnt);
}

template <typename SchedulerType, typename SchedulerContextType, typename GroupedMatmulAlltoAllvTilingData>
__aicore__ inline void QuantGmmA2avKernel<SchedulerType, SchedulerContextType, GroupedMatmulAlltoAllvTilingData>::ProcessPipeLine(uint32_t taskCnt)
{
