...
TEST_F(Arch32TilingTest, McutFloat16In910BTest1)
{
    GroupedMatMulAllReduceCompileInfo compileInfo {20, 196608};
    const std::string socVersion = "Ascend910B";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, McutFloat16In910BTest2)
{
    GroupedMatMulAllReduceCompileInfo compileInfo {20, 196608};
    const std::string socVersion = "Ascend910B";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, McutFloat16In910BTestwin2win)
{
    GroupedMatMulAllReduceCompileInfo compileInfo {20, 196608};
    const std::string socVersion = "Ascend910B";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Test2)
{
    GroupedMatMulAllReduceCompileInfo compileInfo {20, 196608};
    const std::string socVersion = "Ascend910B";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Test3)
{
    GroupedMatMulAllReduceCompileInfo compileInfo {20, 196608};
    const std::string socVersion = "Ascend910B";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Test4)
{
    GroupedMatMulAllReduceCompileInfo compileInfo {20, 196608};
    const std::string socVersion = "Ascend910B";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Test5)
{
    GroupedMatMulAllReduceCompileInfo compileInfo {20, 196608};
    const std::string socVersion = "Ascend910B";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Support3Dim)
{
    GroupedMatMulAllReduceCompileInfo compileInfo {20, 196608};
    const std::string socVersion = "Ascend910B";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Bfloat16)
{
    GroupedMatMulAllReduceCompileInfo compileInfo {20, 196608};
    const std::string socVersion = "Ascend910B";
    uint64_t coreNum = 20;
