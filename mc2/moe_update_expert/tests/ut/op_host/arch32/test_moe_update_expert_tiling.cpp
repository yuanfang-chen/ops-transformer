...
TEST_F(Arch32TilingTest, NoTailor)
{
...
TEST_F(Arch32TilingTest, ExpertTailor)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, WrongDimExpertIds)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, WrongDimExpertScales)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, WrongDimPruningThreshold)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, WrongDimActiveMask)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, WrongDimBalancedExpertIds)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, WrongDimBalancedActiveMask)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
