...
TEST_F(MoeUpdateExpertTiling, NoTailor)
{
...
TEST_F(MoeUpdateExpertTiling, ExpertTailor)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(MoeUpdateExpertTiling, WrongDimExpertIds)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(MoeUpdateExpertTiling, WrongDimExpertScales)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(MoeUpdateExpertTiling, WrongDimPruningThreshold)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(MoeUpdateExpertTiling, WrongDimActiveMask)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(MoeUpdateExpertTiling, WrongDimBalancedExpertIds)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(MoeUpdateExpertTiling, WrongDimBalancedActiveMask)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
