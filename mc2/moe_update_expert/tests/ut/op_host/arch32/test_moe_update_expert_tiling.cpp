...
protected:
    ...
    {
        std::cout << "MoeUpdateExpert Arch32TilingTest SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MoeUpdateExpert Arch32TilingTest TearDown" << std::endl;
    }
};

TEST_F(Arch32TilingTest, MoeUpdateExpertNoTailor)
{
...
TEST_F(Arch32TilingTest, MoeUpdateExpertExpertTailor)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, MoeUpdateExpertWrongDimExpertIds)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, MoeUpdateExpertWrongDimExpertScales)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, MoeUpdateExpertWrongDimPruningThreshold)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, MoeUpdateExpertWrongDimActiveMask)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, MoeUpdateExpertWrongDimBalancedExpertIds)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, MoeUpdateExpertWrongDimBalancedActiveMask)
{
    struct MoeUpdateExpertCompileInfo {} compileInfo;
    const std::string socVersion = "";
    uint64_t coreNum = 20;
