...
protected:
    ...
    virtual ge::graphStatus CheckTensorShape();
    ...
    virtual bool CheckInputTensorShapeDim();
    virtual bool CheckOutputTensorShapeDim();
    virtual bool CheckTensorShapeRelation();
    virtual bool CheckTensorShapeSize();
    virtual bool CheckInputTensorDataType();
    virtual bool CheckOutputTensorDataType();
    virtual bool CheckRelationTensorDataType();
};
} // namespace optiling
#endif