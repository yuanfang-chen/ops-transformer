...
void MoeDistributeDispatchTeardownTilingA3::PrintTilingDataInfo()
{
...
ge::graphStatus MoeDistributeDispatchTeardownTilingA3::CheckRequiredAttrValue()
{
...
ge::graphStatus MoeDistributeDispatchTeardownTilingA3::GetRequiredAttrAndSetTilingData()
{
...
ge::graphStatus MoeDistributeDispatchTeardownTilingA3::CheckOptionalAttrValue()
{
...
ge::graphStatus MoeDistributeDispatchTeardownTilingA3::GetOptionalAttrAndSetTilingData()
{
...
ge::graphStatus MoeDistributeDispatchTeardownTilingA3::CheckTensorShape()
{
    ...
    OP_TILING_CHECK(!CheckInputTensorShapeDim(), OP_LOGE(nodeName_, "Check input dims failed!"), return GRAPH_FAILED);
    OP_TILING_CHECK(!CheckOutputTensorShapeDim(), OP_LOGE(nodeName_, "Check output dims failed!"), return GRAPH_FAILED);
    OP_TILING_CHECK(
        !CheckTensorShapeRelation(), OP_LOGE(nodeName_, "Check shape relation failed!"), return GRAPH_FAILED);
    OP_TILING_CHECK(!CheckTensorShapeSize(), OP_LOGE(nodeName_, "Check shape size failed!"), return GRAPH_FAILED);

    return ge::GRAPH_SUCCESS;
}

bool MoeDistributeDispatchTeardownTilingA3::CheckInputTensorShapeDim()
{
    const gert::StorageShape* xShape = context_->GetInputShape(INPUT_X_INDEX);
    const gert::StorageShape* yShape = context_->GetInputShape(INPUT_Y_INDEX);
    const gert::StorageShape* expertIdsShape = context_->GetInputShape(INPUT_EXPERT_IDS_INDEX);
...
bool MoeDistributeDispatchTeardownTilingA3::CheckOutputTensorShapeDim()
{
    const gert::StorageShape* expandXOutShape = context_->GetOutputShape(OUTPUT_EXPAND_X_INDEX);
    const gert::StorageShape* dynamicScalesOutShape = context_->GetOutputShape(OUTPUT_DYNAMIC_SCALES_INDEX);
    const gert::StorageShape* assitInfoForCombineOutShape =
...
bool MoeDistributeDispatchTeardownTilingA3::CheckTensorShapeRelation()
{
    const gert::StorageShape* xShape = context_->GetInputShape(INPUT_X_INDEX);
    const gert::StorageShape* expertIdsShape = context_->GetInputShape(INPUT_EXPERT_IDS_INDEX);
    const gert::StorageShape* expandXOutShape = context_->GetOutputShape(OUTPUT_EXPAND_X_INDEX);
...
bool MoeDistributeDispatchTeardownTilingA3::CheckTensorShapeSize()
{
    const gert::StorageShape* xShape = context_->GetInputShape(INPUT_X_INDEX);
    const gert::StorageShape* yShape = context_->GetInputShape(INPUT_Y_INDEX);
    const gert::StorageShape* expertIdsShape = context_->GetInputShape(INPUT_EXPERT_IDS_INDEX);
...
bool MoeDistributeDispatchTeardownTilingA3::CheckInputTensorDataType()
{
    OP_TILING_CHECK(
    ...
    OP_TILING_CHECK(
        ...
        OP_LOGE(
            ...
            ops::ToString(context_->GetInputDesc(INPUT_X_INDEX)->GetDataType()).c_str()),
        return false);
    OP_TILING_CHECK(
        ...
        OP_LOGE(
            ...
            ops::ToString(context_->GetInputDesc(INPUT_Y_INDEX)->GetDataType()).c_str()),
        return false);
    OP_TILING_CHECK(
        ...
        OP_LOGE(
            ...
            ops::ToString(context_->GetInputDesc(INPUT_EXPERT_IDS_INDEX)->GetDataType()).c_str()),
        return false);
    OP_TILING_CHECK(
        ...
        OP_LOGE(
            ...
            ops::ToString(context_->GetInputDesc(INPUT_COMM_CMD_INFO_INDEX)->GetDataType()).c_str()),
        return false);
    return true;
}

bool MoeDistributeDispatchTeardownTilingA3::CheckOutputTensorDataType()
{
    OP_TILING_CHECK(
        ...
        OP_LOGE(
            ...
            "%s, y's datatype is %s!",
            ops::ToString(context_->GetOutputDesc(OUTPUT_EXPAND_X_INDEX)->GetDataType()).c_str(),
            ops::ToString(context_->GetOutputDesc(INPUT_Y_INDEX)->GetDataType()).c_str()),
        return false);
    return true;
}

bool MoeDistributeDispatchTeardownTilingA3::CheckRelationTensorDataType()
{
    OP_TILING_CHECK(
    ...
    OP_TILING_CHECK(
        ...
        OP_LOGE(
            ...
            ops::ToString(context_->GetInputDesc(OUTPUT_EXPAND_X_INDEX)->GetDataType()).c_str()),
        return false);
    if (quantMode == DYNAMIC_QUANT) {
        OP_TILING_CHECK(
            ...
            OP_LOGE(
                ...
                ops::ToString(context_->GetOutputDesc(OUTPUT_DYNAMIC_SCALES_INDEX)->GetDataType()).c_str()),
            return false);
    }
    OP_TILING_CHECK(
        ...
        OP_LOGE(
            ...
            ops::ToString(context_->GetOutputDesc(OUTPUT_ASSIST_INFO_FOR_COMBINE_INDEX)->GetDataType()).c_str()),
        return false);
    OP_TILING_CHECK(
        ...
        OP_LOGE(
            ...
            ops::ToString(context_->GetOutputDesc(OUTPUT_EXPERT_TOKEN_NUMS_INDEX)->GetDataType()).c_str()),
        return false);

    return true;
}

ge::graphStatus MoeDistributeDispatchTeardownTilingA3::CheckTensorDataType()
{
    OP_TILING_CHECK(
        !CheckInputTensorDataType(), OP_LOGE(nodeName_, "Check input dataType failed!"), return GRAPH_FAILED);
    OP_TILING_CHECK(
        !CheckOutputTensorDataType(), OP_LOGE(nodeName_, "Check output dataType failed!"), return GRAPH_FAILED);

    return ge::GRAPH_SUCCESS;
}

ge::graphStatus MoeDistributeDispatchTeardownTilingA3::CheckHcclBuffSize()
{
...
void MoeDistributeDispatchTeardownTilingA3::SetTilingKey()
{
    bool isSharedExpert(
...
void MoeDistributeDispatchTeardownTilingA3::SetHcommCfg()
{
...
void MoeDistributeDispatchTeardownTilingA3::SetPlatformInfo()
{
...
ge::graphStatus MoeDistributeDispatchTeardownTilingA3::SetWorkSpace()
{
