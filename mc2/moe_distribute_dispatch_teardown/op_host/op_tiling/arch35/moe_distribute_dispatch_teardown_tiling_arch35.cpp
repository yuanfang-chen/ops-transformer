...
void MoeDistributeDispatchTeardownTilingA5::PrintTilingDataInfo()
{
...
ge::graphStatus MoeDistributeDispatchTeardownTilingA5::CheckRequiredAttrValue()
{
...
ge::graphStatus MoeDistributeDispatchTeardownTilingA5::GetRequiredAttrAndSetTilingData()
{
...
ge::graphStatus MoeDistributeDispatchTeardownTilingA5::CheckOptionalAttrValue()
{
...
ge::graphStatus MoeDistributeDispatchTeardownTilingA5::GetOptionalAttrAndSetTilingData()
{
...
ge::graphStatus MoeDistributeDispatchTeardownTilingA5::CheckTensorShape()
{
...
bool MoeDistributeDispatchTeardownTilingA5::CheckInputTensorShapeDim()
{
    const gert::StorageShape* xShape = context_->GetInputShape(INPUT_X_INDEX);
    const gert::StorageShape* yShape = context_->GetInputShape(INPUT_Y_INDEX);
    const gert::StorageShape* expertIdsShape = context_->GetInputShape(INPUT_EXPERT_IDS_INDEX);
...
bool MoeDistributeDispatchTeardownTilingA5::CheckOutputTensorShapeDim()
{
    const gert::StorageShape* expandXOutShape = context_->GetOutputShape(OUTPUT_EXPAND_X_INDEX);
    const gert::StorageShape* dynamicScalesOutShape = context_->GetOutputShape(OUTPUT_DYNAMIC_SCALES_INDEX);
    const gert::StorageShape* assitInfoForCombineOutShape =
...
bool MoeDistributeDispatchTeardownTilingA5::CheckTensorShapeRelation()
{
    const gert::StorageShape* xShape = context_->GetInputShape(INPUT_X_INDEX);
    const gert::StorageShape* expertIdsShape = context_->GetInputShape(INPUT_EXPERT_IDS_INDEX);
    const gert::StorageShape* expandXOutShape = context_->GetOutputShape(OUTPUT_EXPAND_X_INDEX);
...
bool MoeDistributeDispatchTeardownTilingA5::CheckTensorShapeSize()
{
    const gert::StorageShape* xShape = context_->GetInputShape(INPUT_X_INDEX);
    const gert::StorageShape* yShape = context_->GetInputShape(INPUT_Y_INDEX);
    const gert::StorageShape* expertIdsShape = context_->GetInputShape(INPUT_EXPERT_IDS_INDEX);
...
bool MoeDistributeDispatchTeardownTilingA5::CheckInputTensorDataType()
{
    OP_TILING_CHECK(
...
bool MoeDistributeDispatchTeardownTilingA5::CheckOutputTensorDataType()
{
    OP_TILING_CHECK(
...
bool MoeDistributeDispatchTeardownTilingA5::CheckRelationTensorDataType()
{
    OP_TILING_CHECK(
...
ge::graphStatus MoeDistributeDispatchTeardownTilingA5::CheckTensorDataType()
{
    OP_TILING_CHECK(
...
ge::graphStatus MoeDistributeDispatchTeardownTilingA5::CheckHcclBuffSize()
{
...
void MoeDistributeDispatchTeardownTilingA5::SetTilingKey()
{
    bool isSharedExpert(
...
void MoeDistributeDispatchTeardownTilingA5::SetHcommCfg()
{
...
ge::graphStatus MoeDistributeDispatchTeardownTilingA5::SetWorkSpace()
{
