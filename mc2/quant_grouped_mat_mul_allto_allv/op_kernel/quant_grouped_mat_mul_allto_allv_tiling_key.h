...
#define QUANT_MODE_MX 6   // MX (Microscaling FP8)
...
ASCENDC_TPL_SEL(
    ...
    // ==================== MX (Microscaling FP8) 量化场景 ====================

    // 场景19: 无共享专家，GMM不转置，MM不转置，GMM MX量化，MM不量化
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_BOOL_SEL(TILINGKEY_COMPUTE_MATMUL, 0),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_GMM_WEIGHT_TRANS, 0),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_SHARED_MM_WEIGHT_TRANS, 0),
                         ASCENDC_TPL_UINT_SEL(TILINGKEY_GMM_QUANT_MODE, ASCENDC_TPL_UI_LIST, QUANT_MODE_MX),
                         ASCENDC_TPL_UINT_SEL(TILINGKEY_SHARED_MM_QUANT_MODE, ASCENDC_TPL_UI_LIST, QUANT_MODE_NONE)),

    // 场景20: 无共享专家，GMM转置，MM不转置，GMM MX量化，MM不量化
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_BOOL_SEL(TILINGKEY_COMPUTE_MATMUL, 0),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_GMM_WEIGHT_TRANS, 1),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_SHARED_MM_WEIGHT_TRANS, 0),
                         ASCENDC_TPL_UINT_SEL(TILINGKEY_GMM_QUANT_MODE, ASCENDC_TPL_UI_LIST, QUANT_MODE_MX),
    ...
    // 场景21: 有共享专家，GMM不转置，MM不转置，GMM MX量化，MM不量化
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_BOOL_SEL(TILINGKEY_COMPUTE_MATMUL, 1),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_GMM_WEIGHT_TRANS, 0),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_SHARED_MM_WEIGHT_TRANS, 0),
                         ASCENDC_TPL_UINT_SEL(TILINGKEY_GMM_QUANT_MODE, ASCENDC_TPL_UI_LIST, QUANT_MODE_MX),
    ...
    // 场景22: 有共享专家，GMM不转置，MM不转置，GMM MX量化，MM MX量化
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_BOOL_SEL(TILINGKEY_COMPUTE_MATMUL, 1),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_GMM_WEIGHT_TRANS, 0),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_SHARED_MM_WEIGHT_TRANS, 0),
                         ASCENDC_TPL_UINT_SEL(TILINGKEY_GMM_QUANT_MODE, ASCENDC_TPL_UI_LIST, QUANT_MODE_MX),
                         ASCENDC_TPL_UINT_SEL(TILINGKEY_SHARED_MM_QUANT_MODE, ASCENDC_TPL_UI_LIST, QUANT_MODE_MX)),

    // 场景23: 有共享专家，GMM不转置，MM转置，GMM MX量化，MM MX量化
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_BOOL_SEL(TILINGKEY_COMPUTE_MATMUL, 1),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_GMM_WEIGHT_TRANS, 0),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_SHARED_MM_WEIGHT_TRANS, 1),
                         ASCENDC_TPL_UINT_SEL(TILINGKEY_GMM_QUANT_MODE, ASCENDC_TPL_UI_LIST, QUANT_MODE_MX),
    ...
    // 场景24: 有共享专家，GMM转置，MM不转置，GMM MX量化，MM不量化
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_BOOL_SEL(TILINGKEY_COMPUTE_MATMUL, 1),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_GMM_WEIGHT_TRANS, 1),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_SHARED_MM_WEIGHT_TRANS, 0),
                         ASCENDC_TPL_UINT_SEL(TILINGKEY_GMM_QUANT_MODE, ASCENDC_TPL_UI_LIST, QUANT_MODE_MX),
    ...
    // 场景25: 有共享专家，GMM转置，MM不转置，GMM MX量化，MM MX量化
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_BOOL_SEL(TILINGKEY_COMPUTE_MATMUL, 1),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_GMM_WEIGHT_TRANS, 1),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_SHARED_MM_WEIGHT_TRANS, 0),
                         ASCENDC_TPL_UINT_SEL(TILINGKEY_GMM_QUANT_MODE, ASCENDC_TPL_UI_LIST, QUANT_MODE_MX),
    ...
    // 场景26: 有共享专家，GMM转置，MM转置，GMM MX量化，MM MX量化
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_BOOL_SEL(TILINGKEY_COMPUTE_MATMUL, 1),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_GMM_WEIGHT_TRANS, 1),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_SHARED_MM_WEIGHT_TRANS, 1),
                         ASCENDC_TPL_UINT_SEL(TILINGKEY_GMM_QUANT_MODE, ASCENDC_TPL_UI_LIST, QUANT_MODE_MX),
    ...
    // 场景27: 无共享专家，GMM不转置，MM转置，GMM MX量化，MM MX量化
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_BOOL_SEL(TILINGKEY_COMPUTE_MATMUL, 0),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_GMM_WEIGHT_TRANS, 0),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_SHARED_MM_WEIGHT_TRANS, 1),
                         ASCENDC_TPL_UINT_SEL(TILINGKEY_GMM_QUANT_MODE, ASCENDC_TPL_UI_LIST, QUANT_MODE_MX),
    ...
    // 场景28: 无共享专家，GMM转置，MM转置，GMM MX量化，MM MX量化
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_BOOL_SEL(TILINGKEY_COMPUTE_MATMUL, 0),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_GMM_WEIGHT_TRANS, 1),
                         ASCENDC_TPL_BOOL_SEL(TILINGKEY_SHARED_MM_WEIGHT_TRANS, 1),
                         ASCENDC_TPL_UINT_SEL(TILINGKEY_GMM_QUANT_MODE, ASCENDC_TPL_UI_LIST, QUANT_MODE_MX),
