...
ASCENDC_TPL_ARGS_DECL(MoeDistributeDispatchV2Extend,
    ...
    ASCENDC_TPL_UINT_DECL(TILINGKEY_FULLMESH, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, 
                        TILINGKEY_NO_FULLMESH, TILINGKEY_ENABLE_FULLMESH, TILINGKEY_ENABLE_HIERARCHY),
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(TILINGKEY_COMM_MODE, ASCENDC_TPL_UI_LIST, TILINGKEY_TPL_MTE, TILINGKEY_TPL_CCU),
