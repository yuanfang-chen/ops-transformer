...
class MoeDistributeCombineAddRmsNormArch32TilingTest : public testing::TestWithParam<TestParam>
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "MoeDistributeCombineAddRmsNormArch32TilingTest SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MoeDistributeCombineAddRmsNormArch32TilingTest TearDown" << std::endl;
    }
};
...
TEST_P(MoeDistributeCombineAddRmsNormArch32TilingTest, MoeDistributeCombineAddRmsNormCommonTest)
{
