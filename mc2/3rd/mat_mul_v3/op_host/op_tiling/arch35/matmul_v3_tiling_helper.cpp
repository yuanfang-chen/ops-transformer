...
using ResetBaseFunc = void (*)(const gert::TilingContext*, const Mc2MatMulV3Args &, Mc2MatMulV3RunInfo &);
...
// ------------------------------ GetL0C2Out -------------------------------------------//
Mc2MatMulV3L0C2Out GetL0C2OutDefault(const gert::TilingContext*, const Mc2MatMulV3Args & /* args */,
...
using GetL0C2OutFunc = Mc2MatMulV3L0C2Out (*)(const gert::TilingContext*, const Mc2MatMulV3Args &, const Mc2MatMulV3RunInfo &);
...
void Mc2MatMulV3TilingHelper::ResetBase(const gert::TilingContext* context, const Mc2MatMulV3Args &args,
...
Mc2MatMulV3L0C2Out Mc2MatMulV3TilingHelper::GetL0C2Out(const gert::TilingContext* context, const Mc2MatMulV3Args &args,
                                                 const Mc2MatMulV3RunInfo &runInfo)
{
    auto platformInfo = context->GetPlatformInfo();
    auto ascendcPlatform = platform_ascendc::PlatformAscendC(platformInfo);
    ...
    return iter(context, args, runInfo);
}
