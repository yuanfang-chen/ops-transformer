...
#ifndef MC2_CATLASS_GEMM_TILE_COPY_L1_TO_L0A_HPP
#define MC2_CATLASS_GEMM_TILE_COPY_L1_TO_L0A_HPP
...
struct CopyL1ToL0A<ArchTag, mc2_Catlass::Gemm::GemmType<Element, layout::zN, AscendC::TPosition::A1>, mc2_Catlass::Gemm::GemmType<Element, layout::zZ, AscendC::TPosition::A2>>{
...
template<class ArchTag, class Element>
struct CopyL1ToL0A<ArchTag, mc2_Catlass::Gemm::GemmType<Element, layout::nN, AscendC::TPosition::A1>, mc2_Catlass::Gemm::GemmType<Element, layout::zZ, AscendC::TPosition::A2>>{
    using LayoutDst = layout::zZ;
...
struct CopyL1ToL0A<ArchTag, mc2_Catlass::Gemm::GemmType<float, layout::nN, AscendC::TPosition::A1>, mc2_Catlass::Gemm::GemmType<float, layout::zZ, AscendC::TPosition::A2>>{
    using Element = float;
    using LayoutDst = layout::zZ;
    using LayoutSrc = layout::nN;
...
template<class ArchTag>
struct CopyL1ToL0A<ArchTag, mc2_Catlass::Gemm::GemmType<int8_t, layout::nZ, AscendC::TPosition::A1>, mc2_Catlass::Gemm::GemmType<int8_t, layout::zZ, AscendC::TPosition::A2>>{
