...
#ifndef MC2_CATLASS_GEMM_TILE_COPY_L1_TO_L0B_HPP
#define MC2_CATLASS_GEMM_TILE_COPY_L1_TO_L0B_HPP
...
namespace mc2_Catlass::Gemm::Tile {
...
struct CopyL1ToL0B<ArchTag, mc2_Catlass::Gemm::GemmType<Element, layout::zZ, AscendC::TPosition::B1>, mc2_Catlass::Gemm::GemmType<Element, layout::nZ, AscendC::TPosition::B2>>{
...
struct CopyL1ToL0B<ArchTag, mc2_Catlass::Gemm::GemmType<float, layout::zZ, AscendC::TPosition::B1>, mc2_Catlass::Gemm::GemmType<float, layout::nZ, AscendC::TPosition::B2>>{
    using Element = float;
    using LayoutDst = layout::nZ;
    using LayoutSrc = layout::zZ;
...
template<class ArchTag>
struct CopyL1ToL0B<ArchTag, mc2_Catlass::Gemm::GemmType<int8_t, layout::zN, AscendC::TPosition::B1>, mc2_Catlass::Gemm::GemmType<int8_t, layout::nZ, AscendC::TPosition::B2>>{
...
template <class ArchTag, class Element>
struct CopyL1ToL0B<ArchTag, mc2_Catlass::Gemm::GemmType<Element, layout::nZ, AscendC::TPosition::B1>, mc2_Catlass::Gemm::GemmType<Element, layout::nZ, AscendC::TPosition::B2>> {
    using LayoutDst = layout::nZ;
...
/// new add gemv
template <class ArchTag, class Element>
struct CopyL1ToL0B<ArchTag, mc2_Catlass::Gemm::GemmType<Element, layout::zN, AscendC::TPosition::B1>, mc2_Catlass::Gemm::GemmType<Element, layout::zN, AscendC::TPosition::B2>>{
...
template <class ArchTag, class Element>
struct CopyL1ToL0B<ArchTag, mc2_Catlass::Gemm::GemmType<Element, layout::nN, AscendC::TPosition::B1>, mc2_Catlass::Gemm::GemmType<Element, layout::zN, AscendC::TPosition::B2>>
{
    using LayoutDst = layout::zN;
...
template <class ArchTag>
struct CopyL1ToL0B<ArchTag, mc2_Catlass::Gemm::GemmType<float, layout::nN, AscendC::TPosition::B1>, mc2_Catlass::Gemm::GemmType<float, layout::zN, AscendC::TPosition::B2>>{
    using LayoutDst = layout::zN;
    using LayoutSrc = layout::nN;
    using Element = float;
...
template <class ArchTag>
struct CopyL1ToL0B<ArchTag, mc2_Catlass::Gemm::GemmType<int8_t, layout::nZ, AscendC::TPosition::B1>, mc2_Catlass::Gemm::GemmType<int8_t, layout::zN, AscendC::TPosition::B2>>{
    using LayoutDst = layout::zN;
    using LayoutSrc = layout::nZ;
    using Element = int8_t;
