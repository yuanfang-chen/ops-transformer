 ...
 * \brief
 */
#ifndef MC2_GROUPED_MATMUL_WEIGHT_QUANT_VCV_BASIC_BLOCK_H
#define MC2_GROUPED_MATMUL_WEIGHT_QUANT_VCV_BASIC_BLOCK_H
...
#endif  // MC2_GROUPED_MATMUL_WEIGHT_QUANT_VCV_BASIC_BLOCK_H
