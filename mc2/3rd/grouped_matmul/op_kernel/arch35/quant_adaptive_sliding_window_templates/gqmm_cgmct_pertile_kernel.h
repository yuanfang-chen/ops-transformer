 ...
 * \brief
 */
#ifndef MC2_GQMM_CGMCT_PERTILE_KERNEL_H
#define MC2_GQMM_CGMCT_PERTILE_KERNEL_H
                                             ...
                                             AscendC::TPipe *que)
{
    ...
    Params params = {{1, 1, 1, 1},                    // shape
                     ...
                     {(GM_ADDR)MC2_GROUPED_MATMUL::GetTensorAddr<YType>(0, y),
                      (GM_ADDR)MC2_GROUPED_MATMUL::GetTensorAddr<ScaleType>(0, scale), perTokenScale, nullptr,
                      static_cast<uint32_t>(mmTilingDataIn->baseM), static_cast<uint32_t>(mmTilingDataIn->baseN),
                      static_cast<uint32_t>(mmTilingDataIn->baseK), 1, Mc2QuantUtils::PER_BLOCK_SIZE,
                      Mc2QuantUtils::PER_BLOCK_SIZE}, // epilogue args
                     gmmParams};
    GmmKernel gmm;
    gmm(params);
}
