 ...
 * \brief
 */
#ifndef ASCENDC_MC2_GROUPED_MATMUL_UTILS_H
#define ASCENDC_MC2_GROUPED_MATMUL_UTILS_H
...
__aicore__ inline __gm__ T* GetTensorAddr(uint16_t index, GM_ADDR tensorPtr) {
    return (__gm__ T*)tensorPtr; // TODO
...
#endif  // ASCENDC_MC2_GROUPED_MATMUL_UTILS_H
