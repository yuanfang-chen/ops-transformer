 ...
 * \brief
 */
#ifndef MC2_GROUPED_MATMUL_WEIGHT_QUANT_BASIC_CONTROLLER_H
#define MC2_GROUPED_MATMUL_WEIGHT_QUANT_BASIC_CONTROLLER_H
...
using Mc2WeightQuantBatchMatmulV2::Arch35::WeightQuantMatmulBasicBlock;
    ...
    uint64_t groupIdx, uint64_t &preOffset, BasicBlockOffsetParam &offsetParam)
{
    ...
    if (gmmBaseTiling_->groupType == 0) {
        ...
        offsetParam.kAlign =
            Mc2WeightQuantBatchMatmulV2::Arch35::CeilAlign(offsetParam.kSize, static_cast<uint64_t>(BLOCK_CUBE));
...
#endif  // MC2_GROUPED_MATMUL_WEIGHT_QUANT_BASIC_CONTROLLER_H
