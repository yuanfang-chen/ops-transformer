...
CATLASS_DEVICE void grouped_matmul_fixaxismove(uint32_t m, uint32_t k, uint32_t n, uint32_t groupNum, 
    ...
    using LayoutA = mc2_Catlass::layout::RowMajor;
    using LayoutB = mc2_Catlass::layout::zN;
    using LayoutD = mc2_Catlass::layout::RowMajor;
    LayoutA layoutA{m, k};
    LayoutB layoutB = LayoutB::template MakeLayout<WeightDType>(k, n);
    mc2_Catlass::layout::VectorLayout layoutScale{n};
    mc2_Catlass::layout::VectorLayout layoutPerTokenScale{m};
    LayoutD layoutD{m, n};
