...
#ifndef MC2_CATLASS_GEMM_TILE_COPY_L0C_TO_GM_HPP
#define MC2_CATLASS_GEMM_TILE_COPY_L0C_TO_GM_HPP
...
template <
    ...
    bool ReluEnable_
>
struct CopyL0CToGm<mc2_Catlass::Arch::AtlasA2,
                   ElementAccumulator_,
                   Gemm::GemmType<ElementDst_, layout::RowMajor>,
                   ScaleGranularity::NO_QUANT,
                   ReluEnable_>
{
    using ArchTag = mc2_Catlass::Arch::AtlasA2;
    using ElementDst = ElementDst_;
    using ElementSrc = ElementAccumulator_;
    using LayoutSrc = mc2_Catlass::layout::zN;
    using LayoutDst = mc2_Catlass::layout::RowMajor;
                   ...
                   ReluEnable_>
{
    ...
    using ElementSrc = ElementAccumulator_;
    using LayoutSrc = mc2_Catlass::layout::zN;
    using LayoutDst = mc2_Catlass::layout::zN;
    static constexpr auto quantPre = CopyL0CToGmQuantMode<ArchTag, ElementSrc, ElementDst,
        ScaleGranularity::NO_QUANT>::VALUE;
    static constexpr auto reluEn = ReluEnable_;
