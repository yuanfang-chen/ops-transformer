 ...
 * \brief
 */
#ifndef MC2_GROUPED_WEIGHT_QUANT_BATCH_MATMUL_TILING_H
#define MC2_GROUPED_WEIGHT_QUANT_BATCH_MATMUL_TILING_H
...
#endif  // MC2_GROUPED_WEIGHT_QUANT_BATCH_MATMUL_TILING_H