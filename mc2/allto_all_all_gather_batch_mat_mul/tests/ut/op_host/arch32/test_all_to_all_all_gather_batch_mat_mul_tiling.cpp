...
TEST_F(Arch32TilingTest, Float16Test1)
{
...
TEST_F(Arch32TilingTest, Float16Xshard0)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Shard0InvalidH)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Shard0UnequalH)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Test1WeightTrans)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16XShard1ActType1)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16XShard1ActType4)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16InvalidE)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Shard)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, InvalidEOverepIntercept)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16ShardWithBias)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16ShardWithBiasBf16)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Shard0)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Shard1)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Shard1Test1)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16ShardWithBiasTest1)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16ShardWithBiasTest2)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16ShardWithBiasTest3)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16ShardWithBiasTest4)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16ShardWithBiasTest5)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16ShardWithBiasTest6)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16ShardWithBiasTest7)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16ShardWithBiasTest8)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16ShardWithBiasTest9)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16ShardWithBiasTest10)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16ShardWithBiasTest11)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16ShardWithBiasTest12)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Xshard0Ep2)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Xshard0CutE)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Xshard0CutC)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Xshard0TileShort)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Xshard0MultiE)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
...
TEST_F(Arch32TilingTest, Float16Xshard0LocalTailE)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    const std::string socVersion = "Ascend910_93";
    uint64_t coreNum = 20;
