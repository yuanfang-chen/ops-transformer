...
#include "../../op_kernel/all_gather_matmul_inner_tiling_key.h"
#include "../../op_kernel/all_gather_matmul_inner_tiling.h"

using namespace AscendC;
using namespace ge;
using namespace all_gather_matmul_inner_tiling_key;
...
{
    OP_LOGD("AllGatherMatmulInner", " tiling.usedCoreNum %d", tiling.usedCoreNum);
    OP_LOGD("AllGatherMatmulInner", " tiling.M %d", tiling.M);
    OP_LOGD("AllGatherMatmulInner", " tiling.N %d", tiling.N);
    OP_LOGD("AllGatherMatmulInner", " tiling.Ka %d", tiling.Ka);
    OP_LOGD("AllGatherMatmulInner", " tiling.Kb %d", tiling.Kb);
    OP_LOGD("AllGatherMatmulInner", " tiling.singleCoreM %d", tiling.singleCoreM);
    OP_LOGD("AllGatherMatmulInner", " tiling.singleCoreN %d", tiling.singleCoreN);
    OP_LOGD("AllGatherMatmulInner", " tiling.singleCoreK %d", tiling.singleCoreK);
    OP_LOGD("AllGatherMatmulInner", " tiling.baseM %d", tiling.baseM);
    OP_LOGD("AllGatherMatmulInner", " tiling.baseN %d", tiling.baseN);
    OP_LOGD("AllGatherMatmulInner", " tiling.baseK %d", tiling.baseK);
    OP_LOGD("AllGatherMatmulInner", " tiling.depthA1 %d", tiling.depthA1);
    OP_LOGD("AllGatherMatmulInner", " tiling.depthB1 %d", tiling.depthB1);
    OP_LOGD("AllGatherMatmulInner", " tiling.stepM %d", tiling.stepM);
    OP_LOGD("AllGatherMatmulInner", " tiling.stepN %d", tiling.stepN);
    OP_LOGD("AllGatherMatmulInner", " tiling.stepka %d", tiling.stepKa);
    OP_LOGD("AllGatherMatmulInner", " tiling.stepkb %d", tiling.stepKb);
    OP_LOGD("AllGatherMatmulInner", " tiling.isBias %d", tiling.isBias);
    OP_LOGD("AllGatherMatmulInner", " tiling.transLength %d", tiling.transLength);
    OP_LOGD("AllGatherMatmulInner", " tiling.iterateOrder %s", ((tiling.iterateOrder == 1) ? "orderM" : "orderN"));
    OP_LOGD("AllGatherMatmulInner", " tiling.usedL1Size %d", tiling.shareL1Size);
    OP_LOGD("AllGatherMatmulInner", " tiling.usedL0CSize %d", tiling.shareL0CSize);
    OP_LOGD("AllGatherMatmulInner", " tiling.dbL0C %d", tiling.dbL0C);
    OP_LOGD("AllGatherMatmulInner", " tiling.usedUBSize %d", tiling.shareUbSize);
    OP_LOGD("AllGatherMatmulInner", " tiling.batchM %d", tiling.batchM);
    OP_LOGD("AllGatherMatmulInner", " tiling.batchN %d", tiling.batchN);
    OP_LOGD("AllGatherMatmulInner", " tiling.singleBatchM %d", tiling.singleBatchM);
    OP_LOGD("AllGatherMatmulInner", " tiling.singleBatchN %d", tiling.singleBatchN);
}

static void PrintTilingData(Mc2Tiling::RCSTiling& rcsTiling)
{
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.commtype %d", rcsTiling.commtype);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.subtype %d", rcsTiling.subtype);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.rankDim %d", rcsTiling.rankDim);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.rankID %d", rcsTiling.rankID);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.tileCnt %d", rcsTiling.tileCnt);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.tailM %d", rcsTiling.tailM);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.tailCnt %d", rcsTiling.tailCnt);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.isTransA %d", rcsTiling.isTransposeA);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.isTransB %d", rcsTiling.isTransposeB);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.rankM %d", rcsTiling.rankM);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.rankN %d", rcsTiling.rankN);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.rankK %d", rcsTiling.rankK);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.gatherIndex %d", rcsTiling.gatherIndex);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.cToFloatLen %lu", rcsTiling.cToFloatLen);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.nd2NzWorkLen %lu", rcsTiling.nd2NzWorkLen);
    OP_LOGD("AllGatherMatmulInner", " rcsTiling.gatherLen %lu", rcsTiling.gatherLen);
}

static void PrintTilingData(Mc2Tiling::TileL2Tiling& tileL2Tiling)
{
    OP_LOGD("AllGatherMatmulInner", " tileL2Tiling.mL2TileCnt %d", tileL2Tiling.mL2TileCnt);
    OP_LOGD("AllGatherMatmulInner", " tileL2Tiling.nL2TileCnt %d", tileL2Tiling.nL2TileCnt);
    OP_LOGD("AllGatherMatmulInner", " tileL2Tiling.mTileBlocks %d", tileL2Tiling.mTileBlocks);
    OP_LOGD("AllGatherMatmulInner", " tileL2Tiling.nTileBlocks %d", tileL2Tiling.nTileBlocks);
    OP_LOGD("AllGatherMatmulInner", " tileL2Tiling.mTailBlocks %d", tileL2Tiling.mTailBlocks);
    OP_LOGD("AllGatherMatmulInner", " tileL2Tiling.nTailBlocks %d", tileL2Tiling.nTailBlocks);
    OP_LOGD("AllGatherMatmulInner", " tileL2Tiling.rankTileNum %d", tileL2Tiling.rankTileNum);
    OP_LOGD("AllGatherMatmulInner", " tileL2Tiling.calcOrder %d", tileL2Tiling.calcOrder);
    OP_LOGD("AllGatherMatmulInner", " tileL2Tiling.enableL2Tile %d", tileL2Tiling.enableL2Tile);
}
}
...
static ge::graphStatus MC2SetWorkspace(gert::TilingContext* context, Mc2Tiling::AllGatherMatmulInnerTilingData& tilingData,
...
static ge::graphStatus SetCommAlg(Mc2Tiling::AllGatherMatmulInnerTilingData &tilingData)
{
...
static ge::graphStatus GetAllGatherFormulateTileCnt(const gert::TilingContext* ctx,
    Mc2Tiling::AllGatherMatmulInnerTilingData& tilingData, mc2tiling::TilingArgs& args)
{
...
// 第一个参数m
static ge::graphStatus MCSpliteM(gert::TilingContext* ctx, Mc2Tiling::AllGatherMatmulInnerTilingData& tilingData,
                                 mc2tiling::TilingArgs& args)
{
...
static void UpdateTilingKey(uint64_t& tilingKey, const Mc2Tiling::AllGatherMatmulInnerTilingData& tilingData, bool isBias)
{
...
static ge::graphStatus SetMatmulTilingAllGatherMatmul(gert::TilingContext* context,
                                                      Mc2Tiling::AllGatherMatmulInnerTilingData& tilingData,
                                                      mc2tiling::TilingArgs& args)
{
...
static uint64_t GetStorage_a(Mc2Tiling::AllGatherMatmulInnerTilingData& tilingData, mc2tiling::TilingArgs& args)
{
...
static void SetSocParam(Mc2Tiling::AllGatherMatmulInnerTilingData* tilingData, const char* group)
{
...
static ge::graphStatus InitHcclParam(const gert::TilingContext *context, 
                                     Mc2Tiling::AllGatherMatmulInnerTilingData* tilingData, const char* group)
{
...
static ge::graphStatus AllGatherMatmulTilingFunc(gert::TilingContext *context) {
  // 对参数进行校验
  int index = 0;
  Mc2Tiling::AllGatherMatmulInnerTilingData* tilingData = context->GetTilingData<Mc2Tiling::AllGatherMatmulInnerTilingData>();
  mc2tiling::TilingArgs args;
  ...
  tilingData->param.isTransposeA = 0;
  tilingData->param.isTransposeB =  0;
  tilingData->param.gatherIndex = 0;
