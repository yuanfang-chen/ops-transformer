...
/*!
 * \file all_gather_matmul_inner_tiling_key.h
 * \brief
 */

#ifndef __OP_KERNEL_ALL_GATHER_MATMUL_INNER_TILING_KEY_H__
#define __OP_KERNEL_ALL_GATHER_MATMUL_INNER_TILING_KEY_H__

#include "ascendc/host_api/tiling/template_argument.h"

namespace all_gather_matmul_inner_tiling_key{
// 模板参数
ASCENDC_TPL_ARGS_DECL(
    AllGatherMatmulInner, // 算子OpType
...
} // all_gather_matmul_inner_tiling_key
#endif // __OP_KERNEL_ALL_GATHER_MATMUL_INNER_TILING_KEY_H__
