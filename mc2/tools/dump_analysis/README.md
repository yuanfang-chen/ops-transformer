...
<b>上述结果为多卡间的dispatch&combine的执行次数、moe专家数、globalbs对比，当多卡间的dispatch/combine算子的上诉数据不同时，将该异常以warning的形式输出，并将各卡的dispatch&combine执行次数存储至win_all_card_run_num.csv。</b>
