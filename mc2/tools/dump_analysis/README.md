...
<table style="undefined;table-layout: fixed; width: 1392px"> <colgroup>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>输出</td>
   <td>存放分析出的异常点及异常位置，即把打屏日志中的Warning信息存储在该csv文件中。<b>如：d0卡dispatchv2算子第35个核的第2个状态位没有等到</td>
   <td>csv表</td>
  </tr>
  <tr>
   <td>win_data</td>
  ...
  <tr>
   <td>win_data_list</td>
   <td>输出</td>
   <td>存放解析出的各卡中每个核的moe专家数、使用核数、执行次数、epworldsize以及0/1标识位数据，<br>如：d0卡dispatchv2的使用核数为72，则将72个核的win区的moe专家数记录并储存至win_data_list，d0_dispatch_moe专家数:[0:72]。</td>
   <td>csv表</td>
  </tr>
 </tbody>
</table>
