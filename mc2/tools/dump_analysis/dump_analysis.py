...
max_com_run_num = 0
soc_version_a5 = "950"
soc_version_a3 = "910_93"

if (soc_version == soc_version_a5):
    perfix = "mc2_"
    endfix = ""
elif (soc_version == soc_version_a3):
    perfix = "exception_info"
    endfix = ".workspace.1.bin.npy"
else:
    logging.error("soc_version:%d 非法输入, soc_version should be: %s or %s", soc_version, soc_version_a5, soc_version_a3)
