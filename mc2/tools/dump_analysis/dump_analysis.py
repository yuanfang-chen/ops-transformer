...
def compare_run_num(parms: Func_class, dis_diff_indices_func: list, com_diff_indices_func: list) -> dict:
...
def dis_status_analysis(parms: Func_class, dis_core_num_func: int, dis_unwait_index_func: list):
...
def com_status_analysis(parms: Func_class, com_core_num_func: int, share_expert_num_func: int,
...
for filename in tqdm(os.listdir(os.path.join(floder_path))):
    if filename.startswith(perfix) and filename.endswith(endfix):
        ...
        if (dis_core_num != 0 and com_core_num != 0):
            run_num_class = Func_class(win_data_list_01=dis_run_num_list, win_data_list_02=com_run_num_list,
        ...
        if (dis_core_num != 0):
            ...
            if dis_0_1 == 0:
                ...
                dis_status_class = Func_class(win_data_list_01=int32_dis_0_status, win_data_list_02=dis_status_list, 
                ...
                dis_status_class = Func_class(win_data_list_01=int32_dis_1_status, win_data_list_02=dis_status_list, 
                                              win_data_01=dis_status_num, win_data_02=dis_0_1, card_num_class=card_num,
                                              bs_class=bs, k_class=k)
                error_dict.update(dis_status_analysis(dis_status_class, dis_core_num, dis_unwait_index))
                logging.info("2.3 dispatch状态区分析完成\n")
        ...
        if (com_core_num != 0):
            ...
            if com_0_1 == 0:
                ...
                com_status_class = Func_class(win_data_list_01=int32_com_0_status, win_data_list_02=com_status_list, 
                ...
                com_status_class = Func_class(win_data_list_01=int32_com_1_status, win_data_list_02=com_status_list, 
                                              win_data_01=com_status_num, win_data_02=com_0_1, bs_class=bs,
                                              k_class=k, card_num_class=card_num)
                error_dict.update(com_status_analysis(com_status_class, com_core_num, share_expert_num,
                                                      com_unwait_index))
