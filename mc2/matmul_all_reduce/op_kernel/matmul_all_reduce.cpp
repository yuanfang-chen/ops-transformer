    ...
    GM_ADDR workspaceGM, GM_ADDR tilingGM)
{
    ...
    REGISTER_TILING_DEFAULT(Mc2Tiling::WeightQuantMatmulAllReduceNzTilingData);
    REGISTER_TILING_FOR_TILINGKEY("MMTYPE == MATMUL_ALLREDUCE_MM_TYPE_QUANT_MATMUL",
        Mc2Tiling::QuantMatmulAllReduceTilingData);
    REGISTER_TILING_FOR_TILINGKEY("(MMTYPE == MATMUL_ALLREDUCE_MM_TYPE_WEIGHT_QUANT_MATMUL) && \
    ...
    REGISTER_TILING_FOR_TILINGKEY("(MMTYPE == MATMUL_ALLREDUCE_MM_TYPE_FP_MM) && \
