...
class AclnnQuantMatmulAllReduceV4UT : public testing::TestWithParam<MatmulAllReduceApiUtParam> {
protected:
    static void SetUpTestCase()
    {
        op::SetPlatformSocVersion(op::SocVersion::ASCEND910B);
        std::cout << "AclnnQuantMatmulAllReduceV4UT SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        op::SetPlatformSocVersion(op::SocVersion::ASCEND910B);
        std::cout << "AclnnQuantMatmulAllReduceV4UT TearDown" << std::endl;
    }
};

// 测试 aclTensor 入参为 nullptr 的场景 =================================================================================
TEST_F(AclnnQuantMatmulAllReduceV4UT, aclnnGetWorkspaceSizeParamNullptr)
{
...
std::vector<MatmulAllReduceApiUtParam> casesQuantV4 {
    // 正确用例
    {"int8_pertoken", {{32, 64}, ACL_INT8, ACL_FORMAT_ND}, {{64, 128}, ACL_INT8, ACL_FORMAT_ND}, {{128}, ACL_INT32, ACL_FORMAT_ND}, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{32}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{128}, ACL_FLOAT16, ACL_FORMAT_ND}, "test_group", "sum", 0, 1, 0, 0, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, ACLNN_SUCCESS},
    {"int8_no_x1scale", {{32, 64}, ACL_INT8, ACL_FORMAT_ND}, {{64, 128}, ACL_INT8, ACL_FORMAT_ND}, {{128}, ACL_INT32, ACL_FORMAT_ND}, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_INT64, ACL_FORMAT_ND}, {{}, ACL_FLOAT16, ACL_FORMAT_ND}, {{}, ACL_FLOAT16, ACL_FORMAT_ND}, "test_group", "sum", 0, 1, 0, 0, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, ACLNN_SUCCESS},
    {"int8_bf16_output", {{32, 64}, ACL_INT8, ACL_FORMAT_ND}, {{64, 128}, ACL_INT8, ACL_FORMAT_ND}, {{128}, ACL_INT32, ACL_FORMAT_ND}, {{32, 128}, ACL_BF16, ACL_FORMAT_ND}, {{}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_BF16, ACL_FORMAT_ND}, {{128}, ACL_BF16, ACL_FORMAT_ND}, {{128}, ACL_BF16, ACL_FORMAT_ND}, "test_group", "sum", 0, 1, 0, 0, {{32, 128}, ACL_BF16, ACL_FORMAT_ND}, ACLNN_SUCCESS},
    ...
    {"float4_e1m2", {{32, 64}, ACL_FLOAT4_E1M2, ACL_FORMAT_ND}, {{64, 128}, ACL_FLOAT4_E1M2, ACL_FORMAT_ND}, {{128}, ACL_FLOAT, ACL_FORMAT_ND}, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{2, 1, 2}, ACL_FLOAT8_E8M0, ACL_FORMAT_ND}, {{128, 2, 2}, ACL_FLOAT8_E8M0, ACL_FORMAT_ND}, {{}, ACL_FLOAT16, ACL_FORMAT_ND}, {{}, ACL_FLOAT16, ACL_FORMAT_ND}, "test_group", "sum", 0, 1, 0, 0, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, ACLNN_SUCCESS},
    {"fp8_dynamic_quant", {{32, 64}, ACL_FLOAT8_E4M3FN, ACL_FORMAT_ND}, {{64, 128}, ACL_FLOAT8_E4M3FN, ACL_FORMAT_ND}, {{128}, ACL_FLOAT, ACL_FORMAT_ND}, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{32}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_FLOAT, ACL_FORMAT_ND}, {{}, ACL_FLOAT16, ACL_FORMAT_ND}, {{}, ACL_FLOAT16, ACL_FORMAT_ND}, "test_group", "sum", 0, 1, 0, 1, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, ACLNN_SUCCESS},
    ...
    {"invalid_reduce_op", {{32, 64}, ACL_INT8, ACL_FORMAT_ND}, {{64, 128}, ACL_INT8, ACL_FORMAT_ND}, {{128}, ACL_INT32, ACL_FORMAT_ND}, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{32}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{128}, ACL_FLOAT16, ACL_FORMAT_ND}, "test_group", "max", 0, 1, 0, 0, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, ACLNN_ERR_PARAM_INVALID},
    {"invalid_stream_mode_zero", {{32, 64}, ACL_INT8, ACL_FORMAT_ND}, {{64, 128}, ACL_INT8, ACL_FORMAT_ND}, {{128}, ACL_INT32, ACL_FORMAT_ND}, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{32}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{128}, ACL_FLOAT16, ACL_FORMAT_ND}, "test_group", "sum", 0, 0, 0, 0, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, ACLNN_ERR_PARAM_INVALID},
    // 失败用例：shape 冲突
    {"invalid_shape_x1_and_x2", {{32, 64}, ACL_INT8, ACL_FORMAT_ND}, {{48, 128}, ACL_INT8, ACL_FORMAT_ND}, {{128}, ACL_INT32, ACL_FORMAT_ND}, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{32}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{128}, ACL_FLOAT16, ACL_FORMAT_ND}, "test_group", "sum", 0, 1, 0, 0, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, ACLNN_ERR_PARAM_INVALID},
    // 失败用例：dtype 冲突
    {"invalid_dtype_x1", {{32, 64}, ACL_INT16, ACL_FORMAT_ND}, {{64, 128}, ACL_INT8, ACL_FORMAT_ND}, {{128}, ACL_INT32, ACL_FORMAT_ND}, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{32}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{128}, ACL_FLOAT16, ACL_FORMAT_ND}, "test_group", "sum", 0, 1, 0, 0, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, ACLNN_ERR_PARAM_INVALID},
    {"invalid_dtype_x2", {{32, 64}, ACL_INT8, ACL_FORMAT_ND}, {{64, 128}, ACL_INT16, ACL_FORMAT_ND}, {{128}, ACL_INT32, ACL_FORMAT_ND}, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{32}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_FLOAT, ACL_FORMAT_ND}, {{128}, ACL_FLOAT16, ACL_FORMAT_ND}, {{128}, ACL_FLOAT16, ACL_FORMAT_ND}, "test_group", "sum", 0, 1, 0, 0, {{32, 128}, ACL_FLOAT16, ACL_FORMAT_ND}, ACLNN_ERR_PARAM_INVALID}
};

TEST_P(AclnnQuantMatmulAllReduceV4UT, aclnnGetWorkspaceSize)
{
    auto param = GetParam();
    auto ut = OP_API_UT(
        aclnnQuantMatmulAllReduceV4,
...
INSTANTIATE_TEST_SUITE_P(
    QuantMatmulAllReduceV4,
    AclnnQuantMatmulAllReduceV4UT,
