...
protected:
    ...
    {
        std::cout << "MatmulAllReduce AclnnQuantMatmulAllReduceUT SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MatmulAllReduce AclnnQuantMatmulAllReduceUT TearDown" << std::endl;
    }
};

// 测试 aclTensor 入参为 nullptr 的场景 =================================================================================
TEST_F(AclnnQuantMatmulAllReduceUT, aclnnGetWorkspaceSizeAclTensorNull)
{
...
TEST_P(AclnnQuantMatmulAllReduceUT, aclnnGetWorkspaceSizeParamTest)
{
    auto param = GetParam();
    auto ut = OP_API_UT(
        aclnnQuantMatmulAllReduce,
