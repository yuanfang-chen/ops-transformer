...
class MatmulAllReduceAclnnNullptrTest : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "MatmulAllReduce AclnnNullptrTest SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        op::SetPlatformSocVersion(op::SocVersion::ASCEND910B);
        std::cout << "MatmulAllReduce AclnnNullptrTest TearDown" << std::endl;
    }
};

TEST_F(MatmulAllReduceAclnnNullptrTest, aclnnMatmulAllReduce)
{
...
TEST_F(MatmulAllReduceAclnnNullptrTest, aclnnMatmulAllReduceV2)
{
...
TEST_F(MatmulAllReduceAclnnNullptrTest, aclnnQuantMatmulAllReduce)
{
...
TEST_F(MatmulAllReduceAclnnNullptrTest, aclnnQuantMatmulAllReduceV2)
{
    TensorDesc x1 = {{32, 64}, ACL_INT8, ACL_FORMAT_ND};
    TensorDesc x2 = {{64, 128}, ACL_INT8, ACL_FORMAT_ND};
    TensorDesc bias = {{128}, ACL_INT32, ACL_FORMAT_ND};
...
TEST_F(MatmulAllReduceAclnnNullptrTest, aclnnQuantMatmulAllReduceV3)
{
    TensorDesc x1 = {{32, 64}, ACL_INT8, ACL_FORMAT_ND};
    TensorDesc x2 = {{64, 128}, ACL_INT8, ACL_FORMAT_ND};
    TensorDesc bias = {{128}, ACL_INT32, ACL_FORMAT_ND};
...
TEST_F(MatmulAllReduceAclnnNullptrTest, aclnnQuantMatmulAllReduceV4)
{
    TensorDesc x1 = {{32, 64}, ACL_INT8, ACL_FORMAT_ND};
    TensorDesc x2 = {{64, 128}, ACL_INT8, ACL_FORMAT_ND};
    TensorDesc bias = {{128}, ACL_INT32, ACL_FORMAT_ND};
...
TEST_F(MatmulAllReduceAclnnNullptrTest, AclnnWeightQuantMatmulAllReduce)
{
