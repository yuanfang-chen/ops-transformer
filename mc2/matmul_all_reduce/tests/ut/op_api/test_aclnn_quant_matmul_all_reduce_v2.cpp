...
protected:
    ...
    {
        std::cout << "MatmulAllReduce AclnnQuantMatmulAllReduceV2UT SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MatmulAllReduce AclnnQuantMatmulAllReduceV2UT TearDown" << std::endl;
    }
};

// 测试 aclTensor 入参为 nullptr 的场景 =================================================================================
TEST_F(AclnnQuantMatmulAllReduceV2UT, aclnnGetWorkspaceSizeAclTensorNull)
{
...
TEST_P(AclnnQuantMatmulAllReduceV2UT, aclnnGetWorkspaceSizeParamTest)
{
    auto param = GetParam();
    auto ut = OP_API_UT(
        aclnnQuantMatmulAllReduceV2,
