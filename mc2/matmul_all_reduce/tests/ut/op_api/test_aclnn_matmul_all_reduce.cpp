...
protected:
    ...
    {
        std::cout << "MatmulAllReduce AclnnMatmulAllReduceUT SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MatmulAllReduce AclnnMatmulAllReduceUT TearDown" << std::endl;
    }
};

// 测试 aclTensor 入参为 nullptr 的场景 =================================================================================
TEST_F(AclnnMatmulAllReduceUT, aclnnGetWorkspaceSizeAclTensorNull)
{
...
TEST_P(AclnnMatmulAllReduceUT, aclnnGetWorkspaceSizeParamTest)
{
    auto param = GetParam();
    auto ut = OP_API_UT(
        aclnnMatmulAllReduce,
