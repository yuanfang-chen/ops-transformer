...
protected:
    ...
    {
        std::cout << "MatmulAllReduce AclnnMatmulAllReduceV2UT SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MatmulAllReduce AclnnMatmulAllReduceV2UT TearDown" << std::endl;
    }
};

// 测试 aclTensor 入参为 nullptr 的场景 =================================================================================
TEST_F(AclnnMatmulAllReduceV2UT, aclnnGetWorkspaceSizeAclTensorNull)
{
...
TEST_P(AclnnMatmulAllReduceV2UT, aclnnGetWorkspaceSizeParamTest)
{
    auto param = GetParam();
    auto ut = OP_API_UT(
        aclnnMatmulAllReduceV2,
