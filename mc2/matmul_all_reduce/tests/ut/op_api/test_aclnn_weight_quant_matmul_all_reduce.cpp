...
protected:
    ...
    {
        std::cout << "MatmulAllReduce AclnnWeightQuantMatmulAllReduceUT SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MatmulAllReduce AclnnWeightQuantMatmulAllReduceUT TearDown" << std::endl;
    }
};

// 测试 aclTensor 入参为 nullptr 的场景 =================================================================================
TEST_F(AclnnWeightQuantMatmulAllReduceUT, aclnnGetWorkspaceSizeAclTensorNull)
{
...
TEST_P(AclnnWeightQuantMatmulAllReduceUT, aclnnGetWorkspaceSizeParamTest)
{
    auto param = GetParam();
    auto ut = OP_API_UT(
        aclnnWeightQuantMatmulAllReduce,
