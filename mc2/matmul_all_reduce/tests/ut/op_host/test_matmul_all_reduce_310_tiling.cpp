...
class MatmulAllReduce310TilingUT : public testing::TestWithParam<MatmulAllReduceHostUtParam> {
protected:
    static void SetUpTestCase()
    {
        std::cout << "MatmulAllReduce310TilingUT SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MatmulAllReduce310TilingUT TearDown" << std::endl;
    }
};

std::vector<MatmulAllReduceHostUtParam> cases310 {
    // 正确用例
...
TEST_P(MatmulAllReduce310TilingUT, arc20)
{
    auto param = GetParam();
...
INSTANTIATE_TEST_SUITE_P(
    MatmulAllReduce,
    MatmulAllReduce310TilingUT,
    testing::ValuesIn(cases310),
    PrintMatmulAllReduceHostUtParam
);
