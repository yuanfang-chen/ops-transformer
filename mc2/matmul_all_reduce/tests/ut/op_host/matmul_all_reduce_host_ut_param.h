...
protected:
    int GetDataType(const csv_map& csvMap, const std::string& dtypeKey, ge::DataType& out)
    {
    ...
    template<typename T>
    int GetTensor(const csv_map& csvMap, const std::string& shapeKey, const std::string& dtypeKey,
