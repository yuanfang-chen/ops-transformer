...
// inferShape 用例 =====================================================================================================
class MatmulAllReduceInferShapeUT : public testing::TestWithParam<MatmulAllReduceInferShapeUtParam> {
protected:
    static void SetUpTestCase()
    {
        std::cout << "MatmulAllReduceInferShapeUT SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MatmulAllReduceInferShapeUT TearDown" << std::endl;
    }
};
...
TEST_P(MatmulAllReduceInferShapeUT, inferShape)
{
    auto param = GetParam();
...
INSTANTIATE_TEST_SUITE_P(
    MatmulAllReduce,
    MatmulAllReduceInferShapeUT,
    testing::ValuesIn(casesInferShape),
    GetCaseInfoString<MatmulAllReduceInferShapeUtParam>
);

// inferDataType 用例 ==================================================================================================
class MatmulAllReduceInferDataTypeUT : public testing::TestWithParam<MatmulAllReduceInferDataTypeUtParam> {
protected:
    static void SetUpTestCase()
    {
        std::cout << "MatmulAllReduceInferDataTypeUT SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MatmulAllReduceInferDataTypeUT TearDown" << std::endl;
    }
};
...
TEST_P(MatmulAllReduceInferDataTypeUT, inferDataType)
{
    auto param = GetParam();
...
INSTANTIATE_TEST_SUITE_P(
    MatmulAllReduce,
    MatmulAllReduceInferDataTypeUT,
