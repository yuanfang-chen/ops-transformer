...
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_196611, WeightQuantMatmulAllReduceA5TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_1245187, WeightQuantMatmulAllReduceA5TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_196615, WeightQuantMatmulAllReduceA5TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_1245191, WeightQuantMatmulAllReduceA5TilingData);
...
END_TILING_DATA_DEF;
// weight fp8/hif8
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_393223, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_1441799, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_397319, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_1445895, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_401415, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_1449991, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_405511, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_1454087, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_2490383, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_3538959, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_2494479, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_3543055, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_2498575, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_3547151, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_2502671, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_3551247, WeightQuantMatmulAllReduceA5Fp8TilingData);

REGISTER_TILING_DATA_CLASS(MatmulAllReduce_339971, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_1388547, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_405507, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_1454083, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_2437131, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_3485707, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_2502667, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_3551243, WeightQuantMatmulAllReduceA5Fp8TilingData);

REGISTER_TILING_DATA_CLASS(MatmulAllReduce_344071, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_1392647, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_409607, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_1458183, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_2441231, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_3489807, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_2506767, WeightQuantMatmulAllReduceA5Fp8TilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_3555343, WeightQuantMatmulAllReduceA5Fp8TilingData);
