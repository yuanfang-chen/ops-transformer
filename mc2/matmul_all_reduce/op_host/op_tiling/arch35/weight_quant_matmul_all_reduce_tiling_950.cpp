...
uint64_t WeightQuantMatmulAllReduceTilingA5::GetTilingKey() const
{
    ...
    bool isA2ARSAG = mc2tiling::isUseAllReduceTwoShot(args_.rankDim, npuArch_, USE_ALLREDUCE_TWO_SHOT);
    const uint64_t tilingKey = GET_TPL_TILING_KEY(  \
...
ge::graphStatus WeightQuantMatmulAllReduceTilingA5::GetWorkspaceSize()
{
    ...
    if (socVersion_ == platform_ascendc::SocVersion::ASCEND910B) {
        ...
        if(mc2tiling::isUseAllReduceTwoShot(args_.rankDim, npuArch_, USE_ALLREDUCE_TWO_SHOT)){
            OP_TILING_CHECK(
...
ge::graphStatus WeightQuantMatmulAllReduceTilingA5::SetMc2Hcomm()
{
    ...
    bool isUseAllReduceTwoShot = mc2tiling::isUseAllReduceTwoShot(args_.rankDim, npuArch_, USE_ALLREDUCE_TWO_SHOT);
