...
MatmulReduceScatterFP16BF16<AType, BType, BiasType, CType>::ExecuteAicMatMulPipeline(
    GM_ADDR aGM, 
    GM_ADDR bGM, 
    GM_ADDR biasGM, 
    GM_ADDR sendBuf, 
...
TEMPLATE_CLASS_PARAMS
__aicore__ inline void
MatmulReduceScatterFP16BF16<AType, BType, BiasType, CType>::ExecuteAivCommReducePipeline(
    GM_ADDR recvGMAddr,
    GM_ADDR sendGMAddr,
    Mc2MatMulV3TilingData& tiling, 
    uint32_t count, 
