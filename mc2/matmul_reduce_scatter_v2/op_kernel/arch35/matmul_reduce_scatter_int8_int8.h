...
{
    if constexpr (IsPerToken && std::is_same<ScaleType, int64_t>::value) {
        MatMulComputReduceScatterPerToken(aGM, cGM, x1ScaleGM, nullptr, qBMmtiling, tileCnt, gmToFloat, isTail);
        DoX2Dequant();
    } else if (IsPerToken) {
