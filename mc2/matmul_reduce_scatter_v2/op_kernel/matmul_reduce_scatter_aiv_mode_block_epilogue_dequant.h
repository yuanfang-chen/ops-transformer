...
public:
    ...
    void operator() (__gm__ ElementScale *ptrScale, LayoutScale layoutScale,
                     __gm__ ElementPerTokenScale *ptrPerTokenScale, LayoutPerTokenScale layoutPerTokenScale, __gm__ ElementC *ptrBias, LayoutC layoutBias,
    ...
    // perChannel
    CATLASS_DEVICE
    void operator() (__gm__ ElementScale *ptrScale, LayoutScale layoutScale, __gm__ ElementC *ptrBias, LayoutC layoutBias,
                     __gm__ ElementC *ptrC, LayoutC layoutC, __gm__ ElementD *ptrD, LayoutD layoutD,
                     GemmCoord problemShape)
    {
        // Calculate the offset of the current block
