...
#define TPL_X_INT8_IS_PERTOKEN_SCALE_FLOAT 2
#define TPL_X_INT8_IS_PERTOKEN_SCALE_INT64 3
#define TPL_X_INT8_IS_PERCHANNEL_SCALE_FLOAT 4
#define TPL_X_INT8_IS_PERCHANNEL_SCALE_INT64 5
...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_UINT_DECL(TPL_INPUT, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, \
                        INPUT_TYPE_IS_FP8, INPUT_TYPE_IS_FP16_BF16, INPUT_TYPE_IS_INT8),
    ...
    ASCENDC_TPL_UINT_DECL(TPL_SCALETYPE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, \
                        TPL_X1_X2_DTYPE_IS_OTHER, TPL_X1_X2_DTYPE_IS_FP8E8M0, TPL_X_INT8_IS_PERTOKEN_SCALE_FLOAT, \
                        TPL_X_INT8_IS_PERTOKEN_SCALE_INT64, TPL_X_INT8_IS_PERCHANNEL_SCALE_FLOAT, TPL_X_INT8_IS_PERCHANNEL_SCALE_INT64),
);
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_BOOL_SEL(TPL_TRANSA, 0),
        ASCENDC_TPL_BOOL_SEL(TPL_TRANSB, 0, 1),
        ASCENDC_TPL_UINT_SEL(TPL_INPUT, ASCENDC_TPL_UI_LIST, INPUT_TYPE_IS_INT8),
        ASCENDC_TPL_UINT_SEL(TPL_OUTPUTDTYPE, ASCENDC_TPL_UI_LIST, OUTPUT_TYPE_IS_FP16_BF16),
        ASCENDC_TPL_UINT_SEL(TPL_SCALETYPE, ASCENDC_TPL_UI_LIST, TPL_X_INT8_IS_PERTOKEN_SCALE_FLOAT, \
                            TPL_X_INT8_IS_PERTOKEN_SCALE_INT64)),
    // int8 PerChannel
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_BOOL_SEL(TPL_ISPERBLOCK, 0),
        ASCENDC_TPL_BOOL_SEL(TPL_TRANSA, 0),
        ...
        ASCENDC_TPL_UINT_SEL(TPL_INPUT, ASCENDC_TPL_UI_LIST, INPUT_TYPE_IS_INT8),
        ASCENDC_TPL_UINT_SEL(TPL_OUTPUTDTYPE, ASCENDC_TPL_UI_LIST, OUTPUT_TYPE_IS_FP16_BF16),
        ASCENDC_TPL_UINT_SEL(TPL_SCALETYPE, ASCENDC_TPL_UI_LIST, TPL_X_INT8_IS_PERCHANNEL_SCALE_FLOAT, \
                            TPL_X_INT8_IS_PERCHANNEL_SCALE_INT64)),
);
