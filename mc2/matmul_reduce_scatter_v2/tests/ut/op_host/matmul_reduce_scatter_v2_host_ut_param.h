...
struct MatmulReduceScatterV2HostUtParamBase {
    ...
    MatmulReduceScatterV2HostUtParamBase(const csv_map& csvMap)
    {
        ...
        this->is_trans_a = stoll(ReadMap(csvMap, "is_trans_a"));
        this->is_trans_b = stoll(ReadMap(csvMap, "is_trans_b"));
        ...
        this->is_amax_out = stoll(ReadMap(csvMap, "is_amax_out"));
...
struct MatmulReduceScatterV2TilingUtParam: public MatmulReduceScatterV2HostUtParamBase {
        ...
        MatmulReduceScatterV2HostUtParamBase(csvMap)
    {
        ...
        this->coreNum = stoll(ReadMap(csvMap, "core_num"));
        this->ubsize = stoll(ReadMap(csvMap, "ubsize"));
        if(this->expectResult == ge::GRAPH_SUCCESS) {
            this->expectTilingKey = stoll(ReadMap(csvMap, "expectTilingKey"));
