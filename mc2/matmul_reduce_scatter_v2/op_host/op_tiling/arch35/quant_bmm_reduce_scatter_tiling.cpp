 ...
 */
ge::graphStatus QuantBmmReduceScatterTiling::CheckMMOutputSize()
{
    ...
    OP_TILING_CHECK(sizeOfSingleM > mc2tiling::ALL_GATHER_HCCL_MEM_LIMIT,
        OP_LOGE(opName_, "Unsupported mm output size. Even after splitting data x1 into (1, n), the size still exceeds 256MB."), return ge::GRAPH_FAILED);
...
{
    GE_ASSERT_GRAPH_SUCCESS(CheckMMOutputSize());
