 ...
 * @param [in] gmmXScaleOptional: 左矩阵的量化参数，数据类型为FLOAT32。
 * @param [in] gmmWeightScaleOptional: 右矩阵的量化参数，数据类型为FLOAT32。
 ...
 * gmmWieghtScaleOptional: pertensor场景(1,);
 * groupList: (e);
 * mmXOptional: (BS, H);
 ...
 * A = recvCounts的累加和;
 */
__attribute__((visibility("default"))) aclnnStatus aclnnQuantAlltoAllvGroupedMatMulGetWorkspaceSize(
 ...
 */
__attribute__((visibility("default"))) aclnnStatus aclnnQuantAlltoAllvGroupedMatMul(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
    aclrtStream stream);
