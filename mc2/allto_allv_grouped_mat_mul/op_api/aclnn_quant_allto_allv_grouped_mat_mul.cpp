...
extern "C" aclnnStatus aclnnInnerAlltoAllvGroupedMatMulGetWorkspaceSize(
    ...
    const aclIntArray *recvCounts, bool transGmmWeight, bool transMmWeight, int64_t groupSize, bool permuteOutFlag, int64_t gmmXQuantMode,
    ...
    uint64_t *workspaceSize, aclOpExecutor **executor)
{
    ...
    aclnnStatus ret = aclnnInnerAlltoAllvGroupedMatMulGetWorkspaceSize(
        ...
        sendCounts, recvCounts, transGmmWeight, transMmWeight, groupSize, permuteOutFlag, gmmXQuantMode, gmmWeightQuantMode,
