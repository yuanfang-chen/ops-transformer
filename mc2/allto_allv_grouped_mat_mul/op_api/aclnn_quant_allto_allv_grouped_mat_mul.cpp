...
static bool CheckQuantValid(int64_t gmmXQuantMode, int64_t gmmWeightQuantMode, const aclTensor *gmmXScaleOptional, const aclTensor *gmmWeightScaleOptional,
                           int64_t mmXQuantMode, int64_t mmWeightQuantMode, const aclTensor *mmXScaleOptional, const aclTensor *mmWeightScaleOptional) {
