...
*/
#ifndef ALLTO_ALLV_MAT_MUL_HOST_UT_PARAM_H
#define ALLTO_ALLV_MAT_MUL_HOST_UT_PARAM_H
...
struct AlltoAllvGroupedMatMulTilingUTParamBase {
    ...
    AlltoAllvGroupedMatMulTilingUTParamBase(const csv_map& csvMap)
    {
...
inline std::ostream& operator<<(std::ostream& os, const AlltoAllvGroupedMatMulTilingUTParamBase& param)
{
    return os << param.case_name;
}

struct AlltoAllvGroupedMatMulTilingUTParam : public AlltoAllvGroupedMatMulTilingUTParamBase {
    ...
    AlltoAllvGroupedMatMulTilingUTParam(const csv_map& csvMap) :
        AlltoAllvGroupedMatMulTilingUTParamBase(csvMap)
    {
...
#endif // ALLTO_ALLV_MAT_MUL_HOST_UT_PARAM_H