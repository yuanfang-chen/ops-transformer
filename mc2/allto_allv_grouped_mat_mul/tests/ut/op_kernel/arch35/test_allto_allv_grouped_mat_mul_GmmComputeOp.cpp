...
/**
 * Case7: 多 rank 场景 (epWorldSize=2)，验证 GetExpertTokenCount 跨 rank 累加
 * 基于 Case5 (5 专家，K=30, N=10)，每专家总 M=10 不变
 * sendCnt 按专家分组连续排列：sendCnt[expertIdx * epWorldSize + rank]
 * 每专家两个 rank 的 token 之和 = 10，与 Case5 一致
 * 预期输出与 Case5 完全相同
 */
TEST_F(GmmComputeOpArch35Test, Case7_MultiRank_CrossRankAccumulation)
{
    AscendC::SetKernelMode(KernelMode::AIC_MODE);
    constexpr uint32_t K = 30, N = 10, E = 5;
    constexpr uint32_t totalM = 50;
    ...
    taskTiling->H1 = K;
    taskTiling->N1 = N;
    taskTiling->epWorldSize = 2;
    taskTiling->e = E;
    // sendCnt[expertIdx * epWorldSize + rank]:
    // expert 0: r0=6, r1=4 → total=10
    // expert 1: r0=4, r1=6 → total=10
    // expert 2: r0=7, r1=3 → total=10
    // expert 3: r0=3, r1=7 → total=10
    // expert 4: r0=5, r1=5 → total=10
    taskTiling->sendCnt[0] = 6;  taskTiling->sendCnt[1] = 4;
    taskTiling->sendCnt[2] = 4;  taskTiling->sendCnt[3] = 6;
    taskTiling->sendCnt[4] = 7;  taskTiling->sendCnt[5] = 3;
    taskTiling->sendCnt[6] = 3;  taskTiling->sendCnt[7] = 7;
    taskTiling->sendCnt[8] = 5;  taskTiling->sendCnt[9] = 5;
    ...
    // 4. weight 数据 — 复用 Case5 (5x30x10 = 1500, K×N 布局)
    static const int8_t wValsKN[1500] = {
        // expert 0 (30x10)
        -120, -112, -94, -96, 16, -120, 8, 16, 16, 20,
        -112, -94, 0, 8, -120, -112, 32, 8, 8, 16,
    ...
    // 7. 校验 — 预期输出与 Case5 完全相同 (每专家总 M=10 不变)
    static const float expected[500] = {
        -12.f, 38.f, 128.f, 44.f, 10.f, 78.f, 14.f, 20.f, -18.f, 62.f,
        64.f, 12.f, 148.f, 136.f, -16.f, -56.f, -166.f, 46.f, -166.f, -2.f,
        -58.f, -114.f, 44.f, 62.f, 102.f, 10.f, -98.f, -124.f, 46.f, 194.f,
