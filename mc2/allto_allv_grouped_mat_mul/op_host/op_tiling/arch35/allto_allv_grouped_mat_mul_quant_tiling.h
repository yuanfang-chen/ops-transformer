...
protected:
    ...
    void SetGMMQuantParams(GroupedMatmulTilingData::GMMQuantTilingData &gmmQuantTilingData);
    void SetGMMArray(GroupedMatmulTilingData::GMMQuantTilingData &gmmQuantTilingData);
    void SetTilingParams(GroupedMatmulTilingData::GMMQuantTilingData &gmmQuantTilingData);
    ...
    void PrintQuantTilingData(const GroupedMatmulTilingData::GMMQuantTilingData &data) const;
