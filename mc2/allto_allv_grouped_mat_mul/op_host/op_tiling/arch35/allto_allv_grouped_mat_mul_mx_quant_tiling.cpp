...
void AlltoAllvGmmMXQuantTiling::SetTilingMxTypeParam(Mc2GroupedMatmulTilingData::GMMQuantTilingData &gmmQuantTilingData) const
{
    auto &mm = gmmQuantTilingData.mmTilingData;
...
uint64_t AlltoAllvGmmMXQuantTiling::GetDepthA1B1(uint64_t leftSize, uint64_t perDepthSize, uint64_t baseKSize, uint64_t depthInit) const
{
...
ge::graphStatus AlltoAllvGmmMXQuantTiling::CheckQuantMode() const
{
    ...
    OP_TILING_CHECK(gmmXQuantMode != MX_PERGROUP_QUANT_MODE,
        OP_LOGE(context_->GetNodeName(), "gmmXQuantMode should be 6(mx pergroup mode)."), return ge::GRAPH_FAILED);
    // gmmWeightQuantMode
    ...
    OP_TILING_CHECK(gmmWeightQuantMode != MX_PERGROUP_QUANT_MODE,
        OP_LOGE(context_->GetNodeName(), "gmmWeightQuantMode should be 6(mx pergroup mode)."),
        return ge::GRAPH_FAILED);
...
ge::graphStatus AlltoAllvGmmMXQuantTiling::CheckShareExpertQuantMode() const
{
    ...
    OP_TILING_CHECK(mmXQuantMode != MX_PERGROUP_QUANT_MODE,
        OP_LOGE(context_->GetNodeName(), "mmXQuantMode should be 6(mx pergroup mode)."), return ge::GRAPH_FAILED);
    ...
    OP_TILING_CHECK(mmWeightQuantMode != MX_PERGROUP_QUANT_MODE,
        OP_LOGE(context_->GetNodeName(), "mmWeightQuantMode should be 6(mx pergroup mode)."),
        return ge::GRAPH_FAILED);
