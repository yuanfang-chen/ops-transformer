...
ge::graphStatus AlltoAllvGmmQuantTilingBase::GetWorkspaceSize()
{
    ...
    // mx pergroup quant
    if (gmmQuantTilingData.gmmQuantParams.aQuantMode == MX_PERGROUP_MODE &&
...
void AlltoAllvGmmQuantTilingBase::SetTilingParams(Mc2GroupedMatmulTilingData::GMMQuantTilingData &gmmQuantTilingData, uint64_t M, uint64_t N, uint64_t K) const
{
    return;
}
...
ge::graphStatus AlltoAllvGmmQuantTilingBase::CheckGmmDType() const
{
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus AlltoAllvGmmQuantTilingBase::CheckMmDType() const
{
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus AlltoAllvGmmQuantTilingBase::CheckQuantMode() const
{
    return ge::GRAPH_SUCCESS;
}
