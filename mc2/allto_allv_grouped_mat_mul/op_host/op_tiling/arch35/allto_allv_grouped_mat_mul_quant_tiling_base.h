...
protected:
    ...
    // quant base
    virtual ge::graphStatus CheckGmmDType() {return ge::GRAPH_SUCCESS;};
    virtual ge::graphStatus CheckMmDType() {return ge::GRAPH_SUCCESS;};
    virtual ge::graphStatus CheckQuantMode() {return ge::GRAPH_SUCCESS;};
    ...
    virtual void SetTilingParams(Mc2GroupedMatmulTilingData::GMMQuantTilingData &gmmQuantTilingData, uint64_t M, uint64_t N, uint64_t K) {};
