...
- **参数说明**
    ...
    <td><ul><li>数据类型与gmmWeight保持一致。</li><li>支持2维，shape为(BSK, H1)。</li></ul></td>
    ...
    <td><ul><li>当前版本暂不支持，需传nullptr。</li></ul></td>
    <td>INT32、INT64</td>
    <td>ND</td>
    <td>1</td>
    <td>×</td>
    ...
    <td><ul><li>需与mmWeightOptional同时传入或同为nullptr。</li><li>数据类型与gmmX保持一致。</li><li>支持2维，shape为(BS, H2)。</li></ul></td>
    <td>FLOAT16、BFLOAT16</td>
    <td>ND</td>
    <td>2</td>
    <td>×</td>
    ...
    <td><ul><li>需与mmXOptional同时传入或同为nullptr。</li><li>数据类型与gmmX保持一致。</li><li>支持2维，shape为(H2, N2)。</li></ul></td>
    <td>FLOAT16、BFLOAT16</td>
    <td>ND</td>
    <td>2</td>
    <td>×</td>
    ...
    <td><ul><li>字符串长度需大于0，小于128。</li></ul></td>
    <td>STRING</td>
    <td>-</td>
    <td>-</td>
    <td>-</td>
    ...
    <td><ul><li>true表示需要转置，false表示不转置。</li></ul></td>
    <td>BOOL</td>
    <td>-</td>
    <td>-</td>
    <td>-</td>
    ...
    <td><ul><li>true表明需要输出permuteOutOptional，false表明不需要输出。</li></ul></td>
    <td>BOOL</td>
    <td>-</td>
    <td>-</td>
    <td>-</td>
    ...
    <td><ul><li>数据类型与输入gmmX保持一致。</li><li>支持2维，shape为(A, N1)。</li></ul></td>
    <td>FLOAT16、BFLOAT16</td>
    <td>ND</td>
    <td>2</td>
    <td>×</td>
    ...
    <td><ul><li>数据类型与gmmX保持一致。</li><li>仅当permuteOutFlag为true时输出，否则需传nullptr。</li></ul></td>
    <td>FLOAT16、BFLOAT16</td>
    <td>ND</td>
    <td>2</td>
    <td>×</td>
