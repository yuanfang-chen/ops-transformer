...
class Arch32TilingTest : public testing::TestWithParam<QuantReduceScatterTestParam> {
protected:
    static void SetUpTestCase()
    {
        std::cout << "TestQuantReduceScatter Arch32TilingTest SetUp." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "TestQuantReduceScatter Arch32TilingTest TearDown." << std::endl;
    }
};
...
TEST_P(Arch32TilingTest, QuantReduceScatterGeneralCasesTest)
{
    auto param = GetParam();
    auto tilingContextPara = BuildTilingContextPara(param);
...
TEST_F(Arch32TilingTest, QuantReduceScatterGeneralCasesMultiThreadTest)
{
    TestExecMultiThread(g_testCases, sizeof(g_testCases) / sizeof(QuantReduceScatterTestParam), 3);
}

INSTANTIATE_TEST_CASE_P(QuantReduceScatterTilingUT, Arch32TilingTest, testing::ValuesIn(g_testCases));
