...
TEST_P(QuantReduceScatterArch32TilingTest, QuantReduceScatterGeneralCasesTest)
{
    auto param = GetParam();
    auto tilingContextPara = BuildTilingContextPara(param);
...
TEST_F(QuantReduceScatterArch32TilingTest, QuantReduceScatterGeneralCasesMultiThreadTest)
{
