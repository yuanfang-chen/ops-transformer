...
TEST_P(QuantReduceScatterArch35TilingTest, QuantReduceScatterGeneralCasesTest)
{
    auto param = GetParam();
    auto tilingContextPara = BuildTilingContextPara(param);
...
TEST_F(QuantReduceScatterArch35TilingTest, QuantReduceScatterGeneralCasesMultiThreadTest)
{
