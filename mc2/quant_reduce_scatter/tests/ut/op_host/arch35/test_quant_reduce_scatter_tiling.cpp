...
class Arch35TilingTest : public testing::TestWithParam<QuantReduceScatterTestParam> {
protected:
    static void SetUpTestCase()
    {
        std::cout << "TestQuantReduceScatter Arch35TilingTest SetUp." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "TestQuantReduceScatter Arch35TilingTest TearDown." << std::endl;
    }
};
...
TEST_P(Arch35TilingTest, QuantReduceScatterGeneralCasesTest)
{
    auto param = GetParam();
    auto tilingContextPara = BuildTilingContextPara(param);
...
TEST_F(Arch35TilingTest, QuantReduceScatterGeneralCasesMultiThreadTest)
{
    TestExecMultiThread(g_testCases, sizeof(g_testCases) / sizeof(QuantReduceScatterTestParam), 3);
}

INSTANTIATE_TEST_CASE_P(QuantReduceScatterTilingUT, Arch35TilingTest, testing::ValuesIn(g_testCases));
