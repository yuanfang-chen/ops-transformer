...
// setup & teardown
class Arch32TilingTest : public testing::TestWithParam<QuantAllReduceTestParam> {
protected:
    static void SetUpTestCase()
    {
        std::cout << "TestQuantAllReduce Arch32TilingTest SetUp." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "TestQuantAllReduce Arch32TilingTest TearDown." << std::endl;
    }
};
...
TEST_P(Arch32TilingTest, QuantAllReduceGeneralCases)
{
    auto param = GetParam();
    auto tilingContextPara = BuildTilingContextPara(param);
...
TEST_F(Arch32TilingTest, QuantAllReduceGeneralCasesMultiThread)
{
    TestExecMultiThread(g_testCases, sizeof(g_testCases) / sizeof(QuantAllReduceTestParam), 3);
}

INSTANTIATE_TEST_CASE_P(QuantAllReduceTilingUT, Arch32TilingTest, testing::ValuesIn(g_testCases));
