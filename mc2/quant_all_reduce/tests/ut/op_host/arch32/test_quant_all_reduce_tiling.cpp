...
// setup & teardown
class QuantAllReduceArch32TilingTest : public testing::TestWithParam<QuantAllReduceTestParam> {
protected:
    static void SetUpTestCase()
    {
        std::cout << "QuantAllReduceArch32TilingTest SetUp." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "QuantAllReduceArch32TilingTest TearDown." << std::endl;
    }
};
...
TEST_P(QuantAllReduceArch32TilingTest, QuantAllReduceGeneralCases)
{
    auto param = GetParam();
    auto tilingContextPara = BuildTilingContextPara(param);
...
TEST_F(QuantAllReduceArch32TilingTest, QuantAllReduceGeneralCasesMultiThread)
{
    TestExecMultiThread(g_testCases, sizeof(g_testCases) / sizeof(QuantAllReduceTestParam), 3);
}

INSTANTIATE_TEST_CASE_P(QuantAllReduceTilingUT, QuantAllReduceArch32TilingTest, testing::ValuesIn(g_testCases));
