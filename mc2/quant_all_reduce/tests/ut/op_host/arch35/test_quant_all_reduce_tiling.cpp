...
// setup & teardown
class Arch35TilingTest : public testing::TestWithParam<QuantAllReduceTestParam> {
protected:
    static void SetUpTestCase()
    {
        std::cout << "TestQuantAllReduce Arch35TilingTest SetUp." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "TestQuantAllReduce Arch35TilingTest TearDown." << std::endl;
    }
};
...
TEST_P(Arch35TilingTest, QuantAllReduceGeneralCases)
{
    auto param = GetParam();
    auto tilingContextPara = BuildTilingContextPara(param);
...
TEST_F(Arch35TilingTest, QuantAllReduceGeneralCasesMultiThread)
{
    TestExecMultiThread(g_testCases, sizeof(g_testCases) / sizeof(QuantAllReduceTestParam), 3);
}

INSTANTIATE_TEST_CASE_P(QuantAllReduceTilingUT, Arch35TilingTest, testing::ValuesIn(g_testCases));
