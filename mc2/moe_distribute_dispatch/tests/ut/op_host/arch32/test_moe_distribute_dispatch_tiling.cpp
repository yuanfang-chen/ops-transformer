...
TEST_F(Arch32TilingTest, A2Quant0Layered)
{
    struct MoeDistributeDispatchCompileInfo {};
    MoeDistributeDispatchCompileInfo compileInfo;
    uint64_t coreNum = 48;
...
TEST_F(Arch32TilingTest, A2Quant0)
{
    struct MoeDistributeDispatchCompileInfo {};
    MoeDistributeDispatchCompileInfo compileInfo;
    uint64_t coreNum = 48;
...
// 可选传入默认值   除了quant_mode = 0   
TEST_F(Arch32TilingTest, A2GlobalBs)
{
    struct MoeDistributeDispatchCompileInfo {};
    MoeDistributeDispatchCompileInfo compileInfo;
    uint64_t coreNum = 48;
...
TEST_F(Arch32TilingTest, A2ShapeAndEpRankId)
{
    struct MoeDistributeDispatchCompileInfo {};
    MoeDistributeDispatchCompileInfo compileInfo;
    uint64_t coreNum = 48;
...
TEST_F(Arch32TilingTest, A2MoeExpertNum)
{
    struct MoeDistributeDispatchCompileInfo {};
    MoeDistributeDispatchCompileInfo compileInfo;
    uint64_t coreNum = 48;
