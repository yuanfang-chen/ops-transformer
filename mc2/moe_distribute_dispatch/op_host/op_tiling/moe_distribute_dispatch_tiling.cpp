...
static ge::graphStatus CheckAttrPointersNotNull(const char *nodeName, const MoeDistributeDispatch &attrPtrs)
{
...
static ge::graphStatus CheckAttrValuesValid(const char *nodeName, const MoeDistributeDispatch &attrPtrs, std::string &groupTp)
{
    ...
    MoeDistributeDispatchTilingData &tilingData, std::string &groupEp, std::string &groupTp)
{
    ...
    MoeDistributeDispatch attrPtrs;  
