...
#define TemplateDispatchTypeClass XType, ExpandXOutType, StaticQuant, DynamicQuant, IsSmoothScaleExist, IsNeedAllgather
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::Init(
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::QuantInit(GM_ADDR scales)
{
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::SendToSharedExpert()
{
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::CalTokenSendExpertCnt(uint32_t dstExpertId, int32_t calCnt,
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::SplitToCore(uint32_t curSendCnt, uint32_t curUseAivNum, 
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::SendToMoeExpert()
{
...
*/
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::AlltoAllDispatch()
{
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::SetStatus()
{
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::QuantProcess(uint32_t expertIndex)
{
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::WaitDispatch()
{
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::GetCumSum(LocalTensor<int32_t>& outLocal, int32_t totalCount)
{
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::CreateZeroTensor(LocalTensor<uint32_t> &outLocal)
{
    TBuf<> outBuf;
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::LocalWindowCopy()
{
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::AllGatherSetStatusAndWait()
{
    PipeBarrier<PIPE_ALL>();
    if(startExpertId_ >=  totalExpertNum_) {
        return;
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::AllgatherProcessOut()
{
    if(startExpertId_ >=  totalExpertNum_) {
        return;
    }
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::UpdateMultiMoeTokenNumsOut()
{
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::InitBufferWait()
{
    tpipe_->Reset();
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::UpdateTokenNumsOut()
{
...
template <TemplateDispatchTypeClass>
__aicore__ inline void MoeDistributeDispatch<TemplateDispatchTypeClass>::Process()
{
