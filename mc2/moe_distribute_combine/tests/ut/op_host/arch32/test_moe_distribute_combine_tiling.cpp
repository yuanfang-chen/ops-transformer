...
TEST_F(Arch32TilingTest, A2Layered)
{
    struct MoeDistributeCombineCompileInfo {};
    MoeDistributeCombineCompileInfo compileInfo;
    std::string epGroup("epGroup");
...
TEST_F(Arch32TilingTest, A2Shape)
{
    struct MoeDistributeCombineCompileInfo {};
    MoeDistributeCombineCompileInfo compileInfo;
    std::string epGroup("epGroup");
...
TEST_F(Arch32TilingTest, A2EpRankId)
{
    struct MoeDistributeCombineCompileInfo {};
    MoeDistributeCombineCompileInfo compileInfo;
    std::string epGroup("epGroup");
...
TEST_F(Arch32TilingTest, A2Int8Quant)
{
    struct MoeDistributeCombineCompileInfo {};
    MoeDistributeCombineCompileInfo compileInfo;
    std::string epGroup("epGroup");
...
TEST_F(Arch32TilingTest, A2InvalidCommQuantMode)
{
    struct MoeDistributeCombineCompileInfo {};
    MoeDistributeCombineCompileInfo compileInfo;
    std::string epGroup("epGroup");
