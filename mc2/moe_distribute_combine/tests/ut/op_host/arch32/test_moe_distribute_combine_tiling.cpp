...
TEST_F(Arch32TilingTest, MoeDistributeDispatchA2)
{
    struct MoeDistributeCombineCompileInfo {};
    MoeDistributeCombineCompileInfo compileInfo;
    std::string epGroup("epGroup");
...
TEST_F(Arch32TilingTest, MoeDistributeDispatchA2Layered)
{
    struct MoeDistributeCombineCompileInfo {};
    MoeDistributeCombineCompileInfo compileInfo;
    std::string epGroup("epGroup");
...
TEST_F(Arch32TilingTest, MoeDistributeDispatchA2Shape)
{
    struct MoeDistributeCombineCompileInfo {};
    MoeDistributeCombineCompileInfo compileInfo;
    std::string epGroup("epGroup");
...
TEST_F(Arch32TilingTest, MoeDistributeDispatchA2EpRankId)
{
    struct MoeDistributeCombineCompileInfo {};
    MoeDistributeCombineCompileInfo compileInfo;
    std::string epGroup("epGroup");
...
TEST_F(Arch32TilingTest, MoeDistributeDispatchA2Int8Quant)
{
    struct MoeDistributeCombineCompileInfo {};
    MoeDistributeCombineCompileInfo compileInfo;
    std::string epGroup("epGroup");
...
TEST_F(Arch32TilingTest, MoeDistributeDispatchA2InvalidCommQuantMode)
{
    struct MoeDistributeCombineCompileInfo {};
    MoeDistributeCombineCompileInfo compileInfo;
    std::string epGroup("epGroup");
