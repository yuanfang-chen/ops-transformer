...
void NnopbaseGetOutputTensorAddr(void *executor, const size_t index, void **addr);
void NnopbaseGetInputTensorAddr(void *executor, const size_t index, void **addr);
void NnopbaseSetInputTensorAddr(void *executor, const size_t index, const void *const addr);
