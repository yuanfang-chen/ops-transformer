...
TEST_F(AllGatherMatmulArch32TilingTest, Float16Test1)
{
    ...
    gert::TilingContextPara tilingContextPara("AllGatherMatmul",
        ...
        {
            {{{4096, 3904}, {512, 3904}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{4096, 12288}, {512, 12288}}, ge::DT_FLOAT16, ge::FORMAT_ND},
        },
        {
...
TEST_F(AllGatherMatmulArch32TilingTest, Float16Test2)
{
    ...
    gert::TilingContextPara tilingContextPara("AllGatherMatmul",
        ...
        {
            {{{16384, 1536}, {2048, 1536}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{16384, 4096}, {2048, 4096}}, ge::DT_FLOAT16, ge::FORMAT_ND},
        },
        {
            {"group", Ops::Transformer::AnyValue::CreateFrom<std::string>("group")},
            {"is_trans_a", Ops::Transformer::AnyValue::CreateFrom<bool>(false)},
...
TEST_F(AllGatherMatmulArch32TilingTest, Float16Test3)
{
    ...
    gert::TilingContextPara tilingContextPara("AllGatherMatmul",
        ...
        {
            {{{2621440, 10240}, {327680, 10240}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{2621440, 15360}, {327680, 15360}}, ge::DT_FLOAT16, ge::FORMAT_ND},
        },
        {
            {"group", Ops::Transformer::AnyValue::CreateFrom<std::string>("group")},
            {"is_trans_a", Ops::Transformer::AnyValue::CreateFrom<bool>(false)},
...
TEST_F(AllGatherMatmulArch32TilingTest, Float16TestL2cache)
{
    ...
    gert::TilingContextPara tilingContextPara("AllGatherMatmul",
        ...
        {
            {{{65536, 12288}, {8192, 12288}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{65536, 5120}, {8192, 5120}}, ge::DT_FLOAT16, ge::FORMAT_ND},
        },
        {
            {"group", Ops::Transformer::AnyValue::CreateFrom<std::string>("group")},
            {"is_trans_a", Ops::Transformer::AnyValue::CreateFrom<bool>(false)},
...
TEST_F(AllGatherMatmulArch32TilingTest, N0)
{
    ...
    gert::TilingContextPara tilingContextPara("AllGatherMatmul",
        ...
        {
            {{{8192, 0}, {1024, 0}}, ge::DT_FLOAT16, ge::FORMAT_ND},
            {{{8192, 256}, {1024, 256}}, ge::DT_FLOAT16, ge::FORMAT_ND},
        },
        {
            {"group", Ops::Transformer::AnyValue::CreateFrom<std::string>("group")},
            {"is_trans_a", Ops::Transformer::AnyValue::CreateFrom<bool>(false)},
