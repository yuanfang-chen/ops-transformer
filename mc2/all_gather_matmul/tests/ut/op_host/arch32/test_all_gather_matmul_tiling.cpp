...
TEST_F(AllGatherMatmulTiling, Float16Test1)
{
...
TEST_F(AllGatherMatmulTiling, Float16Test2)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulTiling, Float16Test3)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulTiling, Bfloat16)
{
    // tilingFunc simulate
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulTiling, Float16TestL2cache)
{
    // tilingFunc simulate
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulTiling, N0)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
