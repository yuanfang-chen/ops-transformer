...
TEST_F(Arch32TilingTest, AllGatherMatmulFloat16Test1)
{
...
TEST_F(Arch32TilingTest, AllGatherMatmulFloat16Test2)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(Arch32TilingTest, AllGatherMatmulFloat16Test3)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(Arch32TilingTest, AllGatherMatmulBfloat16)
{
    // tilingFunc simulate
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(Arch32TilingTest, AllGatherMatmulFloat16TestL2cache)
{
    // tilingFunc simulate
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(Arch32TilingTest, AllGatherMatmulN0)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
