...
struct AllGatherMatmulInferShapeUtParam: public AllGatherMatmulHostUtParamBase {
    gert::TilingContextPara::TensorDescription x1 = ID_DEFAULT;
    gert::TilingContextPara::TensorDescription x2 = ID_DEFAULT;
    gert::TilingContextPara::TensorDescription bias = ID_DEFAULT;
    gert::TilingContextPara::TensorDescription y = ID_DEFAULT;
    gert::TilingContextPara::TensorDescription gather_out = ID_DEFAULT;
...
struct AllGatherMatmulInferDataTypeUtParam: public AllGatherMatmulHostUtParamBase {
        ...
        AllGatherMatmulHostUtParamBase(csvMap)
    {
        ...
        if(this->expectResult == ge::GRAPH_SUCCESS) {
            ...
            GetDataType(csvMap, "expect_gather_out_dtype", gather_out);
        }
    }
};
