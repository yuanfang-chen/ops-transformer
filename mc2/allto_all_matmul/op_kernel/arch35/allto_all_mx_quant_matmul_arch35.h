...
private:
    ...
    static constexpr uint64_t ALIGN_BYTES = 512UL;
    ...
    GM_ADDR workspaceGM, AlltoAllMatmulTilingDataType *tilingData, TPipe *tPipe)
{
    ...
    x1ScaleLen = CeilDiv(x1ScaleLen, ALIGN_BYTES) * ALIGN_BYTES; // 对齐
...
AlltoAllMxQuantMatmulArch35<SchedulerType, SchedulerContextType, AlltoAllMatmulTilingDataType>::ProcessScale(){
    ...
    pipeLineContext_.scaleTransposeContext->nextSrcBlockOffset = (uint64_t)mc2Tiling_.rankM / mc2Tiling_.rankDim * rankKdivByGroupSize;
