...
AlltoAllMxQuantMatmulArch35<SchedulerType, SchedulerContextType, AlltoAllMatmulTilingDataType>::ProcessTile(uint32_t taskCnt)
{
    ...
    pipeLineContext_.computationContext->baseData.aGM = permuteOutGM_;
    ...
    pipeLineContext_.computationContext->baseData.b_offset = 0UL;
    pipeLineContext_.computationContext->baseData.c_offset =
        (uint64_t)mc2Tiling_.tileM * (uint64_t)mc2Tiling_.rankN * sizeof(DTYPE_Y);
    pipeLineContext_.computationContext->additionalData.x1_scale = x1Scale_;
    pipeLineContext_.computationContext->additionalData.x1_scale_offset = 
...
AlltoAllMxQuantMatmulArch35<SchedulerType, SchedulerContextType, AlltoAllMatmulTilingDataType>::ProcessTail(uint32_t taskCnt)
{
    ...
    pipeLineContext_.computationContext->baseData.aGM = permuteOutGM_ + tileCntMultitileMMultiRankK * sizeof(DTYPE_X1) * mc2Tiling_.rankDim;
    pipeLineContext_.computationContext->baseData.bGM = x2_;
    ...
    pipeLineContext_.computationContext->additionalData.x1_scale =
