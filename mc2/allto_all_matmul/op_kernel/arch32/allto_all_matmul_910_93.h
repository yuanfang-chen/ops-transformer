...
/*!
 * \file allto_all_matmul_910_93.h
 * \brief
 */

#ifndef ALLTO_ALL_MATMUL_910_93_H
#define ALLTO_ALL_MATMUL_910_93_H

#include "allto_all_matmul_tiling_data_910_93.h"
...
class AlltoAllMatmulA3
{
public:
    __aicore__ inline AlltoAllMatmulA3(SchedulerType* pipeLine) : pipeLine_(pipeLine){};
...
template <typename SchedulerType, typename SchedulerContextType, typename AlltoAllMatmulTilingDataType>
__aicore__ inline void AlltoAllMatmulA3<SchedulerType, SchedulerContextType, AlltoAllMatmulTilingDataType>::Init(GM_ADDR x1, GM_ADDR x2, GM_ADDR bias, GM_ADDR y,
...
template <typename SchedulerType, typename SchedulerContextType, typename AlltoAllMatmulTilingDataType>
__aicore__ inline void AlltoAllMatmulA3<SchedulerType, SchedulerContextType, AlltoAllMatmulTilingDataType>::Process()
{
    auto&& mc2Tiling_ = tilingData_->alltoAllMatmulTilingInfo;
    // 启动主块流水
...
template <typename SchedulerType, typename SchedulerContextType, typename AlltoAllMatmulTilingDataType>
__aicore__ inline void AlltoAllMatmulA3<SchedulerType, SchedulerContextType, AlltoAllMatmulTilingDataType>::ProcessTile(uint32_t taskCnt)
{
    auto&& mc2Tiling_ = tilingData_->alltoAllMatmulTilingInfo;
    // 复用的变量
...
template <typename SchedulerType, typename SchedulerContextType, typename AlltoAllMatmulTilingDataType>
__aicore__ inline void AlltoAllMatmulA3<SchedulerType, SchedulerContextType, AlltoAllMatmulTilingDataType>::ProcessTail(uint32_t taskCnt)
{
    auto&& mc2Tiling_ = tilingData_->alltoAllMatmulTilingInfo;
    // 复用的变量
...
template <typename SchedulerType, typename SchedulerContextType, typename AlltoAllMatmulTilingDataType>
__aicore__ inline void AlltoAllMatmulA3<SchedulerType, SchedulerContextType, AlltoAllMatmulTilingDataType>::ProcessPipeLine(uint32_t taskCnt)
{
