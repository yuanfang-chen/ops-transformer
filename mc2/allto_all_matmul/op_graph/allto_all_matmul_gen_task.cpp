 	                                    ...
 	                                    std::vector<std::vector<uint8_t>> &tasks)
{
    ...
    return Mc2GenTaskUtils::CommonKFCMc2GenTask(context, tasks, AlltoAllMatmulGenTaskCallback);
}

IMPL_OP_CT(AlltoAllMatmul).CalcOpParam(AlltoAllMatmulCalcOpParamFunc).GenerateTask(AlltoAllMatmulGenTaskFunc);
