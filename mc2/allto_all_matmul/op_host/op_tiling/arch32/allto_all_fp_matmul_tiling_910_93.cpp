...
namespace {
constexpr uint32_t ATTR_GROUP_INDEX = 0; // 设置Hccl通信域group的index
}
...
bool AllToAllFpMatmulTilingBaseA3::IsCapable()
{
    ...
    if ((mode == QuantMode::NON_QUANT) && (socVersionStr == "Ascend910_93")) {
...
ge::graphStatus AllToAllFpMatmulTilingBaseA3::DoMMTiling()
{
    ...
    Mc2MMRegisterCfg registerCfg{"Mc2MatMulV3", ascendcPlatForm.GetSocVersion(), priorities};
 ...
 * @return ge::graphStatus
 */
ge::graphStatus AllToAllFpMatmulTilingBaseA3::DoMatmulV3Tiling(Mc2MatmulHelper::Mc2MatmulTilingCfg &tilingCfg,
...
ge::graphStatus AllToAllFpMatmulTilingBaseA3::SetHcclTiling()
{
    ...
    OP_TILING_CHECK(mc2CcTilingConfig.GetTiling(localTilingData_.mc2InitTiling) != 0,                  \
                    ...
                    return ge::GRAPH_FAILED);
    OP_TILING_CHECK(mc2CcTilingConfig.GetTiling(localTilingData_.mc2CcTilingV1) != 0,                  \
...
REGISTER_TILING_TEMPLATE_WITH_SOCVERSION(AlltoAllMatmul, AllToAllFpMatmulTilingBaseA3,
                                         static_cast<int32_t>(platform_ascendc::SocVersion::ASCEND910_93), 0);
} // namespace MC2Tiling
