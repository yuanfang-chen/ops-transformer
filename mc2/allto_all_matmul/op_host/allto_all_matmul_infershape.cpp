...
/**
 * @brief 静态shape图shape合法性校验
 *
 * @param context
 * @param shape
 */
static ge::graphStatus CheckShapeForStaticGraph(const gert::InferShapeContext* context, AlltoAllMatmulShapeInfo& shape)
{
...
static ge::graphStatus CheckShapeForAlltoAllMatmul(const gert::InferShapeContext* context, AlltoAllMatmulShapeInfo& shape)
{
    ...
    if (shape.m != NUM_MINUS_ONE) {
        ...
        CheckShapeForStaticGraph(context, shape);
    }
