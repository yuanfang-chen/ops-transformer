...
public:
    explicit AlltoAllMatmul(const char *name) : OpDef(name)
    {
        ...
        aicoreConfig_910_93.Output("all2all_out")
            ...
            .DataType({ge::DT_FLOAT16, ge::DT_BF16})
            .FormatList({ge::FORMAT_ND});
        aicoreConfig_910_93.Attr("group").AttrType(REQUIRED).String();
        aicoreConfig_910_93.Attr("world_size").AttrType(REQUIRED).Int();
        aicoreConfig_910_93.Attr("all2all_axes").AttrType(OPTIONAL).ListInt({-2, -1});
        aicoreConfig_910_93.Attr("y_dtype").AttrType(OPTIONAL).Int(static_cast<int64_t>(ge::DT_UNDEFINED));
        aicoreConfig_910_93.Attr("x1_quant_mode").AttrType(OPTIONAL).Int(0);
        aicoreConfig_910_93.Attr("x2_quant_mode").AttrType(OPTIONAL).Int(0);
        aicoreConfig_910_93.Attr("comm_quant_mode").AttrType(OPTIONAL).Int(0);
        aicoreConfig_910_93.Attr("x1_quant_dtype").AttrType(OPTIONAL).Int(static_cast<int64_t>(ge::DT_UNDEFINED));
        aicoreConfig_910_93.Attr("comm_quant_dtype").AttrType(OPTIONAL).Int(static_cast<int64_t>(ge::DT_UNDEFINED));
        aicoreConfig_910_93.Attr("transpose_x1").AttrType(OPTIONAL).Bool(false);
        aicoreConfig_910_93.Attr("transpose_x2").AttrType(OPTIONAL).Bool(false);
        aicoreConfig_910_93.Attr("group_size").AttrType(OPTIONAL).Int(0);
        aicoreConfig_910_93.Attr("alltoall_out_flag").AttrType(OPTIONAL).Bool(true);
