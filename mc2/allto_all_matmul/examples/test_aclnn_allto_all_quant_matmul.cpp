...
int launchOneThreadAlltoAllQuantMatmul(Args &args)
{
    ...
    std::vector<float> x1HostData(x1ShapeSize, 1.0f);
    std::vector<int8_t> x2HostData(x2ShapeSize, 1);
    std::vector<float> biasHostData(biasShapeSize, 1.0f);
    std::vector<float> x2ScaleHostData(x2ScaleShapeSize, 1.0f);
    std::vector<float> outHostData(outShapeSize, 0.0f);
    std::vector<float> allToAllOutHostData(allToAllOutShapeSize, 0.0f);
