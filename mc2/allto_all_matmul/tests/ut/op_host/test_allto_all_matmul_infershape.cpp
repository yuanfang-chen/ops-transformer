...
TEST_F(AlltoAllMatmulInfershape, infer_shape_for_8p) {
    gert::StorageShape x1_shape = {{228344, 1152}, {}};
    gert::StorageShape x2_shape = {{9216, 3072}, {}};
    ...
    std::vector<std::vector<int64_t>> expertOutputShape = {{28543, 3072}, {28543, 9216}};
    Mc2Hcom::MockValues hcomTopologyMockValues{{"rankNum", 8}};
    Mc2ExecuteTestCase(infershapeContextPara, hcomTopologyMockValues, ge::GRAPH_SUCCESS, expertOutputShape);
}

TEST_F(AlltoAllMatmulInfershape, infer_shape_for_4p) {
    gert::StorageShape x1_shape = {{228344, 1152}, {}};
    gert::StorageShape x2_shape = {{4608, 3072}, {}};
    gert::StorageShape bias_shape = {{}, {}};
    gert::StorageShape all2all_out_shape = {{}, {}};
    gert::StorageShape output_shape = {{}, {}};
    ...
    std::vector<std::vector<int64_t>> expertOutputShape = {{57086, 3072}, {57086, 4608}};
...
TEST_F(AlltoAllMatmulInfershape, infer_shape_for_dynamic_shape) {
    gert::StorageShape x1_shape = {{228344, -1}, {}};
    gert::StorageShape x2_shape = {{-2, 3072}, {}};
    gert::StorageShape bias_shape = {{}, {}};
    gert::StorageShape all2all_out_shape = {{}, {}};
    gert::StorageShape output_shape = {{}, {}};
    ...
    std::vector<std::vector<int64_t>> expertOutputShape = {{114172, 3072}, {114172, -2}};
    Mc2Hcom::MockValues hcomTopologyMockValues{{"rankNum", 2}};
    Mc2ExecuteTestCase(infershapeContextPara, hcomTopologyMockValues, ge::GRAPH_FAILED, expertOutputShape);
}
