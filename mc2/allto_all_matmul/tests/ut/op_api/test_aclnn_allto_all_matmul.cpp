...
protected:
    ...
    static void TearDownTestCase() { cout << "test_aclnn_allto_all_matmul TearDown" << endl; }
};
...
static AlltoAllMatmulAclnnTestParam cases_params[] = {
    // 正常用例 12条 （完整正常用例为24条，alltoalloutput不为空场景待补充）
    // ========================bfloat16 系列（6条）========================
    // x和output为bfloat16，按bias分组
    // 1. Bias=BF16 (2)
    {"test_aclnn_allto_all_matmul_bf16_biasbf16_nd_notrans_01", {256, 128}, {128, 256}, {256}, {256, 256}, {},
     ...
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_SUCCESS},
    {"test_aclnn_allto_all_matmul_bf16_biasbf16_nd_trans_03", {256, 128}, {256, 128}, {256}, {256, 256}, {},
     ACL_BF16, ACL_BF16, ACL_BF16, ACL_BF16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, true, ACLNN_SUCCESS},

    // 2. Bias=FLOAT32 (2)
    {"test_aclnn_allto_all_matmul_bf16_biasf32_nd_notrans_09", {256, 128}, {128, 256}, {256}, {256, 256}, {},
     ACL_BF16, ACL_BF16, ACL_FLOAT, ACL_BF16, ACL_DT_UNDEFINED, 
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_SUCCESS},
    {"test_aclnn_allto_all_matmul_bf16_biasf32_nd_trans_11", {256, 128}, {256, 128}, {256}, {256, 256}, {},
     ACL_BF16, ACL_BF16, ACL_FLOAT, ACL_BF16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, true, ACLNN_SUCCESS},

    // 3. Bias=Null (2) 
    {"test_aclnn_allto_all_matmul_bf16_biasnull_nd_notrans_17", {256, 128}, {128, 256}, {}, {256, 256}, {},
     ACL_BF16, ACL_BF16, ACL_DT_UNDEFINED, ACL_BF16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_SUCCESS},
    {"test_aclnn_allto_all_matmul_bf16_biasnull_nd_trans_19", {256, 128}, {256, 128}, {}, {256, 256}, {},
     ACL_BF16, ACL_BF16, ACL_DT_UNDEFINED, ACL_BF16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, true, ACLNN_SUCCESS},
    ...
    // 1. Bias=FP16 (2)
    {"test_aclnn_allto_all_matmul_fp16_biasfp16_nd_notrans_01", {256, 128}, {128, 256}, {256}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_SUCCESS},
    {"test_aclnn_allto_all_matmul_fp16_biasfp16_nd_trans_03", {256, 128}, {256, 128}, {256}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, true, ACLNN_SUCCESS},
    
    // 2. Bias=FLOAT32 (2)
    {"test_aclnn_allto_all_matmul_fp16_biasf32_nd_notrans_09", {256, 128}, {128, 256}, {256}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_SUCCESS},
    {"test_aclnn_allto_all_matmul_fp16_biasf32_nd_trans_11", {256, 128}, {256, 128}, {256}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, true, ACLNN_SUCCESS},

    // 3. Bias=Null (2) 
    {"test_aclnn_allto_all_matmul_fp16_biasnull_nd_notrans_17", {256, 128}, {128, 256}, {}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_DT_UNDEFINED, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_SUCCESS},
    {"test_aclnn_allto_all_matmul_fp16_biasnull_nd_trans_19", {256, 128}, {256, 128}, {}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_DT_UNDEFINED, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, true, ACLNN_SUCCESS},
    ...
    {"test_aclnn_allto_all_matmul_x1dtype_invalid_00", {256, 128}, {128, 256}, {256}, {256, 256}, {},
     ACL_INT8, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_ERR_PARAM_INVALID},

    // 2. x2 dtype不合法 (ACL_UINT8)
    {"test_aclnn_allto_all_matmul_x2dtype_invalid_01", {256, 128}, {128, 256}, {256}, {256, 256}, {},
     ACL_FLOAT16, ACL_UINT8, ACL_FLOAT16, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_ERR_PARAM_INVALID},

    // 3. bias dtype不合法 不等于xdtype或float32(ACL_BF16)
    {"test_aclnn_allto_all_matmul_biasdtype_invalid_02", {256, 128}, {128, 256}, {256}, {256, 256}, {},
    ...
    {"test_aclnn_allto_all_matmul_outdtype_mismatch_03", {256, 128}, {128, 256}, {256}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_ERR_PARAM_INVALID},
    // 4.2 等于不支持类型 (ACL_FLOAT8_E5M2)
    {"test_aclnn_allto_all_matmul_outdtype_unsupport_04", {256, 128}, {128, 256}, {256}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT8_E5M2, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_ERR_PARAM_INVALID},

    // 7. 空tensor (1)
    // 7.1 x2有维度为0
    {"test_aclnn_allto_all_matmul_x2empty_10", {256, 128}, {128, 0}, {0}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_ERR_PARAM_INVALID},

    // 8. format为私有格式(4)
    {"test_aclnn_allto_all_matmul_private_fmt1_12", {256, 128}, {128, 256}, {256}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_FRACTAL_Z, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_ERR_PARAM_INVALID},
    {"test_aclnn_allto_all_matmul_private_fmt2_13", {256, 128}, {128, 256}, {256}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_NCL, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_ERR_PARAM_INVALID},
    {"test_aclnn_allto_all_matmul_private_fmt3_14", {256, 128}, {128, 256}, {256}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_FRACTAL_Z, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_ERR_PARAM_INVALID},
    {"test_aclnn_allto_all_matmul_private_fmt4_15", {256, 128}, {128, 256}, {256}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_NCL, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", false, false, ACLNN_ERR_PARAM_INVALID},

    // 9. AlltoAllAxes不合法
    {"test_aclnn_allto_all_matmul_invalid_axes_16", {256, 128}, {128, 256}, {256}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
    ...
    // 11. transposeX1=true
    {"test_aclnn_allto_all_matmul_transx1_19", {128, 256}, {128, 256}, {256}, {256, 256}, {},
     ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_DT_UNDEFINED,
     ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
     {-2, -1}, "ut_test_matmul_allto_all", true, false, ACLNN_ERR_PARAM_INVALID}
};
