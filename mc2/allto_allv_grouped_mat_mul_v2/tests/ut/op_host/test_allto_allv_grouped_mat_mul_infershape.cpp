...
TEST_P(AlltoAllvGroupedMatMulInfershape, inferdatatype_test)
{
    ...
    auto inferDtypeFunc = spaceRegistry->GetOpImpl("AlltoAllvGroupedMatMulV2")->infer_datatype;
...
INSTANTIATE_TEST_SUITE_P(AlltoAllvGroupedMatMulV2, AlltoAllvGroupedMatMulInfershape,
