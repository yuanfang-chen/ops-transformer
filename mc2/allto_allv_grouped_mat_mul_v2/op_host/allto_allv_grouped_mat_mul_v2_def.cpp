...
namespace ops {
class AlltoAllvGroupedMatMulV2 : public OpDef {
public:
    explicit AlltoAllvGroupedMatMulV2(const char *name) : OpDef(name)
    {
        this->Input("gmm_x")
            .ParamType(REQUIRED)
            .DataType({
       ...
       aicore_config_950.Input("gmm_x_scale")
        ...
        aicore_config_950.Input("gmm_x_offset")
            .ParamType(OPTIONAL)
            .DataType({
                ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT,
                ge::DT_FLOAT, ge::DT_FLOAT,
       ...
       aicore_config_950.Input("gmm_weight_offset")
            .ParamType(OPTIONAL)
            .DataType({
                ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT,
                ge::DT_FLOAT, ge::DT_FLOAT,
       ...
       aicore_config_950.Input("mm_x_scale")
        ...
        aicore_config_950.Input("mm_x_offset")
            .ParamType(OPTIONAL)
            .DataType({
                ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT,
                ge::DT_FLOAT, ge::DT_FLOAT,
        ...
        aicore_config_950.Input("mm_weight_offset")
            .ParamType(OPTIONAL)
            .DataType({
                ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT,
                ge::DT_FLOAT, ge::DT_FLOAT,
        ...
        aicore_config_950.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "allto_allv_grouped_mat_mul_v2_apt");
        this->AICore().AddConfig("ascend950", aicore_config_950);
        this->MC2().HcclGroup({"group"});
    }
};

OP_ADD(AlltoAllvGroupedMatMulV2);
} // namespace ops