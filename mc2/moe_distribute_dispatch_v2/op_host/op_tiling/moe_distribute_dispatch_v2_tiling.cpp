    ...
    const char *nodeName, const bool isSetFullMeshV2, uint32_t localMoeExpertNum, bool isLayered)
{
    ...
    winSizeData.totalWinSizeEp = &tilingData.moeDistributeDispatchV2Info.totalWinSizeEp;
    winSizeData.totalWinSizeTp = &tilingData.moeDistributeDispatchV2Info.totalWinSizeTp;
