    ...
    const char *nodeName, const bool isSetFullMeshV2, uint32_t localMoeExpertNum, bool isLayered)
{
    CheckWinSizeData winSizeData{
        localMoeExpertNum, tilingData.moeDistributeDispatchV2Info.sharedExpertNum,
        static_cast<uint64_t>(tilingData.moeDistributeDispatchV2Info.a), static_cast<uint64_t>(
        tilingData.moeDistributeDispatchV2Info.h), static_cast<uint64_t>(tilingData.moeDistributeDispatchV2Info.k),
        static_cast<uint64_t>(tilingData.moeDistributeDispatchV2Info.bs), static_cast<uint64_t>(
        tilingData.moeDistributeDispatchV2Info.epWorldSize), static_cast<uint64_t>(
        tilingData.moeDistributeDispatchV2Info.globalBs), static_cast<uint64_t>(
        tilingData.moeDistributeDispatchV2Info.moeExpertNum), static_cast<uint64_t>(
        tilingData.moeDistributeDispatchV2Info.tpWorldSize), isSetFullMeshV2, isLayered,
        &tilingData.moeDistributeDispatchV2Info.totalWinSizeEp, &tilingData.moeDistributeDispatchV2Info.totalWinSizeTp
    };
