...
static ge::graphStatus CheckAndSetCommAttrParams(const gert::TilingContext *context, const char *nodeName,
...
static ge::graphStatus CheckAndSetExpertAttrParams(const gert::TilingContext *context, const char *nodeName,
...
static ge::graphStatus GetAttrAndSetTilingData(const gert::TilingContext *context, const char *nodeName,
    ...
    bool &isLayered, DispatchV2Config &config)
{
    OP_TILING_CHECK(!CheckAttrPtrNullptr(context, nodeName, groupEp, config),
        OP_LOGE(nodeName, "params check nulld failed."), return ge::GRAPH_FAILED);
    OP_TILING_CHECK(!CheckAndSetCommAttrParams(context, nodeName, groupTp, isSetFullMeshV2,
        isLayered, config, tilingData),OP_LOGE(nodeName, "params shape is invalid."), return ge::GRAPH_FAILED);
    OP_TILING_CHECK(!CheckAndSetExpertAttrParams(context, nodeName, isLayered, config, tilingData),
