...
- **参数说明**
    ...
    - <term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>：
        ...
        - moeExpertNum 取值范围(0, 512]。
            - 当commAlg="fullmesh"且epWorldSize小于等于8时，还需满足moeExpertNum / (epWorldSize - sharedExpertRankNum) <= 120。
            - 当commAlg="fullmesh"且epWorldSize大于8时，还需满足moeExpertNum / (epWorldSize - sharedExpertRankNum) <= 24。
