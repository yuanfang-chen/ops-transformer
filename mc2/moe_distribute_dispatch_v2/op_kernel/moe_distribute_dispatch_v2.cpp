...
__aicore__ inline WinContext GetWinContext(const MoeDistributeDispatchV2TilingData *tilingData)
{
    ...
    winContext.commEp.localUsrRankId = Mc2Kernel::epWinContext_->localUsrRankId;
    winContext.commEp.rankSize = Mc2Kernel::epWinContext_->rankSize;
    winContext.commEp.getWinSize = Mc2Kernel::epWinContext_->winSize;
    winContext.commEp.getStatusDataSpaceGm = Mc2Kernel::epWinContext_->localWindowsExp;
    uint32_t epWorldSize = tilingData->moeDistributeDispatchV2Info.epWorldSize;
    winContext.commEp.windowInAddr = new uint64_t[epWorldSize];
    winContext.commEp.windowExpAddr = new uint64_t[epWorldSize];
    ...
    winContext.commTp.getWinSize = Mc2Kernel::tpWinContext_->winSize;
    uint32_t tpWorldSize = tilingData->moeDistributeDispatchV2Info.tpWorldSize;
    winContext.commTp.windowInAddr = new uint64_t[tpWorldSize];
    winContext.commTp.windowExpAddr = new uint64_t[tpWorldSize];
