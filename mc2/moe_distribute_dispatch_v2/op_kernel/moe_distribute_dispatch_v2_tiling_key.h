...
#define TILINGKEY_TPL_HOST_KFC 3
...
ASCENDC_TPL_ARGS_DECL(MoeDistributeDispatchV2,
    ...
    ASCENDC_TPL_UINT_DECL(TILINGKEY_QUANT_MODE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, 
                        ...
                        TILINGKEY_PERGROUP_QUANT, TILINGKEY_MX_QUANT),
    ...
    ASCENDC_TPL_UINT_DECL(TILINGKEY_COMM_MODE,ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, 
                        TILINGKEY_TPL_MTE, TILINGKEY_TPL_AICPU, TILINGKEY_TPL_CCU, TILINGKEY_TPL_HOST_KFC),
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(TILINGKEY_QUANT_MODE, ASCENDC_TPL_UI_LIST,
                            TILINGKEY_NO_QUANT, TILINGKEY_PERTOKEN_QUANT,
                            TILINGKEY_PERGROUP_QUANT, TILINGKEY_MX_QUANT),
        ASCENDC_TPL_BOOL_SEL(TILINGKEY_SCALE, 0),
        ASCENDC_TPL_UINT_SEL(TILINGKEY_FULLMESH, ASCENDC_TPL_UI_LIST, TILINGKEY_NO_FULLMESH),
        ASCENDC_TPL_UINT_SEL(TILINGKEY_COMM_MODE, ASCENDC_TPL_UI_LIST, TILINGKEY_TPL_MTE, TILINGKEY_TPL_CCU, TILINGKEY_TPL_HOST_KFC),
