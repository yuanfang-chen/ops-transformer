                                                  ...
                                                  const std::unique_ptr<ge::fusion::MatchResult> &matchResult)
{
    ...
    auto rX1Scale =
        replaceGraphBuilder.CreateInput(3, "x1_scale", inputDTypes[2], inputFormats[2], inputShapes[2].GetDims());
    auto rX2Scale =
        replaceGraphBuilder.CreateInput(4, "x2_scale", inputDTypes[3], inputFormats[3], inputShapes[3].GetDims());
    auto rCommScale =
