...
static QuantMatmulAlltoAllAclnnTestParam MXQuant_cases_params[] = {
    // 正常用例
    {"QMMAA_MX-bf16-success-001", 2, 6, 6, {256, 128}, {128, 256}, {256}, {256, 2, 2}, {2, 256, 2}, {512, 128},
        ACL_FLOAT8_E4M3FN, ACL_FLOAT8_E4M3FN, ACL_FLOAT, ACL_FLOAT8_E8M0, ACL_FLOAT8_E8M0, ACL_BF16,
        ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
        4295032864, {-1, -2}, "ut_test_quant_matmul_allto_all", false, false, ACLNN_SUCCESS}, // 输入fp8_e4m3fn，输出bf16
    {"QMMAA_MX-fp16-success-002", 2, 6, 6, {256, 128}, {128, 256}, {256}, {256, 2, 2}, {2, 256, 2}, {512, 128},
        ACL_FLOAT8_E4M3FN, ACL_FLOAT8_E4M3FN, ACL_FLOAT, ACL_FLOAT8_E8M0, ACL_FLOAT8_E8M0, ACL_FLOAT16,
        ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
        4295032864, {-1, -2}, "ut_test_quant_matmul_allto_all", false, false, ACLNN_SUCCESS}, // 输入fp8_e4m3fn，输出fp16
    {"QMMAA_MX-fp32-success-003", 2, 6, 6, {256, 128}, {128, 256}, {256}, {256, 2, 2}, {2, 256, 2}, {512, 128},
        ACL_FLOAT8_E5M2, ACL_FLOAT8_E5M2, ACL_FLOAT, ACL_FLOAT8_E8M0, ACL_FLOAT8_E8M0, ACL_FLOAT,
        ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
        4295032864, {-1, -2}, "ut_test_quant_matmul_allto_all", false, false, ACLNN_SUCCESS}, // 输入fp8_e4m3fn，输出bf16
    // 异常用例
    {"QMMAA_MX-x1Scale_shape-error-001", 2, 6, 6, {256, 128}, {128, 256}, {256}, {256, 8, 2}, {2, 256, 2}, {512, 128},
        ACL_FLOAT8_E4M3FN, ACL_FLOAT8_E4M3FN, ACL_FLOAT, ACL_FLOAT8_E8M0, ACL_FLOAT8_E8M0, ACL_BF16,
        ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
        4295032864, {-1, -2}, "ut_test_quant_matmul_allto_all", false, false, ACLNN_ERR_PARAM_INVALID}, // x1Scale的shape，ceil(k/64)的维度和x2的不对齐
    {"QMMAA_MX-x2Scale_shape-error-002", 2, 6, 6, {256, 128}, {128, 256}, {256}, {256, 8, 2}, {2, 256, 6}, {512, 128},
        ACL_FLOAT8_E4M3FN, ACL_FLOAT8_E4M3FN, ACL_FLOAT, ACL_FLOAT8_E8M0, ACL_FLOAT8_E8M0, ACL_BF16,
        ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
        4295032864, {-1, -2}, "ut_test_quant_matmul_allto_all", false, false, ACLNN_ERR_PARAM_INVALID}, // x2Scale的shape，lastdim不等于2
    {"QMMAA_MX-groupSize_invalid-error-003", 2, 6, 6, {256, 128}, {128, 256}, {256}, {256, 2, 2}, {2, 256, 2}, {512, 128},
        ACL_FLOAT8_E5M2, ACL_FLOAT8_E5M2, ACL_FLOAT, ACL_FLOAT8_E8M0, ACL_FLOAT8_E8M0, ACL_FLOAT,
        ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND, ACL_FORMAT_ND,
        55778, {-1, -2}, "ut_test_quant_matmul_allto_all", false, false, ACLNN_ERR_PARAM_INVALID} // groupSize不是MX量化需要的值
};
...
TEST_F(TestAclnnQuantMatmulAlltoAll, g_reservedCases)
{
