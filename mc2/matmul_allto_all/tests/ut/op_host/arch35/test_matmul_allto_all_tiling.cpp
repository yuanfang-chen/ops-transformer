...
static MatmulAlltoAllTestParam g_testCases[] = {
    ...
    {"matmul_alltoall_case_bf16_bias_transpose_x2_true",
    ...
    // 量化
    // legal
    {"quant_matmul_alltoall_case_normal_dtype_float8_e4m3fn_float16",
    {88, 128}, ge::DT_FLOAT8_E4M3FN, ge::FORMAT_ND,
    {128, 256}, ge::DT_FLOAT8_E4M3FN, ge::FORMAT_ND,
    ...
    {128, 256}, ge::DT_FLOAT8_E5M2, ge::FORMAT_ND,
    {}, ge::DT_FLOAT, ge::FORMAT_ND,
    {88}, ge::DT_FLOAT, ge::FORMAT_ND,
    {256}, ge::DT_FLOAT, ge::FORMAT_ND,
    {}, ge::DT_FLOAT, ge::FORMAT_ND,
    ...
    {88, 128}, ge::DT_FLOAT8_E5M2, ge::FORMAT_ND,
    {256, 128}, ge::DT_FLOAT8_E5M2, ge::FORMAT_ND,
    {256}, ge::DT_FLOAT, ge::FORMAT_ND,
    {88}, ge::DT_FLOAT, ge::FORMAT_ND,
    {256}, ge::DT_FLOAT, ge::FORMAT_ND,
    {}, ge::DT_FLOAT, ge::FORMAT_ND,
    ...
    {88, 128}, ge::DT_FLOAT8_E4M3FN, ge::FORMAT_ND,
    {256, 128}, ge::DT_FLOAT8_E4M3FN, ge::FORMAT_ND,
    {}, ge::DT_FLOAT, ge::FORMAT_ND,
    {88}, ge::DT_FLOAT, ge::FORMAT_ND,
    {256}, ge::DT_FLOAT, ge::FORMAT_ND,
    {}, ge::DT_FLOAT, ge::FORMAT_ND,
    ...
    {}, ge::DT_FLOAT, ge::FORMAT_ND,
    {28543}, ge::DT_FLOAT, ge::FORMAT_ND,
    ...
    {3072, 9216}, ge::DT_FLOAT8_E4M3FN, ge::FORMAT_ND,
    {9216}, ge::DT_FLOAT, ge::FORMAT_ND,
    {28543}, ge::DT_FLOAT16, ge::FORMAT_ND,
    {9216}, ge::DT_FLOAT, ge::FORMAT_ND,
    {}, ge::DT_FLOAT, ge::FORMAT_ND,
    {}, ge::DT_FLOAT, ge::FORMAT_ND,
    {}, ge::DT_FLOAT, ge::FORMAT_ND,
...
// setup & teardown
class Arch35TilingTest : public testing::TestWithParam<MatmulAlltoAllTestParam> {
protected:
    ...
    {
        std::cout << "TestMatmulAlltoAll Arch35TilingTest TearDown." << std::endl;
    }
};
...
TEST_P(Arch35TilingTest, MatmulAlltoAllGeneralCasesTest)
{
    TestOneParamCase(GetParam());
}

TEST_F(Arch35TilingTest, MatmulAlltoAllGeneralCasesMultiThread)
{
    TestExecMultiThread(g_testCases, sizeof(g_testCases) / sizeof(MatmulAlltoAllTestParam), 1);
}

INSTANTIATE_TEST_CASE_P(MatmulAlltoAllTilingUT, Arch35TilingTest, testing::ValuesIn(g_testCases));
