                                                          ...
                                                          MatmulAlltoAllShapeInfo& shape)
{
    ...
    OP_LOGE_IF(groupStr == nullptr, ge::GRAPH_FAILED, context->GetNodeName(), 
               "Get matmul allto all group failed.");
    ...
    OP_LOGD(INNER_DEBUG, "Matmul m is: %ld, n is: %ld, k1 is: %ld, k2 is: %ld.",
            shape.m, shape.n, shape.k1, shape.k2);
    return ge::GRAPH_SUCCESS;
}
