 ...
 * @param shape
 */
static ge::graphStatus GetMatmulAxisInfo(const gert::InferShapeContext* context, MatmulAlltoAllShapeInfo& shape)
{
    const auto attrs = context->GetAttrs();
...
static ge::graphStatus InferShapeMatmulAlltoAll(gert::InferShapeContext* context)
{
    ...
    OPS_CHECK(
        ...
        return ge::GRAPH_FAILED);
    OPS_CHECK(
        GetMatmulAxisInfo(context, shape) != ge::GRAPH_SUCCESS,
