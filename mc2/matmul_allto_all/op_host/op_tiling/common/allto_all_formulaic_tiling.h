...
static constexpr uint64_t RANK_DIM_2D = 2;
static constexpr uint64_t RANK_DIM_4D = 4;
static constexpr uint64_t RANK_DIM_8D = 8;
static constexpr double COMM_TIME_FACTOR_TWO = 3.0; // A3设置2卡通信时间影响因子
static constexpr double COMM_TIME_FACTOR_FOUR = 5.0; // A3设置4卡通信时间影响因子
static constexpr double COMM_TIME_FACTOR_EIGHT = 10.0; // A3设置8卡通信时间影响因子
static constexpr double COMM_TIME_FACTOR_OTHER = 2.0; // A3设置其他卡数通信时间影响因子
