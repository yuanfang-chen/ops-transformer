...
public:
    ...
    __aicore__ inline ContextType* GetCommContextPtr();
...
HcclCommunication<AICSync, ServerType, ContextType, TilingDataType,Primitive, SendCnt, RecvCnt>::GetCommContextPtr()
{
    return &context_;
}
