...
#ifndef DEFINE_AND_IMPL_MC2_MATMUL_FOR_MATMUL_COMPUTATION_MXFP_QUANT
#define DEFINE_AND_IMPL_MC2_MATMUL_FOR_MATMUL_COMPUTATION_MXFP_QUANT(ComputationType) \
