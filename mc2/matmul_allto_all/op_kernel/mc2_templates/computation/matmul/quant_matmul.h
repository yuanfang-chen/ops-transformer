...
template <typename MMType>
__aicore__ inline void FpMMControl<MMType>::Init(MC2MMBaseGmAddrs *baseDataPtr, KCQuantMMAdditionalData *additionalDataPtr,
...
#define DEFINE_AND_IMPL_MC2_MATMUL_FOR_MATMUL_COMPUTATION_QUANT(TilingType, ComputationType, MMDtypeX1, MMDtypeX2) \
    using ComputationType = MC2MMFactory<\
        MC2MMContext<KCQuantMMAdditionalData, Mc2MatMulV3TilingData>,\
        KCQuantMMControl,\
