...
public:
    __aicore__ inline void  Init(MC2MMBaseGmAddrs* baseDataPtr, FpMMAdditionalData* additionalDataPtr, DequantBmm::Mc2QuantBatchMatmulV3TilingDataParams* tilingDataPtr, MMType* MMImplPtr, AscendC::TPipe *tPipe);
