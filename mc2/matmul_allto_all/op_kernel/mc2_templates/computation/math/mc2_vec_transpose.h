...
//内部函数定义
    ...
    __aicore__ inline void CopyInToUB(const uint64_t & srcGmOffset, const uint64_t & curTileMCntIdx,
        ...
        loadGm2UbParams.srcStride = static_cast<int64_t>(context_.innerOffsetIn * sizeof(transposeDataType) -
                                                    loadGm2UbParams.blockLen);
        loadGm2UbParams.dstStride = static_cast<int64_t>(0);

        DataCopyPadExtParams<transposeDataType> padExtParams{true, 0, 0, reinterpret_cast<transposeDataType>(0)};
