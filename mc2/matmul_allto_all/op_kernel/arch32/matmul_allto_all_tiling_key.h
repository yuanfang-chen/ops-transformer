...
ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_BOOL_SEL(MM_ALLTO_ALL_TRANS_X2, 0),
        ASCENDC_TPL_BOOL_SEL(MM_ALLTO_ALL_HAS_BIAS, 0),
        ASCENDC_TPL_BOOL_SEL(MM_ALLTO_ALL_QUANT_BF16, 0)),
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_BOOL_SEL(MM_ALLTO_ALL_TRANS_X2, 1),
        ASCENDC_TPL_BOOL_SEL(MM_ALLTO_ALL_HAS_BIAS, 0),
        ASCENDC_TPL_BOOL_SEL(MM_ALLTO_ALL_QUANT_BF16, 0)),
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_BOOL_SEL(MM_ALLTO_ALL_TRANS_X2, 0),
