...
- **Shape变量约束**：
  ...
  | Bs           | 本卡最终输出token数:<ul><li> <term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>：0 < Bs ≤256；</li><li><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：0 < Bs ≤ 512，且当commAlg="hierarchy"时，需满足0 < Bs ≤ 256。</li></ul> |
