...
struct CombineV2Config {
    ...
    uint32_t attrGlobalBsIndex  = 10;
    uint32_t attrOutDTypeIndex = 11;
    uint32_t attrCommQuantModeIndex = 12;
    uint32_t attrGroupListTypeIndex = 13;
    uint32_t attrCommAlgIndex = 14;
