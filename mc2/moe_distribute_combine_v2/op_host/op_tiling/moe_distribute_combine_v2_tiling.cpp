    ...
    const char *nodeName, const bool isSetFullMeshV2, uint32_t localMoeExpertNum, bool isLayered)
{
    ...
    winSizeData.totalWinSizeEp = &tilingData.moeDistributeCombineV2Info.totalWinSizeEp;
    winSizeData.totalWinSizeTp = &tilingData.moeDistributeCombineV2Info.totalWinSizeTp;
