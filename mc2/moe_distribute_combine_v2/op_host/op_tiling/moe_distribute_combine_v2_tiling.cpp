                                                                   ...
                                                                   const bool isLayered, const CombineV2Config& config)
{
    ...
    auto zeroExpertNumPtr = attrs->GetAttrPointer<int64_t>(config.attrZeroExpertNumIndex);
    auto copyExpertNumPtr = attrs->GetAttrPointer<int64_t>(config.attrCopyExpertNumIndex);
    auto constExpertNumPtr = attrs->GetAttrPointer<int64_t>(config.attrConstExpertNumIndex);
