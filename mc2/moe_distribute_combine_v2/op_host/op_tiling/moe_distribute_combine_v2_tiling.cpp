...
static bool CheckInputTensorDim(const gert::TilingContext *context, const char *nodeName)
{
    ...
    const gert::StorageShape *epSendCountsStorageShape = context->GetInputShape(config.epSendCountsIndex);
                                ...
                                const bool hasElasticInfo, const bool isPerformance, uint32_t tpWorldSize, const CombineV2Config& config)
{
    ...
    auto epSendCountsDesc = context->GetInputDesc(config.epSendCountsIndex);
    ...
    const CombineV2Config& config)
{
    ...
    const gert::StorageShape *epSendCountStorageShape = context->GetInputShape(config.epSendCountsIndex);
