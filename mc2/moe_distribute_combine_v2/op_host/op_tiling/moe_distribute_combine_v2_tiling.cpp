    ...
    const char *nodeName, const bool isSetFullMeshV2, uint32_t localMoeExpertNum, bool isLayered)
{
    CheckWinSizeData winSizeData{
        localMoeExpertNum, tilingData.moeDistributeCombineV2Info.sharedExpertNum,
        static_cast<uint64_t>(tilingData.moeDistributeCombineV2Info.a), static_cast<uint64_t>(
        tilingData.moeDistributeCombineV2Info.h), static_cast<uint64_t>(tilingData.moeDistributeCombineV2Info.k),
        static_cast<uint64_t>(tilingData.moeDistributeCombineV2Info.bs), static_cast<uint64_t>(
        tilingData.moeDistributeCombineV2Info.epWorldSize), static_cast<uint64_t>(
        tilingData.moeDistributeCombineV2Info.globalBs), static_cast<uint64_t>(
        tilingData.moeDistributeCombineV2Info.moeExpertNum), static_cast<uint64_t>(
        tilingData.moeDistributeCombineV2Info.tpWorldSize), false, isLayered,
        &tilingData.moeDistributeCombineV2Info.totalWinSizeEp, &tilingData.moeDistributeCombineV2Info.totalWinSizeTp
    };
