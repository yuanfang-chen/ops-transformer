...
static ge::graphStatus GetExpertsAttrAndSetTilingData(const gert::TilingContext *context,
    MoeDistributeCombineV2TilingData &tilingData, const char *nodeName, const CombineV2Config& config, bool &isLayered)
{
...
static uint32_t CalA(MoeDistributeCombineV2TilingData &tilingData, bool isShared, uint32_t localMoeExpertNum,
