...
__aicore__ inline WinContext GetWinContext(const MoeDistributeDispatchV2TilingData *tilingData)
{
    ...
    winContext.commEp.getWinSize = Mc2Kernel::epContext->winSize;
    winContext.commEp.getStatusDataSpaceGm = Mc2Kernel::epContext->localWindowsExp;
    ...
    winContext.commTp.getWinSize = Mc2Kernel::tpContext->winSize;
