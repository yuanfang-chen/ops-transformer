...
public:
    ...
    __aicore__ inline void Int8QuantProcess(LocalTensor<XType> &outLocal, LocalTensor<ExpandXType> &inLocal)
    {
    ...
    __aicore__ inline void QuantMxFp8(LocalTensor<XType>& outLocal, LocalTensor<XType>& inLocal)
    {
        ...
        if constexpr (QuantMode == MXFP8_E5M2_COMM_QUANT) {
            ...
            quant::ComputeData<XType, fp8Type, AscendC::RoundMode::CAST_TRUNC, AscendC::RoundMode::CAST_RINT>(
    ...
    __aicore__ inline void QuantProcess(LocalTensor<XType>& outLocal, LocalTensor<XType>& inLocal)
    {
        if constexpr (QuantMode == INT8_COMM_QUANT) {
