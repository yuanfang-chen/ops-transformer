...
private:
    ...
    {
        if (domain == EP_DOMAIN) {
            return (GM_ADDR)(winContext.commEp.windowInAddr[rankId]) + winDataSizeOffsetEp_;
        } else {
            return (GM_ADDR)(winContext.commTp.windowInAddr[rankId]) + winDataSizeOffsetTp_;
        }
    }
    ...
    {
        if (domain == EP_DOMAIN) {
            return (GM_ADDR)(winContext.commEp.windowExpAddr[rankId]) + winStatusOffset_;
        } else {
            return (GM_ADDR)(winContext.commTp.windowExpAddr[rankId]) + winStatusOffset_;
        }
    }
