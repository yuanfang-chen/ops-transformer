...
TEST_F(Arch32TilingTest, Fp16Shard0WithBias)
{
    struct BatchMatMulReduceScatterAlltoAllCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(Arch32TilingTest, Fp16Shard0NonlocalETailFront)
{
    struct BatchMatMulReduceScatterAlltoAllCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(Arch32TilingTest, Bf16Shard0WithBias)
{
    struct BatchMatMulReduceScatterAlltoAllCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(Arch32TilingTest, Fp16Shard0WithBiasInvalidXshape)
{
    struct BatchMatMulReduceScatterAlltoAllCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(Arch32TilingTest, Fp16Shard1WithBiasInvalidXshape)
{
    struct BatchMatMulReduceScatterAlltoAllCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(Arch32TilingTest, Fp16Shard0WithBiasInvalidH)
{
    struct BatchMatMulReduceScatterAlltoAllCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
