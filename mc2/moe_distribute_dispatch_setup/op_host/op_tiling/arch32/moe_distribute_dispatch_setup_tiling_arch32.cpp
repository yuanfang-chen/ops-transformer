...
void MoeDistributeDispatchSetupTilingA3::PrintTilingDataInfo()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckRequiredAttrValue()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::GetRequiredAttrAndSetTilingData()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckSharedExpertAttrValue()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckOptionalAttrValue()
{
    auto attrs = context_->GetAttrs();
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::GetOptionalAttrAndSetTilingData()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::GetComplexAttrAndSetTilingData()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckOneTensorDim(
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckInputTensorDim()
{
    OP_TILING_CHECK(
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckOptionalInputTensorDim()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckOutputTensorDim()
{
    OP_TILING_CHECK(
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckTensorDim()
{
    OP_TILING_CHECK(
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckTensorShapeRelation()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckInputTensorDataType()
{
    ...
    OP_TILING_CHECK(
        ...
        OP_LOGE(
            ...
            ops::ToString(xDesc->GetDataType()).c_str()),
        return ge::GRAPH_FAILED);
    OP_TILING_CHECK(
        (expertIdsDesc->GetDataType() != ge::DT_INT32),
        OP_LOGE(
            nodeName_, "Unsupported dataType, expertIds only support int32, but is %s!",
            ops::ToString(expertIdsDesc->GetDataType()).c_str()),
        return ge::GRAPH_FAILED);

    return ge::GRAPH_SUCCESS;
}

ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckOptionalInputTensorDataType()
{
    ...
    if (scalesDesc != nullptr) {
        OP_TILING_CHECK(
            ...
            OP_LOGE(
                ...
                ops::ToString(scalesDesc->GetDataType()).c_str()),
            return ge::GRAPH_FAILED);
    }
    ...
    if (xActiveMaskDesc != nullptr) {
        OP_TILING_CHECK(
            ...
            OP_LOGE(
                ...
                ops::ToString(xActiveMaskDesc->GetDataType()).c_str()),
            return ge::GRAPH_FAILED);
    }
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckOutputTensorDataType()
{
    ...
    if (tilingData_->moeDistributeDispatchSetupInfo.quantMode == NON_QUANT) {
        OP_TILING_CHECK(
            ...
            OP_LOGE(
                ...
                ops::ToString(yDesc->GetDataType()).c_str()),
            return ge::GRAPH_FAILED);
    } else {
        OP_TILING_CHECK(
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckTensorDataType()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckTensorShapeSizeAndSetTilingData()
{
    auto* xStorageShape = context_->GetInputShape(X_INDEX);
    auto* expertIdsShape = context_->GetInputShape(EXPERT_IDS_INDEX);
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckComplexTensorShapeSize()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckCalcTensorShapeSizeAndSetTilingData()
{
...
void MoeDistributeDispatchSetupTilingA3::SetTilingKey()
{
    /*
     * tilingkey说明
     * 4位的十进制数
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::CheckHcclBuffSize()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA3::SetWorkspace()
{
    size_t* workspace = context_->GetWorkspaceSizes(1);
    OP_TILING_CHECK(
        workspace == nullptr, VECTOR_INNER_ERR_REPORT_TILIING(nodeName_, "get workspace failed"),
        return ge::GRAPH_FAILED);
...
void MoeDistributeDispatchSetupTilingA3::SetPlatformInfo()
{
