...
ge::graphStatus CheckOneTensorDim(
...
void MoeDistributeDispatchSetupTilingA5::SetHcommCfg()
{
    ...
    uint8_t aivEngineValue =
        mc2tiling::GetSocVersion(context_) == "Ascend910_95" ? mc2tiling::A5_AIV_ENGINE : mc2tiling::AIV_ENGINE;
...
{
    OP_LOGD(nodeName_, "Start MoeDistributeDispatchSetupA5 tiling");
    ...
    SetHcommCfg();
    PrintTilingDataInfo();
    OP_LOGD(nodeName_, "Finish MoeDistributeDispatchSetupA5 tiling");
    return ge::GRAPH_SUCCESS;
}
