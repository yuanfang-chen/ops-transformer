...
void MoeDistributeDispatchSetupTilingA5::PrintTilingDataInfo()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckRequiredAttrValue()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::GetRequiredAttrAndSetTilingData()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckSharedExpertAttrValue()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckOptionalAttrValue()
{
    auto attrs = context_->GetAttrs();
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::GetOptionalAttrAndSetTilingData()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::GetComplexAttrAndSetTilingData()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckOneTensorDim(
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckInputTensorDim()
{
    OP_TILING_CHECK(
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckOptionalInputTensorDim()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckOutputTensorDim()
{
    OP_TILING_CHECK(
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckTensorDim()
{
    OP_TILING_CHECK(
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckTensorShapeRelation()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckInputTensorDataType()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckOptionalInputTensorDataType()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckOutputTensorDataType()
{
    auto yDesc = context_->GetOutputDesc(OUTPUT_Y_INDEX);
    ...
    OP_TILING_CHECK((quantMode == UNQUANT)
        ...
        OP_LOGE(
            nodeName_,
            "Invalid yOut's datatype for quantMode %ld. Only bf16/fp16 is supported, but got %s.",
            quantMode, Ops::Base::ToString(yDesc->GetDataType()).c_str()),
        return ge::GRAPH_FAILED);
    OP_TILING_CHECK((quantMode == STATIC_QUANT)
        && (yDesc->GetDataType() != ge::DT_HIFLOAT8) && (yDesc->GetDataType() != ge::DT_INT8),
        OP_LOGE(
            nodeName_, "Invalid yOut's datatype for quantMode %ld. Only int8/hif8 is supported, but got %s.",
            quantMode, Ops::Base::ToString(yDesc->GetDataType()).c_str()),
        return ge::GRAPH_FAILED);
    OP_TILING_CHECK((quantMode == PERTOKEN_DYNAMIC_QUANT)
        ...
        OP_LOGE(
            nodeName_, "Invalid yOut's datatype for quantMode %ld. Only int8/fp8_e4m3fn/fp8_e5m2 is supported, but got %s.",
            quantMode, Ops::Base::ToString(yDesc->GetDataType()).c_str()),
        return ge::GRAPH_FAILED);
    OP_TILING_CHECK(((quantMode == PERGROUP_DYNAMIC_QUANT) || (quantMode == MX_QUANT))
        ...
        OP_LOGE(
            nodeName_, "Invalid yOut's datatype for quantMode %ld. Only fp8_e4m3fn/fp8_e5m2 is supported, but got %s.",
            quantMode, Ops::Base::ToString(yDesc->GetDataType()).c_str()),
        return ge::GRAPH_FAILED);
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckTensorDataType()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckTensorShapeSizeAndSetTilingData()
{
    auto* xStorageShape = context_->GetInputShape(X_INDEX);
    auto* expertIdsShape = context_->GetInputShape(EXPERT_IDS_INDEX);
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckComplexTensorShapeSize()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckCalcTensorShapeSizeAndSetTilingData()
{
...
void MoeDistributeDispatchSetupTilingA5::SetHcommCfg()
{
    ...
    uint8_t aivEngineValue =
        mc2tiling::GetSocVersion(context_) == "Ascend910_95" ? mc2tiling::AIV_ENGINE : mc2tiling::AIV_ENGINE;
...
void MoeDistributeDispatchSetupTilingA5::SetTilingKey()
{
    /*
     * tilingkey说明
     * 4位的十进制数
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::CheckHcclBuffSize()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::SetWorkspace()
{
...
void MoeDistributeDispatchSetupTilingA5::SetPlatformInfo()
{
...
ge::graphStatus MoeDistributeDispatchSetupTilingA5::MoeDistributeDispatchSetupTilingFuncImpl()
{
