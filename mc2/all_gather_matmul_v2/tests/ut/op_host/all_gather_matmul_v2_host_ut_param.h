...
#ifndef ALL_GATHER_MATMUL_V2_HOST_UT_PARAM_H
#define ALL_GATHER_MATMUL_V2_HOST_UT_PARAM_H
...
struct AllGatherMatmulV2TilingUtParam: public AllGatherMatmulV2HostUtParamBase {
    ...
    gert::TilingContextPara::TensorDescription quantScale = TD_DEFAULT;
    gert::TilingContextPara::TensorDescription y = TD_DEFAULT;
    gert::TilingContextPara::TensorDescription gatherOut = TD_DEFAULT;
    gert::TilingContextPara::TensorDescription amaxOut = TD_DEFAULT;
    std::string soc;
    uint64_t coreNum;
    uint64_t ubsize;
        ...
        AllGatherMatmulV2HostUtParamBase(csvMap)
    {
        ...
        this->outputInstance.emplace_back(
            GetTensorGE(csvMap, "output_gather_out_shape", "output_gather_out_dtype", "output_gather_out_format",
                gatherOut));
        this->outputInstance.emplace_back(
            GetTensorGE(csvMap, "output_amax_out_shape", "output_amax_out_dtype", "output_amax_out_format",
                amaxOut));
...
struct AllGatherMatmulV2InferShapeUtParam: public AllGatherMatmulV2HostUtParamBase {
    ...
    gert::InfershapeContextPara::TensorDescription quantScale = ID_DEFAULT;
    ...
    gert::InfershapeContextPara::TensorDescription amaxOut = ID_DEFAULT;
    std::string commMode;
    std::vector<std::vector<int64_t>> expectOutputShape;

    AllGatherMatmulV2InferShapeUtParam(const csv_map& csvMap):
        AllGatherMatmulV2HostUtParamBase(csvMap)
    {
        this->inputInstance.emplace_back(
            GetTensorGE(csvMap, "x1_shape", "x1_dtype", "x1_format",
...
struct AllGatherMatmulV2InferDataTypeUtParam: public AllGatherMatmulV2HostUtParamBase {
    ...
    ge::DataType quantScale = ge::DT_UNDEFINED;
    ge::DataType y = ge::DT_UNDEFINED;
    ge::DataType gatherOut = ge::DT_UNDEFINED;
    ge::DataType amaxOut = ge::DT_UNDEFINED;

    AllGatherMatmulV2InferDataTypeUtParam(const csv_map& csvMap):
        AllGatherMatmulV2HostUtParamBase(csvMap)
    {
        ...
        this->inputInstance.emplace_back(GetDataTypeGE(csvMap, "x1_scale_dtype", x1Scale));
        this->inputInstance.emplace_back(GetDataTypeGE(csvMap, "x2_scale_dtype", x2Scale));
        this->inputInstance.emplace_back(GetDataTypeGE(csvMap, "quant_scale_dtype", quantScale));
        
        if(this->expectResult == ge::GRAPH_SUCCESS) {
            this->outputInstance.emplace_back(GetDataTypeGE(csvMap, "y_dtype", y));
            this->outputInstance.emplace_back(GetDataTypeGE(csvMap, "gather_out_dtype", gatherOut));
            this->outputInstance.emplace_back(GetDataTypeGE(csvMap, "amax_out_dtype", amaxOut));
        }
    }
};
...
#endif // ALL_GATHER_MATMUL_V2_HOST_UT_PARAM_H
