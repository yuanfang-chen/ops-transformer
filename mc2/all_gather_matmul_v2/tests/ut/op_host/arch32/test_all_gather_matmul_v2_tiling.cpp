...
#include "../test_all_gather_matmul_v2_host_ut_param.h"
...
protected:
    ...
    {
        std::cout << "AllGatherMatmulV2Arch32TilingTest SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "AllGatherMatmulV2Arch32TilingTest TearDown" << std::endl;
    }
};
...
INSTANTIATE_TEST_SUITE_P(
    AllGatherMatmulV2,
    AllGatherMatmulV2Arch32TilingTest,
