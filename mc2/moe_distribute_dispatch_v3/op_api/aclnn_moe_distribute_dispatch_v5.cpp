...
 */
#include "aclnn_moe_distribute_dispatch_v5.h"
#include <algorithm>
#include "op_mc2.h"
...
aclnnStatus aclnnMoeDistributeDispatchV5GetWorkspaceSize(
    const aclTensor* context, aclTensor* x, const aclTensor* expertIds,
