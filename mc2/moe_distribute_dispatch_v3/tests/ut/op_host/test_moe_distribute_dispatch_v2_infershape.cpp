...
class MoeDistributeDispatchV3Infershape : public testing::Test {
};

// infer shape with bias, success
TEST_F(MoeDistributeDispatchV3Infershape, inferShape0) 
{
    gert::StorageShape expand_x_shape = {{32, 7168}, {}};
    gert::StorageShape expert_ids_shape = {{32, 8}, {}};

    gert::InfershapeContextPara infershapeContextPara("MoeDistributeDispatchV3",
        {
...
TEST_F(MoeDistributeDispatchV3Infershape, inferDtype0) {
    ...
    auto inferDtypeFunc = spaceRegistry->GetOpImpl("MoeDistributeDispatchV3")->infer_datatype;
