...
class l2_aclnn_moe_distribute_dispatch_v3_test : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        op::SetPlatformSocVersion(op::SocVersion::ASCEND910B);
        cout << "l2_aclnn_moe_distribute_dispatch_v3_test SetUp" << endl;
    }

    static void TearDownTestCase()
    {
        op::SetPlatformSocVersion(op::SocVersion::ASCEND910B);
        cout << "l2_aclnn_moe_distribute_dispatch_v3_test TearDown" << endl;
    }
};

TEST_F(l2_aclnn_moe_distribute_dispatch_v3_test, test_aclnn_moe_distribute_dispatch_first_api) {
    ...
    auto ut = OP_API_UT(aclnnMoeDistributeDispatchV3, INPUT(x, expertIds, scales, xActiveMask, expertScales, "test_moe_distribute_dispatch_ep",
