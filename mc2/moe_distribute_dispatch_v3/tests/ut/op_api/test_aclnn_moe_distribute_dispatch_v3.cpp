...
class L2AclnnMoeDistributeDispatchV3Test : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        op::SetPlatformSocVersion(op::SocVersion::ASCEND910B);
        cout << "L2AclnnMoeDistributeDispatchV3Test SetUp" << endl;
    }

    static void TearDownTestCase()
    {
        op::SetPlatformSocVersion(op::SocVersion::ASCEND910B);
        cout << "L2AclnnMoeDistributeDispatchV3Test TearDown" << endl;
    }
};

TEST_F(L2AclnnMoeDistributeDispatchV3Test, TestAclnnMoeDistributeDispatchFirstApi)
{
    ...
    auto ut = OP_API_UT(aclnnMoeDistributeDispatchV3, INPUT(context, x, expertIds, scales, xActiveMask, expertScales, "test_moe_distribute_dispatch_ep",
