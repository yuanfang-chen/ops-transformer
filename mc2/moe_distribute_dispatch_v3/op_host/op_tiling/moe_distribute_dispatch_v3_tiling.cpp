...
namespace optiling {
static ge::graphStatus MoeDistributeDispatchV3TilingFuncImpl(gert::TilingContext *context)
{
    // dispatch V2 does not have context as input
    MoeDistributeDispatchV2TilingHelper tilingHelper(true);
...
static ge::graphStatus MoeDistributeDispatchV3TilingFunc(gert::TilingContext* context)
{
    ...
    ge::graphStatus ret;
    ret = MoeDistributeDispatchV3TilingFuncImpl(context);
    return ret;
}
