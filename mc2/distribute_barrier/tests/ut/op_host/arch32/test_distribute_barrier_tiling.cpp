...
TEST_F(DistributeBarrierArch32TilingTest, DistributeBarrierTestTiling)
{
...
TEST_F(DistributeBarrierArch32TilingTest, DistributeBarrierTestTilingWorldSize1)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(DistributeBarrierArch32TilingTest, DistributeBarrierTestTilingWorldSize385)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(DistributeBarrierArch32TilingTest, DistributeBarrierTestTilingTimeOut) 
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(DistributeBarrierArch32TilingTest, DistributeBarrierTestTilingElasticInfo) 
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(DistributeBarrierArch32TilingTest, DistributeBarrierTestTilingTimeOutElasticInfo) 
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
