...
TEST_F(DistributeBarrierTiling, TestTiling)
{
...
TEST_F(DistributeBarrierTiling, TestTilingWorldSize1)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(DistributeBarrierTiling, TestTilingWorldSize385)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(DistributeBarrierTiling, TestTilingTimeOut) 
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(DistributeBarrierTiling, TestTilingElasticInfo) 
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(DistributeBarrierTiling, TestTilingTimeOutElasticInfo) 
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
