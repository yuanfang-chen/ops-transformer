...
TEST_F(Arch32TilingTest, TestTiling)
{
...
TEST_F(Arch32TilingTest, TestTilingWorldSize1)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(Arch32TilingTest, TestTilingWorldSize385)
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(Arch32TilingTest, TestTilingTimeOut) 
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(Arch32TilingTest, TestTilingElasticInfo) 
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
...
TEST_F(Arch32TilingTest, TestTilingTimeOutElasticInfo) 
{
    struct DistributeBarrierCompileInfo {} compileInfo;
    uint64_t coreNum = 20;
    uint64_t ubSize = 196608;
