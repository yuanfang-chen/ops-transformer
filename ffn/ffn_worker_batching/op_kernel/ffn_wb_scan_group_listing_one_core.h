...
/*!
* \file ffn_wb_group_listing_one_core.h
* \brief
*/

#ifndef FFN_WB_SCAN_GROUP_LISTING_ONE_CORE_H
#define FFN_WB_SCAN_GROUP_LISTING_ONE_CORE_H
...
#endif  // FFN_WB_SCAN_GROUP_LISTING_ONE_CORE_H