 ...
 * \brief
 */
#ifndef OPS_BUILT_IN_OP_PROTO_INC_FFN_WORKER_BATCHING_OPS_H_
#define OPS_BUILT_IN_OP_PROTO_INC_FFN_WORKER_BATCHING_OPS_H_
...
#endif  // OPS_BUILT_IN_OP_PROTO_INC_FFN_WORKER_BATCHING_OPS_H_
