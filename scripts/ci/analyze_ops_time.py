...
def main():
    ...
    merge_names = ["moe_token_permute_with_routing_map", "moe_token_permute_with_routing_map_grad", "moe_token_unpermute_with_routing_map"]
    ...
    for (soc, op_name), values in merge_dict.items():
        merged_row = {
            'op_name': f"{remove_apt_suffix(op_name)}",
