...
from py.utils.funcbase import invoke, pipe
from py.utils.comm_log import CommLog
...
def generate_hash_list(target_conf, hash_cfg_str, release_dir):
    ...
    stat, output = subprocess.getstatusoutput(hash_cmd)
    if stat != SUCCESS:
