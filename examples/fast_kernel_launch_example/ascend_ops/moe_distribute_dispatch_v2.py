...
class MoeDistributeDispatchv2OpBuilder(OpBuilder):
    ...
    def schema(self) -> str:
        ...
        return "npu_moe_distribute_dispatch_v2(Tensor context, Tensor x, Tensor expert_ids, " \
    ...
    def register_meta(self):
        ...
        def npu_moe_distribute_dispatch_v2_meta(context, x, expert_ids, ep_world_size, ep_rank_id, moe_expert_num,
...
def npu_moe_distribute_dispatch_v2(context, x, expert_ids, ep_world_size, ep_rank_id, moe_expert_num, 
                                   ccl_buffer_size, scales=None, x_active_mask=None, expert_scales=None,
                                   elastic_info=None, performance_info=None, tp_world_size=0, tp_rank_id=0,
                                   expert_shard_type=0, shared_expert_num=1, shared_expert_rank_num=0,
                                   quant_mode=0, global_bs=0, expert_token_nums_type=1, comm_alg="",
    ...
    """
    return op_module.npu_moe_distribute_dispatch_v2(context, x, expert_ids, ep_world_size, ep_rank_id, moe_expert_num,
