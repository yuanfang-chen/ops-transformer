...
class MoeDistributeBuffer:
    ...
    def npu_moe_distribute_dispatch_v2(self, x, topk_idx, num_experts: int, *,
        ...
        (expand_x, dynamic_scales, expand_idx, expert_token_nums, ep_recv_counts, tp_recv_counts, expand_scales) \
            = torch.ops.npu_ops_transformer.npu_moe_distribute_dispatch_v2(
    ...
    def npu_low_latency_combine(self, x, topk_idx, topk_weights, assist_info_for_combine, ep_send_counts, *,
        ...
        return torch.ops.npu_ops_transformer.npu_moe_distribute_combine_v2(
                                             context=self.context,
                                             expand_x=x,
                                             expert_ids=topk_idx,
