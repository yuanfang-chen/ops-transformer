...
class MoeDistributeBuffer:
    ...
    def npu_moe_distribute_dispatch_v2(self, x, expert_ids, mc2_context, group_ep, ep_world_size,
            ep_rank_id, moe_expert_num, total_winsize_ep, *, scales=None, x_active_mask=None,
    ...
    def npu_moe_distribute_combine_v2(self, expand_x, expert_ids, assist_info_for_combine,
            ep_send_counts, expert_scales, mc2_context, group_ep, ep_world_size,
            ep_rank_id, moe_expert_num, total_winsize_ep, *, tp_send_counts=None,
