...
void calculate_buffernum(MoeDistributeCombineV2Info &tilingData, const at::Tensor &expand_x, int64_t comm_quant_mode)
{
    ...
    totalBufferSize = maxSizeTokenBuf + maxSizeRowTmpFloatBuf + mulBufSize + hFloatAlign32Size + hExpandXAlign32Size * BUFFER_DOUBLE
    + flagRcvCount * STATE_OFFSET * BUFFER_DOUBLE + UB_ALIGN;
