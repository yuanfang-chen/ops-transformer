...
TORCH_LIBRARY_FRAGMENT(EXTENSION_MODULE_NAME, m)
{
    m.def("MoeDistributeCombineV2(Tensor expand_x, Tensor expert_ids, Tensor assist_info_for_combine, " \
            ...
            "int ep_rank_id, int moe_expert_num, int total_winsize_ep, *, Tensor? tp_send_counts=None, " \
                                ...
                                MoeDistributeCombineV2Info tilingData)
{
    ...
    if(tp_send_counts.has_value()) {
        tpSendCounts_ptr = get_first_tensor_address<c10::optional<at::Tensor>>(tp_send_counts->scalar_type(),
            tp_send_counts, false);
    }
