...
#include "../../../common/inc/kernel/moe_distribute_base.h"
#include "../../../moe_distribute_dispatch_v2/ascend910_93/op_kernel/check_winsize.h"
#include "../../../moe_distribute_dispatch_v2/ascend910_93/op_kernel/moe_distribute_v2_base.h"
#include "../../../moe_distribute_dispatch_v2/ascend910_93/op_kernel/moe_distribute_elastic.h"
#endif
...
public:
    ...
    __aicore__ inline void Init(GM_ADDR expandX, GM_ADDR expertIds, GM_ADDR expandIdx, GM_ADDR epSendCount, GM_ADDR tpSendCount, GM_ADDR residualX,
                                ...
                                GM_ADDR workspaceGM, GM_ADDR mc2Context, MoeDistributeCombineV2Info tilingData, TPipe *pipe);
...
private:
    ...
    GlobalTensor<int32_t> tpSendCountGM_;
...
__aicore__ inline void MoeDistributeCombineV2<CombineMC2TypeFunc>::InitInputAndOutput(
    ...
    GM_ADDR constExpertAlpha2, GM_ADDR constExpertV, GM_ADDR performanceInfo)
{
...
__aicore__ inline void MoeDistributeCombineV2<CombineMC2TypeFunc>::InitTilingAttrs(const MoeDistributeCombineV2Info tilingData)
{
    ...
    hasElasticInfoFlag_ = tilingData.hasElasticInfo;
    ...
    tpWorldSize_ = tilingData.tpWorldSize;
    tpRankId_ = tilingData.tpRankId;
    totalWinSizeEp_ = tilingData.totalWinSizeEp;
    totalWinSizeTp_ = tilingData.totalWinSizeTp;
    ...
    GM_ADDR workspaceGM, GM_ADDR mc2Context, MoeDistributeCombineV2Info tilingData, TPipe *pipe)
{
    ...
    InitInputAndOutput(
        ...
        constExpertAlpha2, constExpertV, performanceInfo, yOut);
    ...
    LocalTensor<ExpandXType>& gammaLocal, const DataCopyExtParams& copyExtParams)
{
    ...
    PipeBarrier<PIPE_V>();
    LocalTensor<ExpandXType> yLocal = rowTmpFloatBuf_.Get<ExpandXType>();
