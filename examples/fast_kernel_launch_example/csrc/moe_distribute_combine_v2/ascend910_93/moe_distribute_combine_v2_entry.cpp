...
// using namespace MoeDistributeCombineA5Impl;
// #else
...
// using namespace MoeDistributeCombineV2FullMeshImpl;
    ...
    GM_ADDR workspaceGM, GM_ADDR mc2Context, MoeDistributeCombineV2Info tilingData)
{
    ...
    op.InitWithMc2Context(expandX,  expertIds, expandIdx, epSendCount, tpSendCount, residualX, gamma, expertScales,
    xActiveMask, sharedExpertX, elasticInfo, oriX, constExpertAlpha1, constExpertAlpha2, constExpertV, performanceInfo,
    yOut, rstdOut, XOut, workspaceGM, mc2Context, tilingData, &pipe);
    ...
    GM_ADDR workspaceGM, GM_ADDR mc2Context, MoeDistributeCombineV2Info tilingData)
{
    ...
    case 100:
        moe_distribute_combine_v2<float16_t, false>(
            expandX, expertIds, expandIdx, epSendCount, tpSendCount, residualX, gamma, expertScales, xActiveMask,
            sharedExpertX, elasticInfo, oriX, constExpertAlpha1, constExpertAlpha2, constExpertV, performanceInfo, yOut,
...
// <<<>>>调用函数
void moe_distribute_combine_v2_demo(int32_t tilingKey, uint32_t blockDim, void* stream, GM_ADDR expandX, GM_ADDR expertIds,
    GM_ADDR expandIdx, GM_ADDR epSendCount, GM_ADDR tpSendCount, GM_ADDR residualX,
    GM_ADDR gamma, GM_ADDR expertScales, GM_ADDR xActiveMask, GM_ADDR sharedExpertX, GM_ADDR elasticInfo, GM_ADDR oriX,
    GM_ADDR constExpertAlpha1, GM_ADDR constExpertAlpha2, GM_ADDR constExpertV, GM_ADDR performanceInfo, GM_ADDR yOut,
    GM_ADDR workspaceGM, GM_ADDR mc2Context, MoeDistributeCombineV2Info tilingData)
{
