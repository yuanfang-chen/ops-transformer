...
extern "C" __sk__ __aicore__ void moe_distribute_combine_v2_generic_sk(MoeDistributeCombineV2SkArgs *args)
{
...
SK_BIND(moe_distribute_combine_v2_generic, 4, moe_distribute_combine_v2_generic_sk);
