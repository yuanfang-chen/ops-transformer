...
extern "C" __sk__ __aicore__ void moe_distribute_dispatch_v2_generic_sk(MoeDistributeDispatchV2SkArgs *args)
{
...
SK_BIND(moe_distribute_dispatch_v2_generic, 4, moe_distribute_dispatch_v2_generic_sk);
