...
// REGISTER_TILING_DEFAULT(MoeDistributeDispatchV2TilingData);
    ...
    op.InitWithMc2Context(x, expertIds, scales, xActiveMask, expertScales, expandXOut, dynamicScalesOut, assistInfoOut, expertTokenNumsOut,
...
void moe_distribute_dispatch_v2_demo(int8_t type, uint32_t blockDim, void* stream, uint8_t* x, uint8_t* expertIds, uint8_t* scales,
    uint8_t* xActiveMask, uint8_t* expertScales, uint8_t* elasticInfo, uint8_t* performanceInfo, uint8_t* expandXOut, uint8_t* dynamicScalesOut, uint8_t* assistInfoOut,
    uint8_t* expertTokenNumsOut, uint8_t* epSendCountsOut, uint8_t* tpSendCountsOut, uint8_t* expandScalesOut, uint8_t* workspaceGM, uint8_t* mc2Context, uint8_t* tilingGM) {
    moe_distribute_dispatch_v2_Generic<<<blockDim, nullptr, stream>>>(
        ...
        x, expertIds, scales, xActiveMask, expertScales, elasticInfo, performanceInfo, expandXOut, dynamicScalesOut, assistInfoOut, expertTokenNumsOut,
                    epSendCountsOut, tpSendCountsOut, expandScalesOut, workspaceGM, mc2Context, tilingGM
    );
}