    ...
    GM_ADDR expandScalesOut, GM_ADDR workspaceGM, GM_ADDR mc2Context, MoeDistributeDispatchV2Info tilingData)
{
    ...
    case 10010:
        moe_distribute_dispatch_v2<bfloat16_t, bfloat16_t, MoeDistributeDispatchV2Impl::UNQUANT, false, false>(
            x, expertIds, scales, xActiveMask, expertScales, elasticInfo, performanceInfo,
            expandXOut, dynamicScalesOut, assistInfoOut, expertTokenNumsOut,
            epSendCountsOut, tpSendCountsOut, expandScalesOut, workspaceGM, mc2Context, tilingData);
        break;
    ...
    case 10110:
        moe_distribute_dispatch_v2<bfloat16_t, bfloat16_t, MoeDistributeDispatchV2Impl::UNQUANT, true, false>(
            x, expertIds, scales, xActiveMask, expertScales, elasticInfo, performanceInfo,
            expandXOut, dynamicScalesOut, assistInfoOut, expertTokenNumsOut,
            epSendCountsOut, tpSendCountsOut, expandScalesOut, workspaceGM, mc2Context, tilingData);
        break;
    ...
    case 11010:
        moe_distribute_dispatch_v2_full_mesh<bfloat16_t, bfloat16_t, MoeDistributeDispatchV2Impl::UNQUANT, false, false>(
            x, expertIds, scales, xActiveMask, expertScales, elasticInfo, performanceInfo,
            expandXOut, dynamicScalesOut, assistInfoOut, expertTokenNumsOut,
            epSendCountsOut, tpSendCountsOut, expandScalesOut, workspaceGM, mc2Context, tilingData);
        break;
    ...
    case 11110:
        moe_distribute_dispatch_v2_full_mesh<bfloat16_t, bfloat16_t, MoeDistributeDispatchV2Impl::UNQUANT, true, false>(
            x, expertIds, scales, xActiveMask, expertScales, elasticInfo, performanceInfo,
            expandXOut, dynamicScalesOut, assistInfoOut, expertTokenNumsOut,
            epSendCountsOut, tpSendCountsOut, expandScalesOut, workspaceGM, mc2Context, tilingData);
        break;
