                                ...
                                at::Tensor &expand_scales, MoeDistributeDispatchV2Info tilingData)
{
    ...
    CalTilingKey(tilingKey, x.scalar_type(), scales.has_value(), tilingData.quantMode, is_fullmesh_v2);
    moe_distribute_dispatch_v2_demo(tilingKey, tilingData.aivNum, (void*)stream, (GM_ADDR)x_ptr,
    ...
    const c10::optional<at::Tensor> &performance_info)
{
    ...
    tilingData.totalUbSize = 192 * 1024;                // epWorldSize
