...
template <TemplateDispatchV2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2<TemplateDispatchV2TypeFunc>::InitWithMc2Context(
    GM_ADDR x, GM_ADDR expertIds, GM_ADDR scales, GM_ADDR xActiveMask, GM_ADDR elasticInfo, GM_ADDR performanceInfo, 
    GM_ADDR expandXOut, GM_ADDR dynamicScalesOut, GM_ADDR expandIdxOut, GM_ADDR expertTokenNumsOut, GM_ADDR sendCountsOut, 
    GM_ADDR tpSendCountsOut, GM_ADDR workspaceGM, GM_ADDR mc2Context, GM_ADDR tilingGM, TPipe *pipe)
{
    ...
    totalWinSizeTp_ = static_cast<uint64_t>(tilingData.totalWinSizeTp);
    ...
    winDataSizeOffsetTp_ = dataState_ * (totalWinSizeTp_ / 2)
                         + tilingData.a * hSizeAlignCombine;
