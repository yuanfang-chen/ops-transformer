...
public:
    ...
    __aicore__ inline void InitWithMc2Context(
        ...
        GM_ADDR tpSendCountsOut, GM_ADDR workspaceGM, GM_ADDR mc2Context, GM_ADDR tilingGM, TPipe *pipe);
...
private:
    ...
    __aicore__ inline void SetTilingData(const __gm__ MoeDistributeDispatchV2Info &tilingDataInfo);
    ...
    __aicore__ inline void SetTilingDataAndCal(const __gm__ MoeDistributeDispatchV2Info &tilingDataInfo);
    ...
    __gm__ MoeDistributeDispatchV2TilingData* tilingDataOut;
...
__aicore__ inline void MoeDistributeDispatchV2FullMesh<TemplateMC2TypeFullmeshFunc>::SetTilingData(
    const __gm__ MoeDistributeDispatchV2Info &tilingDataInfo)
{
    ...
    hasElasticInfoFlag_ = tilingDataInfo.hasElasticInfo;
...
template <TemplateMC2TypeFullmeshClass>
__aicore__ inline void MoeDistributeDispatchV2FullMesh<TemplateMC2TypeFullmeshFunc>::InitWithMc2Context(
    GM_ADDR x, GM_ADDR expertIds, GM_ADDR scales, GM_ADDR xActiveMask, GM_ADDR elasticInfo, GM_ADDR performanceInfo, 
    GM_ADDR expandXOut, GM_ADDR dynamicScalesOut, GM_ADDR expandIdxOut, GM_ADDR expertTokenNumsOut, GM_ADDR sendCountsOut, 
    GM_ADDR tpSendCountsOut, GM_ADDR workspaceGM, GM_ADDR mc2Context, GM_ADDR tilingGM, TPipe *pipe)
{
    ...
    tilingDataOut = (__gm__  MoeDistributeDispatchV2TilingData*)tilingGM;
    auto&& tilingData = tilingDataOut->moeDistributeDispatchV2Info;
