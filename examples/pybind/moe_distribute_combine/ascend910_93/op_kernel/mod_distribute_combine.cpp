...
at::Tensor ascendc_moe_distribute_combine( 
    const at::Tensor& expandX, const at::Tensor& expertIds, const at::Tensor& expandIdx, const at::Tensor& epSendCount, 
    const at::Tensor& scales, const at::Tensor& tpSendCount,const at::Tensor& xActiveMask, const at::Tensor& activationScale,
    const at::Tensor& weightScale, const at::Tensor& groupList,const at::Tensor& expandScales, const at::Tensor& XOut,
    const at::Tensor& workspaceGM, const at::Tensor& tilingGM
)
    ...
    moe_distribute_combine<false, TILINGKEY_NO_QUANT, TILINGKEY_TPL_MTE, TILINGKEY_TPL_A5><<<num_blocks, nullptr, acl_stream>>>(
        ...
        (uint8_t*)(epSendCount.mutable_data_ptr()), (uint8_t*)(scales.mutable_data_ptr()), (uint8_t*)(tpSendCount.mutable_data_ptr()), 
        (uint8_t*)(xActiveMask.mutable_data_ptr()), (uint8_t*)(activationScale.mutable_data_ptr()), (uint8_t*)(weightScale.mutable_data_ptr()),
        (uint8_t*)(groupList.mutable_data_ptr()), (uint8_t*)(expandScales.mutable_data_ptr()), (uint8_t*)(XOut.mutable_data_ptr()),
        (uint8_t*)(workspaceGM.mutable_data_ptr()), (uint8_t*)(tilingGM.mutable_data_ptr())
