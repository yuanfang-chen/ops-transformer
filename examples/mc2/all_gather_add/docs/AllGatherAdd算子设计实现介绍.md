...
本节介绍[op_host](../op_host/op_api/)目录下如何对API生成的两段式aclnn接口进行封装，并在examples目录下的[test_aclnn_all_gather_add.cpp](../examples/test_aclnn_all_gather_add.cpp)文件中进行调用并完成算子执行的。
