...
extern aclnnStatus aclnnInnerMoeDistributeDispatchV2(void* workspace,
...
aclnnStatus aclnnMoeDistributeDispatchV4GetWorkspaceSize(
  ...
  if (is910B) {
    return aclnnInnerMoeDistributeDispatchV2GetWorkspaceSize(
        shmemContext, x, expertIds, scalesOptional, xActiveMaskOptional,
...
aclnnStatus aclnnMoeDistributeDispatchV4(void* workspace,
                                         uint64_t workspaceSize,
                                         aclOpExecutor* executor,
                                         aclrtStream stream) {
  return aclnnInnerMoeDistributeDispatchV2(workspace, workspaceSize, executor,
                                           stream);
}
#ifdef __cplusplus
}
