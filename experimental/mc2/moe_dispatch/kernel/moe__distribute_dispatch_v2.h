...
class MoeDistributeDispatchV2 {
 public:
  ...
  __aicore__ inline void Init(
      GM_ADDR shmemContext, GM_ADDR x, GM_ADDR expertIds, GM_ADDR scales,
 ...
 private:
  ...
  __aicore__ inline void InitElasticInfo(
      GM_ADDR elasticInfo, const MoeDistributeDispatchV2TilingData *tilingData);
  ...
  __aicore__ inline GM_ADDR GetWindAddrByRankId(uint8_t ctxIdx,
    ...
    return (GM_ADDR)(rank0_shmem_addr_ + rankId * pe_stride_) +
           winDataSizeOffset_;
  }

  __aicore__ inline GM_ADDR GetWindStateAddrByRankId(uint8_t ctxIdx,
                                                     const int32_t rankId) {
    return (GM_ADDR)(rank0_shmem_addr_ + rankId * pe_stride_ + shmem_size_ -
                     2 * 1024 * 1024) +
...
__gm__ ShmemContext *shmemContext_;
...
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::InitElasticInfo(
    GM_ADDR elasticInfo, const MoeDistributeDispatchV2TilingData *tilingData) {
...
__aicore__ inline void MoeDistributeDispatchV2<TemplateMC2TypeFunc>::Init(
    ...
    TPipe *pipe, const MoeDistributeDispatchV2TilingData *tilingData) {
  tpipe_ = pipe;
  aivId_ = GetBlockIdx();
  ...
  shmemContext_ = (__gm__ ShmemContext *)shmemContext;
  pe_stride_ = shmemContext_->pe_stride;
  shmem_size_ = shmemContext_->shmem_size;
  rank0_shmem_addr_ = shmemContext_->shmem_addr - epRankId_ * pe_stride_;
  ...
  axisMaxBS_ =
      tilingData->moeDistributeDispatchV2Info.globalBs / epWorldSizeOriginal_;
  ...
  statusDataSpaceGm_ = (GM_ADDR)(GetShmemSignalAddr(shmemContext_, epRankId_));
  ...
  datastateLocalTensor_.SetValue(
      2, tilingData->moeDistributeDispatchV2Info.epRankId);
  datastateLocalTensor_.SetValue(
      3, tilingData->moeDistributeDispatchV2Info.moeExpertNum);
  datastateLocalTensor_.SetValue(
      4, tilingData->moeDistributeDispatchV2Info.epWorldSize);
  datastateLocalTensor_.SetValue(
      5, tilingData->moeDistributeDispatchV2Info.globalBs);
  ...
  winDataSizeOffset_ =
      dataState_ * (tilingData->moeDistributeDispatchV2Info.totalWinSize / 2) +
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2<TemplateMC2TypeFunc>::QuantInit(
    GM_ADDR scales) {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::SplitToCore(
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::SendToSharedExpert() {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::CalTokenSendExpertCnt(
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::SendToMoeExpert() {
  uint32_t startTokenId, endTokenId, sendTokenNum;  // 每个aiv发送时的起始rankid
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::TokenActiveMaskCal() {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::CalValidExpIdx(
    LocalTensor<bool> maskInputTensor) {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::CalValidBSCnt(
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::ExpertActiveMaskCal() {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::MaskZeroComputeExpert(
    uint32_t maskCnt) {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::GenerateGatherMaskTensor(
    uint32_t maskCnt) {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::ZeroComputeExpertMaskCal() {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::AlltoAllDispatch() {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::SetStatus() {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::ReduceMaxInplace(
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::QuantProcess(
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::SyncCntOnCore(
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::BufferInit() {
  tpipe_->Reset();
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::WaitDispatch() {
  BufferInit();
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeDispatchV2<TemplateMC2TypeFunc>::GetCumSum(
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::LocalWindowCopy() {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::AllGatherSetStatusAndWait() {
  PipeBarrier<PIPE_ALL>();
  if (startExpertId_ >= totalExpertNum_) {
    return;
  }
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::AllgatherProcessOut() {
  if (startExpertId_ >= totalExpertNum_) {
    return;
  }
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeDispatchV2<TemplateMC2TypeFunc>::UpdateTokenNumsOut() {
