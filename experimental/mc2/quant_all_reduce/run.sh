...
# 编译芯片型号选择
VERSION_LIST="Ascend910A Ascend910B Ascend310B1 Ascend310B2 Ascend310B3 Ascend310B4 Ascend310P1 Ascend310P3 Ascend910B1 Ascend910B2 Ascend910B3 Ascend910B4 Ascend910_9599 ascend950pr_9599"
...
if [[ "$RUN_TEST" == "ON" ]]; then    
    ...
    echo "======================================"
    # 运行数据生成脚本
    python3 ${CURRENT_DIR}/scripts/data_gen.py \
            "$case_name" \
            "$bs" \
            "$hidden_size" \
            "$input_tensor_range" \
