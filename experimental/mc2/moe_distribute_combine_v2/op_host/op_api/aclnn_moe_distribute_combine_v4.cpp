...
extern aclnnStatus aclnnInnerMoeDistributeCombineV2(void* workspace,
...
aclnnStatus aclnnMoeDistributeCombineV4GetWorkspaceSize(
  ...
  if (is910B) {
    return aclnnInnerMoeDistributeCombineV2GetWorkspaceSize(
        shmemContext, expandX, expertIds, assistInfoForCombine, epSendCounts,
...
aclnnStatus aclnnMoeDistributeCombineV4(void* workspace, uint64_t workspaceSize,
                                        aclOpExecutor* executor,
                                        aclrtStream stream) {
  return aclnnInnerMoeDistributeCombineV2(workspace, workspaceSize, executor,
                                          stream);
}
