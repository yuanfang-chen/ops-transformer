 ...
 * @brief
 * aclnnMoeDistributeCombineV3的第一段接口，根据具体的计算流程，计算workspace大小。
 ...
 *
 */
ACLNN_API aclnnStatus aclnnMoeDistributeCombineV4GetWorkspaceSize(
    const aclTensor* shmemContext, const aclTensor* expandX,
 ...
 * device侧申请的workspace大小，由第一段接口aclnnMoeDistributeCombineV3GetWorkspaceSize获取。
 * @param [in] executor: op执行器，包含了算子计算流程。
 * @param [in] stream: acl stream流。
 * @return aclnnStatus: 返回状态码
 */
ACLNN_API aclnnStatus aclnnMoeDistributeCombineV4(void* workspace,
