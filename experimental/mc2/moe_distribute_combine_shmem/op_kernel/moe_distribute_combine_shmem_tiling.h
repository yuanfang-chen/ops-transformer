...
/*!
 * \file moe_distribute_combine_shmem_tiling.h
 * \brief
 */
#ifndef MOE_DISTRIBUTE_COMBINE_SHMEM_TILING_H
#define MOE_DISTRIBUTE_COMBINE_SHMEM_TILING_H
...
// a3
struct MoeDistributeCombineShmemInfo {
...
struct MoeDistributeCombineShmemTilingData {
  ...
  MoeDistributeCombineShmemInfo moeDistributeCombineShmemInfo;
};

#endif  //__MOE_DISTRIBUTE_COMBINE_SHMEM_TILING_H__