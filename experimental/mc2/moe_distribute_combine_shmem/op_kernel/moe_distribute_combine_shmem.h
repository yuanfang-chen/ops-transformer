...
/*!
 * \file moe_distribute_combine_shmem.h
 * \brief
 */
...
MoeDistributeCombineShmem<TemplateMC2TypeFunc>::TokenMaskCalCnt() {
  // 一维mask, 计算得到有效bs数量
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeCombineShmem<TemplateMC2TypeFunc>::ExpertMaskCalCnt() {
  // 二维mask, 挑选有效token
  uint64_t rsvdCnt = 0;
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeCombineShmem<TemplateMC2TypeFunc>::InitElasticInfo(
...
__aicore__ inline void MoeDistributeCombineShmem<TemplateMC2TypeFunc>::InitAttrs(
  ...
  hasElasticInfoFlag_ = tilingData->moeDistributeCombineShmemInfo.hasElasticInfo;
  epWorldSizeOriginal_ = tilingData->moeDistributeCombineShmemInfo.epWorldSize;
  ...
  sharedExpertNum_ = tilingData->moeDistributeCombineShmemInfo.sharedExpertNum;
  moeSendNum_ = epWorldSize_ * moeExpertPerRankNum_;
  if (epRankId_ < sharedExpertRankNum) {
    isShareExpertRankFlag_ = true;
  }

  tpWorldSize_ = tilingData->moeDistributeCombineShmemInfo.tpWorldSize;
  tpRankId_ = tilingData->moeDistributeCombineShmemInfo.tpRankId;
  totalWinSize_ = tilingData->moeDistributeCombineShmemInfo.totalWinSize;
  isInputTokenMaskFlag_ = tilingData->moeDistributeCombineShmemInfo.isTokenMask;
  isInputExpertMaskFlag_ = tilingData->moeDistributeCombineShmemInfo.isExpertMask;
  hasSharedExpertX_ = tilingData->moeDistributeCombineShmemInfo.hasSharedExpertX;
  zeroExpertNum_ = tilingData->moeDistributeCombineShmemInfo.zeroExpertNum;
  copyExpertNum_ = tilingData->moeDistributeCombineShmemInfo.copyExpertNum;
  constExpertNum_ = tilingData->moeDistributeCombineShmemInfo.constExpertNum;
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeCombineShmem<TemplateMC2TypeFunc>::InitInt8Quant() {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeCombineShmem<TemplateMC2TypeFunc>::MaskAlign() {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeCombineShmem<TemplateMC2TypeFunc>::GenerateActiveMask(half val) {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeCombineShmem<TemplateMC2TypeFunc>::MaskSpecialExpert() {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeCombineShmem<TemplateMC2TypeFunc>::ReduceScatterTrans() {
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeCombineShmem<TemplateMC2TypeFunc>::Int8QuantProcess() {
  SyncFunc<AscendC::HardEvent::MTE2_V>();
  castLocalTensor_ =
      sendLocalTensor_
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDistributeCombineShmem<TemplateMC2TypeFunc>::CustomAdd(
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeCombineShmem<TemplateMC2TypeFunc>::Int8DequantProcess(
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeCombineShmem<TemplateMC2TypeFunc>::ProcessConstantExpert(
...
template <TemplateMC2TypeClass>
__aicore__ inline void
MoeDistributeCombineShmem<TemplateMC2TypeFunc>::ProcessCopyExpert(
