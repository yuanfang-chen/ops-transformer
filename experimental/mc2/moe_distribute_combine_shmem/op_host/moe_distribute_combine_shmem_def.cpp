...
/*!
 * \file moe_distribute_combine_shmem_def.cpp
 * \brief
 */
...
namespace ops {
class MoeDistributeCombineShmem : public OpDef {
 public:
  explicit MoeDistributeCombineShmem(const char* name) : OpDef(name) {
...
OP_ADD(MoeDistributeCombineShmem);
