...
TORCH_LIBRARY(custom, m) {  
    m.def(R"(npu_fused_infer_attention_score( Tensor query, 
                                            Tensor key, 
                                            Tensor value, 
                                            *, 
                                            ...
                                            int[]? actual_seq_qlen=None, 
                                            int[]? actual_seq_kvlen=None, 
                                            ...
                                            int? query_dtype=None, 
                                            int? key_dtype=None, 
                                            int? value_dtype=None, 
                                            int? query_rope_dtype=None, 
                                            int? key_rope_dtype=None, 
                                            int? key_shared_prefix_dtype=None, 
                                            int? value_shared_prefix_dtype=None, 
                                            int? dequant_scale_query_dtype=None, 
