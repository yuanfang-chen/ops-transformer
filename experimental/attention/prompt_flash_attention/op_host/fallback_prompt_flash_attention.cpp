...
static graphStatus PromptHostExecuteFunc(OpExecuteContext* host_api_ctx)
{
  ...
  OP_LOGD("aclnnFallback",
          "PromptFlashAttentionV4 fallback begin, numHeads = %ld, dScaleValue = %lf",
  ...
  auto api_ret = EXEC_OPAPI_CMD(aclnnPromptFlashAttentionV4, query, key, value, pseShiftGe, attenMaskGe, sabiTensorGe, actSeqArray,
