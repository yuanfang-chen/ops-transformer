...
aclnnStatus InnerPromptFlashAttentionV4GetWorkspaceSize(
...
{
    L2_DFX_PHASE_1(InnerPromptFlashAttentionV4,
    ...
    auto l0AttentionOutOut = l0op::PromptFlashAttention(query, key, value, pseShift, attenMask, sabiTensor,
...
aclnnStatus InnerPromptFlashAttentionV4(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
                                           const aclrtStream stream)
{
    L2_DFX_PHASE_2(InnerPromptFlashAttentionV4);
