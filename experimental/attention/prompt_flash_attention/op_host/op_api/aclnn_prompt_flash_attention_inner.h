 ...
 * @domain aclnn_math
 */
ACLNN_API aclnnStatus InnerPromptFlashAttentionV4GetWorkspaceSize(
 ...
 */
ACLNN_API aclnnStatus InnerPromptFlashAttentionV4(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor,
