...
// Constants
constexpr uint32_t AIC_CORE_NUM = 36;  // TODO 根据编译宏确定 aicpu与kernel的宏保持一致
 ...
 */
inline uint32_t GetAttrAbsIndex(uint32_t aicIdx, uint32_t metaIdx, bool isFDMeta=false, uint32_t aivIdx=0)
{
