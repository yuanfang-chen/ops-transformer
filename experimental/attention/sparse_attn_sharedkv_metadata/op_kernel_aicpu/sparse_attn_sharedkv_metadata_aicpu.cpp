...
bool SparseAttnSharedkvMetadataCpuKernel::CheckSingleParamN128()
{
    // 核心数校验
...
bool SparseAttnSharedkvMetadataCpuKernel::CheckConsistencyN128()
{
...
bool SparseAttnSharedkvMetadataCpuKernel::CheckFeatureN128()
{
    return true;
}

bool SparseAttnSharedkvMetadataCpuKernel::ParamsCheckN128()
{
...
uint32_t SparseAttnSharedkvMetadataCpuKernel::GetCmpTopkLength(uint32_t bIdx)
{
    // 尝试使用 cmpTopkLength_
