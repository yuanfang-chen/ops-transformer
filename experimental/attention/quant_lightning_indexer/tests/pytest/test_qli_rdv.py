...
import itertools
import torch
import check_result_method13
import check_result_a5
import qli_pt_process
import pytest
import random
import pandas as pd
...
pt_dir = "/home/rdv/qli_precision_rdv/pytest_qli/output"
...
def qli(testcase_files):   # 初始化参数和tensor
    cpu_result, npu_result, topk_value, params = qli_pt_process.test_qli_process(testcase_files, device_id=0)
    if npu_result != None:
        result, fulfill_percent = check_result_method13.check_result(cpu_result, npu_result, topk_value, params)
    ...
    row_data = {
        ...
        "act_seq_q": params[13],
        "act_seq_k": params[14],
        "query_quant_mode": params[15],
        "key_quant_mode": params[16],
        "layout_query": params[17],
        "layout_key": params[18],
        "sparse_count":params[19],
        "sparse_mode":params[20],
        "query_datarange":params[21],
        "key_datarange":params[22],
        "weights_datarange":params[23],
        "q_scale_datarange":params[24],
        "k_scale_datarange":params[25],
        "cmp_ratio":params[26],
        "result":result,
        "fulfill_percent":fulfill_percent.cpu()
    }
