...
//     OP_CHECK_IF(
//         ((inputQType_ == at::ScalarType::Half) && (inputKvType_ != at::ScalarType::Half && inputKvType_ != ge::DT_INT8 && inputKvType_ != ge::DT_INT4)), OP_LOGE(ifaContext_->opName, "when input Q type is fp16, KV type %d should be fp16 or int8 or int4", inputKvType_),
//         return custom::graphStatus::GRAPH_FAILED);

//     OP_CHECK_IF(
//         ((inputQType_ == at::ScalarType::BFloat16) && (inputKvType_ != at::ScalarType::BFloat16 && inputKvType_ != ge::DT_INT8 && inputKvType_ != ge::DT_INT4)), OP_LOGE(ifaContext_->opName, "when input Q type is bf16, KV type %d should be bf16 or int8 or int4", inputKvType_),
//         return custom::graphStatus::GRAPH_FAILED);
...
// custom::graphStatus IFATiling::CheckQuant2Shape(const gert::Shape &inputParaShape) const
// {
...
// custom::graphStatus IFATiling::SharedPrefixCheckShapes(const gert::Shape &keyShape, const gert::Shape &valueShape) const
// {
//     OP_CHECK_IF(
...
// custom::graphStatus IFATiling::CheckUbSpace()
// {
...
//         bool quantFlag = antiQuantFlag_ && (antiquantMode_ == PER_CHANNEL_MODE) && (inputQType_ == at::ScalarType::Half || inputQType_ == at::ScalarType::BFloat16) && (inputKvType_ == ge::DT_INT8);
...
//         (inputQType_ == at::ScalarType::BFloat16) && (inputKvType_ == ge::DT_INT8)) {
//         return true;
//     }
//     return false;
// }
...
//         return custom::graphStatus::GRAPH_FAILED;
//     }
//     OP_CHECK_IF(ifaContext_->query.desc->GetDataType() != at::ScalarType::BFloat16,
...
//         ifaContext_->query.desc->GetDataType()), return custom::graphStatus::GRAPH_FAILED);
...
//         ifaContext_->key.desc->GetDataType()), return custom::graphStatus::GRAPH_FAILED);
...
//         ifaContext_->value.desc->GetDataType()), return custom::graphStatus::GRAPH_FAILED);
//     OP_CHECK_IF(ifaContext_->attenOut.desc->GetDataType() != at::ScalarType::BFloat16,
...
//         ifaContext_->attenOut.desc->GetDataType()), return custom::graphStatus::GRAPH_FAILED);
...
//                 "Expect 2 when sparseMode 3 in GQA KV NZ.", attenMaskTensor->GetStorageShape().GetDimNum()), return custom::graphStatus::GRAPH_FAILED);
