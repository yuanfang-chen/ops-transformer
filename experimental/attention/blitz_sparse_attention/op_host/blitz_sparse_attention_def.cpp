...
/*!
 * \file blitz_sparse_attention_def.cpp
 * \brief
 */
#include "register/op_def_registry.h"

// namespace optiling {
// ge::graphStatus TilingBlitzSparseAttention(gert::TilingContext* context);
// }

namespace ops {
class BlitzSparseAttention : public OpDef {
public:
    BlitzSparseAttention(const char* name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
...
OP_ADD(BlitzSparseAttention, optiling::BlitzSparseAttentionCompileInfo);
}
