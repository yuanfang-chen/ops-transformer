...
/*!
 * \file blitz_sparse_attention_template_tiling_key.h
 * \brief
 */
#pragma once
    ...
    ASCENDC_TPL_SEL(        
        //BSA
            ...
            ASCENDC_TPL_ARGS_SEL(  
                ...
                ASCENDC_TPL_TILING_STRUCT_SEL(BlitzSparseAttentionTilingData)
            ),
            #endif
            #if (ORIG_DTYPE_QUERY == DT_FLOAT16) && (ORIG_DTYPE_ATTENTION_OUT == DT_FLOAT16)
            ASCENDC_TPL_ARGS_SEL(
            ...
            ASCENDC_TPL_ARGS_SEL(
                ...
                ASCENDC_TPL_UINT_SEL(TEMPLATE_MODE, ASCENDC_TPL_UI_LIST, 2),
                ASCENDC_TPL_TILING_STRUCT_SEL(BlitzSparseAttentionBaseApiTilingData)
            ),
            #endif
            #if (ORIG_DTYPE_QUERY == DT_BF16) && (ORIG_DTYPE_ATTENTION_OUT == DT_BF16)
            ASCENDC_TPL_ARGS_SEL(
