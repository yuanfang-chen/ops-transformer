...
/*!
 * \file blitz_sparse_attention_var_len_score_sab_baseapi.h
 * \brief
 */

#ifndef BLITZ_SPARSE_ATTENTION_VAR_LEN_SCORE_SAB_BASEAPI_H
#define BLITZ_SPARSE_ATTENTION_VAR_LEN_SCORE_SAB_BASEAPI_H
...
class BlitzSparseAttentionVarLenScoreSameABBaseApi
...
public:
    __aicore__ inline BlitzSparseAttentionVarLenScoreSameABBaseApi(){};
...
__aicore__ inline void BlitzSparseAttentionVarLenScoreSameABBaseApi<TILING_TYPE, implMode, layOutType, hasAtten, INPUT_T, T,
...
template <typename TILING_TYPE, ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasAtten, typename INPUT_T, typename T,
          CubeFormat bmm1Format, MmPolicyType mmPolicyType, bool pageAttention>
__aicore__ inline int64_t BlitzSparseAttentionVarLenScoreSameABBaseApi<TILING_TYPE, implMode, layOutType, hasAtten, INPUT_T, T,
...
template <typename TILING_TYPE, ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasAtten, typename INPUT_T, typename T,
          CubeFormat bmm1Format, MmPolicyType mmPolicyType, bool pageAttention>
__aicore__ inline void
BlitzSparseAttentionVarLenScoreSameABBaseApi<TILING_TYPE, implMode, layOutType, hasAtten, INPUT_T, T,
...
#endif // BLITZ_SPARSE_ATTENTION_VAR_LEN_SCORE_SAB_BASEAPI_H
