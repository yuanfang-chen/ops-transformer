...
#include "blitz_sparse_attention_base_mla.h"
#include "blitz_sparse_attention_base_mla_high_precision.h"
#include "blitz_sparse_attention_s1s2_bns1_mla.h"
#include "blitz_sparse_attention_var_len_score_sab.h"
#include "blitz_sparse_attention_s1s2_bns1_mla_baseapi.h"
#include "blitz_sparse_attention_var_len_score_sab_baseapi.h"
...
#include "blitz_sparse_attention_s1s2_bns1_x310_base.h"
#include "blitz_sparse_attention_s1s2_bns1_x310.h"
#include "blitz_sparse_attention_tiling_data.h"
#include "blitz_sparse_attention_template_tiling_key.h"
#endif
        ...
        *p = reinterpret_cast<uint64_t>(sabiTensor);
        ...
        if constexpr ((Q_T == 0 || Q_T == 6) && (KV_T != 1)){
            ...
            if constexpr ((M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 2) && (M_K_QUANTMODE_P_NEWTILINGFLAG_I_AMLA == 1) && (Q_T == 0) && (M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE == 1) && (OUT_T == 0) && (LAYOUT_T == 1) && (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 0) && (PAGE_ATTENTIOND == 0) && (ENABLE_PREFIX == 0) && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (P_CVDIFF_BASE_FLAG == 0) && (P_CVDIFF_MLA_FLAG == 0)    
                ...
                && (KV_T == 0) && (P_TEMPLATE_VERSION == 2)){
                REGISTER_TILING_FOR_TILINGKEY("TRUE", BlitzSparseAttentionBaseApiTilingData);
                INVOKE_PFA_GENERAL_OP_IMPL_MLA(BlitzSparseAttentionBaseMLA, PFAMLAType<BlitzSparseAttentionBaseApiTilingData>);
            }
            if constexpr ((M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 2) && (M_K_QUANTMODE_P_NEWTILINGFLAG_I_AMLA == 1) && (Q_T == 0 || Q_T == 6) && (M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE == 0 || M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE == 1) && (OUT_T == 0)   
                ...
                && (LAYOUT_T == 0) && (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 4) && (PAGE_ATTENTIOND == 0) && (ENABLE_PREFIX == 0) && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (P_CVDIFF_MLA_FLAG == 0 || P_CVDIFF_MLA_FLAG == 1) && (KV_T == 0)){
                    if (P_CVDIFF_MLA_FLAG == 0){
                        ...
                        REGISTER_TILING_FOR_TILINGKEY("TRUE", BlitzSparseAttentionBaseApiTilingData);
                        INVOKE_PFA_GENERAL_OP_IMPL_MLA(BlitzSparseAttentionBaseMLAHighPrecision, PFAHighPrecisionMLAType<BlitzSparseAttentionBaseApiTilingData, half, false>);
                    }
                }
            }
            ...
            && (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 4) && (PAGE_ATTENTIOND == 0)){
                REGISTER_TILING_FOR_TILINGKEY("TRUE", BlitzSparseAttentionBaseApiTilingData);
                INVOKE_PFA_GENERAL_OP_IMPL_MLA(BlitzSparseAttentionBaseMLAHighPrecision, PFAHighPrecisionMLAType<BlitzSparseAttentionBaseApiTilingData, bfloat16_t, true>);
            }
            ...
            && (PAGE_ATTENTIOND == 0) && (P_CVDIFF_BASE_FLAG == 0)  && (P_CVDIFF_MLA_FLAG == 0)){
                ...
                INVOKE_PFA_GENERAL_OP_IMPL_VAR_LEN(BlitzSparseAttentionVarLenScoreSameAB, MLAGeneralTilingData, ImplModeEnum::AA_HIGH_PRECISION,
            ...
            && (P_CVDIFF_BASE_FLAG == 0)  && (P_CVDIFF_MLA_FLAG == 0)){
                REGISTER_TILING_FOR_TILINGKEY("TRUE", MLAGeneralTilingData);
                INVOKE_PFA_NO_KFC_MLA_OP_IMPL_VAR_LEN(BlitzSparseAttentionVarLenScoreSameABBaseApi, MLAGeneralTilingData, ImplModeEnum::AA_HIGH_PRECISION,
        ...
        if constexpr( (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 0) && (PAGE_ATTENTIOND == 0) && (ENABLE_PREFIX == 0) && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (P_CVDIFF_BASE_FLAG == 0) && (P_CVDIFF_MLA_FLAG == 0)   
            ...
            if constexpr ((M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 8) && (M_K_QUANTMODE_P_NEWTILINGFLAG_I_AMLA == 8) && (Q_T == 2) && (M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE == 2) && (OUT_T == 1) && (LAYOUT_T == 1)){
                ...
                INVOKE_PFA_GENERAL_OP_IMPL(BlitzSparseAttentionS1s2Bns1X310, PFATypeNZ<PFALayoutNZ::BNSD, half, int8_t, half>);
            }
                ...
                INVOKE_PFA_GENERAL_OP_IMPL(BlitzSparseAttentionS1s2Bns1X310, PFATypeNZ<PFALayoutNZ::BSH, half, int8_t, half>);
            }
                ...
                INVOKE_PFA_GENERAL_OP_IMPL(BlitzSparseAttentionS1s2Bns1X310, PFATypeNZ<PFALayoutNZ::BNSD, half, int8_t, half, half, ModeNZ::HighPrecisionNZ>);
            }
                ...
                INVOKE_PFA_GENERAL_OP_IMPL(BlitzSparseAttentionS1s2Bns1X310, PFATypeNZ<PFALayoutNZ::BSH, half, int8_t, half, half, ModeNZ::HighPrecisionNZ>);
            }
        }
    #endif
    }    
