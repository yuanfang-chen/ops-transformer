...
/*!
 * \file blitz_sparse_attention_bnstilling_n_s_no_tailWBNSD.h
 * \brief
 */
#ifndef BLITZ_SPARSE_ATTENTION_SCORE_BNSTILLING_N_S_WITHBNSD_NO_TAIL_H
#define BLITZ_SPARSE_ATTENTION_SCORE_BNSTILLING_N_S_WITHBNSD_NO_TAIL_H
...
class BlitzSparseAttentionBNSTillingNSWithBNSDNoTail : public BlitzSparseAttentionBase<T, U, FORMAT, O, M> {
public:
    // define datatype
    ...
    __aicore__ inline BlitzSparseAttentionBNSTillingNSWithBNSDNoTail() {};
...
__aicore__ inline void BlitzSparseAttentionBNSTillingNSWithBNSDNoTail<T, U, FORMAT, O, M>::Process() {
...
template<typename T, typename U, CubeFormat FORMAT, typename O, OptimizationMode M>
__aicore__ inline void BlitzSparseAttentionBNSTillingNSWithBNSDNoTail<T, U, FORMAT, O, M>::PseShiftCopyIn(uint64_t offset,
                                                                                     uint32_t sinnerSize,
...
template<typename T, typename U, CubeFormat FORMAT, typename O, OptimizationMode M>
__aicore__ inline void BlitzSparseAttentionBNSTillingNSWithBNSDNoTail<T, U, FORMAT, O, M>::AttenMaskCopyIn(uint64_t offset,
                                                                                             uint32_t sinnerSize,
                                                                                             uint32_t sInnerLoopIdx) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O, OptimizationMode M>
__aicore__ inline void BlitzSparseAttentionBNSTillingNSWithBNSDNoTail<T, U, FORMAT, O, M>::PseShiftProcess(int64_t sInnerLoopIdx,
...
template<typename T, typename U, CubeFormat FORMAT, typename O, OptimizationMode M>
__aicore__ inline void BlitzSparseAttentionBNSTillingNSWithBNSDNoTail<T, U, FORMAT, O, M>::Bmm1ResDoVecBmm2ComputeFirst(LocalTensor<mmOutputType>& mmResUb,
...
template<typename T, typename U, CubeFormat FORMAT, typename O, OptimizationMode M>
__aicore__ inline void BlitzSparseAttentionBNSTillingNSWithBNSDNoTail<T, U, FORMAT, O, M>::Bmm1ResDoVecBmm2Compute(LocalTensor<mmOutputType>& mmResUb,
                                            LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb,
...
template<typename T, typename U, CubeFormat FORMAT, typename O, OptimizationMode M>
__aicore__ inline void BlitzSparseAttentionBNSTillingNSWithBNSDNoTail<T, U, FORMAT, O, M>::SInnerLoopFunc(int32_t startIndex,
                                                                                            int32_t endIndex) {
    if (startIndex < 0) {
        startIndex = 0;
    }
...
template<typename T, typename U, CubeFormat FORMAT, typename O, OptimizationMode M>
__aicore__ inline void BlitzSparseAttentionBNSTillingNSWithBNSDNoTail<T, U, FORMAT, O, M>::ComputeEachCoreSInnerLoop(uint32_t startIndex,
                                                                                uint32_t endIndex) {
    bool isSecond = true;
...
template<typename T, typename U, CubeFormat FORMAT, typename O, OptimizationMode M>
__aicore__ inline void BlitzSparseAttentionBNSTillingNSWithBNSDNoTail<T, U, FORMAT, O, M>::ComputeEachCore(uint32_t coreIdx) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O, OptimizationMode M>
__aicore__ inline void BlitzSparseAttentionBNSTillingNSWithBNSDNoTail<T, U, FORMAT, O, M>::ComputeEachCoreBalance(uint32_t coreIdx) {
    int sNum = this->tilingData->promptAttentionBaseParams.dimNumOfseq;
    if (sNum == 0) {
	    return;
    }
...
#endif  // BLITZ_SPARSE_ATTENTION_SCORE_BNSTILLING_N_S_WITHBNSD_NO_TAIL_H
