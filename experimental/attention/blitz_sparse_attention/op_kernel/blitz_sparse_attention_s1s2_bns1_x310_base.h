...
/*!
 * \file blitz_sparse_attention_s1s2_bns1_x310_base.h
 * \brief
 */
#ifndef BLITZ_SPARSE_ATTENTION_S1S2_BNS1_X310_BASE_H
#define BLITZ_SPARSE_ATTENTION_S1S2_BNS1_X310_BASE_H
...
struct BlitzSparseAttentionTypeTraitsNZ
{
    using mmInputType = T;
    using mmBiasType = T;
...
class BlitzSparseAttentionS1s2Bns1X310Base {
public:
    __aicore__ inline BlitzSparseAttentionS1s2Bns1X310Base() {};
    __aicore__ inline void Init(__gm__ uint8_t* query, __gm__ uint8_t* key, __gm__ uint8_t* value,
                                ...
                                const BlitzSparseAttentionTilingData* __restrict tiling, __gm__ uint8_t* gmTiling, TPipe* tPipe);
    ...
    // define datatype
    using mmInputType = typename BlitzSparseAttentionTypeTraitsNZ<T, PFAT::calcMode>::mmInputType;
    using mmBiasType = typename BlitzSparseAttentionTypeTraitsNZ<T, PFAT::calcMode>::mmBiasType;
    using mmOutputType = typename BlitzSparseAttentionTypeTraitsNZ<T, PFAT::calcMode>::mmOutputType;
    using mm1OutputType = typename BlitzSparseAttentionTypeTraitsNZ<T, PFAT::calcMode>::mm1OutputType;
    using softmaxType = typename BlitzSparseAttentionTypeTraitsNZ<T, PFAT::calcMode>::softmaxType;
    // define matmul
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::Init(__gm__ uint8_t* query, __gm__ uint8_t* key,
                                        ...
                                        __gm__ uint8_t* keySharedPrefix, __gm__ uint8_t* valueSharedPrefix, __gm__ uint8_t* actualSharedPrefixLen,
                                        __gm__ uint8_t* attentionOut, __gm__ uint8_t* softmaxLse, __gm__ uint8_t* workspace,
                                        const BlitzSparseAttentionTilingData* __restrict tiling, __gm__ uint8_t* gmTiling,
                                        TPipe* tPipe) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::InitMsd(__gm__ uint8_t* key_antiquant_scale, __gm__ uint8_t* key_antiquant_offset, __gm__ uint8_t* value_antiquant_scale, __gm__ uint8_t* value_antiquant_offset) {
    return;
}

template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::InitOutputSingleCore()
{
...
template<>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFATypeNZ<PFALayoutNZ::BNSD, int8_t, bool, int8_t>>::InitOutputSingleCore() {}
template<>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFATypeNZ<PFALayoutNZ::BSH, int8_t, bool, int8_t>>::InitOutputSingleCore() {}

template<>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFATypeNZ<PFALayoutNZ::BNSD, int8_t, half, int8_t>>::InitOutputSingleCore() {}
template<>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFATypeNZ<PFALayoutNZ::BSH, int8_t, half, int8_t>>::InitOutputSingleCore() {}

template<>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFATypeNZ<PFALayoutNZ::BNSD, int8_t, float, int8_t>>::InitOutputSingleCore() {}
template<>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFATypeNZ<PFALayoutNZ::BSH, int8_t, float, int8_t>>::InitOutputSingleCore() {}

template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::initOffset() {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::InitTensorSize(
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::AttenMaskCopyIn(uint64_t offset,
                                                                                             uint32_t sinnerSize,
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::AttenMaskTransND2NZ(uint32_t SInnerSize, uint32_t SOuterSize)
{
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::ElewiseCompute310P(LocalTensor<mm1OutputType>& mmResUb, uint32_t SInnerSize, uint32_t SOuterSize) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::SoftmaxBasicComputeFirstTail(LocalTensor<mm1OutputType>& mmResUb,
                                                        LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb,
                                                        LocalTensor<softmaxType>& softmaxExpUb, LocalTensor<uint8_t>& sharedTmpUb,
                                                        const SoftMaxShapeInfo &softmaxShapeInfo) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::SoftmaxBasicComputeTail(LocalTensor<mm1OutputType>& mmResUb,
                                                    LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb,
                                                    LocalTensor<softmaxType>& softmaxExpUb, LocalTensor<uint8_t>& sharedTmpUb,
                                                    const SoftMaxShapeInfo &softmaxShapeInfo) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::SoftmaxBasicComputeFirstTailTmp(LocalTensor<mmOutputType>& mmResUb,
                                                        LocalTensor<mmOutputType>& softmaxMaxUb, LocalTensor<mmOutputType>& softmaxSumUb,
                                                        LocalTensor<mmOutputType>& softmaxExpUb, LocalTensor<uint8_t>& sharedTmpUb,
                                                        const SoftMaxShapeInfo &softmaxShapeInfo) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::SoftmaxBasicComputeTailTmp(LocalTensor<mmOutputType>& mmResUb,
                                                    LocalTensor<mmOutputType>& softmaxMaxUb, LocalTensor<mmOutputType>& softmaxSumUb,
                                                    LocalTensor<mmOutputType>& softmaxExpUb, LocalTensor<uint8_t>& sharedTmpUb,
                                                    const SoftMaxShapeInfo &softmaxShapeInfo) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::Bmm2UpdateDivNoTail310P(LocalTensor<mmOutputType>& bmm2ResPreUb,
                                            LocalTensor<float>& softmaxSumUb, LocalTensor<softmaxType>& softmaxExpUb) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::Bmm2UpdateDivNoTail310PTmp(LocalTensor<mmOutputType>& bmm2ResPreUb,
                                            LocalTensor<mmOutputType>& softmaxSumUb, LocalTensor<softmaxType>& softmaxExpUb) {
    int32_t headLoop = tilingData->promptAttentionBaseParams.headSize / softmaxTypeByteNum;
    constexpr int32_t REPEAT_DATA_NUM = 256 / sizeof(softmaxType);
    BinaryRepeatParams repeatParams;
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::Bmm2Compute(LocalTensor<mmOutputType>& bmm2ResL1) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::UpdateVmul(LocalTensor<softmaxType>& softmaxExpUb) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::ComputeAttenMaskOffset(uint32_t sInnerLoopIdx, bool isLast) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::ComputeOffset(uint32_t sInnerLoopIdx, bool isLast) {
    if constexpr (PFAT::layout == PFALayoutNZ::BSH) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::DataCopyTransposeOut(LocalTensor<mmOutputType>& bmm2ResUb) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::Bmm1Compute(LocalTensor<mmInputType>& a1Local,
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::LoopSOuterOffsetInitWithBSH(uint32_t seqListOffsetSize, int sIdx) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::LoopSOuterOffsetInitWithBNSD(uint32_t seqListOffsetSize,
                                                                                    int sIdx) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::LoopSOuterOffsetInit(uint32_t seqListOffsetSize, int sIdx) {
    if constexpr (PFAT::layout == PFALayoutNZ::BSH) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::Bmm2UpdateAdd(LocalTensor<mmOutputType>& bmm2ResUb) {
    LocalTensor<mmOutputType> bmm2ResPreUb = tempBmm2Ub.Get<mmOutputType>(bmm2ResUbSize);
    Add(bmm2ResPreUb, bmm2ResUb, bmm2ResPreUb, bmm2ResUbSize);
}

template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::GetSingleCoreParam(int sIdx) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310Base<PFAT>::CopyND2NZOnTheFly(
...
#endif  // BLITZ_SPARSE_ATTENTION_S1S2_BNS1_X310_BASE_H