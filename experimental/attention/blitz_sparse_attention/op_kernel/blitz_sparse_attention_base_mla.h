...
/*!
 * \file blitz_sparse_attention_base_mla.h
 * \brief
 */
#ifndef BLITZ_SPARSE_ATTENTION_BASE_MLA_H
#define BLITZ_SPARSE_ATTENTION_BASE_MLA_H
...
template <typename PFAT>
class BlitzSparseAttentionBaseMLA {
public:
    __aicore__ inline BlitzSparseAttentionBaseMLA() {};
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionBaseMLA<PFAT>::Init(__gm__ uint8_t* query, __gm__ uint8_t* key,
...
#endif  // BLITZ_SPARSE_ATTENTION_BASE_MLA_H
