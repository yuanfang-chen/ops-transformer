...
/*!
 * \file blitz_sparse_attention_var_len_score_sab.h
 * \brief
 */

#ifndef BLITZ_SPARSE_ATTENTION_VAR_LEN_SCORE_SAB_H
#define BLITZ_SPARSE_ATTENTION_VAR_LEN_SCORE_SAB_H
...
__aicore__ inline void BlitzSparseAttentionVarLenScoreSameAB<TILING_TYPE, implMode, layOutType, hasAtten, INPUT_T, T,
...
template <typename TILING_TYPE, ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasAtten, typename INPUT_T, typename T,
          CubeFormat bmm1Format, MmPolicyType mmPolicyType>
__aicore__ inline void
BlitzSparseAttentionVarLenScoreSameAB<TILING_TYPE, implMode, layOutType, hasAtten, INPUT_T, T,
...
#endif // BLITZ_SPARSE_ATTENTION_VAR_LEN_SCORE_SAB_H
