...
/*!
 * \file blitz_sparse_attention_s1s2_bns1_x910_base.h
 * \brief
 */
#ifndef BLITZ_SPARSE_ATTENTION_S1S2_BNS1_X910_BASE_H
#define BLITZ_SPARSE_ATTENTION_S1S2_BNS1_X910_BASE_H
#include <type_traits>
...
class BlitzSparseAttentionS1s2Bns1X910Base {
public:
    __aicore__ inline BlitzSparseAttentionS1s2Bns1X910Base() {};
    ...
    using mmBiasType = typename BlitzSparseAttentionTypeTraits<T,PFAT::calcMode>::mmBiasType;
                                      ...
                                      const uint64_t tilingPtr, const uint64_t dataPtr)
    {
        ...
        __gm__ BlitzSparseAttentionTilingData* tilingDataPtr = reinterpret_cast<__gm__ BlitzSparseAttentionTilingData*>(tilingPtr);
        // Directly using fixed TilingData on the stack during static compilation.
        BlitzSparseAttentionTilingData allTilingData;
...
protected:
    ...
    GlobalTensor<uint16_t> sabiBaseGm;  // block-sparse attention
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::PostQuant2PerChannelBF16(LocalTensor<computeType> &bmm2ResUb, LocalTensor<int8_t> &outputQuantRes) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::PostQuant2PerChannelFP16(LocalTensor<computeType> &bmm2ResUb, LocalTensor<int8_t> &outputQuantRes) {
    if constexpr (IsSameType<computeType, float>::value) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::PostQuant2PerChannelFP32(LocalTensor<computeType> &bmm2ResUb, LocalTensor<int8_t> &outputQuantRes) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::CalPseShiftOffset(int sIdx) {
    if (!(this->tailParams->usePseShift)) {
        return;
    }
    int64_t queryLeftpaddingSize = GetQueryLeftPaddingSize(sIdx);
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::QuantCompute(LocalTensor<int8_t> quantResUb, LocalTensor<computeType> mmResUb,
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::InitScale2InQuant(__gm__ uint8_t* scale2, __gm__ uint8_t* offset2){
    if (scale2 != nullptr) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::InitOffset2InQuant(__gm__ uint8_t* scale2, __gm__ uint8_t* offset2){
    if (offset2 != nullptr) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::InitQuant(__gm__ uint8_t* deq_scale1,
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::InitKvAntiquant(__gm__ uint8_t* antiq_scale, __gm__ uint8_t* antiq_offset, __gm__ uint8_t* key_antiquant_scale, __gm__ uint8_t* key_antiquant_offset,
                                                                                   __gm__ uint8_t* value_antiquant_scale, __gm__ uint8_t* value_antiquant_offset) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::InitMsd(__gm__ uint8_t* key_antiquant_scale, __gm__ uint8_t* key_antiquant_offset, __gm__ uint8_t* value_antiquant_scale, __gm__ uint8_t* value_antiquant_offset) {
    if constexpr (PFAT::msdMode == MsdMode::MSD_ON) {
        if (key_antiquant_scale != nullptr) {
            keyAntiquantScaleGm.SetGlobalBuffer((__gm__ T*)key_antiquant_scale);
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::InitMsdBuffers(__gm__ uint8_t* workspace) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::Init(__gm__ uint8_t* query, __gm__ uint8_t* key,
    ...
    // Get sabi tensor pointer from user workspace
    constexpr uint32_t kSabiPtrOffBytes = 0; // must be the same as in attention/blitz_sparse_attention/op_kernel/blitz_sparse_attention.cpp sabiOffset
    const uint64_t sabiAddr = *reinterpret_cast<__gm__ const uint64_t*>(workspace + kSabiPtrOffBytes);
    sabiBaseGm.SetGlobalBuffer((__gm__ uint16_t*)sabiAddr);
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::InitLseOutputSingleCore() {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::InitOutputSingleCore()
{
    auto &initParams = tilingData->promptAttentionInitOutputParams;
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::initOffset() {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::InitTensorSize(
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::SoftmaxBasicComputeFirstNoTail(
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::SoftmaxBasicComputeNoTail(LocalTensor<computeType>& mmResUb,
                                            LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb,
                                            LocalTensor<computeType>& softmaxExpUb, uint32_t souterSize) {
    SoftMaxShapeInfo softmaxShapeInfo;
    if (this->headParams->isInnerTail) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::SoftmaxComputeFirstTail(LocalTensor<computeType>& mmResUb,
                                            LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb, uint32_t souterSize) {
    LocalTensor<computeType> null;
    SoftMaxShapeInfo softmaxShapeInfo;
    if (this->headParams->isInnerTail) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::SoftmaxComputeTail(LocalTensor<computeType>& mmResUb,
                                            LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb,
                                            LocalTensor<computeType>& softmaxExpUb, uint32_t souterSize) {
    SoftMaxShapeInfo softmaxShapeInfo;
    if (this->headParams->isInnerTail) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::Bmm2UpdateDivNoTail(LocalTensor<computeType>& bmm2ResPreUb,
                                            LocalTensor<float>& softmaxSumUb) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::UpdateVmul(LocalTensor<computeType>& softmaxExpUb) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::Bmm2UpdateAdd(LocalTensor<computeType>& bmm2ResUb) {
    LocalTensor<computeType> bmm2ResPreUb = tempBmm2Ub.Get<computeType>(bmm2ResUbSize);
    Add(bmm2ResPreUb, bmm2ResUb, bmm2ResPreUb, bmm2ResUbSize);
}

template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X910Base<PFAT>::GetSingleCoreParam(int sIdx) {
    int64_t actualSeqLengthPerBatch = 0;
    int64_t actualSeqLengthKVPerBatch = 0;
...
#endif  // BLITZ_SPARSE_ATTENTION_S1S2_BNS1_X910_BASE_H
