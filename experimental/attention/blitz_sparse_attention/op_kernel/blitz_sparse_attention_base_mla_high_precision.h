...
/*!
 * \file blitz_sparse_attention_base_mla_high_precision.h
 * \brief
 */
#ifndef BLITZ_SPARSE_ATTENTION_BASE_MLA_HIGH_PRECISION_H
#define BLITZ_SPARSE_ATTENTION_BASE_MLA_HIGH_PRECISION_H
...
template <typename PFAT>
class BlitzSparseAttentionBaseMLAHighPrecision {
public:
    __aicore__ inline BlitzSparseAttentionBaseMLAHighPrecision() {};
...
#endif  // BLITZ_SPARSE_ATTENTION_BASE_MLA_HIGH_PRECISION_H
