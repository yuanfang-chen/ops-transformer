...
/*!
 * \file blitz_sparse_attention_s1s2_bns1_x310.h
 * \brief
 */
#ifndef BLITZ_SPARSE_ATTENTION_S1S2_BNS1_X310_H
#define BLITZ_SPARSE_ATTENTION_S1S2_BNS1_X310_H

#include "blitz_sparse_attention_s1s2_bns1_x310_base.h"
#include "kernel_operator.h"
using namespace matmul;
template<typename PFAT>
class BlitzSparseAttentionS1s2Bns1X310 : public BlitzSparseAttentionS1s2Bns1X310Base<PFAT> {
public:
    ...
    __aicore__ inline BlitzSparseAttentionS1s2Bns1X310() {};
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310<PFAT>::Process() {
    ComputeEachCore(this->tmp_block_idx);
}

template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310<PFAT>::SInnerLoopFunc(int32_t startIndex,
                                                                                            int32_t endIndex) {
    if (startIndex < 0) {
        startIndex = 0;
    }
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310<PFAT>::ComputeSoftmax(LocalTensor<mm1OutputType>& mmResUb,
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310<PFAT>::ComputeEachCoreSInnerLoop(uint32_t startIndex,
                                                                                uint32_t endIndex) {
...
template<typename PFAT>
__aicore__ inline void BlitzSparseAttentionS1s2Bns1X310<PFAT>::ComputeEachCore(uint32_t coreIdx) {
...
#endif  // BLITZ_SPARSE_ATTENTION_S1S2_BNS1_X310_H