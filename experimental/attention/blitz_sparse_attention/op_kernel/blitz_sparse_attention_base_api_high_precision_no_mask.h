...
/*!
 * \file blitz_sparse_attention_base_api_high_precision_no_mask.h
 * \brief
 */
#ifndef BLITZ_SPARSE_ATTENTION_BASE_API_HIGH_PRECISION_NO_MASK_H
#define BLITZ_SPARSE_ATTENTION_BASE_API_HIGH_PRECISION_NO_MASK_H
...
template <typename PFAT>
class BlitzSparseAttentionBaseApiHighPrecisionNoMask {
public:
    __aicore__ inline BlitzSparseAttentionBaseApiHighPrecisionNoMask() {};
...
#endif  // BLITZ_SPARSE_ATTENTION_BASE_API_HIGH_PRECISION_NO_MASK_H
