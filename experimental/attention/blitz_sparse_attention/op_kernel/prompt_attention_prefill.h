 ...
 * \brief
 */
#ifndef BLITZ_SPARSE_ATTENTION_PREFILL_H
#define BLITZ_SPARSE_ATTENTION_PREFILL_H
...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                ...
                                __gm__ uint8_t *workspace, const BlitzSparseAttentionBaseApiTilingData* __restrict tiling);
...
protected:
    const BlitzSparseAttentionBaseApiTilingData *__restrict tilingData = nullptr;
...
__aicore__ inline void PromptAttentionPrefill<T, prec_type2>::Init(__gm__ uint8_t *_query, __gm__ uint8_t *_key,
                                ...
                                const BlitzSparseAttentionBaseApiTilingData* __restrict tiling)
{
    tilingData = tiling;
