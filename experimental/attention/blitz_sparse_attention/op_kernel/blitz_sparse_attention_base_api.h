...
/*!
 * \file blitz_sparse_attention_base_api.h
 * \brief
 */
#ifndef BLITZ_SPARSE_ATTENTION_BASE_API_H
#define BLITZ_SPARSE_ATTENTION_BASE_API_H
...
#include "blitz_sparse_attention_base_common.h"
...
template <typename PFAT>
class BlitzSparseAttentionBaseApiHighPerformance {
public:
    __aicore__ inline BlitzSparseAttentionBaseApiHighPerformance() {};
...
template <typename PFAT>
class BlitzSparseAttentionBaseApiHighPrecisionV {
public:
    __aicore__ inline BlitzSparseAttentionBaseApiHighPrecisionV() {};
    __aicore__ inline void Init(__gm__ uint8_t*  query, __gm__ uint8_t*  key, __gm__ uint8_t*  value,
                                __gm__ uint8_t* pseShift, __gm__ uint8_t*  attenMask,
                                __gm__ uint8_t* actualSeqLengths, __gm__ uint8_t* actualSeqLengthsKV, __gm__ uint8_t* blocktable,
                                __gm__ uint8_t* queryPaddingSize, __gm__ uint8_t* kvPaddingSize,
...
#endif // BLITZ_SPARSE_ATTENTION_BASE_API_H
