 ...
 */
/*!
 * \file test_blitz_sparse_attention_tiling.cpp
...
TEST_F(Ts_Pfa_Ascend910B2, blitz_sparse_attention_tiling_int8_in_fp16_out)
{
    PfaCase cs;
    cs.mParam.b = 1;
    cs.mParam.n = 40;
...
TEST_F(Ts_Pfa_Ascend910B2, blitz_sparse_attention_BNSD_attenMask_sparse_mode4_case0)
{
    PfaCase cs;
    cs.mParam.b = 1;
    cs.mParam.n = 8;
...
TEST_F(Ts_Pfa_Ascend910B2, blitz_sparse_attention_BNSD_attenMask_sparse_mode4_case1)
{
    PfaCase cs;
    cs.mParam.b = 1;
    cs.mParam.n = 12;
...
TEST_F(Ts_Pfa_Ascend910B2, blitz_sparse_attention_BNSD_attenMask_sparse_mode4_case2)
{
    PfaCase cs;
    cs.mParam.b = 1;
    cs.mParam.n = 8;
...
TEST_F(Ts_Pfa_Ascend910B2, blitz_sparse_attention_tiling_bf16)
{
    PfaCase cs;
    cs.mParam.b = 2;
    cs.mParam.n = 1;
...
TEST_F(Ts_Pfa_Ascend910B2, blitz_sparse_attention_tiling_3)
{
    PfaCase cs;
    cs.mParam.b = 2;
    cs.mParam.n = 2;
...
TEST_F(Ts_Pfa_Ascend910B2, blitz_sparse_attention_tiling_int8_in_int8_out)
{
    PfaCase cs;
    cs.mParam.b = 2;
    cs.mParam.n = 40;
...
TEST_F(Ts_Pfa_Ascend910B2, blitz_sparse_attention_tiling_4)
{
    PfaCase cs;
    cs.mParam.b = 2;
    cs.mParam.n = 2;
...
TEST_F(Ts_Pfa_Ascend910B2, blitz_sparse_attention_tiling_5)
{
    PfaCase cs;
    cs.mParam.b = 1;
    cs.mParam.n = 40;
...
TEST_F(Ts_Pfa_Ascend910B2, blitz_sparse_attention_tiling_6)
{
    PfaCase cs;
    cs.mParam.b = 2;
    cs.mParam.n = 40;
...
TEST_F(Ts_Pfa_Ascend910B2, blitz_sparse_attention_tiling_7)
{
    PfaCase cs;
    cs.mParam.b = 2;
    cs.mParam.n = 40;
...
TEST_F(Ts_Pfa_Ascend910B2, blitz_sparse_attention_tiling_9)
{
    PfaCase cs;
    cs.mParam.b = 1;
    cs.mParam.n = 40;
...
TEST_F(Ts_Pfa_Ascend910B2, blitz_sparse_attention_tiling_10)
{
    PfaCase cs;
    cs.mParam.b = 1;
    cs.mParam.n = 40;
