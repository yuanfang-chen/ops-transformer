...
#include "sparse_attn_sharedkv_kvcache.h"
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvSwa<CubeBlockType, VecBlockType>::InitMMResBuf()
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvSwa<CubeBlockType, VecBlockType>::InitLocalBuffer()
{
    vecBlock.InitLocalBuffer(pipe, constInfo);
}

template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvSwa<CubeBlockType, VecBlockType>::ComputeConstexpr()
{
    // 计算轴的乘积
    if ASCEND_IS_AIC {
        constInfo.bSize = this->sharedParams.bSize;
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvSwa<CubeBlockType, VecBlockType>::InitUniqueConstInfo()
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvSwa<CubeBlockType, VecBlockType>::Process()
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvSwa<CubeBlockType, VecBlockType>::ProcessMainLoop()
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvSwa<CubeBlockType, VecBlockType>::ComputeAxisIdxByBnAndGs1(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvSwa<CubeBlockType, VecBlockType>::SetRunInfo(
...
SparseAttnSharedkvSwa<CubeBlockType, VecBlockType>::InitUniqueRunInfo(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseAttnSharedkvSwa<CubeBlockType, VecBlockType>::ComputeBmm1Tail(
