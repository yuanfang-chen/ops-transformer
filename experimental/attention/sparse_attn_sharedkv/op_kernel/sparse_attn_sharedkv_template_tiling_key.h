...
/*!
 * \file sparse_flash_attention_antiquant_template_tiling_key.h
 * \brief
 */
...
#define SCFA_LAYOUT_BSND 0
#define SCFA_LAYOUT_TND 1
#define SCFA_LAYOUT_PA_BSND 2
...
ASCENDC_TPL_UINT_DECL(LAYOUT_T, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST,
                      SCFA_LAYOUT_BSND, SCFA_LAYOUT_TND),
ASCENDC_TPL_UINT_DECL(KV_LAYOUT_T, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST,
                      SCFA_LAYOUT_BSND, SCFA_LAYOUT_TND, SCFA_LAYOUT_PA_BSND),
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_UINT_SEL(LAYOUT_T, ASCENDC_TPL_UI_LIST, SCFA_LAYOUT_BSND, SCFA_LAYOUT_TND),
    ASCENDC_TPL_UINT_SEL(KV_LAYOUT_T, ASCENDC_TPL_UI_LIST, SCFA_LAYOUT_BSND,
                         SCFA_LAYOUT_TND, SCFA_LAYOUT_PA_BSND),
    ASCENDC_TPL_UINT_SEL(TEMPLATE_MODE, ASCENDC_TPL_UI_LIST, C_TEMPLATE),
    ),

    ASCENDC_TPL_ARGS_SEL(
    ASCENDC_TPL_BOOL_SEL(FLASH_DECODE, 0),
    ASCENDC_TPL_UINT_SEL(LAYOUT_T, ASCENDC_TPL_UI_LIST, SCFA_LAYOUT_BSND,
                         SCFA_LAYOUT_TND),
    ASCENDC_TPL_UINT_SEL(KV_LAYOUT_T, ASCENDC_TPL_UI_LIST, SCFA_LAYOUT_PA_BSND,
                         SCFA_LAYOUT_BSND, SCFA_LAYOUT_TND),
