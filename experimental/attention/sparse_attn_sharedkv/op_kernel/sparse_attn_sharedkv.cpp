...
sparse_attn_sharedkv(__gm__ uint8_t *query, __gm__ uint8_t *oriKV, __gm__ uint8_t *cmpKV,
                       ...
                       __gm__ uint8_t *seqUsedKV, __gm__ uint8_t *attentionOut, __gm__ uint8_t *workspace,
