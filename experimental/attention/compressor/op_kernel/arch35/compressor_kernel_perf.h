...
__aicore__ inline void CompressorKernelPerf<COMP>::SplitK()
{
    ...
    // printf("[SplitK] dBasicBlockNum:%u,  kBaseNum:%u, kBaseSize:%u, kStartIdx_:%u, dealKSize_:%u, mGroupNum:%u, mCurGroupIdx:%u\n",
    //         constInfo.dBasicBlockNum, constInfo.kBaseNum, constInfo.kBaseSize, kStartIdx_, dealKSize_, constInfo.mGroupNum, constInfo.mCurGroupIdx);
}
