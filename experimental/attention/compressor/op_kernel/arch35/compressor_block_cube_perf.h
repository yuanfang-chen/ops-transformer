...
template <typename COMP>
__aicore__ inline void CompressorBlockCubePerf<COMP>::CopyXGmToL1(LocalTensor<X_T> xL1Tensor,
...
template <typename COMP>
__aicore__ inline void CompressorBlockCubePerf<COMP>::LoadAToL0(LocalTensor<X_T> aL0Tensor,
