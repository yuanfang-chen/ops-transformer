...
{
    int64_t cubeSOuterOffset = sOuterLoopIdx * runParam.qSNumInOneBlock; // s1StartIdx
...
__aicore__ inline bool ComputeS2LoopInfo(int64_t bnIndex, int64_t gS1Index, __gm__ int32_t *cuSeqlensQAddr,
    GlobalTensor<int32_t>& oriTopkLengthGm, bool hasOriTopkLength, GlobalTensor<int32_t>& cmpTopkLengthGm, bool hasCmpTopkLength,
    RunParamStr& runParam, const ConstInfo &constInfo)
{
    ...
    runParam.oriSparseBlockCount = hasOriTopkLength ? oriTopkLengthGm.GetValue(runParam.boIdx) :
