...
#define KV_QUANT_CONTIGUOUS 1
#define KV_QUANT_NONCONTIGUOUS 2

#define ORI_CMP_SCFA_TEMPLATE 4

#define TOPK_INDEX 1
#define TOPK_OFFSET 2
// 模板参数支持的范围定义
...
ASCENDC_TPL_UINT_DECL(TEMPLATE_MODE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, SWA_TEMPLATE, CFA_TEMPLATE, SCFA_TEMPLATE, ORI_SCFA_TEMPLATE, ORI_CMP_SCFA_TEMPLATE),
ASCENDC_TPL_BOOL_DECL(SPLIT_G, 0, 1),
ASCENDC_TPL_UINT_DECL(KV_QUANT_MODE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, KV_QUANT_CONTIGUOUS, KV_QUANT_NONCONTIGUOUS),
ASCENDC_TPL_UINT_DECL(TOPK_VALUE_MODE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, TOPK_INDEX, TOPK_OFFSET),
);
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_UINT_SEL(TEMPLATE_MODE, ASCENDC_TPL_UI_LIST, SWA_TEMPLATE, CFA_TEMPLATE, SCFA_TEMPLATE, ORI_SCFA_TEMPLATE, ORI_CMP_SCFA_TEMPLATE),
    ASCENDC_TPL_BOOL_SEL(SPLIT_G, 0, 1),
    ASCENDC_TPL_UINT_SEL(KV_QUANT_MODE, ASCENDC_TPL_UI_LIST, KV_QUANT_CONTIGUOUS, KV_QUANT_NONCONTIGUOUS),
    ASCENDC_TPL_UINT_SEL(TOPK_VALUE_MODE, ASCENDC_TPL_UI_LIST, TOPK_INDEX, TOPK_OFFSET),
    ),
);
